...
export const COMMON_BTN = {
    ...
    EDIT_BTN: 'editbtn', // 修改
    COPY_BTN:'copybtn', // 复制
    DELETE_BTN:'deletebtn', // 删除
    SUBMIT_BTN:'submitbtn', // 提交
    SUBMIT_GROUP:'submitgroup', // 提交分组
    UNSUBMIT_BTN:'unsubmitbtn', // 收回
    ENTRUST_BTN:'entrustbtn', // 委托办理
    ENTRUST_GROUP:'entrustgroup', // 委托办理分组
    UNENTRUST_BTN:'unentrustbtn', // 取消委托
    ENCLOSURE_BTN:'enclosurebtn', // 附件
    LINK:'link', // 联查
    LINK_GROUP:'linkgroup', // 联查分组
    APPROVALOPINION_BTN:'approvalopinionbtn', // 联查审批意见
    DEBITCONTRACT_BTN:'debitcontractbtn', // 联查借款合同
    CONTRACT_BTN: 'contractbtn', // 联查贷款合同
    PRINT_BTN:'printbtn', // 打印
    PRINT_GROUP:'printgroup', // 打印分组
    OUTPUT_BTN:'outputbtn', // 输出
    REFRESH_BTN:'refreshbtn', // 刷新
    EDIT_INNER_BTN:'edit_innerbtn', // 修改行按钮
    DELETE_INNER_BTN:'delete_innerbtn', // 删除行按钮
    SUBMIT_INNER_BTN:'submit_innerbtn', // 提交行按钮
    UNSUBMIT_INNER_BTN:'unsubmit_innerbtn', // 收回行按钮
