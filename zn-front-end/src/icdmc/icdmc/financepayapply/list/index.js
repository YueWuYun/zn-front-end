...
class List extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            tabStatus: {
                DTJ: {
                    num: "0",
                    content: "36362IAP-000025" /* 国际化处理： 待提交*/,
                    status: "-1"
                },
                DSP: {
                    num: "0",
                    content: "36362IAP-000026" /* 国际化处理： 审批中*/,
                    status: "3"
                },
                all: {
                    num: "",
                    content: "36362IAP-000027" /* 国际化处理： 全部*/,
                    status: "5"
                }
            }, //tab页签页签
    ...
    componentWillMount() {
        ...
        this.props.MultiInit.getMultiLang({
            moduleId: ["36362IAP", "3636PUBLIC","36360PUBLIC"],
            domainName: "icdmc",
            callback
        });
            ...
            <div className="nc-bill-list" >
                ...
                <div className="nc-bill-table-area">
                    {createSimpleTable(this.tableId, {
                        ...
                        onSelected: selectedFinancepayApplyEvent.bind(this),
                ...
                {compositedisplay && (
                    <ApprovalTrans
                        title={
                            this.state.json["36362IAP-000006"]
                        } /* 国际化处理： 指派*/
                        data={compositedata}
