...
class Card extends Component {
    constructor(props) {
        ...
        this.copyUrl = `${baseReqUrl}${javaUrl.copy}`; //复制
    ...
    componentWillMount() {
        ...
        this.props.MultiInit.getMultiLang({
            moduleId: ["36362IAP", "36630PUBLIC","3636PUBLIC","36360PUBLIC"],
            domainName: "icdmc",
            callback
        });
    ...
    getTableHead = () => {
        return (
            <div className="shoulder-definition-area">
                <div className="definition-icons">f
                            ...
                            <div className="header-title-search-area">
                                {
                                    c =='36362IAPA'?
                                        createBillHeadInfo({
                                            title: this.state.json["36362IAP-000005"], //标题/* 国际化处理： 贷款合同*/
