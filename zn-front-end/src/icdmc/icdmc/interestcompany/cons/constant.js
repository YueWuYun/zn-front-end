...
//appcode单据类型
export const appCode = "36362FCIB";
//小应用ID(??, 多语使用)
...
//被联查缓存命名空间
export const linkdataSource = "icdmc.interestcompany.linkdataSource"
//被联查标识
...
export const billType='36CN';
/**
 * 列表
 */
// 列表页面相关编码
export const list = {
    pageCode: "36362FCIB_LIST", //列表页面code
...
// 卡片页面相关编码
export const card = {
    pageCode: "36362FCIB_CARD", //卡片页面code
    pageCode_link: "36630BCIBL_CARD", //联查页面code
 ...
 *  查询借款合同pk
 */
export const QueryLoanContractPK_URL = '/nccloud/icdmc/icdmc/queryloanpk.do';
/*HsJGgXoCueKidK+JSYUoEmNcGPqdTjz1l6/cf28pPu0kUlBaidALKwDeE66avFOR*/