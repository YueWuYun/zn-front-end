...
class List extends Component {
    ...
    componentWillMount() {
        ...
        this.props.MultiInit.getMultiLang({
            moduleId: ["36362FCIB", "3636PUBLIC", "36360PUBLIC"],
            domainName: "icdmc",
            callback
        });
    }
        ...
        if (pks) {
            ...
            let searchData = {
                querycondition: {
                    ...
                    conditions: [
                        {
                            field: "pk_interestlisticdmc", //发行编号
    ...
    render() {
        ...
        let { printOut, showUploader, billInfo } = this.state;
                ...
                {!islinked && (
                    <div className="nc-bill-search-area">
                        {NCCreateSearch(this.searchId, {
                            ...
                            // searchBtnName: this.state.json[ "36362FCIB-000007"] /* 国际化处理： 查询*/,
