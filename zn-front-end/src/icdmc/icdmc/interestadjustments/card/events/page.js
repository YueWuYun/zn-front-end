        ...
        success: (res) => {
            ...
            if (success) {
                ...
                if (isRefresh) {// 更新列表缓存
                    ...
                    toast({color: 'success', content: this.state.json["36360ICIA-000033"]});
                }
            }
        },
        error: (res) => {
 ...
 * @param {*} id  单据id
 */
export function getCopyData (id){
    ajax({
        ...
        success: (res) => {
            ...
            if (success) {
                ...
                this.props.form.setFormItemsDisabled(this.formId, { pk_fundorg: true });
            }
        },
        error: (res) => {
