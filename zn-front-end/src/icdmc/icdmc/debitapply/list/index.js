...
import { go2CardCheck } from 'src/tmpub/pub/util/index';
...
class List extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            tabStatus: {
                DTJ: {
                    num: "0",
                    content: "36362IDA-000014" /* 国际化处理： 待提交*/,
                    status: "-1"
                },
                DSP: {
                    num: "0",
                    content: "36362IDA-000015" /* 国际化处理： 待审批*/,
                    status: "3"
                },
                all: {
                    num: "",
                    content: "36362IDA-000016" /* 国际化处理： 全部*/,
                    status: ""
                }
            }, //tab页签
    ...
    getAssginUsedr = val => {
        bodyBtnOperation.call(
            ...
            javaUrl.commit,
            this.state.json["36362IDA-000017"],
            false,
            val
        ); /* 国际化处理： 提交成功*/
    };
            ...
            <div className="nc-bill-list" >
                ...
                <NCDiv areaCode={NCDiv.config.HEADER} className="nc-bill-header-area">
                        <div className="header-title-search-area">
                            {createBillHeadInfo(
								{
                                    title: this.state.json["36362IDA-000002"],
                                    // loadMultiLang(this.props, '36362IDA-000002'),//国际化处理： 内部借款申请
                ...
                <div className="nc-bill-search-area">
                    {NCCreateSearch(this.searchId, {
                        ...
                        // searchBtnName: this.state.json["36362IDA-000018"] /* 国际化处理： 查询*/,
