            ...
            success: (res) => {
                ...
                if (success) {
                    if (data.grid.table.rows.length > 0) {
                        ...
                        toast({
                            duration: 3,
                            //title: this.props.MutiInit.getIntl("36360ICI") && this.props.MutiInit.getIntl("36360ICI").get('36360ICI-000024')+data.grid[tableId].pageInfo.total+this.props.MutiInit.getIntl("36360ICI") && this.props.MutiInit.getIntl("36360ICI").get('36360ICI-000025')/**国际化处理：查询成功 */,
                            title: this.state.json['36360ICI-000024']+data.grid[tableId].pageInfo.total+this.state.json['36360ICI-000025'],
                            color: 'success'
                        })
                    } else {
                        ...
                        toast({
                             color: 'warning', 
                             //content: this.props.MutiInit.getIntl("36360ICI") && this.props.MutiInit.getIntl("36360ICI").get('36360ICI-000022') 
                             content: this.state.json['36360ICI-000022']
                        });
                    }
                }
