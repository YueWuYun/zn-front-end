...
//引入常量定义
import { base_url, grid_code, list_page_code, list_search_code, viewmod_deal, billtype, print_nodekey,
     print_templateid, funcode, dataSource, card_page_id,dataSourceLink,
     app_code,card_from_id,pk_allocatereceipt,vbillno,elecsignPrintParameter } from '../cons/constant.js';
...
export const VoucherLinkBill = function (props, pageCode, tableId) {
    ...
    if (checkedData && checkedData.length > 0) {
        ...
        ajax({
            url: '/nccloud/sf/allocatereceipt/allocatereceiptVoucherLinked.do',
            data: data,
            success: (res) => {
