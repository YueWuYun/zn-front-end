...
class List extends Component {
	constructor(props) {
		...
		this.tableId = 'table_allocatelog_01';
	...
	getData = (serval) => {
		...
		let data = {
			...
			queryAreaCode: 'search_allocatelog_01',
			oid: '1001Z61000000000B58X',
			queryType: 'simple'
		};
	};
	//双击进卡片
	DoubleClick = (record, index, props, e) => {
		props.pushTo("/card", { status: "browse", id: record.pk_allocatelog_h.value, pagecode: jsoncode.cpageid });
	}
	//页签筛选
			...
			<div className="nc-bill-list">
				<NCDiv areaCode={NCDiv.config.HEADER} className="nc-bill-header-area">
					<div className="header-title-search-area">
						{createBillHeadInfo(
							{
								title: this.props.MutiInit.getIntl("36321AALQ") && this.props.MutiInit.getIntl("36321AALQ").get('36321AALQ-000005'),//标题
