...
import { createPage, ajax, base, high, toast, cacheTools,getMultiLang,createPageIcon} from 'nc-lightapp-front';
...
import { base_url,module_id,module_name ,module_tmpub_name,module_tmpub_id,button, sourceModel_SF, SHOWMODEL_LIULAN,SHOWMODEL_BULU, list_table_id, list_page_id, list_search_id, viewmod_deal, billtype, print_nodekey, print_templateid, funcode, dataSource
...
import { card_page_id } from '../../allocate_pay/cons/constant';
			...
			<div className="nc-bill-list">
				...
				{/* <div className="tab-definInfo-area"> */}
					{<NCTabs activeKey={this.state.activeKey}
						...
						<NCTabPane key={'0'} tab={
							<span>
								{loadMultiLang(this.props,'36320FA-000097')+ '('} 
						...
						<NCTabPane key={'1'} tab={
							<span>
								{loadMultiLang(this.props,'36320FA-000098')+ '('}
						...
						<NCTabPane key={'2'} tab={
							<span>
								{loadMultiLang(this.props,'36320FA-000099')+ '('}
						...
						<NCTabPane key={'3'} tab={
							<span>
								{loadMultiLang(this.props,'36320FA-000100')+ '('}
						...
						/>
						<NCTabPane key={'6'} tab={
							loadMultiLang(this.props,'36320FA-000101')
						}
						/>
					</NCTabs>}
				{/* </div> */}
				...
				{createModal('delete', {
					...
					beSureBtnClick: listMultiOperator.bind(this, this.props, list_page_id, list_table_id, 'pk_allocate_h', '/nccloud/sf/allocation/delete.do', loadMultiLang(this.props,'36320FA-000059'), dataSource)/* 国际化处理： 删除*/
				})}
				...
				<div>
					{assignShow && <ApprovalTrans
						...
						getResult={(value) => {
							...
							listSingleOperatorNoRecord(this.props, list_page_id, list_table_id, base_url + 'commit.do', billId, ts, rowIndex, loadMultiLang(this.props,'36320FA-000006'), dataSource, true, extParam);/* 国际化处理： 提交成功！*/
						}}
						cancel={() => {
							this.setState({ assignShow: false, assignData: null })
						}}
