		...
		return (
			<div className="nc-bill-card">
				...
				{createModal('delmodal', {
					title: loadMultiLang(this.props, '36320AAC-000024'), // 弹框表头信息/* 国际化处理： 删除*/
					content: loadMultiLang(this.props, '36320AAC-000025'), //this.modalContent(), //弹框内容，可以是字符串或dom/* 国际化处理： 确认要删除吗?*/
					...
					rightBtnName: loadMultiLang(this.props, '36320AAC-000009'), //左侧按钮名称,默认关闭/* 国际化处理： 取消*/
					leftBtnName: loadMultiLang(this.props, '36320AAC-000026') //右侧按钮名称， 默认确认/* 国际化处理： 确认*/
				})}
				{/** 审批流指派 **/}
				<div>
