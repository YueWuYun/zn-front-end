...
let { NCTabsControl, NCFormControl,NCAffix } = base;
	...
	render() {
		...
		return (
			<div className="nc-bill-list">
				<NCAffix>
					<div className="nc-bill-header-area">
						<div className="header-title-search-area">
							<h2 className="title-search-detail">{loadMultiLang(this.props,'36320FAA-000042')}</h2>{/* 国际化处理： 下拨申请核准*/}
						</div>
				...
				{!islink && <div className="tab-definInfo-area">
					<NCTabs activeKey={this.state.selectedGroup}
						...
						<NCTabPane key={'0'} tab={
							loadMultiLang(this.props,'36320FAA-000021')/* 国际化处理： 待提交*/
							+ '(' + (numvalues && numvalues.WAITCOMMIT || 0) + ')'}
						/>
						<NCTabPane key={'1'} tab={
							loadMultiLang(this.props,'36320FAA-000022')/* 国际化处理： 审批中*/
							+ '(' + (numvalues && numvalues.WAITAPPROVE || 0) + ')'}
						/>
						<NCTabPane key={'2'} tab={
							loadMultiLang(this.props,'36320FAA-000023')/* 国际化处理： 待下拨*/
							+ '(' + (numvalues && numvalues.WAITALLOCATE || 0) + ')'}
						/>
						<NCTabPane key={'3'} tab={
