...
export default function click(props) {
	...
	if (!selectdata || selectdata.length == 0) {
		...
		if (billstatus == '2') {//待委托
			props.button.setButtonDisabled(['Entrust', 'File', 'Uncommit'], false);
		}
		if (billstatus == '3') {//处理中
		...
		// } else if (activeKey == 1) { //处理中
		// 	props.button.setButtonDisabled(['Uncommit', ], false);
		// } else if (activeKey == 2) { //带委托
		// 	props.button.setButtonDisabled(['Entrust','Unentrust','Uncommit'], false);
