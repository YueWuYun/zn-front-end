...
//被联查页面pagecode
export const linklist_page_code = '';
//查询区域 code
 ...
 */
//页面编码
export const card_page_id = '36320AA_C01';
//表头表单编码
...
//联查页面缓存命名空间
export const dataSourceLink ='sf.allocation.allocateapply.dataSourceLink';
