...
import { dataSource, pk_deliveryreceipt, grid_code ,islink,module_name,module_id,app_code, card_from_id, receiptPk, receiptBillType} from '../cons/constant.js';
import { setPropCache, saveMultiLangRes, loadMultiLang, showErrBtn, createCardWebSocket } from "../../../../tmpub/pub/util/index";
...
class Card extends Component {
	...
	refresh = () => {
		...
		if (this.props.getUrlParam('status') === 'browse') {
			//后台grid只接受pageid。
			let data = { pks: [this.props.getUrlParam('id')], pageid: '36320FCRF_C01' };
			ajax({
			...
			<div className="nc-bill-card">
				...
				<NCDiv areaCode={NCDiv.config.HEADER} className="nc-bill-header-area">
					<div className="header-title-search-area">
							{/* {this.state.billno ? loadMultiLang(this.props, '36320FCRF-000016') + this.state.billno : loadMultiLang(this.props, '36320FCRF-000017')}国际化处理： 上收回单:,上收回单 */}
							{
									createBillHeadInfo(
										{
											title: loadMultiLang(this.props, '36320FCRF-000017'),  //标题/* 国际化处理： 下拨回单*/
