...
//引入常量定义
import { base_url, grid_code, list_page_id, list_search_code, viewmod_deal,
    billtype, print_nodekey, print_templateid, funcode,dataSource, card_page_id,
    elecsignPrintParameter,app_code,card_from_id,pk_deliveryreceipt,vbillno } from '../cons/constant.js';
