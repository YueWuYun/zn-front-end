    ...
    if(searchVal){
        ...
        ajax({
            ...
            success: (res) => {
                ...
                if (success) {
                    if(data){
                        toast({ color: 'success', content: loadMultiLang(this.props,'36320FCRF-000026')});/* 国际化处理： 查询成功*/
                        this.props.table.setAllTableData(this.tableId, data[this.tableId]);
                    }else{
                        toast({color: 'warning', content: loadMultiLang(this.props,'36320FCRF-000023')});/* 国际化处理： 未查询出符合条件的数据!*/
