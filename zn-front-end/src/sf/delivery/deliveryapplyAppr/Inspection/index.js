...
export default class Inspection extends Component {
    ...
    static defaultProps = {
        ...
        // 取消回调函数
        cancel: () => {
            console.warn('没有设置取消回调函数');
        },
        // 确认回调函数
        affirm: () => {
            console.warn('没有设置确认回调函数');
        }
    }
    componentDidMount() { }
            ...
            if (this.state.step === 1) {
                return (
                    ...
                    >
                        ...
                        <NCModal.Footer>
                            <NCButton className="button-undefined u-button-border" onClick={this.props.cancel}>取消</NCButton>
                        </NCModal.Footer>
                    </NCModal>
                )
            } else {
                return (
                    ...
                    >
                        ...
                        <NCModal.Footer>
                            <NCButton className="button-primary" onClick={this.affirm}>联查</NCButton>
                            <NCButton className="button-undefined u-button-border" onClick={this.cancelDialog}>取消</NCButton>
                        </NCModal.Footer>
