...
let { NCTabsControl,NCDiv,NCAffix } = base;
...
import { dataSource, pk_deliveryreceipt, list_page_code, grid_code, islink ,dataSourceLink,module_id,app_code
		,receiptPk,receiptBillType} from '../cons/constant.js';
...
//		initTemplate.call(this, props);
	...
	getNtbLinkBillData = () => {
		...
		ajax({
			url: '/nccloud/sf/deliveryreceipt/deliveryreceiptntblinkbill.do',
			data: { 
			...
			success: (res) => {
				...
				if (success) {
					if (data.grid) {
						...
						toast({ color: 'warning', content: loadMultiLang(this.props,'36320FCR-000048')});/* 国际化处理： 未联查到对应的下拨回单!*/
			...
			<div className="nc-bill-list">
				...
				<NCDiv areaCode={NCDiv.config.HEADER} className="nc-bill-header-area">
					<div className="header-title-search-area">
						...
						{createBillHeadInfo(
                                {
                                    title: loadMultiLang(this.props, '36320FCR-000021'),//标题{/* 国际化处理： 单位上收回单*/}
