...
export default function (props, id) {
  ...
  switch (id) {
    ...
    case 'Saveadd':
      ...
      //     //地址栏跳转
      //     //window.location.href = '../card/index.html#status=add';
      //     props.pushTo("/card", {
    ...
    case 'Savecommit':
      ...
      // orgVersionView(props, jsoncode.formcode);
      // ajax({
      //   url: '/nccloud/sf/deliveryrule/deliveryrulesavecommit.do',
      //   data: props.createMasterChildData('36320ACC_C01', this.formId, this.tableId),
      //   success: (res) => {
      //     if (res.success) {
      //       if (res.data) {
    ...
    //   break;
    // case 'Deletebody':
    //   let currRows = props.cardTable.getCheckedRows("table_deliveryrule_C01");
    //   let currSelect = [];
    ...
    //     }
    //   }
    //   props.cardTable.delRowsByIndex("table_deliveryrule_C01", currSelect);
    //   break;
    // case 'Copybody':
