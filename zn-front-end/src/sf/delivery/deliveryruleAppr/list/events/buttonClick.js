...
export default function buttonClick(props, id) {
    ...
    switch (id) {
        ...
        // 头部 提交
        case 'Commit':
            listMultiOperator(props, jsoncode.pagecode, jsoncode.tablecode, 'pk_deliveryrule_h', requesturl.batchcommit, '提交',jsoncode.dataSource, false, null, (props, data) => {
				let { workflow } = data;
				//有指派信息，则指派，没有则重绘界面
        ...
        // 头部 收回
        case 'Uncommit':
            listMultiOperator(props, jsoncode.pagecode, jsoncode.tablecode, 'pk_deliveryrule_h', requesturl.batchuncommit, '收回', jsoncode.dataSource);
            break;
        //收回 
        // case 'Uncommit':
        //     debugger
        ...
        //     }
        //     ajax({
        //         url: '/nccloud/sf/deliveryrule/deliveryruleuncommit.do',
        //         data: getrequestdata(this),
        //         success: (res) => {
        //             let { success, data } = res;
        //             if (success) {
        //                 toast({ color: 'success', content: '收回成功' });
        //                 let searchData = props.search.getAllSearchData('search_deliveryrule_01');
        ...
        //     }
        //     ajax({
        //         url: '/nccloud/sf/deliveryrule/deliveryruleenable.do',
        //         data: getrequestdata(this),
        //         success: (res) => {
        //             let { success, data } = res;
        //             if (success) {
        ...
        // 头部 启用
        case 'Enable':
            listMultiOperator(props, jsoncode.pagecode, jsoncode.tablecode, 'pk_deliveryrule_h', requesturl.batchenable, '启用', jsoncode.dataSource);
            break;
        // 头部 停用
        case 'Disable':
            listMultiOperator(props, jsoncode.pagecode, jsoncode.tablecode, 'pk_deliveryrule_h', requesturl.batchdisable, '停用', jsoncode.dataSource);
            break;
        //刷新
        case 'Refresh':
        ...
        //     }
        //     ajax({
        //         url: '/nccloud/sf/deliveryrule/deliveryruledisable.do',
        //         data: getrequestdata(this),
        //         success: (res) => {
        //             let { success, data } = res;
        //             if (success) {
        ...
        //         return
        //     }
        //     pkMapTs[selectedData[0].data.values.pk_deliveryrule_h.value] = selectedData[0].data.values.ts.value;
