...
class List extends Component {
	...
	getData = (refreshFlag) => {
		if(!this.flag){
			this.flag = this.props.getUrlParam('scene') == 'pk_src';
		}
	...
	selectedChangeFn = (props, moduleId, newVal, oldVal) => {
		...
		if(this.props.getUrlParam('scene') == 'pk_src'){
	...
	// 		status: 'browse',
	// 		id: record.pk_spepay_receipt_h.value,
	// 	});
	// }
	...
	DoubleClick = (record, index, props, e) => {
		...
		if(this.flag){
				...
				pushToData["id"] =record.pk_spepay_receipt_h.value;
			}else{
				pushToData["id"] = record.pk_spepay_receipt_h.value;
			}
	...
	render() {
		...
		return (
			<div className="nc-bill-list">
				...
				{!linkScene &&<div className="nc-bill-search-area">
