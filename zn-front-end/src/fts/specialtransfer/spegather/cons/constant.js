...
//查询区域缓存标志
export const searchArea = '36300STG_searchAreaData';
//选中的页签缓存标志
export const selectedGroupArea = '36300STG_selectedGroupData';
//判断是否是联查过来的数据
export const islink = 'islink';
//被联查数据
export const linkdata = 'linkdata';
//判断被联查时是否是单条数据（若单条直接跳转卡片 且无返回按钮）
export const islinkone = 'islinkone';
//正式打印与补充打印相关
export const elecsignPrintParameter = {
    actionUrl: '/nccloud/fts/specialtransfer/specialtransferElecsignprint.do',
    //正式打印模版标示
...
//联查页面编码
export const linklist_page_id = '36300STG_LLink01';
//列表表头按钮
...
//表体编辑区（侧拉）编码
export const card_table_id_edit = 'spegatherb_edit';
//表体浏览态编码
export const card_table_id_browse = 'spegatherb_browse';
//节点编码
export const appcode = '36300STG';
//来源模块--现金管理
export const sourcebill = 'CMP';
//表体主键
export const card_table_pk = 'pk_spegather_b';
//来源模块
