...
const card = asyncComponent(() => import(/* webpackChunkName: "fts/specialtransfer/spepay/card/card" */ /* webpackMode: "eager" */ '../card'));
const linkcard = asyncComponent(() => import(/* webpackChunkName: "fts/specialtransfer/spepay/card/card" */ /* webpackMode: "eager" */ '../linkcard'));
const linklist = asyncComponent(() => import(/* webpackChunkName: "fts/specialtransfer/spepay/card/card" */ /* webpackMode: "eager" */ '../linklist'));
