...
//引入配置常量定义
import { module_id, base_url, card_page_id, card_from_id, card_table_id,link_card_page_id } from '../../cons/constant.js';
//引入公共api
...
export default function afterEvent(props, moduleId, key, value, changedrows, i) {
	...
	switch (key) {
		...
		case 'pk_org':
			//获取页面数据
			eventData = props.createHeadAfterEventData(link_card_page_id, card_from_id, [card_table_id], card_from_id, key, value);
			//获取编辑的值
		...
		case 'pk_getfinanceorg':
			//获取页面数据
			eventData = props.createBodyAfterEventData(link_card_page_id, card_from_id, [card_table_id], card_table_id, key, changedrows);
		...
		case 'saveadd':
			//获取页面数据
			eventData = props.createHeadAfterEventData(link_card_page_id, card_from_id, [card_table_id], card_table_id, key, value);
			handleSpePayHeadAfterEdit(props, moduleId, key, value, changedrows, i, eventData);
			break;
		default:
			break;
