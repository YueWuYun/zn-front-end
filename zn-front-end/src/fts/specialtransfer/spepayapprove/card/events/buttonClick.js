...
import { base_url, card_page_id, card_from_id, card_table_id, billtype, print_nodekey, funcode, print_templateid, viewmod_deal, sourceModel, list_page_url, card_page_url, dataSource, pkName } from '../../cons/constant';
...
export const buttonClick = function (props, key, text, record, index) {
  ...
  switch (key) {
    ...
    case 'Cancel':
      promptBox({
        color: "warning",
        title: this.props.MutiInit.getIntl("1880000025") && this.props.MutiInit.getIntl("1880000025").get('1880000025-000002'),/* 国际化处理： 取消*/
        content: this.props.MutiInit.getIntl("1880000025") && this.props.MutiInit.getIntl("1880000025").get('1880000025-000004'),/* 国际化处理： 确定要取消吗？*/
    ...
    //提交
    case 'Commit':
      cardOperator(props, card_page_id, card_from_id, [card_table_id], pkName, base_url + 'spepaycommit.do', this.props.MutiInit.getIntl("1880000025") && this.props.MutiInit.getIntl("1880000025").get('1880000025-000007'), dataSource, commitAssign.bind(this));/* 国际化处理： 提交成功！*/
      break;
    //收回
    case 'UnCommit':
      cardOperator(props, card_page_id, card_from_id, [card_table_id], pkName, base_url + 'spepayuncommit.do', this.props.MutiInit.getIntl("1880000025") && this.props.MutiInit.getIntl("1880000025").get('1880000025-000008'), dataSource, this.toggleShow.bind(this));/* 国际化处理： 收回成功！*/
      break;
    //复制
    case 'Copy':
    ...
    //头部 制证
    case 'Voucher':
      cardOperator(props, card_page_id, card_from_id, [card_table_id], pkName, base_url + 'spepayvoucher.do', this.props.MutiInit.getIntl("1880000025") && this.props.MutiInit.getIntl("1880000025").get('1880000025-000009'), dataSource, this.toggleShow.bind(this));/* 国际化处理： 制证成功！*/
      break;
    //头部 取消制证
    case 'CancelVoucher':
      cardOperator(props, card_page_id, card_from_id, [card_table_id], pkName, base_url + 'spepaycancelvoucher.do', this.props.MutiInit.getIntl("1880000025") && this.props.MutiInit.getIntl("1880000025").get('1880000025-000010'), dataSource, this.toggleShow.bind(this));/* 国际化处理： 取消制证成功！*/
      break;
    //头部 经办
    case 'Decide':
      props.pushTo("/card", {
    ...
    case 'AddLine':
      ...
      if (!pk_org && !orgDisplay) {
        toast({
          color: 'warning',
          content: this.props.MutiInit.getIntl("1880000025") && this.props.MutiInit.getIntl("1880000025").get('1880000025-000011')/* 国际化处理： 请先填写资金组织！*/
        });
        return;
      }
    ...
    case 'DelLine':
      ...
      if (lineNumDel == null || lineNumDel == 0) {
        toast({
          'color': 'warning',
          'content': this.props.MutiInit.getIntl("1880000025") && this.props.MutiInit.getIntl("1880000025").get('1880000025-000012')/* 国际化处理： 表体无数据，不可删除*/
        });
        return false;
      }
    ...
    case 'CopyLine':
      ...
      if (lineNum == null || lineNum == 0) {
        toast({
          'color': 'warning',
          'content': this.props.MutiInit.getIntl("1880000025") && this.props.MutiInit.getIntl("1880000025").get('1880000025-000013')/* 国际化处理： 表体无数据，不可复制*/
        });
        return false;
      }
...
const qrySendBill = function (props) {
  if (!this.props.form.getFormItemsValue(card_from_id, 'pk_spepay_h').value) {
    toast({ color: 'warning', content: this.props.MutiInit.getIntl("1880000025") && this.props.MutiInit.getIntl("1880000025").get('1880000025-000016') });/* 国际化处理： 操作失败，无数据!*/
    return;
  }
...
const qryAccountBalance = function (props) {
  ...
  if (selectDatas == null || selectDatas.length == 0 || selectDatas.length > 1) {
    toast({ color: 'warning', content: this.props.MutiInit.getIntl("1880000025") && this.props.MutiInit.getIntl("1880000025").get('1880000025-000017') });/* 国际化处理： 请选中表体中的一行数据！*/
    return;
  }
