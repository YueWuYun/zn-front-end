 ...
 */
//节点编码
export const appcode = '36300STPAppr';
//应用编码
...
//功能编码
export const funcode = '36300STPAppr';
//打印 模板主键
 ...
 */
//页面编码
export const card_page_id = '36300STPAppr_card';
//表头表单编码
export const card_from_id = 'spepay_card_head';
//表体表格编码
export const card_table_id = 'spepay_card_body';
//表体编辑区（侧拉）编码
export const card_table_id_edit = 'spepay_card_body_form2';
//表体浏览态区域编码
export const card_table_id_browse = 'spepay_card_body_form1';
//来源模块
