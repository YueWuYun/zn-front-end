...
import { base_url, card_page_id, card_from_id, card_table_id, billtype, print_nodekey, funcode, print_templateid, viewmod_deal, sourceModel, list_page_url, card_page_url, pkName, dataSource } from '../../cons/constant';
...
import { versionControl, setCardShouderBtnUseful, handlePastData, repaintView } from "../../util/spegatherUtil";
...
export const buttonClick = function (props, key, text, record, index) {
  ...
  switch (key) {
    ...
    //头部 提交
    case 'Commit':
      cardOperator(props, card_page_id, card_from_id, [card_table_id], pkName, base_url + 'spegathercommit.do', this.state.json['36300STG-000007'], dataSource, commitAssign.bind(this));/* 国际化处理： 提交*/
      break;
    //头部 收回
    case 'UnCommit':
      cardOperator(props, card_page_id, card_from_id, [card_table_id], pkName, base_url + 'spegatheruncommit.do', this.state.json['36300STG-000008'], dataSource, this.toggleShow.bind(this));/* 国际化处理： 收回*/
      break;
    //头部 打印
    case 'Print':
    ...
    //头部 制证
    case 'Premit':
      cardOperator(props, card_page_id, card_from_id, [card_table_id], pkName, base_url + 'spegathervoucher.do', this.state.json['36300STG-000009'], dataSource, this.toggleShow.bind(this));/* 国际化处理： 制证*/
      break;
    //头部 取消制证
    case 'UnPremit':
      cardOperator(props, card_page_id, card_from_id, [card_table_id], pkName, base_url + 'spegathercancelvoucher.do', this.state.json['36300STG-000010'], dataSource, this.toggleShow.bind(this));/* 国际化处理： 取消制证*/
      break;
    //头部 经办
    case 'Decide':
      props.pushTo("/card", {
...
const saveCommitNew = function (props) {
  save.call(this, props, () => {
    cardOperator(props, card_page_id, card_from_id, [], pkName, base_url + 'spegathercommit.do', this.state.json['36300STG-000007'], dataSource, commitAssign.bind(this));/* 国际化处理： 提交*/
  })
}
