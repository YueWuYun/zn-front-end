...
//引入常量定义
import { card_shouder_buttons, group_all, group_needcommit, group_approving, sourceModel, 
    ...
    card_table_id_browse } from "../cons/constant";
...
export const setListButtonUseful = function () {
    ...
    //选中一条数据，根据状态判断哪些按钮可用
        ...
        //转账成功但没制证
            ...
            this.props.button.setButtonDisabled(['BatchUncommit', 'LinkViewApprove', 'LinkSendBill'], false);
        }
        //转账成功且制证
        else if (vbillstatus == '1' && ismakevoucher) {
            this.props.button.setButtonDisabled(['LinkViewApprove', 'LinkSendBill', 'LinkQueryVoucher'], false);
        }
