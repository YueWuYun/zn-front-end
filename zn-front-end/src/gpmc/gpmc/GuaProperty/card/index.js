...
class Card extends Component {
  constructor(props) {
    ...
    ["approvesce", "linksce"].includes(this.props.getUrlParam("scene"))
  ...
  componentDidMount() {
    ...
    if (id) {
      ...
      resolveMeasurable.call(this, true); //处理是否可计量的联动效果
    }
  }
  ...
  initVersionTree = callback => {
    const treeRoot = {
      isleaf: false,
      pid: "__root__",
      refname: this.state.json["36620GP-000001"] /* 国际化处理： 版本号*/,
      refpk: "-1"
    };
    ajax({
