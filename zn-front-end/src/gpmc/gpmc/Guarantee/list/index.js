...
class List extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      status: "busistatus&-1", //状态页签
      tabStatus: {
        DTJ: {
          num: 0,
          content: "36620GC-000062" /* 国际化处理： 待提交*/,
          status: "busistatus&-1"
        },
        SPZ: {
          num: 0,
          content: "36620GC-000063" /* 国际化处理： 审批中*/,
          status: "busistatus&0"
        },
        WZX: {
          num: 0,
          content: "36620GC-000064" /* 国际化处理： 未执行*/,
          status: "busistatus&1"
        },
        ZZX: {
          num: 0,
          content: "36620GC-000065" /* 国际化处理： 在执行*/,
          status: "busistatus&2"
        },
        all: {
          num: "",
          content: "36620GC-000066" /* 国际化处理： 全部*/,
          status: ""
        }
      },
  ...
  getAssginUsedr = val => {
    bodyBtnOperation.call(
      ...
      javaUrl.commit,
      this.state.json["36620GC-000067"],
      false,
      val
    ); /* 国际化处理： 提交成功*/
  };
  ...
  DoubleClick = (record, index, props, e) => {
    props.pushTo("/card", {
      ...
      scene: this.props.getUrlParam("scene") === "linksce" ? "linksce_card" : ""
    });
  };
