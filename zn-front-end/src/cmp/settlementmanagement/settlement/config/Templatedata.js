...
let Templatedata = {
    ...
    tableName:'cmp_settlement',
    //列表中配置id
    list_searchid:"search_area",
    list_tableid:"table_head_area",     //
    list_moduleid:"360704SM",   // 多语名称
    list_pageid:"360704SM_L01",
    ...
    card_tableid_edit:"detail_edit", //结算明细
    ...
    // 缓存标识
    listDataSource: 'cmp.settlement.settle.list',
    cardDataSource: 'cmp.settlement.settle.card',
    ...
    settlementHeadVOClassName:'SettlementHeadVO',
    settleBodyVOClassName:'SettlementBodyVO',
    //ajax请求url专区
    settleback:'/nccloud/cmp/settlement/settleback.do',
    gotocardcheck:'/nccloud/cmp/settlement/settlementgotocardcheck.do',
    //保存
    save:'/nccloud/cmp/settlement/settleditsave.do',
    //查询
    query:'/nccloud/cmp/settlement/settlelistquery.do',
    //分页查询，按照主表pks数组查询数据
    ...
    //联查方面5个
    // 联查网银信息
    linkvalidate:'/nccloud/cmp/settlement/linkvalidate.do',
    ...
    // nccloud.web.cmp.ref.CMPRecBillBankaccSubDefaultGridRefSqlBuilder
    // 交叉校验规则类
    crossrule: 'nccloud.web.cmp.ref.CrossRuleDepSqlBuilder',

    //卡片页按钮
    allBtnName:['signBtn', 'antiSignBtn', 'settleBtn' , 'antiSettleBtn' , 'commitToFTSBtn', 
            ...
            'outputBtn','makebillBtn','imageReview', 'linkApproveBtn'],
    allBtn:['signBtn','antiSignBtn','settleBtn','antiSettleBtn','commitToFTSBtn',
            'cancelCommitToFTSBtn','payGroup', 'linkGroup', 
            'printBtn' , 'additionBtn' , 'saveBtn' , 'cancelBtn' , 'editBtn',
            'combineLineBtn','splitLineBtn','makebillBtn','refreshBtn','linkVoucherBtn',
            'linkNetBankBtn','linkPayAffirmBtn'],

    saveGroup:['saveBtn' , 'cancelBtn'],
    signGroup:['signBtn'],
    antiSignBtn:['antiSignBtn'],
    settleGroup:['settleBtn'],
    antiSettleBtn:['antiSettleBtn'],
    commitGroup:['commitToFTSBtn',],
    cancelCommit:['cancelCommitToFTSBtn'],
    editGroup:['editBtn'],
    splitGroup: ['combineLineBtn','splitLineBtn'],
    otherGruop:['printBtn' , 'additionBtn'],
    makebillBtn:['makebillBtn'],
    refreshBtn:['refreshBtn'],
    // 联查组
    linkGroup:['linkGroup'],
    linkVoucherBtn:['linkVoucherBtn'],
    linkNetBankBtn:['linkNetBankBtn'],
    linkPayAffirmBtn:['linkPayAffirmBtn'],
    // 支付组
    payGroup:['payGroup'],
    // 支付组所有支付按钮
    payBtn:['netpayBtn','combinpayBtn' , 'preparenetBtn', 'redHandleBtn' ,'settlePayChangeBtn'],
    netpayBtn:['netpayBtn'],
    combinpayBtn:['combinpayBtn'],
    preparenetBtn:['preparenetBtn'],
    redHandleBtn:['redHandleBtn'],
    settlePayChangeBtn:['settlePayChangeBtn'],
