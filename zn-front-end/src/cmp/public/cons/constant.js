...
// 按钮常量 tianhaok common_btn
export const common_btn = {
    btn_group:'btn_group', // 分组
    add_group:'add_group', // 新增
    add_btn:'add_btn', // 新增
    edit_btn: 'edit_btn', // 修改
    copy_btn:'copy_btn', // 复制
    delete_btn:'delete_btn', // 删除
    submit_btn:'submit_btn', // 提交
    submit_group:'submit_group', // 提交分组
    unsubmit_btn:'unsubmit_btn', // 收回
    entrust_btn:'entrust_btn', // 委托办理
    entrust_group:'entrust_group', // 委托办理分组
    unentrust_btn:'unentrust_btn', // 取消委托
    enclosure_btn:'enclosure_btn', // 附件
    link:'link', // 联查
    link_group:'link_group', // 联查分组
    approvalopinion_btn:'approvalopinion_btn', // 联查审批意见
    debitcontract_btn:'debitcontract_btn', // 联查借款合同
    print_btn:'print_btn', // 打印
    print_group:'print_group', // 打印分组
    output_btn:'output_btn', // 输出
    refresh_btn:'refresh_btn', // 刷新
    edit_inner_btn:'edit_inner_btn', // 修改行按钮
    delete_inner_btn:'delete_inner_btn', // 删除行按钮
    submit_inner_btn:'submit_inner_btn', // 提交行按钮
    unsubmit_inner_btn:'unsubmit_inner_btn', // 收回行按钮
    entrust_inner_btn:'entrust_inner_btn', // 委托办理行按钮
    unentrust_inner_btn:'unentrust_inner_btn', // 取消委托行按钮
    save_group: 'save_group',
    save_btn: 'save_btn',
    saveadd_btn: 'saveadd_btn',
    savesubmit_btn: 'savesubmit_btn',
