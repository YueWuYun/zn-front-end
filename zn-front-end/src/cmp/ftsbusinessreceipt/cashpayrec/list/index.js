...
import { createPage, ajax, base, getMultiLang, toast, cardCache, deepClone, createPageIcon } from 'nc-lightapp-front';
...
class List extends Component {
	...
	DoubleClick = (record, index, props, e) => {
		this.props.pushTo('/card', {
			status: 'browse',
			id: record.pk_cashpay_receipt_h.value,
		});
	}
							...
							{createBillHeadInfo(
                                {
									title: this.props.MutiInit.getIntl("36300REC") && 
										this.props.MutiInit.getIntl("36300REC").get('36300REC-000005'),//标题
