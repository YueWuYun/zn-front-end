...
class List extends Component {
	...
	setStateCache = () =>{
		...
		        setDefData(BBR_CONST.paybill_stateKey, BBR_CONST.paybillCacheKey, thisstate);
		    }
  
	// 还原列表页数据
	    restoreData = () =>{
		                //获取页签数据
		        let cachestate = getDefData(BBR_CONST.paybill_stateKey, BBR_CONST.paybillCacheKey);
		        if (cachestate) {
