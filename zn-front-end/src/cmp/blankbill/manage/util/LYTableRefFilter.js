/*3cCSPYp6A0D8iWhYbTHUagm/bOEAClpiy162qXEc8+M2w88F/jcRomxU6kphhDxj*/
...
const { APPCODE, LY_PAGECODE, FORM_BBM_LY01,FORM_BBM_LY02, } = APP_INFO
...
export const FormBeforeEvent = function(props, moduleId, key) {
	...
	meta[FORM_BBM_LY02].items.map((item) => {
