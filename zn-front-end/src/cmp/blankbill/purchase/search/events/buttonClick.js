...
import { list_search_id, PAYBILL_CONST } from "../../cons/constant.js";
    ...
    switch (id) {
            ...
            if (copyData.length != 1) {
                toast({
                    ...
                    content:
                        ...
                        this.props.MutiInit.getIntl("36070PBR").get(
                            "36070PBR-000068"
                        )
                }); /* 国际化处理： 请选择单条数据进行复制操作*/
                ...
                success: res => {
                    ...
                    if (data && data.length > 0) {
                        for (let operatorResult of data) {
                            ...
                            if (state == 0) {
                                ...
                                if (
                                    ...
                                    result.head["head"].rows.length > 0
                                ) {
                        ...
                        if (updateDataArr.length > 0) {
                            props.table.updateDataByIndexs(
                    ...
                    if (res.data) {
                        if (res.data[this.tableId]) {
                            props.pushTo("/card", {
                                status: "browse",
                                id:
                                    res.data[this.tableId].rows[1].values
                                        .pk_paybill.value,
                                pagecode:
                                    res.data[this.tableId].rows[1].values
                                        .trade_type.value
        ...
        case "billlinkquery":
            ...
            billlinkData.forEach(val => {
                ...
                if (
                    val.data.values.pk_upbill != null &&
            ...
            ajax({
                ...
                success: res => {
                    if (res.data) {
                        ...
                        props.openTo(
                            "/cmp/billmanagement/recbill/linkcard/index.html",
                            {
                                appcode: "36070RBM",
        ...
        case "Associate":
            ...
            let query = {
                ...
                src: 1,
                callback:
                    "/nccloud/resources/cmp/billmanagement/paybill/card/index.html"
            };
            props.openTo(
                "/nccloud/resources/cmp/settlementmanagement/settlepublic/list/index.html",
                {
                    appcode: "360704SM",
        ...
        case "BillLQueryVoucher":
            ...
            link_selectedData.forEach(val => {
                if (
                    val.data.values.pk_paybill &&
                    val.data.values.pk_paybill.value != null
                ) {
                ...
                if (
                    ...
                    val.data.values.trade_type.value != null
                ) {
...
function checkNoSelected(selectDatas) {
    ...
    if (selectDatas == null || selectDatas.length == 0) {
        toast({
            ...
            content:
                this.props.MutiInit.getIntl("36070PBR") &&
                this.props.MutiInit.getIntl("36070PBR").get("36070PBR-000084")
        }); /* 国际化处理： 未选中行！*/
        return false;
    }
    return true;
            ...
            if (data && data.length > 0) {
                ...
                for (let operatorResult of data) {
                    ...
                    if (state == 0) {
                        ...
                        successIndexs = successIndexs + 1;
                        //删除缓存数据
                        props.table.deleteCacheId(
                            PAYBILL_CONST.list_table_id,
                            pk
                        );
                        //删除行
                        props.table.deleteTableRowsByIndex(
                            PAYBILL_CONST.list_table_id,
                            rowIndex
                        );
                    } else if (state == 1) {
