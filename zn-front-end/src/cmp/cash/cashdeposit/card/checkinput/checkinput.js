...
export const checkinput = function (props) {
    ...
    if(!pk_org){
        toast({
            color: 'warning',
            content: this.state.json['36070DC-000043'] /* 国际化处理： 提交成功*/
        });
        return false;
    }
    ...
    if(!pk_currency){
        toast({
            color: 'warning',
            content: this.state.json['36070DC-000044'] /* 国际化处理： 提交成功*/
        });
        return false;
    }
    ...
    if(!pk_cashaccount){
        toast({
            color: 'warning',
            content: this.state.json['36070DC-000045'] /* 国际化处理： 提交成功*/
        });
        return false;
    }
    ...
    if(!pk_bankaccount){
        toast({
            color: 'warning',
            content: this.state.json['36070DC-000046'] /* 国际化处理： 提交成功*/
        });
        return false;
    }
    ...
    if(!money){
        toast({
            color: 'warning',
            content: this.state.json['36070DC-000047'] /* 国际化处理： 提交成功*/
        });
        return false;
    }
    ...
    if(!olcrate){
        toast({
            color: 'warning',
            content: this.state.json['36070DC-000048'] /* 国际化处理： 提交成功*/
        });
        return false;
    }
    ...
    if(!olcmoney){
        toast({
            color: 'warning',
            content: this.state.json['36070DC-000049'] /* 国际化处理： 提交成功*/
        });
        return false;
    }
    return true;
