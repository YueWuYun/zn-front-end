...
import {toast,print,getBusinessInfo,promptBox,output} from 'nc-lightapp-front';
...
export default function buttonClick(props, id) {
	...
	switch (id) {
		...
		case 'unsubmitBtn':
			...
			// 委托付款
		case 'transfer':
			listMultiOperator(props, LIST_PAGE_INFO.PAGE_CODE, LIST_PAGE_INFO.TABLE_CODE, ITEM_INFO.PK, URL_INFO.COMMON.COMMIT, this.state.json['36070DC-000053'], APP_INFO.DATA_SOURCE);/* 国际化处理： 委托付款*/
			break;
			// 取消委托付款
		case 'canceltransfer':
			listMultiOperator(props, LIST_PAGE_INFO.PAGE_CODE, LIST_PAGE_INFO.TABLE_CODE, ITEM_INFO.PK, URL_INFO.COMMON.UNCOMMIT, this.state.json['36070DC-000054'] , APP_INFO.DATA_SOURCE);/* 国际化处理： 取消委托*/
			break;
			//结算
		case 'settleBtn':
		...
		case 'refreshBtn':
			...
			break;
			case 'exportFile': //导出
			exportFile.call(this,props,constant.ltablecode,'pk_cashdeposit');
			break;
	}
}
