...
class BankDailyBookQuery extends Component {
  constructor(props) {
    super(props);
  }
  /**
...
BankDailyBookQuery = createPage({
  mutiLangCode: '36070REPORT'
})(BankDailyBookQuery);

export default BankDailyBookQuery;
ReactDOM.render(<BankDailyBookQuery />, document.getElementById("app"));
