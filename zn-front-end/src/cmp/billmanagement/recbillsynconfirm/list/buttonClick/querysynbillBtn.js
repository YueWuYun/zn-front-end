    ...
    if (querysynbillBtnData.length != 1) {
        toast({
            ...
            content: this.props.MutiInit.getIntl("36070RBMCP") &&
                this.props.MutiInit.getIntl("36070RBMCP").get('36070RBMCP-000049')
        ...
        success: (res) => {
            ...
            if (success) {
                ...
                let querysynbillBtn_appOption = {
                    ...
                    name: this.props.MutiInit.getIntl("36070RBMCP") && this.props.MutiInit.getIntl("36070RBMCP").get('36070RBMCP-000013'),/* 国际化处理： 付款结算管理*/
                ...
                this.props.openTo('/cmp/billmanagement/paybill/linkcard/index.html',
                    {
                        ...
                        status: 'browse',
                        src: Templatedata.synbill_paybillsrc,
                        name: this.props.MutiInit.getIntl("36070RBMCP") && this.props.MutiInit.getIntl("36070RBMCP").get('36070RBMCP-000051'),/* 国际化处理： 付款结算联查*/
                    });
            }
        }
    });
