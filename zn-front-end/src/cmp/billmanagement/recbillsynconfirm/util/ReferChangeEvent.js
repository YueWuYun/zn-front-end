...
export const ObjectTypeHandle = function (props, moduleId, value) {
	...
	if (moduleId == this.formId) {
		if (value == '0') {
			item.itemtype = 'refer';
			item.refName = this.props.MutiInit.getIntl("36070RBMCP") && this.props.MutiInit.getIntl("36070RBMCP").get('36070RBMCP-000068');//'客户银行账户'
			item.refcode = 'uapbd/refer/pub/CustBankAccGridRef/index.js';
			tableItem.itemtype = 'refer';
			tableItem.refName = this.props.MutiInit.getIntl("36070RBMCP") && this.props.MutiInit.getIntl("36070RBMCP").get('36070RBMCP-000068');//'客户银行账户'
			tableItem.refcode = 'uapbd/refer/pub/CustBankAccGridRef/index.js';
		}
		if (value == '1') {
			item.itemtype = 'refer';
			item.refName = this.props.MutiInit.getIntl("36070RBMCP") && this.props.MutiInit.getIntl("36070RBMCP").get('36070RBMCP-000069');//'供应商银行账户'
			item.refcode = 'uapbd/refer/pub/CustBankAccGridRef/index.js';
			tableItem.itemtype = 'refer';
			tableItem.refName = this.props.MutiInit.getIntl("36070RBMCP") && this.props.MutiInit.getIntl("36070RBMCP").get('36070RBMCP-000069');//'供应商银行账户'
			tableItem.refcode = 'uapbd/refer/pub/CustBankAccGridRef/index.js';
		}
		if (value == '3') {

			item.itemtype = 'refer';
			item.refName = this.props.MutiInit.getIntl("36070RBMCP") && this.props.MutiInit.getIntl("36070RBMCP").get('36070RBMCP-000070');//个人银行账户';
			item.refcode = 'uapbd/refer/pubinfo/PsnbankaccGridRef/index.js';
			tableItem.itemtype = 'refer';
			tableItem.refName = this.props.MutiInit.getIntl("36070RBMCP") && this.props.MutiInit.getIntl("36070RBMCP").get('36070RBMCP-000070');//个人银行账户';
