 ...
 */
//应用编码
export const app_id = '0001Z61000000003H1O2';
//模块编码
export const module_id = '2052';
//实体id
export const oid = '1001Z61000000000B6Z5';
//请求后端基础地址
 ...
 */
//页面编码
export const card_page_id = '36070PBR_C03';
//表头表单编码
...
//list页跳转路径
export const list_page_url= '/cmp/billmanagement/paybillappr/list/index.html';
//cardt页跳转路径
export const card_page_url= '/cmp/billmanagement/paybillappr/card/index.html';
