        ...
        success: (res) => {
            if (res.success) {
                if (res.data) {
                    ...
                    //侧拉编辑框
                    this.props.form.setFormItemsDisabled(this.tableId, {
                        'local_rate': true
                    });
                    this.props.form.setFormItemsDisabled(this.tableId, {
                        'global_rate': true
                    ...
                    //侧拉编辑框
                    this.props.form.setFormItemsDisabled('childform1', {
                        'local_rate': true
                    });
                    this.props.form.setFormItemsDisabled('childform1', {
                        'global_rate': true
...
export const judgeFormRate = function (extParam, formCode) {
    if (extParam) {
        ...
        this.props.form.setFormItemsDisabled(formCode, {
            'local_rate': !obj.olcRateEditable
        });
        this.props.form.setFormItemsDisabled(formCode, {
            'group_rate': !obj.glcRateEditable
        });
        this.props.form.setFormItemsDisabled(formCode, {
            'global_rate': !obj.gllcRateEditable
        });
    }
}
...
export const judgeTableRate = function (extParam, tableCode, i) {
    if (extParam) {
        ...
        if (i) {
            ...
            this. props.cardTable.setColEditableByKey(tableCode, 'local_rate', obj.olcRateEditable);
            this.props.cardTable.setColEditableByKey(tableCode, 'group_rate', obj.glcRateEditable);
            this.props.cardTable.setColEditableByKey(tableCode, 'global_rate', obj.gllcRateEditable);
