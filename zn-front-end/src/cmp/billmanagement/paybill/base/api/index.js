...
import { saveMultiLangRes, loadMultiLang, createSimpleBillData, hasDefaultOrg, setDefOrg2Form, buildLightBodyAfterEditData, setDefOrg2AdvanceSrchArea, setDefOrg2ListSrchArea, elecSignListPrint, elecSignCardPrint, addDefReferFilter, bodyRateEditOnAfterEdit, setRate2NewRow, createListWebSocket, createCardWebSocket, saveCommit, showErrBtn,go2CardCheck } from "../../../../../tmpub/pub/util";
import cmpUtil from '../../../../pub/utils'

/**
 * 公共API列表
 */
const comm = {
    createListWebSocket, createCardWebSocket, showErrBtn, showTbbMsg: cmpUtil.showTbbMsg, getTbbMsg: cmpUtil.getTbbMsg,go2CardCheck
};
