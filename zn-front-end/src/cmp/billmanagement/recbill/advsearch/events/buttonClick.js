    ...
    switch (id) {
        ...
        case 'deleteBtn':
            ...
            if (selectedData.length == 0) {
                toast({ color: 'warning', content: this.props.MutiInit.getIntl("36070RBMLINK") && this.props.MutiInit.getIntl("36070RBMLINK").get('36070RBMLINK-000044') });/* 国际化处理： 请选择数据*/
                return
            }
            ...
            let delObj = {
                ...
                values: {
                    ts: {
                        display: this.props.MutiInit.getIntl("36070RBMLINK") && this.props.MutiInit.getIntl("36070RBMLINK").get('36070RBMLINK-000049'),/* 国际化处理： 时间戳*/
                    },
                    pk_cruexchange: {
                        display: this.props.MutiInit.getIntl("36070RBMLINK") && this.props.MutiInit.getIntl("36070RBMLINK").get('36070RBMLINK-000050'),/* 国际化处理： 主键*/
                    }
                }
            };
            //处理选择数据
        ...
        case 'copyBtn':
            ...
            if (copyData.length != 1) {
                toast({ color: 'warning', content: this.props.MutiInit.getIntl("36070RBMLINK") && this.props.MutiInit.getIntl("36070RBMLINK").get('36070RBMLINK-000051') });/* 国际化处理： 请选择1条数据*/
                return
            }
            let copyid = 0;
        ...
        case 'querysynbillBtn':
         ...
         let querysynbillBtnData = props.table.getCheckedRows(this.tableId);
            ...
            if (querysynbillBtnData.length != 1) {
                toast({ color: 'warning', content: this.props.MutiInit.getIntl("36070RBMLINK") && this.props.MutiInit.getIntl("36070RBMLINK").get('36070RBMLINK-000052') });/* 国际化处理： 请选择单条数据，联查协同单据!*/
                return;
            }
            ...
            let querysynbillBtn_appOption = {
                ...
                name: this.props.MutiInit.getIntl("36070RBMLINK") && this.props.MutiInit.getIntl("36070RBMLINK").get('36070RBMLINK-000011'),/* 国际化处理： 付款结算管理*/
        ...
        case 'redbillBtn':
            ...
            ajax({
                ...
                success: (res) => {
                    let { success, data } = res;
                    if (success) {
                        toast({ color: 'success', content: this.props.MutiInit.getIntl("36070RBMLINK") && this.props.MutiInit.getIntl("36070RBMLINK").get('36070RBMLINK-000053') });/* 国际化处理： 红冲成功*/
                        // NCMessage.create({ content: '提交成功', color: 'success', position: 'top' });
                        self.refresh();
                    }else{
         ...
         if (voucherData.length != 1) {
             toast({
                 color: 'warning',
                 content: this.props.MutiInit.getIntl("36070RBMLINK") && this.props.MutiInit.getIntl("36070RBMLINK").get('36070RBMLINK-000054')/* 国际化处理： 请选择单条，联查凭证!*/
             });
             return;
         }
         let voucherArr = [];
         ...
         let voucher_appOption = {
             code: voucher_code,
             name: this.props.MutiInit.getIntl("36070RBMLINK") && this.props.MutiInit.getIntl("36070RBMLINK").get('36070RBMLINK-000009'),/* 国际化处理： 联查凭证*/
        ...
        if (queryconsumeData.length == 0) {
            toast({ color: 'warning', content: this.props.MutiInit.getIntl("36070RBMLINK") && this.props.MutiInit.getIntl("36070RBMLINK").get('36070RBMLINK-000055') });/* 国际化处理： 请选择数据，进行联查预算!*/
            return;
        }
        ...
        break;
           ...
           if (printcardData.length == 0) {
               toast({ color: 'warning', content: this.props.MutiInit.getIntl("36070RBMLINK") && this.props.MutiInit.getIntl("36070RBMLINK").get('36070RBMLINK-000056') });/* 国际化处理： 请选择数据，进行打印!*/
               return;
           }
           let oids = [];
       ...
       case 'outputBtn':
        ...
        break;
           ...
           if (linkquerybillData.length != 1) {
               toast({
                   color: 'warning',
                   content: this.props.MutiInit.getIntl("36070RBMLINK") && this.props.MutiInit.getIntl("36070RBMLINK").get('36070RBMLINK-000057')/* 国际化处理： 请选择单条数据，联查单据!*/
               });
               return;
           }
           //处理选择数据
       ...
       case 'querymsgBtn':
           ...
           if (approvemsgData.length != 1) {
               toast({
                   color: 'warning',
                   content: this.props.MutiInit.getIntl("36070RBMLINK") && this.props.MutiInit.getIntl("36070RBMLINK").get('36070RBMLINK-000058')/* 国际化处理： 请选择单条数据，查看审批意见!*/
               });
               return;
           }
           //处理选择数据
