...
import {  ajax,  toast, cacheTools, print } from 'nc-lightapp-front';
    ...
    switch (id) {
        ...
        case 'editBtn':
            ...
            if (editData.length != 1) {
                toast({
                    ...
                    title: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000047'),      // 提示标题, 默认不同类别下分别为："已成功"/"帮助信息"/"请注意"/"出错啦",非必输/* 国际化处理： 请注意*/
                    content: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000048')   // 提示内容,非必输/* 国际化处理： 请选择单条数据!*/
                })
                return
            }
            let editId = 0;
        ...
        case 'deleteBtn':
            ...
            if (selectedData.length == 0) {
                toast({
                    ...
                    color: 'warning',     // 提示类别，默认是 "success",非必输
                    title: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000047'),      // 提示标题, 默认不同类别下分别为："已成功"/"帮助信息"/"请注意"/"出错啦",非必输/* 国际化处理： 请注意*/
                    content: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000049')   // 提示内容,非必输/* 国际化处理： 请选择数据,进行删除!*/
                })
                return;
            }
        ...
        case 'approveBtn':
            ...
            if (approveData.length == 0) {
                toast({
                    ...
                    color: 'warning',     // 提示类别，默认是 "success",非必输
                    title: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000047'),      // 提示标题, 默认不同类别下分别为："已成功"/"帮助信息"/"请注意"/"出错啦",非必输/* 国际化处理： 请注意*/
                    content: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000050')   // 提示内容,非必输/* 国际化处理： 请选择数据!*/
                })
                return
            }
            let indexArrapprove = [];
                ...
                success: function (res) {
                    ...
                    if (success) {
                        toast({
                            ...
                            content: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000052')   // 提示内容,非必输/* 国际化处理： 审批成功!*/
                        })
                        that.refresh();
                    }
                }
                ...
                success: function (res) {
                    ...
                    if (success) {
                        toast({
                            ...
                            color: 'success',     // 提示类别，默认是 "success",非必输
                            title: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000051'),      // 提示标题, 默认不同类别下分别为："已成功"/"帮助信息"/"请注意"/"出错啦",非必输/* 国际化处理： 已成功*/
                            content: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000053')   // 提示内容,非必输/* 国际化处理： 审批取消成功!*/
                        })
                        that.refresh();
                    }
                }
        ...
        case 'settlelistBtn':
            ...
            if (settleData.length == 0) {
                toast({
                    ...
                    color: 'warning',     // 提示类别，默认是 "success",非必输
                    title: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000047'),      // 提示标题, 默认不同类别下分别为："已成功"/"帮助信息"/"请注意"/"出错啦",非必输/* 国际化处理： 请注意*/
                    content: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000054')   // 提示内容,非必输/* 国际化处理： 请选择数据,进行结算!*/
                })
                return
            }
            let indexArr4 = [];
                ...
                success: function (res) {
                    ...
                    if (success) {
                        toast({
                            ...
                            color: 'success',     // 提示类别，默认是 "success",非必输
                            title: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000051'),      // 提示标题, 默认不同类别下分别为："已成功"/"帮助信息"/"请注意"/"出错啦",非必输/* 国际化处理： 已成功*/
                            content: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000055')   // 提示内容,非必输/* 国际化处理： 结算成功!*/
                        })
                        that.refresh();
                    }
                }
        ...
        case 'unsettlelistBtn':
            ...
            if (unsettleData.length == 0) {
                toast({
                    ...
                    color: 'warning',     // 提示类别，默认是 "success",非必输
                    title: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000047'),      // 提示标题, 默认不同类别下分别为："已成功"/"帮助信息"/"请注意"/"出错啦",非必输/* 国际化处理： 请注意*/
                    content: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000056')   // 提示内容,非必输/* 国际化处理： 请选择数据,进行取消结算!*/
                })
                return
            }
            let indexArr5 = [];
                ...
                success: function (res) {
                    ...
                    if (success) {
                        toast({
                            ...
                            color: 'success',     // 提示类别，默认是 "success",非必输
                            title: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000051'),      // 提示标题, 默认不同类别下分别为："已成功"/"帮助信息"/"请注意"/"出错啦",非必输/* 国际化处理： 已成功*/
                            content: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000057')   // 提示内容,非必输/* 国际化处理： 结算取消成功!*/
                        })
                        that.refresh();
                    }
                }
        ...
        case 'copyBtn':
            ...
            if (copyData.length != 1) {
                toast({
                    ...
                    color: 'warning',     // 提示类别，默认是 "success",非必输
                    title: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000047'),      // 提示标题, 默认不同类别下分别为："已成功"/"帮助信息"/"请注意"/"出错啦",非必输/* 国际化处理： 请注意*/
                    content: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000058')   // 提示内容,非必输/* 国际化处理： 请选择单条数据,进行复制!*/
                })
                return
            }
            let copyid = 0;
        ...
        case 'submitlistBtn':
            ...
            if (submitData.length == 0) {
                toast({
                    ...
                    color: 'warning',     // 提示类别，默认是 "success",非必输
                    title: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000047'),      // 提示标题, 默认不同类别下分别为："已成功"/"帮助信息"/"请注意"/"出错啦",非必输/* 国际化处理： 请注意*/
                    content: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000059')   // 提示内容,非必输/* 国际化处理： 请选择数据,进行提交!*/
                })
                return
            }
            let indexArr6 = [];
                ...
                success: function (res) {
                    ...
                    if (success) {
                        toast({
                            duration: 3,          // 消失时间，默认是3秒; 值为 infinity 时不消失,非必输
                            color: 'success',     // 提示类别，默认是 "success",非必输
                            title: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000060'),      // 提示标题, 默认不同类别下分别为："已成功"/"帮助信息"/"请注意"/"出错啦",非必输/* 国际化处理： 已完成*/
        ...
        case 'unsubmitlistBtn':
            ...
            if (unsubmitData.length == 0) {
                toast({
                    ...
                    color: 'warning',     // 提示类别，默认是 "success",非必输
                    title: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000047'),      // 提示标题, 默认不同类别下分别为："已成功"/"帮助信息"/"请注意"/"出错啦",非必输/* 国际化处理： 请注意*/
                    content: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000062')   // 提示内容,非必输/* 国际化处理： 请选择数据，进行收回*/
                })
                return
            }
            let indexArr7 = [];
        ...
        case 'makebillBtn':
            ...
            if (makebilData.length == 0) {
                toast({
                    ...
                    color: 'warning',     // 提示类别，默认是 "success",非必输
                    title: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000047'),      // 提示标题, 默认不同类别下分别为："已成功"/"帮助信息"/"请注意"/"出错啦",非必输/* 国际化处理： 请注意*/
                    content: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000064')   // 提示内容,非必输/* 国际化处理： 请选择数据，进行制单！*/
                })
                return;
            }
            if (makebilData.length != 1) {
                toast({
                    ...
                    color: 'warning',     // 提示类别，默认是 "success",非必输
                    title: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000047'),      // 提示标题, 默认不同类别下分别为："已成功"/"帮助信息"/"请注意"/"出错啦",非必输/* 国际化处理： 请注意*/
                    content: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000065')   // 提示内容,非必输/* 国际化处理： 请选择单条数据，进行制单！*/
                })
                return;
            }
            let makebillArr = [];
        ...
        case 'testBtn':
            ...
            window.parent.openNew({
                code: '36070RBM',
                name: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000066'),/* 国际化处理： 收款结算管理*/
        ...
        case 'buybalanceBtn':
            ...
            if (buybalanceBtnData.length != 1) {
                toast({
                    ...
                    color: 'warning',     // 提示类别，默认是 "success",非必输
                    title: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000047'),      // 提示标题, 默认不同类别下分别为："已成功"/"帮助信息"/"请注意"/"出错啦",非必输/* 国际化处理： 请注意*/
                    content: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000067')   // 提示内容,非必输/* 国际化处理： 请选择单条数据，联查买入账户余额!*/
                })
                return;
            }
                ...
                if (val.data.values.pk_buyacct && val.data.values.pk_buyacct.value != null) {
                    ...
                    if (!pk_buyacct) {
                        toast({
                            ...
                            color: 'warning',     // 提示类别，默认是 "success",非必输
                            title: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000047'),      // 提示标题, 默认不同类别下分别为："已成功"/"帮助信息"/"请注意"/"出错啦",非必输/* 国际化处理： 请注意*/
                            content: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000068')   // 提示内容,非必输/* 国际化处理： 不存在买入账户!*/
                        })
                        return;
                    }
        ...
        case 'sellbalanceBtn':
            ...
            if (sellbalanceBtnData.length != 1) {
                toast({
                    ...
                    color: 'warning',     // 提示类别，默认是 "success",非必输
                    title: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000047'),      // 提示标题, 默认不同类别下分别为："已成功"/"帮助信息"/"请注意"/"出错啦",非必输/* 国际化处理： 请注意*/
                    content: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000069')   // 提示内容,非必输/* 国际化处理： 请选择单条数据，联查卖出账户余额！*/
                })
                return;
            }
                ...
                if (val.data.values.pk_sellacct && val.data.values.pk_sellacct.value != null) {
                    ...
                    if (!pk_sellacct) {
                        toast({
                            ...
                            color: 'warning',     // 提示类别，默认是 "success",非必输
                            title: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000047'),      // 提示标题, 默认不同类别下分别为："已成功"/"帮助信息"/"请注意"/"出错啦",非必输/* 国际化处理： 请注意*/
                            content: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000070')   // 提示内容,非必输/* 国际化处理： 不存在卖出账户！*/
                        })
                        return;
                    }
        ...
        case 'chargebalanceBtn':
            ...
            if (chargebalanceBtnData.length != 1) {
                toast({
                    ...
                    color: 'warning',     // 提示类别，默认是 "success",非必输
                    title: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000047'),      // 提示标题, 默认不同类别下分别为："已成功"/"帮助信息"/"请注意"/"出错啦",非必输/* 国际化处理： 请注意*/
                    content: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000071')   // 提示内容,非必输/* 国际化处理： 请选择单条数据，联查手续费账户！*/
                })
                return;
            }
                ...
                if (val.data.values.pk_paychargeacct && val.data.values.pk_paychargeacct.value != null) {
                    ...
                    if (!pk_paychargeacct) {
                        toast({
                            ...
                            color: 'warning',     // 提示类别，默认是 "success",非必输
                            title: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000047'),      // 提示标题, 默认不同类别下分别为："已成功"/"帮助信息"/"请注意"/"出错啦",非必输/* 国际化处理： 请注意*/
                            content: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000072')   // 提示内容,非必输/* 国际化处理： 不存在手续费账户！！*/
                        })
                        return;
                    }
        ...
        case 'voucherBtn':
            ...
            if (selectData.length == 0) {
                toast({
                    ...
                    color: 'warning',     // 提示类别，默认是 "success",非必输
                    title: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000047'),      // 提示标题, 默认不同类别下分别为："已成功"/"帮助信息"/"请注意"/"出错啦",非必输/* 国际化处理： 请注意*/
                    content: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000073')   // 提示内容,非必输/* 国际化处理： 请选择数据，进行联查凭证！*/
                })
                return;
            }
            if (selectData.length != 1) {
                toast({
                    ...
                    color: 'warning',     // 提示类别，默认是 "success",非必输
                    title: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000047'),      // 提示标题, 默认不同类别下分别为："已成功"/"帮助信息"/"请注意"/"出错啦",非必输/* 国际化处理： 请注意*/
                    content: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000074')   // 提示内容,非必输/* 国际化处理： 请选择单条数据，进行联查凭证！*/
                })
                return;
            }
            let record_pk = '';
        ...
        case 'approvemsgBtn':
            ...
            if (approvemsgData.length != 1) {
                toast({
                    ...
                    color: 'warning',     // 提示类别，默认是 "success",非必输
                    title: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000047'),      // 提示标题, 默认不同类别下分别为："已成功"/"帮助信息"/"请注意"/"出错啦",非必输/* 国际化处理： 请注意*/
                    content: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000075')   // 提示内容,非必输/* 国际化处理： 请选择单条数据，查看审批意见!*/
                })
                return;
            }
            //处理选择数据
        ...
        case 'printBtn':
            ...
            if (printData.length == 0) {
                toast({
                    ...
                    color: 'warning',     // 提示类别，默认是 "success",非必输
                    title: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000047'),      // 提示标题, 默认不同类别下分别为："已成功"/"帮助信息"/"请注意"/"出错啦",非必输/* 国际化处理： 请注意*/
                    content: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000076')   // 提示内容,非必输/* 国际化处理： 请选择数据，进行打印!*/
                })
                return;
            }
            let pks = [];
        ...
        //预览
        case 'previewBtn':
            toast({ color: 'warning', content: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000012') });/* 国际化处理： 功能待开发*/
            break
        //输出
        case 'outputBtn':
            ...
            if (outputBtnData.length == 0) {
                toast({
                    ...
                    color: 'warning',     // 提示类别，默认是 "success",非必输
                    title: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000047'),      // 提示标题, 默认不同类别下分别为："已成功"/"帮助信息"/"请注意"/"出错啦",非必输/* 国际化处理： 请注意*/
                    content: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000077')   // 提示内容,非必输/* 国际化处理： 请选择数据，进行打印输出!*/
                })
                return;
            }
            let oids = [];
        ...
        case 'accessoryBtn':
            ...
            if (accessoryBtnData.length == 1) {
                ...
                toast({
                    ...
                    color: 'warning',     // 提示类别，默认是 "success",非必输
                    title: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000047'),      // 提示标题, 默认不同类别下分别为："已成功"/"帮助信息"/"请注意"/"出错啦",非必输/* 国际化处理： 请注意*/
                    content: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000078')   // 提示内容,非必输/* 国际化处理： 附件支持单条操作!*/
                })
                return;
            }
            console.log(bill_no, this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000079'));/* 国际化处理： 附件*/
            ...
            if (!pk_rec) {
                toast({
                    ...
                    color: 'warning',     // 提示类别，默认是 "success",非必输
                    title: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000047'),      // 提示标题, 默认不同类别下分别为："已成功"/"帮助信息"/"请注意"/"出错啦",非必输/* 国际化处理： 请注意*/
                    content: this.props.MutiInit.getIntl("36070FCEAPP") && this.props.MutiInit.getIntl("36070FCEAPP").get('36070FCEAPP-000011')   // 提示内容,非必输/* 国际化处理： 操作失败，无数据!*/
                })
                return;
            }
