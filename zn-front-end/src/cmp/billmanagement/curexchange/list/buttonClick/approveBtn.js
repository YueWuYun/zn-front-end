/*zqAuII6o5qEwztOmt+O6sjOfelhVsKM41j6oajqsHstIdP8uRXdLFDThvib7vgZ+*/
 ...
 * @param {*} props 
 */
export const approveBtn = function () {
    let approveData = this.props.table.getCheckedRows(this.tableId);
    //数据校验
    ...
    ajax({
        url: Templatedata.buttonclick_approve,
        data: data2,
        success: (res) => {
            ...
            if (success) {
                toast({
                    ...
                    content: this.props.MutiInit.getIntl("36070FCE") && this.props.MutiInit.getIntl("36070FCE").get('36070FCE-000049')   // 提示内容,非必输/* 国际化处理： 审批成功!*/
                })
                this.refresh();
            }
        }
