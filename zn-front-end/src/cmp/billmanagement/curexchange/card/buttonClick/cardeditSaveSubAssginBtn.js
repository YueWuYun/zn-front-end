/*1DynFQdKFkaLOWq5G1JBvGjQ1Wfj+QZyZTQ66WbV2ocLoHr/LdTkEe6rUEvTGdgZuAGI5gmC0/9X
NkJRht8tSA==*/
 ...
 * @param {*} props  
 */
export const cardeditSaveSubAssginBtn = function () {
    ...
    ajax({
        ...
        success: (res) => {
            ...
            this.billno = subbillno//附件管理使用单据编号
