...
let Templatedata = {
    //请求url跳转url
    //查询url
    gotocardcheck:'/nccloud/cmp/curexchange/curexchangegotocardcheck.do',
    ...
    tablebutton_settleBtn:'/nccloud/cmp/curexchange/curexchangelistsettle.do',//结算
    tablebutton_unsettltBtn:'/nccloud/cmp/curexchange/curexchangelistunsettle.do',//取消结算
    tablebutton_editinnerBtn:'/card',//卡片页面
    ...
    pageinfo_query:'/nccloud/cmp/curexchange/curexchangequerybyids.do',//list分页查询
    ...
    buttonclick_settle:'/nccloud/cmp/curexchange/curexchangelistsettle.do',
    buttonclick_unsettle:'/nccloud/cmp/curexchange/curexchangelistunsettle.do',
    buttonclick_submit:'/nccloud/cmp/curexchange/curexchangesubmit.do',
    buttonclick_assginsubmit:'/nccloud/cmp/curexchange/assginSubmit.do',
    ...
    app_code:'36070FCE',
    //缓存相关
    dataSource:'cmp.billmanagement.curexchange.list',
    pkname:'pk_cruexchange',
    key:'curexchange.list.data.key',
    search_key:'cmp.billmanagement.curexchange.search',
    voucher_linkkey:'cmp.billmanagement.curexchange.key',
    tableName:'cmp_curexchange',
