...
export default function (props, id) {
	...
	switch (id) {
		...
		case 'makebillBtn':
			...
			// 附件
		case 'enclosureBtn':
			let pk_accountagiotagee = props.form.getFormItemsValue(this.formId, 'pk_accountagiotage').value;
		...
		case 'outputBtn':
			...
			// 刷新
		case 'refreshBtn':
			let cashdrawpk = props.form.getFormItemsValue(this.formId, 'pk_accountagiotage').value;
			let data = {
				pk: cashdrawpk,
