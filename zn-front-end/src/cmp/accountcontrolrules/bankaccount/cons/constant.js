...
//请求后端基础地址
export const base_url = '/nccloud/cmp/bankaccount/';
//按钮平铺显示数量
 ...
 */
//页面编码
export const list_page_id = '36070BACR_L01';
//查询区域编码
export const list_search_id = 'search';
//表格区域编码
export const list_table_id = 'pk_bankaccount_table';
...
export const APP_INFO = {
     ...
     * 聚合VO class
     */
    CLASS_AGGVO: 'nc.vo.cmp.bankaccrule.BankaccRuleVO',
    /**
     * 缓存标识
     */
    DATA_SOURCE: 'tm.accountcontrolrules.bankaccount.datasource'
}
...
export const LIST_PAGE_INFO = {
     ...
     * 表格区域编码
     */
    TABLE_CODE: 'pk_bankaccount_table'
}
 ...
 * 请求基础路径
 */
const REQ_BASE_URL = '/nccloud/cmp/bankaccount/';
/**
 * 页面跳转基础路径
 */
