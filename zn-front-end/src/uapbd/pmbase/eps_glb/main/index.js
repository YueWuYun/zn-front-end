...
let config = {
    title:'项目基本分类-全局',
    pageCode:'10140EPSB_form',
    nodeType:'GLOBE_NODE',
    formId:'head',
    treeId:'epsTree',
    appcode:'10140EPSB',
    refresh:'uapbd/pmbase/eps_glb/main/index.html'
};
 ...
 * 渲染页面
 */
ReactDOM.render(<Eps_Glb {...{config:config}}/>, document.querySelector('#app'));
//bLkXFuKw3KUaZeb8Dj31ZbW4TYbp/FpJTggm9pjHvEEfh1GZfWjTZgkhzpdZeH65