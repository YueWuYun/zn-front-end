//u646GFjCb7Ag+OXCHmFwfX6s64Jz8389nDt+RpzTejuVFBUSsJGIQGO+v8Cfe+p7
...
export default class ProjectType extends Component {
    ...
    render(){
        if(!this.lang)
            return '';
        const {asyncTree,syncTree,form,button,ncmodal,search,DragWidthCom} = this.props;
        ...
        return(
            <div>
                {createModal('modal',{
                    leftBtnName : this.lang['10140PRJT-000035']})/* 国际化处理： 确定*/}
                {/* 头部 header*/}
