 ...
 * @Last Modified time: 2020-01-06 10:20:10
...
/**
 * 批量操作错误提示，这个错误提示，除非点击关闭，否则不会自动消失
 * @param {*} title
 * @param {*} content
 * @param {*} detailMsg
 * @param {*} param
 */
function showBatchOperateErrorInfo(title, content, detailMsg, param = {}) {
	showInfo(
		title,
		content,
		'infinity',
