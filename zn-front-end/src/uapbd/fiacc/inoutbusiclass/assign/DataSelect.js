...
let { NCTree, NCButton,NCCheckbox, NCModal,NCFormControl,NCDiv  } = base;
...
class DataSelect extends Component {
    constructor(props) {
        ...
        this.state = {
            treeWapper: new TreeWapper(this.lang['INOUTBUSICLASS-000010']),
            treesearchorigin:{
    ...
    render() {
        ...
        return (
            <div className = 'transfer_tree_container'>
                <NCDiv fieldid="inoutbusileft" areaCode={NCDiv.config.TREE} className = 'left-area' style={{height:'350px',padding:'10px',width:'calc(50% - 25px)',overflow:'hidden'}}>
                        <div className = 'left-area-nei' style={{overflow:'auto'}}>
                            <div style={{height:30,width:'100%',margin: 0,paddingTop: 5,paddingLeft: 20}}>{this.lang['INOUTBUSICLASS-000011']/* 国际化处理： 待选择数据*/}</div>
                            <div style={{width:200,marginLeft:20,marginTop:10}}>
                                <NCFormControl {...this.state.treesearchorigin}/>
                            </div>
                            <NCDiv fieldid="synctreeleft" areaCode={NCDiv.config.TreeCom}>
                                <div  className="syncTreeCom" style={{height:'calc(100% - 70px)'}}>
                                    <NCDiv fieldid= 'origintree' areaCode={NCDiv.config.TreeCom} style={{marginLeft:20,width:'calc(100% - 20px)'}}>
                ...
                <div className = 'button-area'>
                    ...
                    <div className="opr-botton opr-botton-trans">
                        <NCButton fieldid ='movetotagetall' onClick={moveToOriginAll.bind(this)}>&lt;&lt;</NCButton>
                    </div>
                </div>
                <NCDiv fieldid="inoutbusiright" areaCode={NCDiv.config.TREE} className = 'right-area' style={{height:'350px',padding:'10px',width:'calc(50% - 25px)',overflow:'hidden'}}>
                    <div className = 'right-area-nei' style={{overflow:'auto'}}>
                        <div style={{height:30,width:'100%',margin: 0,paddingTop: 5,paddingLeft: 20}}>{this.lang['INOUTBUSICLASS-000012']/* 国际化处理： 已选择数据*/}</div>
                        <div style={{width:200,marginLeft:20,marginTop:20}}>
                            <NCFormControl {...this.state.treesearchtarget}/>
                        </div>
                        <NCDiv fieldid="synctreeright" areaCode={NCDiv.config.TreeCom}>
                            <div  className="syncTreeCom" style={{height:'calc(100% - 70px)'}}>
                ...
                <div style={{height:40,display:'flex',justifyContent:'center',alignItems:'center'}}>
                    <NCCheckbox {...this.state.incChild}>{this.lang['INOUTBUSICLASS-000013']/* 国际化处理： 包含下级*/}</NCCheckbox>
                </div>
            </div>
