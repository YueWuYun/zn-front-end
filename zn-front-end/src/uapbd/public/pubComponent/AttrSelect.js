...
class AttrSelect extends Component {
    ...
    AttrRefonChange = (val) => {
        ...
        this.state.attr_valueMap = {};
        let realSelectedAttrs = val.map(v => {
            return v.refcode
        });
        ...
        return (
            <div style={{minWidth:'650px'}}>
                <div style={{display: 'inline-block'}}>
                    <div className='nc-theme-common-font-c' style={{
                    ...
                    <div style={{display: 'inline-block', width: 240, verticalAlign: 'middle'}}>
                        <NCSelect value={ this.state.tabVal.refname || this.state.tabs.length !== 0 && this.state.tabs[0].refname }
                                  onChange={this.TabRefonChange.bind(this)} fieldid={"referSelect"}>
                ...
                <div style={{display: 'inline-block'}}>
                    <h1 className='nc-theme-common-font-c' style={{
                        display: 'inline-block',
                        verticalAlign: 'middle',
                        width: '70px',
                        marginLeft: '20px'
