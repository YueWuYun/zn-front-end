...
const {NCButton, NCModal, NCCheckbox, NCRow, NCCol, NCFormControl} = base;
const {NCTable} = component;
import confirmUtil from '../../../public/pubComponent/confirmUtil/confirmUtil';
import './importTempletDlg.less';
/**
 * 数据模板
 * author zhenmx
 *
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: (text, record, index) => {
                            return (
                                <div>
                                    <NCCheckbox fieldid = 'check' colors="info"
                    ...
                    },
                    {
                        ...
                        render: (text, record, index) => {
                            return (
                                <div>
                                    <a fieldid = 'del' href='javascript:void(0);' onClick={this.onDeleteTemplet.bind(this, record)}
                                       style={{marginRight: 8}}>{this.props.json['dataTemplet-000015']}</a>{/* 国际化处理： 删除*/}
                                    <a fieldid = 'usetemp' href='javascript:void(0);'
    ...
    render() {
        ...
        return (
            <NCModal {...modalCfg} onHide={this.onClose.bind(this)} fieldid={"dataTemplateModal"}>
                ...
                <NCModal.Footer>
                    <NCButton onClick={this.onSaveTemp.bind(this)} fieldid={"btn1st"}>{this.state.showGrid ? this.props.json['dataTemplet-000010']:this.props.json['dataTemplet-000008']}</NCButton>{/* 国际化处理： 保存模板*/}
                    <NCButton onClick={this.onClose.bind(this)} fieldid={"btn2nd"}>{this.props.json['dataTemplet-000009']}</NCButton>{/* 国际化处理： 取消*/}
                </NCModal.Footer>
            </NCModal>
        );
    }
