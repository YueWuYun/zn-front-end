//wb6hAvIuL5NGP2ozhRp04qZAdPdpukZfOVsdXbxOnfiMb8AuLdqtn5DmUlQohhMo
...
class NCC_HR_Tree extends Component{
    ...
    componentWillReceiveProps(newProps){
        ...
        this.state.defaultExpandAll = newProps.defaultExpandAll;
        this.state.autoExpandParent = newProps.autoExpandParent;
    ...
    onTreeNodeChecked(checkedKeys,obj){
        if(this.props.onlyLeafCanSelect && !obj.node.props.isleaf){
            return false
        }
        ...
        setExpandedKeys(this.state.expandedKeys,()=>{
            setMultiMode(obj.checked?true:(checkedKeys.length>1?true:false),()=>{
    ...
    render =()=> {
        const loop = data =>{
           ...
           return items.map((item) => {
                ...
                return <NCTree.NCTreeNode 
                    {...item} 
                    liAttr={{"fieldid": `${item.refcode}_node`}}
        ...
        return [
            <div className='refer-tree-header nc-theme-area-split-bc' style={{'border-right':'1px solid #d0d0d0','-webkit-box-sizing':'border-box','box-sizing':'border-box'}}>
            ...
            <div className='refer-tree-wrapper nc-theme-area-split-bc' style={{'border-right':'1px solid #d0d0d0'}}>
                <NCDiv className='refer-tree-container' fieldid={this.props.fieldid} areaCode={NCDiv.config.TreeCom}>
                    <NCTree
                        focusable = {true}
