...
export default function (props = {}) {
	var conf = {
		...
		refType: 'grid',
		refName: 'refer-000249',/* 国际化处理： 维修组织体系*/
		placeholder: 'refer-000249',/* 国际化处理： 维修组织体系*/
		refCode: 'uapbd.ref.MOrgStruDefaultGridRef',
		queryGridUrl: '/nccloud/uapbd/ref/MOrgStruDefaultGridRef.do',
		columnConfig: [{
