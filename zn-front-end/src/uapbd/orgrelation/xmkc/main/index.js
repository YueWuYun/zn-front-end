...
var config = {
	title: 'orgrelation-000085',
	OrgRelationTypeID: 'ITEMSTOCKCONSIGN0000', 
	appCode : '10100ORES',
	pagecode : '10100ORES_list',
	cacheId : 'orgrelation_xmkc',
	...
	meta[tableid].items.forEach((e,i) =>{
		if(e.attrcode === 'sourcer'){
			Object.assign(meta[tableid].items[i], {
				label: props.MutiInit.getIntl("orgrelation") && props.MutiInit.getIntl("orgrelation").get('orgrelation-000088'),
				attrcode: 'sourcer',
				itemtype: 'refer',
				visible:true,
				refcode: 'uapbd/refer/org/ItemOrgDefaultTreeRef/index.js',
				required:true,
				width:250
			})
			e.queryCondition = {
				AppCode : config.appCode,
				TreeRefActionExt: 'nccloud.web.uapbd.ref.org.PrimaryOrgByTypeSQLBuilder'
			}
		}else if(e.attrcode === 'target'){
			Object.assign(meta[tableid].items[i], {
				label: props.MutiInit.getIntl("orgrelation") && props.MutiInit.getIntl("orgrelation").get('orgrelation-000080'),
				attrcode: 'target',
				itemtype: 'refer',
				visible:true,
		...
		}else if(e.attrcode === 'entity1'){//项目类型
			Object.assign(meta[tableid].items[i], {
				label: props.MutiInit.getIntl("orgrelation") && props.MutiInit.getIntl("orgrelation").get('orgrelation-000087'),
				attrcode: 'entity1',
				itemtype: 'refer',
				visible:true,
				refcode: 'uapbd/refer/pm/ProjectTypeGridRef/index.js'
			})
		}else if(e.attrcode === 'entity3'){//项目基本分类
			Object.assign(meta[tableid].items[i], {
				label: props.MutiInit.getIntl("orgrelation") && props.MutiInit.getIntl("orgrelation").get('orgrelation-000089')/* 国际化处理： 项目基本分类*/,
				attrcode: 'entity3',
				itemtype: 'refer',
				visible:true,
				refcode: 'uapbd/refer/pm/EpsTreeRef/index.js',
				hyperlinkflag: false,
				isnextrow: false,
				containlower: false,
				datatype: "204",
		...
		}else if(e.attrcode === 'entity2'){//物料基本分类
			Object.assign(meta[tableid].items[i], {
				label: props.MutiInit.getIntl("orgrelation") && props.MutiInit.getIntl("orgrelation").get('orgrelation-000086')/* 国际化处理： 物料基本分类*/,
				attrcode: 'entity2',
				itemtype: 'refer',
				visible:true,
