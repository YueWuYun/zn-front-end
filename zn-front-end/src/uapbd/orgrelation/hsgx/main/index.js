...
var config = {
  title: 'orgrelation-000055',//'核算委托关系',
  OrgRelationTypeID: 'FINACACCOUTING000000',
  appCode : '10100HSGX',
  pagecode : '10100HSGX_list',
  cacheId : 'orgrelation_hsgx',
  appid : '0001Z010000000000IGB',
	...
	meta[tableid].items.forEach((e,i) =>{
		if(e.attrcode === 'sourcer'){
			Object.assign(meta[tableid].items[i], {
				label: props.MutiInit.getIntl("orgrelation") && props.MutiInit.getIntl("orgrelation").get('orgrelation-000016')/* 国际化处理： 业务单元*/,
				attrcode: 'sourcer',
				itemtype: 'refer',
				visible:true,
