...
import { conf } from '../../../refer/org/BusinessUnitTreeRef';
...
var config = {
  title: 'orgrelation-000061',//'资产使用权业务委托关系',
  OrgRelationTypeID: 'USERASSETCONSIGN0000',
  appCode : '10100ORUA',
  pagecode : '10100ORUA_list',
  appid : '0001Z010000000000I0O',
  cacheId : 'orgrelation_orua',
	...
	meta[tableid].items.forEach((e,i) =>{
		if(e.attrcode === 'sourcer'){
			Object.assign(meta[tableid].items[i], {
				label: props.MutiInit.getIntl("orgrelation") && props.MutiInit.getIntl("orgrelation").get('orgrelation-000053')/* 国际化处理： 使用权*/,
				attrcode: 'sourcer',
				itemtype: 'refer',
				visible:true,
				refcode: 'uapbd/refer/org/BusinessUnitAllTreeRef/index.js',
			...
			Object.assign(meta[tableid].items[i], {
				label: props.MutiInit.getIntl("orgrelation") && props.MutiInit.getIntl("orgrelation").get('orgrelation-000054')/* 国际化处理： 使用管理组织*/,
				attrcode: 'target',
				itemtype: 'refer',
				visible:true,
