...
var config = {
  title: 'orgrelation-000059',//'采购业务委托关系',
  OrgRelationTypeID: 'PURSTOCKCONSIGN00000',
  appCode : '10100ORSP',
  pagecode : '10100ORSP_list',
  appid : '0001Z010000000000HZK',
  cacheId : 'orgrelation_orsp',
...
function modifierMeta(props,meta) {
	...
	meta[tableid].items.forEach((e,i) =>{
		if(e.attrcode === 'sourcer'){
			...
			Object.assign(meta[tableid].items[i], {
				label: props.MutiInit.getIntl("orgrelation") && props.MutiInit.getIntl("orgrelation").get('orgrelation-000045')/* 国际化处理： 采购组织*/,
				attrcode: 'target',
				itemtype: 'refer',
				visible:true,
				refcode: 'uapbd/refer/org/PurchaseOrgAllGridRef/index.js',
				required:true
			})
		}else if(e.attrcode === 'entity1'){//物料采购分类
			Object.assign(meta[tableid].items[i], {
				label: props.MutiInit.getIntl("orgrelation") && props.MutiInit.getIntl("orgrelation").get('orgrelation-000046')/* 国际化处理： 物料采购分类*/,
				attrcode: 'entity1',
				itemtype: 'refer',
				visible:true,
				refcode: 'uapbd/refer/material/MaterialPuClassTreeRef/index.js'
			})
		...
		}else if(e.attrcode === 'default2'){//应付组织
			Object.assign(meta[tableid].items[i], {
				label: props.MutiInit.getIntl("orgrelation") && props.MutiInit.getIntl("orgrelation").get('orgrelation-000048')/* 国际化处理： 应付组织*/,
				attrcode: 'default2',
				itemtype: 'refer',
				visible:true,
				refcode: 'uapbd/refer/org/FinanceOrgAllDataTreeRef/index.js',
