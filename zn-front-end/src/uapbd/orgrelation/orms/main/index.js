...
var config = {
  title: 'orgrelation-000078',//'维修库存业务委托关系',
  OrgRelationTypeID: 'MAINTAINSTOCKCONSIGN',
  appCode : '10100ORMS',
  pagecode : '10100ORMS_list',
  //appid : '0001Z010000000000I08',
  cacheId : 'orgrelation_orms',
	...
	meta[tableid].items.forEach((e,i) =>{
		if(e.attrcode === 'sourcer'){
			Object.assign(meta[tableid].items[i], {
				label: props.MutiInit.getIntl("orgrelation") && props.MutiInit.getIntl("orgrelation").get('orgrelation-000079')/* 国际化处理：维修组织*/,
				attrcode: 'sourcer',
				itemtype: 'refer',
				visible:true,
			...
			Object.assign(meta[tableid].items[i], {
				label: props.MutiInit.getIntl("orgrelation") && props.MutiInit.getIntl("orgrelation").get('orgrelation-000080')/* 国际化处理： 库存组织*/,
				attrcode: 'target',
				itemtype: 'refer',
				visible:true,
