...
var config = {
  title: 'orgrelation-000056',//'资产库存业务委托关系',
  OrgRelationTypeID: 'ASSETSTOCKCONSIGN000',
  appCode : '10100ORAS',
  pagecode : '10100ORAS_list',
  appid : '0001Z010000000000I08',
  cacheId : 'orgrelation_oras',
...
function modifierMeta(props,meta) {
	...
	meta[tableid].items.forEach((e,i) =>{
		if(e.attrcode === 'sourcer'){
			...
			Object.assign(meta[tableid].items[i], {
				label: props.MutiInit.getIntl("orgrelation") && props.MutiInit.getIntl("orgrelation").get('orgrelation-000037')/* 国际化处理： 资产组织*/,
				attrcode: 'target',
				itemtype: 'refer',
				visible:true,
