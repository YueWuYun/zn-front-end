...
var config = {
  title: 'orgrelation-000072',//'资产维修业务委托关系',
  OrgRelationTypeID: 'ASSETMAINTAINCONSIGN',
  appCode : '10100ORAR',
  pagecode : '10100ORAR_list',
  appid : '1002ZZ1000000000Z2CJ',//todo
  cacheId : 'orgrelation_orar',
	...
	meta[tableid].items.forEach((e,i) =>{
		if(e.attrcode === 'sourcer'){
			Object.assign(meta[tableid].items[i], {
				label: props.MutiInit.getIntl("orgrelation") && props.MutiInit.getIntl("orgrelation").get('orgrelation-000073')/* 国际化处理： 资产组织*/,
				attrcode: 'sourcer',
				itemtype: 'refer',
				visible:true,
				refcode: 'uapbd/refer/org/AssetOrgAllDataGridRef/index.js',
			...
			Object.assign(meta[tableid].items[i], {
				label: props.MutiInit.getIntl("orgrelation") && props.MutiInit.getIntl("orgrelation").get('orgrelation-000074')/* 国际化处理： 维修组织*/,
				attrcode: 'target',
				itemtype: 'refer',
				visible:true,
				refcode: 'uapbd/refer/org/MaintainOrgDefaultAllDataGridRef/index.js',
				required:true
			})
		}else if(e.attrcode === 'entity1'){//设备类别（ncc资产类别）
			Object.assign(meta[tableid].items[i], {
				label: props.MutiInit.getIntl("orgrelation") && props.MutiInit.getIntl("orgrelation").get('orgrelation-000075')/* 国际化处理： 设备类别*/,
				attrcode: 'entity1',
				itemtype: 'refer',
				visible:true,
