...
var config = {
  title: 'orgrelation-000058',//'资产货主业务委托关系',
  OrgRelationTypeID: 'SHIPPERASSETCONSIGN0',
  appCode : '10100ORSA',
  pagecode : '10100ORSA_list',
  appid : '0001Z010000000000I0M',
  cacheId : 'orgrelation_orsa',
	...
	meta[tableid].items.forEach((e,i) =>{
		if(e.attrcode === 'sourcer'){
			Object.assign(meta[tableid].items[i], {
				label: props.MutiInit.getIntl("orgrelation") && props.MutiInit.getIntl("orgrelation").get('orgrelation-000043')/* 国际化处理： 货主*/,
				attrcode: 'sourcer',
				itemtype: 'refer',
				visible:true,
			...
			Object.assign(meta[tableid].items[i], {
				label: props.MutiInit.getIntl("orgrelation") && props.MutiInit.getIntl("orgrelation").get('orgrelation-000044')/* 国际化处理： 货主管理组织*/,
				attrcode: 'target',
				itemtype: 'refer',
				visible:true,
		...
		}else if(e.attrcode === 'default1'){//财务组织
			Object.assign(meta[tableid].items[i], {
