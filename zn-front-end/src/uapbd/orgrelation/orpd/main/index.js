...
var config = {
  title: 'orgrelation-000070',//'生产领料委托关系',
  OrgRelationTypeID: 'OUTSTOCKCONSIGN00000',
  appCode : '10100ORPD',
  pagecode : '10100ORPD_list',
  appid : '1002ZZ1000000000Z2DO',//todo
  cacheId : 'orgrelation_orpd',
	...
	meta[tableid].items.forEach((e,i) =>{
		if(e.attrcode === 'sourcer'){
			Object.assign(meta[tableid].items[i], {
				...
				itemtype: 'refer',
				visible:true,
				refcode: 'uapbd/refer/org/FactoryGridRef/index.js',
			...
			Object.assign(meta[tableid].items[i], {
				label: props.MutiInit.getIntl("orgrelation") && props.MutiInit.getIntl("orgrelation").get('orgrelation-000071')/* 国际化处理： 发料库存组织*/,
				attrcode: 'target',
				itemtype: 'refer',
				visible:true,
