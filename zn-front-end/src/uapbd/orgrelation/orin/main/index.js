...
var config = {
  title: 'orgrelation-000066',//'完工入库委托关系',
  OrgRelationTypeID: 'INSTOCKCONSIGN000000',
  appCode : '10100ORIN',
  pagecode : '10100ORIN_list',
  appid : '1002ZZ1000000000Z5FN',
  cacheId : 'orgrelation_orin',
	...
	meta[tableid].items.forEach((e,i) =>{
		if(e.attrcode === 'sourcer'){
			Object.assign(meta[tableid].items[i], {
				label: props.MutiInit.getIntl("orgrelation") && props.MutiInit.getIntl("orgrelation").get('orgrelation-000067')/* 国际化处理： 工厂*/,
				attrcode: 'sourcer',
				itemtype: 'refer',
				visible:true,
				refcode: 'uapbd/refer/org/FactoryAllGridRef/index.js',
			...
			Object.assign(meta[tableid].items[i], {
				label: props.MutiInit.getIntl("orgrelation") && props.MutiInit.getIntl("orgrelation").get('orgrelation-000068')/* 国际化处理： 入库库存组织*/,
				attrcode: 'target',
				itemtype: 'refer',
				visible:true,
		...
		}else if(e.attrcode === 'entity1'){//物料分类
			Object.assign(meta[tableid].items[i], {
				label: props.MutiInit.getIntl("orgrelation") && props.MutiInit.getIntl("orgrelation").get('orgrelation-000069')/* 国际化处理： 物料分类*/,
				attrcode: 'entity1',
				itemtype: 'refer',
				visible:true,
