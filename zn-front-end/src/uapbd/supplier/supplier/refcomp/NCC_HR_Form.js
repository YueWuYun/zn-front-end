...
class NCC_HR_Form extends Component{
    ...
    render(){
        ...
        const renderFormItems = (code,items)=>(items.map((item)=>{
            ...
            return (visible?(
                <span id={itemKey}>
                        <NCCol xs={1} className="formLabel ncc-hr-font-size" style={{lineHeight: '21px',height: '21px',textAlign: 'right',position: "relative",top: '5px','font-size':'13px','text-overflow':'ellipsis',
                            'white-space':'nowrap'}}>
