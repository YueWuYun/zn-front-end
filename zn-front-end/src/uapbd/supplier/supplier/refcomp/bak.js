//oooR7oePJ5ELhDYQqgw7GjjDqVot9efh0LAWuhpNLJ4cFMbkcGqT25iS08K3S7ij
...
class NCC_HR_Form extends Component{
    ...
    render(){
        ...
        const renderFormItems = (code,items)=>(items.map((item)=>{
            ...
            return (visible?(
                <span id={itemKey}>
                        <NCCol xs={1} className="formLabel ncc-hr-font-size" style={{lineHeight: '21px',height: '21px',textAlign: 'right',position: "relative",top: '5px','font-size':'13px'}}>
                        ...
                        <NCCol xs={item.col-1} className = 'clearfix formControl' style={{paddingLeft: '12px',paddingBottom: '25px'}}>
                             {<div style={{minHeight: '28px','font-size':'13px'}} className={`form-component-item-wrapper ${item.itemtype}-wrapper ${this.state.formStatus} ncc-hr-font-size`}>
                                 {element}
                             </div>}
