...
import { MULTILANG, CARD, PRIMARTKEY, CARD_BUTTON, DATASOURCE,REQUESTURL } from '../constant';
...
class Card extends Component {
    constructor(props) {
        ...
        this.root = {
            "isleaf": false,
            "key":"~",
            "title":"1001Z310000000015LOU",/* 国际化处理： 成本中心*/
            "id":"~",
            "innercode":"~",
            "pid": "",
            "refname": "1001Z310000000015LOU",/* 国际化处理： 成本中心*/
            "refpk": "~"
        };
        this.requestParam={ type:"tree",pk:"1001Z310000000015LOU" };
    }
    //处理树结构数据
    dealTreeData(data){
