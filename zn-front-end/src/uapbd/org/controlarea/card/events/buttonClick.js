  ...
  switch (id) {
    ...
    case 'Delete'://删除
        promptBox({
          ...
          content: this.state.json['38200CA-000002'],             /* 国际化处理： ​确定要删除吗？*/
          noFooter: false,                 
          noCancelBtn: false,              
          ...
          beSureBtnClick: ()=>{
            ajax({
                url: '/nccloud/cm/inprocomstuff/delete.do',
                data: {
                    pk_bill: pk_bill,
      ...
      case 'Cancel'://取消
          promptBox({
              color: 'warning',
              title: this.state.json['38200CA-000008'],                  /* 国际化处理： 取消*/
              content: this.state.json['38200CA-000010'],             /* 国际化处理： ​确定要取消吗？*/
              noFooter: false,
              noCancelBtn: false,
              beSureBtnName: this.state.json['38200CA-000007'],           /* 国际化处理： 确定*/
              cancelBtnName: this.state.json['38200CA-000008'],          /* 国际化处理： 取消*/
