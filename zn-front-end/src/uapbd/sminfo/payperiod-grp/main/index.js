...
const dataSource = 'uapbd.sminfo.payperiod-grp.data'
const tableid = 'payperiod';
const appid = '0001Z010000000000NXL'
const appCode = '10140PAYPG'
const pagecode = '10140PAYPG_list';
