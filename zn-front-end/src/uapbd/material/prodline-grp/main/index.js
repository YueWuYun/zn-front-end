...
import {SingleTable,editTableBtn,tableid} from '../../prodline/main/Prodline.js';
...
var config = {
	title: '10140PLB-000006',/* 国际化处理： 产品线-集团*/
	nodetype: 'grp',//group
	appid : '0001Z010000000000O3Q',   
	tableid : 'prodline',   
	funcode: '10140PLG', 
	pagecode : '10140PLG_list',
	billType:'prodline_grp',
	pkorg : '',
	initTemplate: initTemplate
  };

var Prodline_Grp = createPage({
    billinfo:{
        billtype: 'grid',
        pagecode: config.pagecode,
...
ReactDOM.render(<Prodline_Grp {...{config:config}}/>, document.querySelector('#app'));
