...
import StockPlanGridRef from '../../../../uapbd/refer/org/BusinessUnitTreeRef/index';// 库存/计划
                            ...
                            <div className="refclass-line">
                                <div className="refclass">
                                    {LiabilityCenterOrgTreeRef({
                                        fieldid:'LiabilityCenterOrgTreeRef',
                            ...
                            <div className="refclass-line">
                                <div className="refclass">
                                    {CostRegionDefaultGridRef({
                                        fieldid:'CostRegionDefaultGridRef',
                            ...
                            <div className="refclass-line">
                                <div className="refclass">
                                    {LiactCostrgDefaultGridRef({
                                        fieldid:'LiactCostrgDefaultGridRef',
