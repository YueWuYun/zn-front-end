...
import { module_id, base_url, card_page_id, card_from_id, card_table_id,fun_code,node_key,printTemplate_ID,setNull,dataSource,pkname } from '../cons/constant.js';
import { orgVersionView } from "../../../pub/util/version/index";
/**
 * 清空卡片字段
 * @param {*} form 表单对象
 * @param {*} formID 卡片表单编码
