/*kiI9csRJT4wy66Q+QKlTiqRzq2UBou1ceErzJvAD7N76qkFGkXEZwsyKcSjAzOIj*/
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("nc-lightapp-front"), require("react-dom"));
	else if(typeof define === 'function' && define.amd)
		define(["nc-lightapp-front", "react-dom"], factory);
	else if(typeof exports === 'object')
		exports["fbm/pfbm/impawnpool/util/index"] = factory(require("nc-lightapp-front"), require("react-dom"));
	else
		root["fbm/pfbm/impawnpool/util/index"] = factory(root["nc-lightapp-front"], root["ReactDOM"]);
...
var _card = __webpack_require__(157);
...
var _cardEvent = __webpack_require__(158);
...
var _constant = __webpack_require__(155);
...
exports.default = function (props, id, tableId) {
  var _this = this;

  // const langData = this.props.MultiInit.getLangData(MODULE_ID);
  var status = props.getUrlParam("status");
  var pk = props.form.getFormItemsValue(this.formId, this.primaryId) && props.form.getFormItemsValue(this.formId, this.primaryId).value;
  if (!pk) {
  ...
  switch (id) {
    //头部 新增
    case "Add":
      _container.card.cardAdd.call(this);
      break;
    //头部 保存
    case "Save":
      _container.card.cardSave.call(this);
      break;
    //头部 保存新增
    case "SaveAdd":
      _container.card.cardSaveAdd.call(this);
      break;
    //头部 保存提交
    case "SaveCommit":
      _container.card.cardSaveCommit.call(this);
      break;

    //头部 修改
    case "Edit":
      _container.card.cardEdit.call(this);
      break;
    //头部 删除
    case "Delete":
      (0, _ncLightappFront.promptBox)({
        ...
        , content: this.state.json["fbmpublic-000001"] /* 国际化处理： 确定删除吗？*/
        , beSureBtnClick: function beSureBtnClick() {
          _container.card.cardDelete.call(_this);
        }
      });
    ...
    case "Copy":
      ...
      _page.setEditStatus.call(this, "edit");
      _page.getCardData.call(this, pk, true);
      _EmptyAreaValueUtil.EmptyAreaValue.call(this, this.billInfo, this.formId, "pk_register.");
      break;
    //头部 受理  2019-11-27 开票申请受理添加
    case "Accept":
      _container.card.cardAccept.call(this);
      break;
    //头部 取消受理  2019-11-27 开票申请受理添加
    case "UnAccept":
      _container.card.cardUnAccept.call(this);
      break;
    //头部 提交
    case "Commit":
      _container.card.cardCommit.call(this);
      break;
    //头部 收回
    case "Uncommit":
      _container.card.cardUncommit.call(this);
      break;
    //头部 终止
    case "Terminate":
      (0, _ncLightappFront.promptBox)({
        color: "warning",
        title: this.state.json["fbmpublic-000002"] /* 国际化处理： 终止*/ /* 国际化处理： 终止*/
        , content: this.state.json["fbmpublic-000003"] /* 国际化处理： */ /* 国际化处理： 确定终止吗？*/
        , beSureBtnClick: function beSureBtnClick() {
          _container.card.cardTerminate.call(_this);
        }
      });
      break;
    //头部 取消终止
    case "Unterminate":
      _container.card.cardUnterminate.call(this);
      break;
    //核销
    case "Destroy":
      (0, _ncLightappFront.promptBox)({
        ...
        , content: this.state.json["fbmpublic-000078"] /* 国际化处理： 核销为不可逆操作，是否核销？ */
        , beSureBtnClick: function beSureBtnClick() {
          _container.card.cardDestroy.call(_this);
        }
      });
      break;
    //制证
    case "MakeVoucher":
      _container.card.cardMakeVoucher.call(this);
      break;
    //取消制证
    case "CancelVoucher":
      _container.card.cardCancelVoucher.call(this);
      break;
    // 确认收妥
    case "Confirmreceipt":
      this.setState({
    ...
    case "Unconfirereceipt":
      _container.card.cardUnconfirmreceipt.call(this);
      break;
    // 头部 取消
    case "Cancel":
      (0, _ncLightappFront.promptBox)({
        color: "warning",
        title: this.state.json["fbmpublic-000004"] /* 国际化处理： 取消*/ /* 国际化处理： 取消*/
        , content: this.state.json["fbmpublic-000005"] /* 国际化处理： 是否确认要取消？*/ /* 国际化处理： 是否确认要取消？*/
        , beSureBtnClick: function beSureBtnClick() {
          _container.card.cardCancel.call(_this);
        }
      });
      break;
    //头部 打印
    case "Print":
      var pkarr = [];
      pkarr.push(pk);
      _container.card.cardPrint.call(this, pkarr);
      break;
    //头部 输出
    case "Output":
    case "Out":
      _container.card.cardOutput.call(this, [pk]);
      break;
    //头部 附件
    case "Attachment":
      var billNo = this.props.form.getFormItemsValue(this.formId, this.billNo).value;
      _container.card.cardFileMgr.call(this, pk, billNo);
      break;
    //头部 刷新
    case "Refresh":
      _container.card.cardRefresh.call(this, pk, true);
      break;
    // 正式打印
    case 'OffiPrint':
      (0, _index.elecSignCardPrint)(this.props, {
        ...
        getOrgFunc: function getOrgFunc() {
          return _this.props.form.getFormItemsValue(_this.formId, "pk_org").value;
        }
      });
      break;
    // 补充打印
    ...
    case "CreditAmount":
      var balanceinfo = {
        pk_protocol: this.props.form.getFormItemsValue(this.formId, "ccno") && this.props.form.getFormItemsValue(this.formId, "ccno").value,
        pk_currtype: this.props.form.getFormItemsValue(this.formId, "pk_cccurrtype") && this.props.form.getFormItemsValue(this.formId, "pk_cccurrtype").value,
        pk_org: this.props.form.getFormItemsValue(this.formId, "pk_org") && this.props.form.getFormItemsValue(this.formId, "pk_org").value,
        credittype: this.props.form.getFormItemsValue(this.formId, "pk_cctype") && this.props.form.getFormItemsValue(this.formId, "pk_cctype").value,
        pk_bankdoc: this.props.form.getFormItemsValue(this.formId, "ccbank") && this.props.form.getFormItemsValue(this.formId, "ccbank").value
      };
      _container.common.linkCredit.call(this, balanceinfo);
      break;
    //联查 审批详情
    case "ApproveDetail":
      _container.common.linkApproveDetail.call(this, pk);
      break;
    //联查 资金计划
    case "FundPlan":
      _container.common.linkNtb.call(this, pk);
      break;
    //联查 凭证
    case "Voucher":
      var voucherArr = [{
        pk_billtype: this.billtype,
        pk_group: this.props.form.getFormItemsValue(this.formId, "pk_group") && this.props.form.getFormItemsValue(this.formId, "pk_group").value,
        pk_org: this.props.form.getFormItemsValue(this.formId, "pk_org") && this.props.form.getFormItemsValue(this.formId, "pk_org").value,
        relationID: this.props.form.getFormItemsValue(this.formId, this.primaryId) && this.props.form.getFormItemsValue(this.formId, this.primaryId).value
      }];
      if (this.pageId === "36200BR_LIST") {
        //出池
        voucherArr.billdate = this.props.form.getFormItemsValue(this.formId, "outputdate") && this.props.form.getFormItemsValue(this.formId, "outputdate").value;
      } else if (this.pageId === "36200BT_LIST") {
        //票据入池
        voucherArr.billdate = this.props.form.getFormItemsValue(this.formId, "inputdate") && this.props.form.getFormItemsValue(this.formId, "inputdate").value;
      } else if (this.pageId === "36180BRR_LIST") {
        //应收票据退票
        voucherArr.billdate = this.props.form.getFormItemsValue(this.formId, "dreturndate") && this.props.form.getFormItemsValue(this.formId, "dreturndate").value;
      }
    ...
    case "Balance":
      var balanceData = [{
        pk_org: this.props.form.getFormItemsValue(this.formId, "pk_org") && this.props.form.getFormItemsValue(this.formId, "pk_org").value,
        pk_account: this.props.form.getFormItemsValue(this.formId, this.fields.issueAccount) && this.props.form.getFormItemsValue(this.formId, this.fields.issueAccount).value
      }];
    ...
    case "LinkInnerAccount":
      var accpk = this.props.form.getFormItemsValue(this.formId, this.pk_inbalaacc) && this.props.form.getFormItemsValue(this.formId, this.pk_inbalaacc).value;
      _container.common.linkInnerAccount.call(this, accpk);
      break;
    //联查内部结算账户
    case "LQueryInSecurityAcc":
      var pk_insecurityacc = this.props.form.getFormItemsValue(this.formId, this.pk_insecurityacc) && this.props.form.getFormItemsValue(this.formId, this.pk_insecurityacc).value;
      _container.common.linkInnerAccount.call(this, pk_insecurityacc);
      break;
    //跳转到票据签发
    case "SignLink":
    ...
    // 联查开票申请单
    case "SignApplyLink":
      var signApplyPk = this.props.form.getFormItemsValue(this.formId, "pk_signapply") && this.props.form.getFormItemsValue(this.formId, "pk_signapply").value;
      _container.common.signApplyLink.call(this, signApplyPk);
      break;
    // 联查票据签发单
    case "SignBillLink":
      _container.common.SignBillLink.call(this, pk);
      break;
    // 联查票据付款单
    case "AcceptBillLink":
      var pk_accept = this.props.form.getFormItemsValue(this.formId, "pk_srcbill") && this.props.form.getFormItemsValue(this.formId, "pk_srcbill").value;
      _container.common.acceptLink.call(this, pk_accept);
      break;
    // 联查应付票据贴现单
    case "BuyerDiscountBillLink":
      var pk_buyerdiscount = this.props.form.getFormItemsValue(this.formId, "pk_srcbill") && this.props.form.getFormItemsValue(this.formId, "pk_srcbill").value;
      _container.common.buyerDiscountLink.call(this, pk_buyerdiscount);
      break;
    // 联查票据签发单（签发回单使用）
    case "RegisterBillLink":
      var registerPK = this.props.form.getFormItemsValue(this.formId, "pk_parent") && this.props.form.getFormItemsValue(this.formId, "pk_parent").value;
      _container.common.registerLink.call(this, registerPK);
      break;
    // 联查 担保合同
    case "Guarantee":
      var changeRows = props.cardTable.getTabData("guarantee");
      var register = this.props.form.getFormItemsValue(this.formId, this.primaryId) && this.props.form.getFormItemsValue(this.formId, this.primaryId).value;
    ...
    // 取消作废
    case "CancelInvalid":
      _container.card.cardCancelDisable.call(this);
      break;
    // 作废
    case "Invalid":
      this.setState({
    ...
    case "SendInstruction":
      _container.card.cardSendCommand.call(this, pk);
      break;
    // 收回指令
    case "CancelInstruction":
      _container.card.cardTakeCommand.call(this);
      break;
    //下面是应收票据退票的按钮
    // 冲销
    case "Transform":
      _container.card.cardTransfrom.call(this);
      break;
    // 取消冲销
    case "CancelTransform":
      _container.card.cardCancelTransform.call(this);
      break;
    // 记账
    case "Tally":
      this.setState({
        ...
        // 获取 pk_org
        var pk_org = _this.props.form.getFormItemsValue(_this.formId, "pk_org").value;
        // 设置质押回收人参照按财务组织过滤
    ...
    // 取消记账
    case "CancelTally":
      _container.card.cardCancelTally.call(this);
      break;
    //下面是额度管理的指令
    //维护
    case "Mainten":
      _container.card.cardMainten.call(this);
      break;
    //头部 经办
    case "Handle":
      _container.card.cardHandle.call(this);
      break;
    // 退回
    case "Return":
      this.setState({
    ...
    // 额度申请
    case "RequestList":
      var pk_srcbill = props.form.getFormItemsValue(this.formId, "pk_srcbill") && props.form.getFormItemsValue(this.formId, "pk_srcbill").value;
      _container.common.linkQuotaApply.call(this, pk_srcbill);
      break;
    // 单位下拨可用额度
    case "UnitQuota":
      _container.common.linkUnitQuota.call(this, pk);
      break;
    // 额度上收
    case "Upquota":
      _container.common.linkUpquota.call(this, pk);
      break;
    // 额度下拨
    case "Downquota":
      _container.card.cardDownquota.call(this);
      break;
    //联查收付单据
    case "LinkReceAndPaybill":
      var pk_register_rr = this.props.form.getFormItemsValue(this.formId, "pk_register");
      var vbillno = this.props.form.getFormItemsValue(this.formId, "vbillno");
      var pk_group = this.props.form.getFormItemsValue(this.formId, "pk_group");
      if (!pk_register_rr) {
        // 主表无票据信息，取子表的
        var selectDatas = this.props.cardTable.getCheckedRows(this.tabCode);
        if (selectDatas.length && selectDatas.length == 1) {
          pk_register_rr = selectDatas[0] && selectDatas[0].data.values["pk_register"];
        } else {
          (0, _ncLightappFront.toast)({
            color: "danger",
            content: this.state.json["fbmpublic-000006"] /* 国际化处理： 请勾选一条票据数据*/
          });
          return;
        }
      }
      _container.common.linkReceAndPaybill.call(this, pk, vbillno && vbillno.value, pk_register_rr && pk_register_rr.value, pk_group && pk_group.value);
      break;
    //下面是票据质押、池内质押的指令
    // 解除质押
    ...
    case "CancelImpawnBack":
      _container.card.cancelImpawnBack.call(this);
      break;
    //质押/质押收回撤回
    case "WithdrawImpawn":
      _container.card.withdrawImpawn.call(this);
      break;
    //质押/质押收回撤回
    case "ImpawnBackSign":
      _container.card.impawnBackSign.call(this);
      break;
    case "LinkSDBook":
      var pk_register = this.props.form.getFormItemsValue(this.formId, "pk_register") && this.props.form.getFormItemsValue(this.formId, "pk_register").value;

      if (!pk_register) {
        // 主表无票据信息，取子表的
        var _selectDatas = this.props.cardTable.getCheckedRows(this.tabCode);
        if (!_selectDatas.length || _selectDatas.length !== 1) {
          (0, _ncLightappFront.toast)({
            color: "danger",
            content: this.state.json["fbmpublic-000006"] /* 国际化处理： 请勾选一条票据数据*/
          });
        ...
        if (!_selectDatas[0].data.values["pk_register"]) {
          (0, _ncLightappFront.toast)({
            color: "danger",
            content: this.state.json["fbmpublic-000006"] /* 国际化处理： 请勾选一条票据数据*/
          });
        ...
        pk_register = _selectDatas[0] && _selectDatas[0].data.values["pk_register"] && _selectDatas[0].data.values["pk_register"].value;
      }
      if (!pk_register) {
        (0, _ncLightappFront.toast)({
          color: "danger",
          content: this.state.json["fbmpublic-000007"] /* 国际化处理： 请选择一条票据数据*/
        });
        return;
      }
    ...
    case "Commission":
      ...
      _container.card.cardCommission.call(this);
      break;
    // 取消委托办理
    case "CommissionCancel":
      // common.doUnCommission.call(this,props);
      _container.card.cardUnCommission.call(this);
      break;
    // 取消转单 
    case 'CancelTransfer':
      var _status = this.props.form.getFormStatus(this.formId);
      if (_status != "browse") {
        (0, _ncLightappFront.promptBox)({
          color: "warning",
          title: this.state.json["fbmpublic-000096"] /* 国际化处理： 退出转单*/
          , content: this.state.json["fbmpublic-000008"] /* 国际化处理：有未保存的单据，确定要退出转单吗?*/
          , beSureBtnClick: function beSureBtnClick() {
            _this.setState({
    ...
    case 'discountTransact':
      var pk_discount = this.props.getUrlParam("id") || this.props.form.getFormItemsValue(this.formId, this.primaryId).value;
      var pk_billtypecode = this.props.form.getFormItemsValue(this.formId, "pk_billtypecode");
...
var _EmptyAreaValueUtil = __webpack_require__(173);
...
exports.afterEvent = exports.buttonVisible = exports.initTemplate2 = exports.initTemplate1 = exports.initTemplate = exports.buttonClick = undefined;

var _buttonClick = __webpack_require__(151);

var _buttonClick2 = _interopRequireDefault(_buttonClick);

var _initTemplate = __webpack_require__(252);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(253);

var _initTemplate4 = _interopRequireDefault(_initTemplate3);

var _initTemplate5 = __webpack_require__(254);

var _initTemplate6 = _interopRequireDefault(_initTemplate5);

var _buttonVisible = __webpack_require__(211);

var _afterEvent = __webpack_require__(255);
...
exports.initTemplate2 = _initTemplate6.default;
exports.buttonVisible = _buttonVisible.buttonVisible;
...
function buttonVisible(props) {
  ...
  var isBrowse = status === "browse";
  var buttons = props.button.getButtons().map(function (item) {
    return item.key;
  });
  var vbillstatus = props.form.getFormItemsValue(this.formId, "vbillstatus") && props.form.getFormItemsValue(this.formId, "vbillstatus").value;
  var btnObj = {};
  var showBtn = [];
  var disabledBtn = ["deleteRow"];
  var unionBtn = ["LinkSDBook", "Voucher", "LinkBudgetPlan", "ApproveDetail"]; //联查按钮
  var editBtn = ["Save", "SaveAdd", "SaveCommit", "Cancel"]; //编辑态显示按钮
  var allBtns = [].concat(_toConsumableArray(buttons), editBtn, unionBtn, ["Add", "Edit", "Delete", "Uncommit", "Commit", "Copy"]);
  ...
  if (!status) {
    ...
    if (!id) {
      ...
      //单据浏览态
      //质押指令状态
      var paymentstatus = props.form.getFormItemsValue(this.formId, "paymentstatus") && props.form.getFormItemsValue(this.formId, "paymentstatus").value;
      //是否勾选网银
      var onlinebankflag = props.form.getFormItemsValue(this.formId, "onlinebankflag") && props.form.getFormItemsValue(this.formId, "onlinebankflag").value;
      //解除质押指令状态
      var backimpawnstatus = props.form.getFormItemsValue(this.formId, "backimpawnstatus") && props.form.getFormItemsValue(this.formId, "backimpawnstatus").value;
      //解除质押签收指令状态
      var impawnbacksignstatus = props.form.getFormItemsValue(this.formId, "impawnbacksignstatus") && props.form.getFormItemsValue(this.formId, "impawnbacksignstatus").value;
      //质押状态
      var impawnstatus = props.form.getFormItemsValue(this.formId, "impawnstatus") && props.form.getFormItemsValue(this.formId, "impawnstatus").value;
      //作废状态
      var disableflag = props.form.getFormItemsValue(this.formId, "disableflag") && props.form.getFormItemsValue(this.formId, "disableflag").value;

      var commonBtn = [].concat(unionBtn, ["LinkGroup", "Print", "Output", "Attachment", "Refresh"]);
      switch (vbillstatus) {
        case "-1":
          //待提交
          commonBtn = commonBtn.filter(function (item) {
            return item !== "ApproveDetail";
          });
          showBtn = ["Add", "Edit", "Delete", "Commit", "Copy"].concat(_toConsumableArray(commonBtn));
          props.button.setMainButton("Add", false);
          break;
        case "2":
          //审批进行中
          showBtn = ["Add", "Uncommit", "Copy"].concat(_toConsumableArray(commonBtn));
          props.button.setMainButton("Add", true);
          break;
        case "3":
          //审批进行中
        ...
        case "1":
          ...
          if (onlinebankflag) {
            ...
            if (impawnbacksignstatus == null) {
              ...
              if (backimpawnstatus == null) {
                ...
                if (paymentstatus == null) {
                  //发送指令状态
                  showBtn = ["Add", "Uncommit", "Copy", "SendInstruction"].concat(_toConsumableArray(commonBtn));
                } else {
                  if (disableflag) {
                    showBtn = ["Add", "Copy", "CancelDisabled"].concat(_toConsumableArray(commonBtn));
                  } else {
                    if (paymentstatus == 1) {
                      //成功显示解除质押
                      showBtn = ["Add", "Copy", "ImpawnBackInstr"].concat(_toConsumableArray(commonBtn));
                    } else if (paymentstatus == 2) {
                      //失败显示发送指令
                      showBtn = ["Add", "Copy", "SendInstruction", "Disabled"].concat(_toConsumableArray(commonBtn));
                    } else if (paymentstatus == 3) {
                      //不明
                      showBtn = ["Add", "Copy"].concat(_toConsumableArray(commonBtn));
                    }
                  }
                }
              } else {
                if (backimpawnstatus == 1) {
                  showBtn = ["Add", "Copy", "ImpawnBackSign"].concat(_toConsumableArray(commonBtn));
              ...
              if (impawnbacksignstatus == 1) {
                showBtn = ["Add", "Copy", "CancelImpawnBack"].concat(_toConsumableArray(commonBtn));
            ...
            if (impawnstatus == "hasback") {
              ...
              showBtn = ["Add", "Uncommit", "Copy", "ImpawnBackInstr"].concat(_toConsumableArray(commonBtn));
            }
          }
          props.button.setMainButton("Add", false);
          break;
  ...
  // 添加解除质押 弹框内按钮
  showBtn = [].concat(_toConsumableArray(showBtn), ["ImpawnbackOK", "ImpawnbackCancel", "onCancel", "onSure"]);
  var _iteratorNormalCompletion = true;
  var _didIteratorError = false;
  var _iteratorError = undefined;

  try {
    for (var _iterator = allBtns[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var item = _step.value;
  ...
  props.cardTable.setStatus(_constant.CARD.tab_code, status);
  props.form.setFormStatus(_constant.CARD.form_id, status);
  //是否是推单过来的数据
  var srcbill = props.form.getFormItemsValue(this.formId, "pk_srcbill") && props.form.getFormItemsValue(this.formId, "pk_srcbill").value;
  if (null != srcbill) {
...
exports.default = function (props, templateCallback) {
  var _this = this;

  var appcode = props.getSearchParam("c") || props.getUrlParam("c");
  props.createUIDom({
    pagecode: _constant.CARD.page_id, //页面id
    appcode: appcode
  }, function (data) {
    if (data) {
      if (data.template) {
        var meta = data.template;
        meta = modifierMeta.call(_this, meta);
      ...
      if (data.button) {
        ...
        _buttonVisible.buttonVisible.call(_this, props, button);
      }
      ...
      if (data.context) {
        ...
        if (props.getUrlParam("status") === "add") {
          //设置默认组织
          var pk_org = context.pk_org,
              org_Name = context.org_Name,
              pk_org_v = context.pk_org_v,
              org_v_Name = context.org_v_Name;

          if (pk_org) {
            props.form.setFormItemsValue(_this.formId, {
              pk_org: { value: pk_org, display: org_Name },
              pk_org_v: { value: pk_org_v, display: org_v_Name }
            });
            _index.afterEvent.call(_this, props, _this.formId, "pk_org", { display: org_Name, value: pk_org }, { value: null });
          }
        }
      }
    }
...
function modifierMeta(meta) {
  ...
  //表头
  meta[this.formId].items.map(function (item) {
    if (item.attrcode.indexOf("def") > -1) {
      //自定义档案按照组织或者集团过滤
      item.queryCondition = function (p) {
        var pk_org = _this2.props.form.getFormItemsValue(_this2.formId, "pk_org").value;
        var pk_group = _this2.props.form.getFormItemsValue(_this2.formId, "pk_group").value;
        return {
          pk_org: pk_org,
          pk_group: pk_group
        };
    ...
    if (item.attrcode === "impawnpersonid") {
      ...
      item.queryCondition = function () {
        return {
          pk_org: _this2.props.form.getFormItemsValue(_this2.formId, "pk_org").value
        };
      };
    }
    ...
    if (item.attrcode == "debitunit") {
      item.queryCondition = function () {
        var pk_org = _this2.props.form.getFormItemsValue(_this2.formId, "pk_org");
        var pk_group = _this2.props.form.getFormItemsValue(_this2.formId, "pk_group");
        return {
    ...
    if (item.attrcode == "pk_register") {
      item.queryCondition = function () {
        var pk_register = _this2.props.form.getFormItemsValue(_this2.formId, "pk_register") && _this2.props.form.getFormItemsValue(_this2.formId, "pk_register").value;
        var pk_org = _this2.props.form.getFormItemsValue(_this2.formId, "pk_org") && _this2.props.form.getFormItemsValue(_this2.formId, "pk_org").value;
        var pk_impawn = _this2.props.form.getFormItemsValue(_this2.formId, "pk_impawn") && _this2.props.form.getFormItemsValue(_this2.formId, "pk_impawn").value;
        return {
          pk_register: pk_register,
          pk_org: pk_org,
          billpoolflag: "true",
          pk_impawn: pk_impawn,
          GridRefActionExt: "nccloud.web.fbm.pfbm.impawnpool.filter.ImpawnpoolBillFilter"
        };
      };
    }
  });
  // 网银信息
  meta['billpoolinfo'].items.map(function (item) {
    if (item.attrcode === "holderaccount") {
      //电票签约账户
      item.showHistory = true;
      item.queryCondition = function () {
        var data = _this2.props.form.getFormItemsValue(_this2.formId, "pk_org").value;
        return {
          isenableelecbill: "Y",
          pk_org: data,
  ...
  //表头
  meta[_constant.impawnbackAreaCode].items.map(function (item) {
    if (item.attrcode === "impawnbackpersonid") {
      //质押回收人
      item.showHistory = true;
      item.queryCondition = function () {
...
exports.default = function (props, templateCallback) {
  ...
  props.createUIDom({
    pagecode: _constant.CARD.page_id_link, //页面id
    appcode: app_code
  }, function (data) {
    if (data) {
      if (data.template) {
        var meta = data.template;
        props.meta.setMeta(meta);
        templateCallback.call(_this, props, meta);
      }
      if (data.button) {
        var button = data.button;
        props.button.setButtons(button);
...
exports.default = function (props, templateCallback) {
	var appcode = props.getSearchParam("c") || props.getUrlParam("c");
	props.createUIDom({
		pagecode: _constant.CARD.page_id_approve,
		appcode: _constant.approve_app_code
	}, function (data) {
		if (data) {
			if (data.template) {
				var meta = data.template;
...
var _FBMAfterEditUtil = __webpack_require__(179);

function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; } //表头编辑后事件
...
function afterEvent(props, moduleId, key, value, oldValue) {
	...
	var eventDatas = this.props.createHeadAfterEventData(this.pageId, this.formId, '', moduleId, key, value);
	var eventData = { 'eventPosition': 'head', 'eventType': 'card', 'eventData': JSON.stringify(eventDatas) };
	if (key === 'pk_org') {
		this.props.resMetaAfterPkorgEdit();
		//财务组织
		if (!oldValue || !oldValue.value) {
			//编辑后事件
			_index.cardEvent.changeOrg.call(this, value, function () {}).then(function () {
				if (value.value) {
					_index.cardEvent.getAfterEventData.call(_this, eventData).then(function (res) {
						props.form.setAllFormValue(_defineProperty({}, _this.formId, res.data.card.head[_this.formId]));
					});
				}
			});
		} else {
			(0, _ncLightappFront.promptBox)({
				...
				beSureBtnClick: function beSureBtnClick() {
					_index.cardEvent.changeOrg.call(_this, value).then(function () {
						props.form.EmptyAllFormValue(_this.formId);
						if (value.value != null) {
							_index.cardEvent.getAfterEventData.call(_this, eventData).then(function (res) {
								setAfterEditFormValue.call(_this, props, res);
							});
						}
					});
				},
				cancelBtnClick: function cancelBtnClick() {
					if (oldValue.value != null) {
						props.form.setFormItemsValue(_this.formId, { 'pk_org': { value: oldValue.value, display: oldValue.display } });
					}
				}
			});
		}
		...
		if (value.value !== oldValue.value) {
			_EmptyAreaValueUtil.EmptyAreaValue.call(this, this.baseinfo, this.formId, "pk_register.");
			_index.cardEvent.getAfterEventData.call(this, eventData).then(function (res) {
				//池内质押网银字段不限制是否可编辑
				props.form.setAllFormValue(_defineProperty({}, _this.formId, res.data.card.head[_this.formId]));
				var pk_olccurr = res.data.userjson;
				var pk_curr = props.form.getFormItemsValue(moduleId, 'pk_register.pk_curr');
	...
	function setAfterEditFormValue(props, res) {
		var success = res.success,
		    data = res.data;
		var card = data.card,
		    retExtParam = data.retExtParam,
		    headProp = data.headProp,
		    bodyItemProps = data.bodyItemProps,
		    headItemProps = data.headItemProps;
		var head = card.head,
		    bodys = card.bodys;

		props.form.setAllFormValue(_defineProperty({}, this.formId, res.data.card.head[this.formId]));
		(0, _FBMAfterEditUtil.setHeadItemProp)(props, this.formId, headItemProps);
	}
}
...
exports.updateBody = exports.addNewRow = exports.processBodyOlcRateEditable = exports.processColumnPrecision = exports.addLineAction = exports.delLineAction = exports.edit = exports.loadSearchCache = exports.getCahceValue = exports.go2card = exports.repaintViewApprove = exports.repaintView = exports.loadCopyData = exports.saveCommit = exports.loadNeedDealDataByPK = exports.qryDataByPKApprove = exports.qryDataByPK = exports.loadData2Card = exports.dealBillNOApprove = exports.dealBillNO = exports.versionControl = undefined;
...
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; } //引入轻量化api  
 ...
 * @param {*} props 
 */
var versionControl = exports.versionControl = function versionControl(props) {
    //组织版本试图
    (0, _index.orgVersionView)(props, _constant.CARD_PAGE_INFO.HEAD_CODE);
};
/**
 * 处理单据号
 */
var dealBillNO = exports.dealBillNO = function dealBillNO(props, viewmode) {
    if (viewmode == 'browse') {
 ...
 * 处理单据号
 */
var dealBillNOApprove = exports.dealBillNOApprove = function dealBillNOApprove(props, viewmode) {
    if (viewmode == 'browse') {
        props.BillHeadInfo.setBillHeadInfoVisible({
            showBackBtn: false, //控制显示返回按钮: true为显示,false为隐藏 ---非必传
            showBillCode: true //控制显示单据号：true为显示,false为隐藏 ---非必传
 ...
 * @param {*} data 
 */
var loadData2Card = exports.loadData2Card = function loadData2Card(props, data, callback) {
    //数据存在则更新卡片界面
    if (data) {
        var head = data.head,
            body = data.body;
        ...
        if (head) {
            ...
            // } else {
            props.form.setAllFormValue(_defineProperty({}, _constant.CARD_PAGE_INFO.HEAD_CODE, head[_constant.CARD_PAGE_INFO.HEAD_CODE]));
            // }
        }
        if (body) {
            props.cardTable.setTableData(_constant.CARD_PAGE_INFO.BODY_CODE, body[_constant.CARD_PAGE_INFO.BODY_CODE]);
        }
    }
    //数据不存在，则置空卡片
    else {
            props.form.EmptyAllFormValue(_constant.CARD_PAGE_INFO.HEAD_CODE);
            props.cardTable.setTableData(_constant.CARD_PAGE_INFO.BODY_CODE, { rows: [] });
        }
    if (callback && typeof callback == 'function') {
 ...
 * @param {*} pk  主键
 */
var qryDataByPK = exports.qryDataByPK = function qryDataByPK(props, pk, updateStateFunc) {
    var status = props.getUrlParam('status');
    var extParam = void 0;
    if (status == _constant.SHOW_MODE.EDIT) {
    ...
    var data = { pk: props.getUrlParam('id'), pageCode: _constant.CARD_PAGE_INFO.PAGE_CODE, pks: pks, extParam: extParam };
    (0, _ncLightappFront.ajax)({
        url: _constant.URL_INFO.CARD.QRY,
        data: data,
        success: function success(res) {
            var data = res.data;
            ...
            loadData2Card(props, res.data, function () {
                var billID = res.data.head[_constant.CARD_PAGE_INFO.HEAD_CODE].rows[0].values.pk_apply.value;
                var billNO = res.data.head[_constant.CARD_PAGE_INFO.HEAD_CODE].rows[0].values.vbillno.value;
                if (updateStateFunc && typeof updateStateFunc == 'function') {
                    updateStateFunc({
                        billID: billID, billNO: billNO
                    });
                }
                //添加缓存
                _ncLightappFront.cardCache.updateCache(_constant.ITEM_INFO.PK, billID, res.data, _constant.CARD_PAGE_INFO.HEAD_CODE, _constant.APP_INFO.DATA_SOURCE);
                //界面重绘
                repaintView(props);
            });
        }
 ...
 * @param {*} pk  主键
 */
var qryDataByPKApprove = exports.qryDataByPKApprove = function qryDataByPKApprove(props, pk, updateStateFunc) {
    var status = props.getUrlParam('status');
    var extParam = void 0;
    if (status == _constant.SHOW_MODE.EDIT) {
        extParam = { 'uiState': 'edit' };
 ...
 * @param {*} ts 时间戳
 */
var loadNeedDealDataByPK = exports.loadNeedDealDataByPK = function loadNeedDealDataByPK(props, pk, ts) {
    //获取时间戳
    var pkMapTs = {};
    pkMapTs[pk] = ts || null;
    //请求数据
    var data = { pkMapTs: pkMapTs, pageCode: _constant.CARD_PAGE_INFO.PAGE_CODE };
    (0, _ncLightappFront.ajax)({
        url: _constant.URL_INFO.CARD.QRYDEALINFO,
        data: data,
        success: function success(res) {
            var data = res.data;
            //加载到卡片
            ...
            loadData2Card(props, res.data, function () {
                var billID = res.data.head[_constant.CARD_PAGE_INFO.HEAD_CODE].rows[0].values.pk_innertransfer_h.value;
                var billNO = res.data.head[_constant.CARD_PAGE_INFO.HEAD_CODE].rows[0].values.vbillno.value;
                //更新缓存
                _ncLightappFront.cardCache.updateCache(_constant.ITEM_INFO.PK, billID, data, _constant.CARD_PAGE_INFO.HEAD_CODE, _constant.APP_INFO.DATA_SOURCE);
                //版本控制
                ...
                //设置表头字段编辑性
                props.form.setFormItemsDisabled(_constant.CARD_PAGE_INFO.HEAD_CODE, editItemArr);
                //设置表体字段编辑性
                props.cardTable.setColEditableByKey(_constant.CARD_PAGE_INFO.BODY_CODE, ['pk_financeorg_p', 'pk_inneraccount_p', 'pk_financeorg_r', 'pk_inneraccount_r', 'amount'], true);
                props.cardTable.setColEditableByKey(_constant.CARD_PAGE_INFO.BODY_CODE, ['brief', 'pk_getplanitem', 'pk_payplanitem'], false);
            });
        }
    });
};
 ...
 * 保存提交
 */
var saveCommit = exports.saveCommit = function saveCommit() {
    var _this = this;

    var billdata = this.props.createMasterChildData(_constant.CARD_PAGE_INFO.PAGE_CODE, _constant.CARD_PAGE_INFO.HEAD_CODE, _constant.CARD_PAGE_INFO.BODY_CODE);
    var pageCode = _constant.CARD_PAGE_INFO.PAGE_CODE;
    var data = { data: JSON.stringify(billdata), pageCode: pageCode };
    (0, _ncLightappFront.ajax)({
        url: _constant.URL_INFO.CARD.SAVECOMMIT,
        data: data,
        success: function success(res) {
            var data = res.data;
            //加载到卡片

            loadData2Card(props, data, function () {
                var billID = data.head[_constant.CARD_PAGE_INFO.HEAD_CODE].rows[0].values.pk_apply.value;
                var billNO = data.head[_constant.CARD_PAGE_INFO.HEAD_CODE].rows[0].values.vbillno.value;
                //更新卡片界面的state
                _this.setState({ billID: billID, billNO: billNO });
                //更新缓存
                _ncLightappFront.cardCache.updateCache(_constant.ITEM_INFO.PK, billID, data, _constant.CARD_PAGE_INFO.HEAD_CODE, _constant.APP_INFO.DATA_SOURCE);
                //界面重绘
                repaintView(props);
 ...
 * @param {*} pk  主键
 */
var loadCopyData = exports.loadCopyData = function loadCopyData(props, pk) {
    var pkMapTs = {};
    var extParam = { 'uiState': 'add' };
    pkMapTs[pk] = null;
    var data = { pkMapTs: pkMapTs, pageCode: _constant.CARD_PAGE_INFO.PAGE_CODE, extParam: extParam };
    (0, _ncLightappFront.ajax)({
        url: _constant.URL_INFO.CARD.QRYCOPY,
        data: data,
        success: function success(res) {
            var _res$data = res.data,
                card = _res$data.card,
                extParam = _res$data.extParam,
                headItemProps = _res$data.headItemProps,
                bodyItemProps = _res$data.bodyItemProps;
            var head = card.head,
                bodys = card.bodys;
            //更新表单数据
            ...
            props.form.setAllFormValue(_defineProperty({}, _constant.CARD_PAGE_INFO.HEAD_CODE, head[_constant.CARD_PAGE_INFO.HEAD_CODE]));
            //更新表体数据
            props.cardTable.setTableData(_constant.CARD_PAGE_INFO.BODY_CODE, bodys[_constant.CARD_PAGE_INFO.BODY_CODE]);
            //设置表头字段属性
            (0, _FBMAfterEditUtil.setHeadItemProp)(props, _constant.CARD_PAGE_INFO.HEAD_CODE, headItemProps);
            var billID = head[_constant.CARD_PAGE_INFO.HEAD_CODE].rows[0].values.pk_apply.value;
            var billNO = head[_constant.CARD_PAGE_INFO.HEAD_CODE].rows[0].values.vbillno.value;
            //组织选中值则恢复其余字段的编辑性
            props.resMetaAfterPkorgEdit();
            props.form.setFormItemsDisabled(_constant.CARD_PAGE_INFO.HEAD_CODE, { 'pk_supplier': false });
            //版本控制
            versionControl(props);
            //界面重绘
            repaintView(props);
            //更新缓存
            _ncLightappFront.cardCache.updateCache(_constant.ITEM_INFO.PK, billID, card, _constant.CARD_PAGE_INFO.HEAD_CODE, _constant.APP_INFO.DATA_SOURCE);
        }
    });
};
/**
 ...
 * @param {*} props 
 */
var repaintView = exports.repaintView = function repaintView(props) {
    //从地址栏获取状态
    var status = props.getUrlParam("status");
    //判断是否是浏览态
    var viewmode = status == _constant.SHOW_MODE.COPY ? _constant.SHOW_MODE.ADD : status;
    //处理单据号
    dealBillNO(props, viewmode);
    //设置页面组件的显示状态
    props.form.setFormStatus(_constant.CARD_PAGE_INFO.HEAD_CODE, viewmode);
    //表体只有编辑和浏览两种状态
    props.cardTable.setStatus(_constant.CARD_PAGE_INFO.BODY_CODE, viewmode == _constant.SHOW_MODE.ADD || viewmode == _constant.SHOW_MODE.EDIT ? _constant.SHOW_MODE.EDIT : _constant.SHOW_MODE.BROWSER);
    //新增/复制时组织可修改
    var orgedit = status == _constant.SHOW_MODE.ADD || status == _constant.SHOW_MODE.COPY || status == _constant.SHOW_MODE.EDIT;
    props.form.setFormItemsDisabled(_constant.CARD_PAGE_INFO.HEAD_CODE, { 'pk_org': !orgedit });
    //版本控制
    versionControl(props);
    //处理按钮
    (0, _index2.buttonVisible)(props);
};
 ...
 * @param {*} props 
 */
var repaintViewApprove = exports.repaintViewApprove = function repaintViewApprove(props) {
    //从地址栏获取状态
    var status = props.getUrlParam("status");
    //判断是否是浏览态
    var viewmode = status == _constant.SHOW_MODE.COPY ? _constant.SHOW_MODE.ADD : status;
 ...
 * @param {*} urlParam 
 */
var go2card = exports.go2card = function go2card(props, urlParam, getStateFunc, callback) {
    //获取分组合计数据
    var groupCount = getStateFunc('groupCount');
    //缓存分组合计数据
    _ncLightappFront.cardCache.setDefData(_constant.CACHE_KEY.GROUP_COUNT, _constant.APP_INFO.DATA_SOURCE, groupCount);
    //获取选中的分组页签
    var selectedGroup = getStateFunc('selectedGroup');
    //缓存选中的分组页签
    _ncLightappFront.cardCache.setDefData(_constant.CACHE_KEY.SELECT_GROUP, _constant.APP_INFO.DATA_SOURCE, selectedGroup);
    //获取查询区域条件(不校验必输项)
    ...
    urlParam['pagecode'] = _constant.CARD_PAGE_INFO.PAGE_CODE;
    var tradeType = JSON.parse(sessionStorage.getItem('sessionTP'));
    ...
    //页面跳转
    props.pushTo(_constant.URL_INFO.CARD_PAGE_URL, urlParam);
    //回调
    if (callback && typeof callback == 'function') {
        callback(props);
    }
 ...
 * 获取缓存数据
 */
var getCahceValue = exports.getCahceValue = function getCahceValue(props, updateStateFunc, callback) {
    var updateStateObj = {};
    //从缓存中获取分组合计数据
    var groupCount = _ncLightappFront.cardCache.getDefData(_constant.CACHE_KEY.GROUP_COUNT, _constant.APP_INFO.DATA_SOURCE);
    if (groupCount) {
        updateStateObj['groupCount'] = groupCount;
    }
    //从缓存中获取选中的分组页签数据
    var selectedGroup = _ncLightappFront.cardCache.getDefData(_constant.CACHE_KEY.SELECT_GROUP, _constant.APP_INFO.DATA_SOURCE);
    if (selectedGroup) {
...
var loadSearchCache = exports.loadSearchCache = function loadSearchCache(props) {
    //从缓存中获取查询区域条件
    var searchData = _ncLightappFront.cardCache.getDefData(_constant.CACHE_KEY.SEARCH_DATA, _constant.APP_INFO.DATA_SOURCE);
    //更新查询区域
    if (searchData) {
        props.search.setSearchValue(_constant.LIST_PAGE_INFO.SEARCH_CODE, searchData);
    }
};
/**
 * 修改
 * @param {*} props  页面内置对象
 */
var edit = exports.edit = function edit(props, callback) {
    var url = _constant.URL_INFO.CARD.EDIT;
    var pkMapTs = {};
    var pk = props.form.getFormItemsValue(_constant.CARD_PAGE_INFO.HEAD_CODE, _constant.ITEM_INFO.PK).value;
    var ts = props.form.getFormItemsValue(_constant.CARD_PAGE_INFO.HEAD_CODE, 'ts').value;
    pkMapTs[pk] = ts;

    (0, _ncLightappFront.ajax)({
        url: url,
        data: { pkMapTs: pkMapTs, pageCode: _constant.CARD_PAGE_INFO.PAGE_CODE, isRet: true },
        success: function success(res) {
            var data = res.data;

            if (data) {
                var headItemProps = data.headItemProps,
                    bodyItemProps = data.bodyItemProps,
                    card = data.card;
                ...
                if (head || bodys) {
                    ...
                    var busistatus = head[_constant.CARD_PAGE_INFO.HEAD_CODE].rows[0].values.busistatus.value;
                    //待提交态不设置编辑性
 ...
 * @param {*} props  页面内置对象
 */
var delLineAction = exports.delLineAction = function delLineAction(props, key, record, index, callback) {
    if (key && key == 'DeletebodyBtn') {
        var selectDatas = props.table.getCheckedRows(_constant.CARD_PAGE_INFO.BODY_CODE);
        if (selectDatas == null || selectDatas.length == 0) {
            (0, _ncLightappFront.toast)({
                'color': 'warning',
                'content': '未选中要删除的行'
        ...
        try {
            for (var _iterator = selectDatas[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                var item = _step.value;
        ...
        props.cardTable.delRowsByIndex(_constant.CARD_PAGE_INFO.BODY_CODE, selectIndexs);
        var rowid = selectDatas[0].data.rowid;
        var changedrows = [];
        var map = { newvalue: null, oldvalue: null, rowid: rowid };
        changedrows.push(map);
        var eventData = props.createBodyAfterEventData(_constant.CARD_PAGE_INFO.PAGE_CODE, _constant.CARD_PAGE_INFO.HEAD_CODE, [_constant.CARD_PAGE_INFO.BODY_CODE], _constant.CARD_PAGE_INFO.BODY_CODE, 'line', changedrows);
        var data = { 'eventPosition': 'body', 'eventType': 'card', 'eventData': JSON.stringify(eventData) };
        (0, _ncLightappFront.ajax)({
            url: _constant.URL_INFO.CARD.AFTEREDIT,
            data: data,
            success: function success(res) {
                //处理请求返回数据
                var _res$data2 = res.data,
                    card = _res$data2.card,
                    extParam = _res$data2.extParam,
                    headItemProps = _res$data2.headItemProps;
                var head = card.head,
                    bodys = card.bodys;
                //更新表单数据
        ...
        props.cardTable.delRowsByIndex(_constant.CARD_PAGE_INFO.BODY_CODE, index);
        var _rowid = record.rowid;
        var _changedrows = [];
        var _map = { newvalue: null, oldvalue: null, rowid: _rowid };
        _changedrows.push(_map);
        var _eventData = props.createBodyAfterEventData(_constant.CARD_PAGE_INFO.PAGE_CODE, _constant.CARD_PAGE_INFO.HEAD_CODE, [_constant.CARD_PAGE_INFO.BODY_CODE], _constant.CARD_PAGE_INFO.BODY_CODE, 'line', _changedrows);
        var _data = { 'eventPosition': 'body', 'eventType': 'card', 'eventData': JSON.stringify(_eventData) };
        (0, _ncLightappFront.ajax)({
            url: _constant.URL_INFO.CARD.AFTEREDIT,
            data: _data,
            success: function success(res) {
                ...
                var _res$data3 = res.data,
                    card = _res$data3.card,
                    extParam = _res$data3.extParam,
                    headItemProps = _res$data3.headItemProps;
                var head = card.head,
                    bodys = card.bodys;
                //更新表单数据
 ...
 * @param {*} recored 
 */
var processNewRecord = function processNewRecord(record) {
    //数据新增状态
    record.status = '2';
    //未选中
    record.selected = false;
    //去除主键
    record.values[_constant.ITEM_INFO.PK] = {
        value: null,
        display: null,
        scale: -1
        //去除表体主键
    };record.values[_constant.ITEM_INFO.BPK] = {
        value: null,
        display: null,
        scale: -1
        //去除ts
    };record.values[_constant.ITEM_INFO.TS] = {
        value: null,
        display: null,
        scale: -1
        //清空伪列
    };record.values[_constant.ITEM_INFO.PSEUDOCOLUMN] = {
        value: null,
        display: null,
        scale: -1
    };
 ...
 * @param {*} props  页面内置对象
 */
var addLineAction = exports.addLineAction = function addLineAction(props, key, record, callback) {
    var selectDatas = props.cardTable.getCheckedRows(_constant.CARD_PAGE_INFO.BODY_CODE);
    //判断是否有选中行
    if (selectDatas == null || selectDatas.length == 0) {
        (0, _ncLightappFront.toast)({ color: 'warning', content: '未选中行！' });
        return;
    }
    var recordArr = [];
    var recored = {};
    //获取行尾行号    
    var rowIndex = props.cardTable.getNumberOfRows(_constant.CARD_PAGE_INFO.BODY_CODE);
    ...
    try {
        for (var _iterator2 = selectDatas[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            var selectData = _step2.value;
    ...
    props.cardTable.insertRowsAfterIndex(_constant.CARD_PAGE_INFO.BODY_CODE, recordArr, offset);
 ...
 */
var processColumnPrecision = exports.processColumnPrecision = function processColumnPrecision(props, columnPrecisions) {
 ...
 * @param {*} props 
 */
var processBodyOlcRateEditable = exports.processBodyOlcRateEditable = function processBodyOlcRateEditable(props, extParam) {
    if (extParam.hasOwnProperty('bodyOlcRateEditable')) {
        //设置列得编辑性，flag=true是不可编辑，false是可编辑
        var flag = extParam['bodyOlcRateEditable'] == 'Y' ? false : true;
        props.cardTable.setColEditableByKey(_constant.CARD_PAGE_INFO.BODY_CODE, ['olcrate'], flag);
    }
};
 ...
 * @param {*} props 
 */
var addNewRow = exports.addNewRow = function addNewRow(props) {
    //获取表头的组织，集团
    var pk_org = props.form.getFormItemsValue(_constant.CARD_PAGE_INFO.HEAD_CODE, 'pk_org');
    var pk_group = props.form.getFormItemsValue(_constant.CARD_PAGE_INFO.HEAD_CODE, 'pk_group');
    var pk_currtype = props.form.getFormItemsValue(_constant.CARD_PAGE_INFO.HEAD_CODE, 'pk_currtype');
    var pk_bankacc_p = props.form.getFormItemsValue(_constant.CARD_PAGE_INFO.HEAD_CODE, 'pk_bankacc_p');
    var pk_bankacc_pd = props.form.getFormItemsValue(_constant.CARD_PAGE_INFO.HEAD_CODE, 'pk_bankacc_pd');
    var pk_bankacc_r = props.form.getFormItemsValue(_constant.CARD_PAGE_INFO.HEAD_CODE, 'pk_bankacc_r');
    var pk_acceptorg = props.form.getFormItemsValue(_constant.CARD_PAGE_INFO.HEAD_CODE, 'pk_acceptorg');
    var pk_billtypecode = props.form.getFormItemsValue(_constant.CARD_PAGE_INFO.HEAD_CODE, 'pk_billtypecode');
    var pk_billtypeid = props.form.getFormItemsValue(_constant.CARD_PAGE_INFO.HEAD_CODE, 'pk_billtypeid');
    var defaultRowData = {
        'pk_org': pk_org,
        'pk_group': pk_group,
    ...
    AddLine(props, _constant.CARD_PAGE_INFO.BODY_CODE, defaultRowData);
};
 ...
 * @param {*} body 
 */
var updateBody = exports.updateBody = function updateBody(props, body) {
    //rowid存在则按照差异化处理
    if (body[_constant.CARD_PAGE_INFO.BODY_CODE] && body[_constant.CARD_PAGE_INFO.BODY_CODE].rows && body[_constant.CARD_PAGE_INFO.BODY_CODE].rows[0] && body[_constant.CARD_PAGE_INFO.BODY_CODE].rows[0].rowid) {
        body[_constant.CARD_PAGE_INFO.BODY_CODE] = props.cardTable.updateDataByRowId(_constant.CARD_PAGE_INFO.BODY_CODE, body[_constant.CARD_PAGE_INFO.BODY_CODE]);
    }
    //否则直接更新表体
    else {
            props.cardTable.setTableData(_constant.CARD_PAGE_INFO.BODY_CODE, body[_constant.CARD_PAGE_INFO.BODY_CODE]);
...
//# sourceMappingURL=index.187be82a.js.map
/*kiI9csRJT4wy66Q+QKlTiqRzq2UBou1ceErzJvAD7N76qkFGkXEZwsyKcSjAzOIj*/