...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/pfbm/impawnpool/ref22/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/pfbm/impawnpool/ref22/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
var _initTemplate = __webpack_require__(387);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(388);

var _initTemplate4 = _interopRequireDefault(_initTemplate3);

var _initTemplate5 = __webpack_require__(389);

var _initTemplate6 = _interopRequireDefault(_initTemplate5);

var _buttonVisible = __webpack_require__(261);

var _afterEvent = __webpack_require__(390);
...
function buttonVisible(props) {
    ...
    var allBtns = [].concat(_toConsumableArray(buttons), editBtn, unionBtn, ["Edit", "Delete", "Uncommit", "Commit", "Copy"]);
        ...
        if (!id) {
            ...
            switch (vbillstatus) {
                case "-1":
                    ...
                    showBtn = ["Edit", "Delete", "Commit", "Copy"].concat(_toConsumableArray(commonBtn));
                    break;
                case "2":
                    //审批进行中
                    showBtn = ["Uncommit", "Copy"].concat(_toConsumableArray(commonBtn));
                    break;
                case "3":
                    //审批进行中
                    showBtn = ["Uncommit", "Copy"].concat(_toConsumableArray(commonBtn));
                    ...
                    if (onlinebankflag) {
                        ...
                        if (backimpawnstatus == null) {
                            ...
                            if (paymentstatus == null) {
                                //发送指令状态
                                showBtn = ["Uncommit", "Copy", "SendInstruction"].concat(_toConsumableArray(commonBtn));
                            } else {
                                if (disableflag) {
                                    showBtn = ["Copy", "CancelDisabled"].concat(_toConsumableArray(commonBtn));
                                } else {
                                    if (paymentstatus == 1) {
                                        //成功显示质押收回
                                        showBtn = ["Copy", "ImpawnBackInstr"].concat(_toConsumableArray(commonBtn));
                                    } else if (paymentstatus == 2) {
                                        //失败显示发送指令
                                        showBtn = ["Copy", "SendInstruction", "Disabled"].concat(_toConsumableArray(commonBtn));
                                    } else if (paymentstatus == 3) {
                                        //不明
                                        showBtn = ["Copy"].concat(_toConsumableArray(commonBtn));
                                    }
                                }
                            }
                        } else {
                        ...
                        if (impawnstatus == "hasback") {
                            showBtn = ["Copy", "CancelImpawnBack"].concat(_toConsumableArray(commonBtn));
                        } else {
                            showBtn = ["Uncommit", "Copy", "ImpawnBackInstr"].concat(_toConsumableArray(commonBtn));
                        }
                    }
                    break;
                default:
    ...
    // 添加解除质押 弹框内按钮
    showBtn = [].concat(_toConsumableArray(showBtn), ["ImpawnbackOK", "ImpawnbackCancel", "onCancel", "onSure", "CancelTransfer"]);
    var _iteratorNormalCompletion = true;
    var _didIteratorError = false;
    var _iteratorError = undefined;
...
var _events = __webpack_require__(260);
    ...
    value: function render() {
      return _react2.default.createElement(_BaseCard2.default, _extends({
        constant: {
          ...
          transferQueryUrl: _constant.API_URL.impawnpooltranstocard, //转单卡片接口地址
