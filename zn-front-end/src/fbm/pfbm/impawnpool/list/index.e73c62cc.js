...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/pfbm/impawnpool/list/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/pfbm/impawnpool/list/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
var _initTemplate = __webpack_require__(374);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _buttonDisable = __webpack_require__(375);
        ...
        value: function render() {
            var tabs = {
                ...
                items: [{
                    key: "-1",
                    name: "numZY",
                    title: this.props.MutiInit.getIntl("36200BI") && this.props.MutiInit.getIntl("36200BI").get("36200BI-000005") /* 国际化处理： 待提交*/
                }, {
                    key: "2,3",
                    name: "numTJ",
                    title: this.props.MutiInit.getIntl("36200BI") && this.props.MutiInit.getIntl("36200BI").get("36200BI-000006") /* 国际化处理： 审批中*/
                }, {
                    key: "cmd2,3",
                    name: "numOnCmd",
                    title: this.props.MutiInit.getIntl("36200BI") && this.props.MutiInit.getIntl("36200BI").get("36200BI-000008") /* 国际化处理： 指令处理中*/
                }, {
                    key: "all",
                    title: this.props.MutiInit.getIntl("36200BI") && this.props.MutiInit.getIntl("36200BI").get("36200BI-000007") /* 国际化处理： 全部*/
                }],
            ...
            return _react2.default.createElement(_BaseList2.default, _extends({
                constant: {
                    ...
                    encryptVOClassName: "nccloud.itf.pfbm.impawnpool.ImpawnpoolEncryptVO4NCC", //ca类
                    cafalg: "true",
                    showIndex: true,
                    modulecode: "3620",
  ...
  props.createUIDom({
    ...
    if (data) {
      if (data.button) {
        ...
        props.button.setButtons(button);
        props.button.setPopContent("DeleteInner", _this.props.MutiInit.getIntl("36200BI") && _this.props.MutiInit.getIntl("36200BI").get("36200BI-000003")); /* 国际化处理： 确认要删除吗?*/
      ...
      if (data.template) {
        ...
        //给高级查询区域赋默认业务单元(在setMeta之前使用)
        (0, _index.setDefOrg2AdvanceSrchArea)(props, _constant.LIST.search_id, data);
        props.meta.setMeta(meta);
        //给列表查询区域赋默认业务单元(在setMeta之后使用)
        (0, _index.setDefOrg2ListSrchArea)(props, _constant.LIST.search_id, data);
...
function modifierMeta(props, meta) {
  ...
  meta[this.searchId].items.map(function (item) {
    ...
    if (item.attrcode == "debitunit") {
      item.queryCondition = function () {
        var pk_org = _this2.props.form.getFormItemsValue(_this2.searchId, "pk_org");
  ...
  meta[this.tableId].items.push({
    itemtype: "customer",
    attrcode: "opr",
    label: this.props.MutiInit.getIntl("36200BI") && this.props.MutiInit.getIntl("36200BI").get("36200BI-000004") /* 国际化处理： 操作*/
    , width: 200,
    fixed: "right",
    className: "table-opr",
    visible: true,
    render: function render(text, record, index) {
      ...
      //质押收回指令状态
      var backimpawnstatus = record.backimpawnstatus && record.backimpawnstatus.value;
      //质押状态
      var impawnstatus = record.impawnstatus && record.impawnstatus.value;
      //作废状态
      var disableflag = record.disableflag && record.disableflag.value;
      //解除质押签收指令状态
      var impawnbacksignstatus = record.impawnbacksignstatus && record.impawnbacksignstatus.value;
      //是否是推单过来的数据
      var srcbill = record.pk_srcbill && record.pk_srcbill.value;
      ...
      return props.button.createOprationButton(buttonAry, {
        ...
        onButtonClick: function onButtonClick(props, key) {
          return _index2.bodyButtonClick.call(_this2, key, record, index);
        }
      });
    }
  });
...
function buttonDisable() {
  ...
  if (selectedData.length == 1) {
    var dataValues = selectedData[0].data.values;
    var vbillstatus = dataValues.vbillstatus.value;
    //质押指令状态
    var paymentstatus = dataValues.paymentstatus && dataValues.paymentstatus.value;
    //是否勾选网银
    var onlinebankflag = dataValues.onlinebankflag && dataValues.onlinebankflag.value;
    //质押收回指令状态
    var backimpawnstatus = dataValues.backimpawnstatus && dataValues.backimpawnstatus.value;
    //质押状态
    var impawnstatus = dataValues.impawnstatus && dataValues.impawnstatus.value;
    //作废状态
    var disableflag = dataValues.disableflag && dataValues.disableflag.value;
    //解除质押签收指令状态
    var impawnbacksignstatus = dataValues.impawnbacksignstatus && dataValues.impawnbacksignstatus.value;

    switch (vbillstatus) {
      case "-1":
        //待提交
        this.props.button.setButtonDisabled(["Add", "Delete", "Copy", "Commit", "Attachment", "LinkSDBook", "Voucher", "LinkBudgetPlan", "ApproveDetail", "Print", "Output"], false);
        this.props.button.setButtonDisabled(["SendInstruction", "ImpawnBackInstr", "CancelImpawnBack", "ImpawnBackSign", "Disabled", "CancelDisabled"], true);
        break;
      case "2": //待审批
      case "3":
        //提交
        this.props.button.setButtonDisabled(["Add", "Copy", "Uncommit", "Attachment", "LinkSDBook", "Voucher", "LinkBudgetPlan", "ApproveDetail", "Print", "Output"], false);
        this.props.button.setButtonDisabled(["Delete", "Commit", "SendInstruction", "ImpawnBackInstr", "CancelImpawnBack", "ImpawnBackSign", "Disabled", "CancelDisabled"], true);
        break;
      case "1":
        //审批通过
        this.props.button.setButtonDisabled(["Add", "Copy", "Uncommit", "Attachment", "LinkSDBook", "Voucher", "LinkBudgetPlan", "ApproveDetail", "Print", "Output"], false);
    ...
    //是否是推单过来的数据
    var srcbill = this.props.form.getFormItemsValue(this.formId, "pk_srcbill") && this.props.form.getFormItemsValue(this.formId, "pk_srcbill").value;
    if (null != srcbill) {
      this.props.button.setButtonDisabled(["Edit", "Uncommit"], true);
    }
  } else if (selectedData.length == 0) {
    this.props.button.setButtonDisabled(["Delete", "Copy", "Commit", "Uncommit", "SendInstruction", "ImpawnBackInstr", "CancelImpawnBack", "ImpawnBackSign", "Disabled", "CancelDisabled", "Attachment", "LinkSDBook", "Voucher", "LinkBudgetPlan", "ApproveDetail", "Print", "Output"], true);
  } else {
    this.props.button.setButtonDisabled(["Delete", "Copy", "Commit", "Uncommit", "SendInstruction", "CancelImpawnBack", "ImpawnBackSign", "Disabled", "CancelDisabled", "Attachment", "LinkSDBook", "Voucher", "LinkBudgetPlan", "ApproveDetail", "Print", "Output"], false);
  }

  //待提交 页签不能收回发指令撤回指令作废取消作废
  if (this.state.activeTab == "-1") {
    this.props.button.setButtonDisabled(["Uncommit", "SendInstruction", "ImpawnBackInstr", "CancelImpawnBack", "ImpawnBackSign", "Disabled", "CancelDisabled"], true);
  }
  //审批中 页签不能提交删除发送指令撤回指令作废取消作废
  if (this.state.activeTab == "2,3") {
    this.props.button.setButtonDisabled(["Commit", "Delete", "SendInstruction", "ImpawnBackInstr", "CancelImpawnBack", "ImpawnBackSign", "Disabled", "CancelDisabled"], true);
  }
  //指令处理中 页签不能提交删除收回作废取消作废
  if (this.state.activeTab == "cmd2,3") {
    this.props.button.setButtonDisabled(["Uncommit", "Commit", "Delete", "Uncommit"], true);
  }
}
