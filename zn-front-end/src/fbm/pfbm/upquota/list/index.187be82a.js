...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/pfbm/upquota/list/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/pfbm/upquota/list/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
var _buttonDisable = __webpack_require__(436);
    ...
    _createClass(List, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_BaseList2.default, _extends((_extends2 = {
                ...
                pageTitle: _constant.LIST.page_title //节点标题
                , headBtnArea: _constant.LIST.head_btn_code //表头按钮区域
            }, _defineProperty(_extends2, "_selectedEvent", this.myselectedEvent), _defineProperty(_extends2, "listDidMount", listDidMount), _defineProperty(_extends2, "linkItems", ["approveDetail", "creditBalance"]), _defineProperty(_extends2, "initImport", false), _defineProperty(_extends2, "showSearch", false), _extends2), this.props));
        }
    }]);
	...
	props.createUIDom({
		...
		if (data) {
			if (data.button) {
				...
				props.button.setButtons(button);
				props.button.setPopContent('DeleteInner', '确认要删除吗?');
...
var FormControl = _ncLightappFront.base.FormControl;
...
function buttonDisable() {
    ...
    if (selectedData.length == 1) {
        ...
        var upquota = selectedData[0].data.values.upquota.value;
        var uppaystatus = selectedData[0].data.values.uppaystatus.value;
        switch (vbillstatus) {
            case '-1': //待提交
            case '2': //待审批
            case '3':
                //提交
                this.props.button.setButtonDisabled(['Mainten', 'SendInstruction'], true);
                break;
            case '1':
                //审批通过
                var avaibleBtns = ['Mainten'];
                var upquotaFloat = 0;
                if (upquota) {
                    var upquotaFloatStr = upquota.replace(/,/g, '');
                    upquotaFloat = parseFloat(upquotaFloatStr);
        ...
        this.props.button.setButtonDisabled(['Mainten', 'SendInstruction'], false);
    }
}
