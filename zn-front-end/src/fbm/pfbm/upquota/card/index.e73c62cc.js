...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/pfbm/upquota/card/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/pfbm/upquota/card/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
//小应用编码
var app_code = exports.app_code = '36185530';
//联查小应用编码
var link_app_code = exports.link_app_code = '36185530';
//审批小应用编码
var approve_app_code = exports.approve_app_code = '36185530A';
//请求基础路径
var base_path = exports.base_path = '/nccloud/fbm/quotamanagerment';
//按钮平铺显示数量
var button_limit = exports.button_limit = 3;
//打印输出编码
var nodekey = exports.nodekey = '36185530P';
//打印清单编码
var nodekeyList = exports.nodekeyList = '36185530PL';

var module_id = exports.module_id = '36185530';
//单据类型
...
var LIST = exports.LIST = {
    ...
    //缓存标示
};var DATA_SOURCE = exports.DATA_SOURCE = 'tm.fbm.upquota.datasource';
...
var searchCache = exports.searchCache = {
    ...
    /* 
        ...
        btnName:按钮编码
     */
};var DISABLE_BTN_PARAM = exports.DISABLE_BTN_PARAM = [{ // 在共代码中控制按钮的可用性
...
function SendInstructionCtl(selectedRow) {
    ...
    var vbillstatus = selectedRow.vbillstatus.value;
    var upquota = selectedRow.upquota.value;
    var uppaystatus = selectedRow.uppaystatus.value;
    var showCommand = false;
    if (vbillstatus == '1') {
        var upquotaFloat = 0;
        if (upquota) {
            var upquotaFloatStr = upquota.replace(/,/g, '');
...
var _initTemplate = __webpack_require__(430);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(431);

var _initTemplate4 = _interopRequireDefault(_initTemplate3);

var _initTemplate5 = __webpack_require__(432);

var _initTemplate6 = _interopRequireDefault(_initTemplate5);

var _buttonVisible = __webpack_require__(271);

var _afterEvent = __webpack_require__(433);
...
var _constant = __webpack_require__(205);
...
function buttonVisible(props) {
    ...
    var upquota = props.form.getFormItemsValue(this.formId, 'upquota') && props.form.getFormItemsValue(this.formId, 'upquota').value;
    var uppaystatus = props.form.getFormItemsValue(this.formId, 'uppaystatus') && props.form.getFormItemsValue(this.formId, 'uppaystatus').value;
    var btnObj = {};
    var showBtn = [];
    ...
    var editBtn = ['Save', 'Cancel']; //编辑态显示按钮
    if (!isBrowse) {
        //编辑态
        showBtn = editBtn;
    } else {
...
function cardDidMount() {
    ...
    var status = this.props.getUrlParam("status");
    _page.initForm.call(this, status, function () {
        if (status === 'mainten') {
            //清空上收指令状态、上收银行返回信息、上收额度等
    ...
    _createClass(Card, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_BaseCard2.default, _extends({
                ...
                pageTitle: _constant.CARD.page_title //节点标题
