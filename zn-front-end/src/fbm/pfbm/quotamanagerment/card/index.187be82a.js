...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/pfbm/quotamanagerment/card/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/pfbm/quotamanagerment/card/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
//小应用编码
var app_code = exports.app_code = '36185515';
//联查小应用编码
var link_app_code = exports.link_app_code = '36185515';
//审批小应用编码
var approve_app_code = exports.approve_app_code = '36185515A';
//请求基础路径
var base_path = exports.base_path = '/nccloud/fbm/quotamanagerment';
//按钮平铺显示数量
var button_limit = exports.button_limit = 3;
//打印输出编码
var nodekey = exports.nodekey = '36185515P_02';
//打印清单编码
var nodekeyList = exports.nodekeyList = '36185515PL';

var module_id = exports.module_id = '36185515';
//单据类型
var billtype = exports.billtype = '36HZ';
/**
 * 列表
 */
var LIST = exports.LIST = {
    ...
    //缓存标示
};var DATA_SOURCE = exports.DATA_SOURCE = 'tm.fbm.quotamanagerment.datasource';
...
var _initTemplate = __webpack_require__(414);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(415);

var _initTemplate4 = _interopRequireDefault(_initTemplate3);

var _initTemplate5 = __webpack_require__(416);

var _initTemplate6 = _interopRequireDefault(_initTemplate5);

var _buttonVisible = __webpack_require__(267);

var _afterEvent = __webpack_require__(417);
...
function buttonVisible(props) {
    ...
    var unionBtn = ['ApproveDetail', 'CreditAmount']; //联查按钮
    ...
    if (!isBrowse) {
        ...
        switch (vbillstatus) {
            case '-1':
                ...
                if (busistatus != '0') {
                    showBtn = ['Edit', 'Commit'].concat(_toConsumableArray(commonBtn));
                } else {
                    showBtn = ['Handle', 'Return'].concat(_toConsumableArray(commonBtn));
                }
                break;
            case '2': //审批进行中
            case '3':
                //提交
                showBtn = ['Uncommit'].concat(_toConsumableArray(commonBtn));
                break;
            case '1':
                //已审批
                if (paymentstatus === null) {
                    showBtn = ['Uncommit', 'Downquota'].concat(_toConsumableArray(commonBtn));
                } else if (paymentstatus === '1') {
                    showBtn = ['Upquota'].concat(_toConsumableArray(commonBtn));
                } else {
                    showBtn = ['Downquota'].concat(_toConsumableArray(commonBtn));
                }
                break;
            default:
                break;
    ...
    // 添加解除质押 弹框内按钮
    showBtn = [].concat(_toConsumableArray(showBtn), ["onCancel", "onSure"]);
    var _iteratorNormalCompletion = true;
    var _didIteratorError = false;
    var _iteratorError = undefined;
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_BaseCard2.default, _extends({
                constant: {
                    ...
                    nodekeyList: _constant.nodekeyList, //打印清单用
                    ...
                    encryptVOClassName: "nccloud.itf.fbm.quotamanagerment.QuotaManagermentEncryptVO4NCC", //ca
                    cafalg: "true", //ca
                ...
                pageTitle: this.props.MutiInit.getIntl("36185515") && this.props.MutiInit.getIntl("36185515").get("36185515-000002") //页面标题/* 国际化处理： 额度管理*/
