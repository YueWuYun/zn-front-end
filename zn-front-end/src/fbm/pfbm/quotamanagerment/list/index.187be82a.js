...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/pfbm/quotamanagerment/list/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/pfbm/quotamanagerment/list/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
var _initTemplate = __webpack_require__(419);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _buttonDisable = __webpack_require__(420);
...
var List = function (_Component) {
    ...
    function List(props) {
        ...
        _this.myRenderCompleteEvent = function () {
            ...
            var applyquota = muti && muti.get("36185515-000009") /* 国际化处理： 申请额度*/;
            var downquota = muti && muti.get("36185515-000012") /* 国际化处理： 下拨额度*/;
            var start = muti && muti.get("36185515-000010") /* 国际化处理： 开始*/;
            var end = muti && muti.get("36185515-000011") /* 国际化处理： 结束*/;
            this.props.search.setTemlateByField(this.searchId, 'applyquota', 'defaultPlaceholder', { start: applyquota + start, end: applyquota + end });
            this.props.search.setTemlateByField(this.searchId, 'downquota', 'defaultPlaceholder', { start: downquota + start, end: downquota + end });
        ...
        value: function render() {
            ...
            var tabs = {
                ...
                items: [{
                    key: "4",
                    name: "numZLCLZ",
                    title: this.props.MutiInit.getIntl("36185515") && this.props.MutiInit.getIntl("36185515").get("36185515-000008") /* 国际化处理： 待经办*/
                }, {
                    key: "-1",
                    name: "numZY",
                    title: this.props.MutiInit.getIntl("36185515") && this.props.MutiInit.getIntl("36185515").get("36185515-000005") /* 国际化处理： 待提交*/
                }, {
                    key: "2,3",
                    name: "numTJ",
                    title: this.props.MutiInit.getIntl("36185515") && this.props.MutiInit.getIntl("36185515").get("36185515-000006") /* 国际化处理： 审批中*/
                }, {
                    key: "all",
                    title: this.props.MutiInit.getIntl("36185515") && this.props.MutiInit.getIntl("36185515").get("36185515-000007") /* 国际化处理： 全部*/
                }],
                tabChangeServal: this.tabChangeServal.bind(this)
            };

            return _react2.default.createElement(_BaseList2.default, _extends((_extends2 = {
                constant: {
                    ...
                    nodekeyList: _constant.nodekeyList,
                    ...
                    busistatus: _constant.LIST.busistatus, // 特殊页签对应的条件
                ...
                _selectedEvent: _events.selectedEvent,
            ...
            }, _defineProperty(_extends2, "_selectedEvent", this.myselectedEvent), _defineProperty(_extends2, "listTabs", tabs), _defineProperty(_extends2, "linkItems", ["approveDetail", "creditBalance"]), _defineProperty(_extends2, "initImport", false), _extends2), this.props));
        }
    }]);
	...
	props.createUIDom({
		...
		if (data) {
			if (data.button) {
				...
				props.button.setButtons(button);
				props.button.setPopContent('DeleteInner', _this.props.MutiInit.getIntl("36185515") && _this.props.MutiInit.getIntl("36185515").get('36185515-000003')); /* 国际化处理： 确认要删除吗?*/
...
function buttonDisable() {
    ...
    if (selectedData.length == 1) {
        ...
        var paymentstatus = selectedData[0].data.values.paymentstatus.value;
        switch (vbillstatus) {
            case '-1':
                //待提交
                if (busistatus != '0') {
                    this.props.button.setButtonDisabled(['Commit', 'Attachment', 'RequestList', 'UnitQuota', 'ApproveDetail', 'Print', 'Output', 'PrintList'], false);
                    this.props.button.setButtonDisabled(['Return', 'Handle', 'Uncommit', 'Upquota', 'Downquota'], true);
                } else {
                    this.props.button.setButtonDisabled(['Return', 'Handle', 'Attachment', 'RequestList', 'UnitQuota', 'ApproveDetail', 'Print', 'Output', 'PrintList'], false);
                    this.props.button.setButtonDisabled(['Commit', 'Uncommit', 'Upquota', 'Downquota'], true);
                }
            ...
            case '3':
                //提交
                this.props.button.setButtonDisabled(['Uncommit', 'Attachment', 'RequestList', 'UnitQuota', 'ApproveDetail', 'Print', 'Output', 'PrintList'], false);
                this.props.button.setButtonDisabled(['Return', 'Commit', 'Handle', 'Upquota', 'Downquota'], true);
                break;
            case '1':
                //审批通过
                if (!paymentstatus) {
                    this.props.button.setButtonDisabled(['Uncommit', 'Downquota', 'Attachment', 'RequestList', 'UnitQuota', 'ApproveDetail', 'Print', 'Output', 'PrintList'], false);
                    this.props.button.setButtonDisabled(['Commit', 'Handle', 'Return', 'Upquota'], true);
                } else if (paymentstatus === '1') {
                    this.props.button.setButtonDisabled(['Upquota', 'Attachment', 'RequestList', 'UnitQuota', 'ApproveDetail', 'Print', 'Output', 'PrintList'], false);
                    this.props.button.setButtonDisabled(['Downquota', 'Uncommit', 'Commit', 'Handle', 'Return'], true);
                } else {
                    this.props.button.setButtonDisabled(['Downquota', 'Attachment', 'RequestList', 'UnitQuota', 'ApproveDetail', 'Print', 'Output', 'PrintList'], false);
                    this.props.button.setButtonDisabled(['Uncommit', 'Commit', 'Handle', 'Return', 'Upquota'], true);
                }

                break;
        }
    } else if (selectedData.length == 0) {
        this.props.button.setButtonDisabled(['Return', 'Handle', 'Commit', 'Uncommit', 'Downquota', 'Upquota', 'Attachment', 'RequestList', 'UnitQuota', 'Print', 'ApproveDetail', 'PrintList', 'Output'], true);
    } else {
        this.props.button.setButtonDisabled(['Return', 'Handle', 'Commit', 'Uncommit', 'Downquota', 'Upquota', 'Attachment', 'RequestList', 'UnitQuota', 'Print', 'ApproveDetail', 'PrintList', 'Output'], false);
    }
}
