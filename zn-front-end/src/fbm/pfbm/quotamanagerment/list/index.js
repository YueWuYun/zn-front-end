...
class List extends Component {
    ...
    myRenderCompleteEvent = function() {
        ...
        let applyquota = muti && muti.get("36185515-000009") /* 国际化处理： 申请额度*/;
        let downquota = muti && muti.get("36185515-000012") /* 国际化处理： 下拨额度*/;
        let start = muti && muti.get("36185515-000010") /* 国际化处理： 开始*/;
        let end  = muti && muti.get("36185515-000011") /* 国际化处理： 结束*/;
        this.props.search.setTemlateByField(this.searchId,
            'applyquota','defaultPlaceholder',{start: applyquota+start,end: applyquota+end})
        this.props.search.setTemlateByField(this.searchId,
            'downquota','defaultPlaceholder',{start: downquota+start,end: downquota+end})
        ...
        return (
            <BaseList
                constant={{
                    ...
                    busistatus: LIST.busistatus, // 特殊页签对应的条件
