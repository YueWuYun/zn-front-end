...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/pfbm/consignbankinpool/ref22/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/pfbm/consignbankinpool/ref22/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
})(window, function(__WEBPACK_EXTERNAL_MODULE__1__, __WEBPACK_EXTERNAL_MODULE__2__, __WEBPACK_EXTERNAL_MODULE__6__, __WEBPACK_EXTERNAL_MODULE__138__) {
...
var _events = __webpack_require__(160);
...
var _meta = __webpack_require__(167);
...
var _buttonClick = __webpack_require__(168);
...
var _buttonClick = __webpack_require__(169);
...
var _initTemplate = __webpack_require__(161);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _balance = __webpack_require__(139);
...
var _initTemplate = __webpack_require__(163);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _restmoney = __webpack_require__(140);
...
var _AcceptModal = __webpack_require__(150);
...
var NCDiv = _ncLightappFront.base.NCDiv,
    ...
    NCScrollElement = _ncLightappFront.base.NCScrollElement;
var PrintOutput = _ncLightappFront.high.PrintOutput,
...
var BaseCard = (_temp = _class = function (_Component) {
    ...
    function BaseCard(props) {
        ...
        var _this = _possibleConstructorReturn(this, (BaseCard.__proto__ || Object.getPrototypeOf(BaseCard)).call(this, props));

        _this.getTransferValue = function (transferIds) {
            if (transferIds) {
                //从缓存中获取查询区域条件
                var queryVO = _ncLightappFront.cardCache.getDefData(_this.searchId, _this.dataSource);
                var pkMapTs = {};
                var index = 0;
                var pk = null;
                var ts = null;
                ...
                (0, _ncLightappFront.ajax)({
                    url: _this.transferQueryUrl,
                    data: { pkMapTs: pkMapTs, queryVO: queryVO },
                    success: function success(res) {
                        var success = res.success,
                            data = res.data;
                        ...
                        if (success) {
                            ...
                            if (data) {
                                _this.props.transferTable.setTransferListValue(_this.transferListId, data);
                            }
                        } else {
                            _this.props.transferTable.setTransferListValue(_this.transferListId, []);
                        }
                    }
                });
            } else {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _this.props.button.createButtonApp({
                        area: _this.props.shoulderBtnArea,
                        // buttonLimit: btnLimit,
                        onButtonClick: _this.props._bodyButtonClick && _this.props._bodyButtonClick.bind(_this),
        ...
        _this.tabsChange = function (key) {
            //console.log(`${this.state.json['36650PUB-000008']}${key}${this.state.json['36650PUB-000009']}-----`);/* 国际化处理： 当前切换到,区域了*/
            _this.props.tabsTableChange && _this.props.tabsTableChange(key);
        };

        _this.onTreeMouseEnter = function (key) {
            _this.props.syncTree.hideIcon(_this.treeId, key, {
                delIcon: false,
                editIcon: false,
                addIcon: false
            });
        ...
        _this.getAssginUsedr = function (value) {
            var name = "commit";
            if (_this.saveOneCommit) {
                name = 'saveCommit';
            }
            _container.card.cardCommit.call(_this, {
                data: {
                    pks: [_this.props.getUrlParam("id")],
                    userObj: value,
                    pageCode: _this.pageId,
                    name: name
                },
                successAfter: function successAfter() {
                    _this.compositeTurnOff();
                }
            });
        };

        _this.compositeTurnOff = function () {
            _this.setState({
                compositedata: null,
        ...
        _this.socketMesg = function (props, mesg) {
            if (mesg.error) {
                //出错时，控制业务按钮显示
        ...
        _this.buttonVisible = props._buttonVisible && props._buttonVisible.bind(_this);
        _this.saveBefore = props.saveBefore && props.saveBefore.bind(_this); //保存前事件
        _this.state = {
            json: {},
            inlt: null,
            billNo: "", //单据编号
    ...
    _createClass(BaseCard, [{
        ...
        value: function componentDidMount() {
            ...
            this.props._initTemplate.call(this, this.props, this.props.cardDidMount.bind(this)); // 如模板内也有多语处理，平台推荐模板加载操作放于此处， 在取到json多语资源后用传参的方式传入intemplate模板函数中
            // 设置编辑态关闭浏览器窗口提示语
            window.onbeforeunload = function () {
                var status = _this3.props.form.getFormStatus(_this3.formId);
                if (status != "browse") {
                    return _this3.state.json["fbmpublic-000008"]; //'当前单据未保存，您确认离开此页面？';/* 国际化处理： 当前单据未保存，您确认离开此页面？*/
                }
            };
            var transfer = this.props.getUrlParam("srcbilltype") === "ref22";
            if (transfer) {
                var transferIds = this.props.transferTable.getTransferTableSelectedId(this.formId);
        ...
        key: "handleTransferBackClick",
        value: function handleTransferBackClick() {
            var _this4 = this;
            ...
            if (scene) urlParm = _extends({}, urlParm, { scene: scene });
            var status = this.props.getUrlParam('status');
            if (status == 'browse') {
                ...
                (0, _ncLightappFront.promptBox)({
                    color: "warning",
                    title: this.state.json["fbmpublic-000097"] /* 国际化处理： 返回*/
                    , content: this.state.json["fbmpublic-000098"] /* 国际化处理： 有未保存的单据，确定要返回吗?*/
                    , beSureBtnClick: function beSureBtnClick() {
                        _this4.setState({
                            transferFinishedBillPkArr: []
                        });
                        //此处需要有提示  
                        _this4.props.pushTo(_this4.TRAN_LIST_PAGE_URL, urlParm);
                    }
                });
            }
        }
         ...
         * @param {*} props 
         */
        value: function repaintView(props) {
            //从地址栏获取状态
            var status = props.getUrlParam("status");
            //判断是否是浏览态
            var viewmode = status == status == 'copy' ? 'add' : status;
            //处理单据号
            if (viewmode == 'browse') {
            ...
            //新增/复制时组织可修改
            var orgedit = status == 'add' || status == 'copy' || status == 'edit';
        ...
        value: function render() {
            ...
            var _props = this.props,
                _afterEvent = _props._afterEvent,
                _beforeEvent = _props._beforeEvent,
                _afterTableEvent = _props._afterTableEvent,
                _bodySelectedEvent = _props._bodySelectedEvent,
                _bodySelectedAllEvent = _props._bodySelectedAllEvent,
                constant = _props.constant,
                pageTitle = _props.pageTitle,
                headBtnArea = _props.headBtnArea,
                _props$formParams = _props.formParams,
                formParams = _props$formParams === undefined ? {} : _props$formParams,
                _props$tabTableParams = _props.tabTableParams,
                tabTableParams = _props$tabTableParams === undefined ? {} : _props$tabTableParams,
                linkItems = _props.linkItems,
                socket = _props.socket,
                DragWidthCom = _props.DragWidthCom;
            var _props2 = this.props,
                cardTable = _props2.cardTable,
                form = _props2.form,
                button = _props2.button,
                ncmodal = _props2.ncmodal,
                cardPagination = _props2.cardPagination,
                syncTree = _props2.syncTree,
                BillHeadInfo = _props2.BillHeadInfo,
                _buttonClick = _props2._buttonClick,
                transferTable = _props2.transferTable;
            ...
            var createSyncTree = syncTree.createSyncTree;
            var createBillHeadInfo = BillHeadInfo.createBillHeadInfo;

            var status = this.props.getUrlParam("status") === "browse";
            var billNo = this.props.form.getFormItemsValue(this.formId, this.billNo);
            var scene = this.props.getUrlParam("scene"); //场景
            /* 卡片子表区域 */
            var cardFormTableDom = _react2.default.createElement(
                "div",
                { className: "nc-bill-bottom-area" },
                _react2.default.createElement(
                    "div",
                    { className: "nc-bill-table-area" },
                    createTabsTable(this.tabCode, _extends({
                        showCheck: !status && this.props.getUrlParam("status") !== undefined,
                        showIndex: true,
                        adaptionHeight: true,
                        onAfterEvent: _afterTableEvent && _afterTableEvent.bind(this),
                        tableHead: this.getTableHead.bind(this),
                        onTabChange: this.tabsChange.bind(this),
                        onSelected: _bodySelectedEvent && _bodySelectedEvent.bind(this), // 左侧选择列单个选择框回调
                        onSelectedAll: _bodySelectedAllEvent && _bodySelectedAllEvent.bind(this), // 左侧选择列全选回调
                        modelSave: _events.buttonClick.bind(this, this.props, "Save") }, tabTableParams))
                )
            );
            if (this.transferCard) {
                return _react2.default.createElement(
                    "div",
                    { id: "transferCard", className: "nc-bill-transferList" },
                    _react2.default.createElement(
                        "div",
                    ...
                    _react2.default.createElement(
                        "div",
                        { className: "nc-bill-transferList-content" },
                        createTransferList({
                            //表格组件id
                            headcode: this.formId,
                            transferListId: this.transferListId, //转单列表id
                            onTransferItemSelected: function onTransferItemSelected(record, status) {
                                //转单缩略图被选中时的钩子函数
                                //需要确保以下代码只在自动跳转到下一个新增时调用，因为没有处理saga标识显示问题 
                                var isEdit = status ? 'browse' : 'add';
                                if (isEdit == 'browse') {
                                    _this5.props.setUrlParam({ status: 'browse' });
                                    var id = record.head[_this5.formId].rows[0].values[_this5.primaryId].value;
                                    if (id) {
                                        _this5.props.setUrlParam({ id: id });
                                        _this5.props.form.setFormStatus([_this5.formId], isEdit);
                                        _this5.props.form.setAllFormValue(_defineProperty({}, _this5.formId, record.head[_this5.formId]));
                                    }
                                } else {
                                    _this5.props.delUrlParam('id');
                                    _this5.props.setUrlParam({ status: 'add' });
                                    _this5.props.form.setFormStatus([_this5.formId], isEdit);
                                    _this5.props.resMetaAfterPkorgEdit();
                                    _this5.props.form.setAllFormValue(_defineProperty({}, _this5.formId, record.head[_this5.formId]));
                                }
                                _this5.repaintView(_this5.props);
                            },
                            onTransferItemClick: function onTransferItemClick(record, index, status) {
                                //已经废弃了
                            }
                        }),
                        _react2.default.createElement(
                            "div",
                            { className: "transferList-content-right nc-bill-card", id: "paybill-card" },
                            _react2.default.createElement(
                                NCScrollElement,
                                { name: "forminfo" },
                                _react2.default.createElement(
                        ...
                        linkItems.includes("ntb") && _react2.default.createElement(Inspection, {
                            ...
                            cancel: function cancel() {
                                _this5.setState({ showNtbDetail: false });
                            },
                        ...
                        _react2.default.createElement(_DisabledCom2.default, {
                            ...
                            onSureCallback: _container.card.cardInvalid.bind(this)
                        }),
                        _react2.default.createElement(_impawnbackcom2.default, {
                            ...
                            onSureCallback: _container.card.impawnBackInstr.bind(this)
                        }),
                        _react2.default.createElement(_ConfirmreceiptCom2.default, {
                            ...
                            onSureCallback: _container.card.cardConfirmreceipt.bind(this)
                        }),
                        _react2.default.createElement(_AcceptModal2.default, {
                            ...
                            onSure: function onSure() {
                                // 是
                                _container.card.baseOperation.call(_this5, {
                                    name: "accept",
                                    data: Object.assign({ extParam: { isacceptednow: "Y" } }, _this5.acceptData)
                                });
                                _this5.setState({
                            ...
                            onDeny: function onDeny() {
                                ...
                                _container.card.baseOperation.call(_this5, {
                                    name: "accept",
                                    data: Object.assign({ extParam: { isacceptednow: "N" } }, _this5.acceptData)
                                });
                                _this5.setState({
                                    acceptModalShow: false
                                });
                        ...
                        _react2.default.createElement(_ReturnCom2.default, {
                            ...
                            onSureCallback: _container.card.cardReturn.bind(this)
                        }),
                        _react2.default.createElement(_TallyCom2.default, {
                            ...
                            onSureCallback: _container.card.cardTally.bind(this)
                        })
                    )
                );
            } else {
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            status && scene !== "linksce" && scene !== "approvesce" && !isVersion && _react2.default.createElement(
                                "div",
                                { className: "header-cardPagination-area" },
                                createCardPagination({
                                    dataSource: this.dataSource,
                                    handlePageInfoChange: _page.pageClick.bind(this)
                                })
                            )
                        )
                    ),
                    _react2.default.createElement(
                        "div",
                        {
                            className: "nc-bill-top-area " + (!constant.tabCode && "remove-block")
                        },
                        _react2.default.createElement(
                            "div",
                            { className: "nc-bill-form-area" },
                            createForm(this.formId, _extends({
                                onAfterEvent: _afterEvent && _afterEvent.bind(this),
                                onBeforeEvent: _beforeEvent && _beforeEvent.bind(this)
                            }, formParams))
                        )
...
var LIST = exports.LIST = {
  //page_title: this.state.json['36200BC-000003'],                       //页面标题/* 国际化处理： 池内托收*/
  disabled_btn: ['Delete', 'Copy', 'Commit', 'Uncommit', 'Attachment', 'Print', 'ApproveDetail', 'Voucher', 'LinkBudgetPlan', 'LinkSDBook', 'Disabled', 'CancelDisabled', 'Output', 'SendInstruction', 'CancelInstruction'], //默认禁用按钮
  page_id: '36200BC_L01', //页面编码
  page_id_link: '36200BCLINK_L01',
  app_code: '36200BC', //应用编码
  ...
  billno: 'vbillno', //单据编号
  page_id: '36200BC_C01', //页面编码
  page_id_link: '36200BCLINK_C01', //联查页面编码
  page_id_approve: '36200BC_C01', //审批页面编码
...
var searchCache = exports.searchCache = {
  key: 'fbm.pfbm.consignbank.searchCache', //查询区域缓存Key
  dataSource: 'fbm.pfbm.consignbank.searchSpace' //查询区域缓存数据的名称空间
...
var REF21_CONST = {
  ...
  tableId: "", //表体区域
  transPageId: "36200BC_TL01", //列表pagecode
  transCardId: "36200BC_TC01", //卡片pagecode
...
exports.beforeEvent = exports.afterEvent = exports.buttonVisible = exports.initTemplate2 = exports.initTemplate1 = exports.initTemplate = exports.buttonClick = undefined;

var _buttonClick = __webpack_require__(151);

var _buttonClick2 = _interopRequireDefault(_buttonClick);

var _initTemplate = __webpack_require__(293);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(294);

var _initTemplate4 = _interopRequireDefault(_initTemplate3);

var _initTemplate5 = __webpack_require__(295);

var _initTemplate6 = _interopRequireDefault(_initTemplate5);

var _buttonVisible = __webpack_require__(244);

var _afterEvent = __webpack_require__(296);

var _beforeEvent = __webpack_require__(297);
...
function buttonVisible(props) {
    var status = props.getUrlParam('status');
    var visible = true;
    var flag = status === 'browse' ? false : true;
    var copyflag = this.state.copyflag || false;
    ...
    // 票据状态 
    var busistatus = props.form.getFormItemsValue(this.formId, 'busistatus') && props.form.getFormItemsValue(this.formId, 'busistatus').value;
    // 是否制证
    var voucher = props.form.getFormItemsValue(this.formId, 'voucher') && props.form.getFormItemsValue(this.formId, 'voucher').value;
    // 网银
    ...
    // 设置所有按钮不可见
    props.button.setButtonVisible(['Save', 'SaveAdd', 'SaveCommit', 'Cancel', 'Add', 'AddFrom', 'Edit', 'Copy', 'Delete', 'Commit', 'Uncommit', 'Print', 'Refresh', 'Attachment', 'Confirmreceipt', 'Unconfirereceipt', 'MakeVoucher', 'CancelVoucher', 'Linkedquery', 'LinkBook', 'ApproveDetail', 'Voucher', 'LinkBudgetPlan', 'Disabled', 'CancelDisabled', 'SendInstruction', 'CancelInstruction'], !visible);

    if (status === 'edit' || status === 'add' || status === 'copy') {
        // 编辑状态：显示按钮：保存，保存提交，取消
        props.button.setButtonVisible(['Save', 'SaveCommit', 'Cancel', 'CancelTransfer'], visible);
    } else if (status === 'browse') {
        if (!id) {
            props.button.setButtonVisible(['Add'], visible);
            props.button.setButtonVisible(['CancelTransfer'], !visible);
            props.button.setButtonVisible(['Refresh'], !visible);
            props.button.setMainButton(['Add'], true);
        } else {
            if (vbillstatus == '-1') {
                // 待提交
                // 单据浏览-待提交：新增、修改、删除、复制、提交、附件、联查、打印、刷新
                props.button.setButtonVisible(['Add', 'Edit', 'Delete', 'Copy', 'Commit', 'Attachment', 'Linkedquery', 'LinkBook', 'Print', 'Refresh', 'CancelTransfer'], visible);
                //设置新增按钮为灰，提交为红色
                ...
                if (onlinebankflag) {
                    ...
                    if (paymentstatus == '2') {
                        ...
                        if (disableflag) {
                            // 作废
                            // 新增、复制、取消作废、联查、附件、打印
                            props.button.setButtonVisible(['Add', 'Copy', 'CancelDisabled', 'Attachment', 'Linkedquery', 'LinkBook', 'ApproveDetail', 'LinkBudgetPlan', 'Print', 'Refresh'], visible);
                        } else {
                            // 新增、复制、发送指令、作废、联查、附件、打印
                            props.button.setButtonVisible(['Add', 'Copy', 'SendInstruction', 'Disabled', 'Attachment', 'Linkedquery', 'LinkBook', 'ApproveDetail', 'LinkBudgetPlan', 'Print', 'Refresh'], visible);
                        }
                    } else if (paymentstatus == '3') {
                        //交易不明=3
                        // 新增、复制、撤回指令、联查、附件、打印
                        props.button.setButtonVisible(['Add', 'Copy', 'CancelInstruction', 'Attachment', 'Linkedquery', 'LinkBook', 'ApproveDetail', 'LinkBudgetPlan', 'Print', 'Refresh'], visible);
                    } else if (paymentstatus == '1') {
                        // 交易成功
                        if (busistatus === 'has_collectionsettle') {
                            // 确认收妥后：已托收结清
                            if (voucher == null || !voucher) {
                                // 非制证
                                // 新增、复制、取消确认、制证、联查、附件、打印
                                props.button.setButtonVisible(['Add', 'Copy', 'Unconfirereceipt', 'MakeVoucher', 'Attachment', 'Linkedquery', 'LinkBook', 'ApproveDetail', 'LinkBudgetPlan', 'Print', 'Refresh'], visible);
                            } else {
                                // 新增、复制、取消确认、取消制证、联查、附件、打印
                                props.button.setButtonVisible(['Add', 'Copy', 'Unconfirereceipt', 'CancelVoucher', 'Attachment', 'Linkedquery', 'LinkBook', 'ApproveDetail', 'LinkBudgetPlan', 'Print', 'Refresh'], visible);
                            }
                        } else {
                            // 新增、复制、确认收妥、联查、附件、打印
                            props.button.setButtonVisible(['Add', 'Copy', 'Confirmreceipt', 'Attachment', 'Linkedquery', 'LinkBook', 'ApproveDetail', 'LinkBudgetPlan', 'Print', 'Refresh'], visible);
                        }
                    } else {
                        // 新增、复制、发送指令、联查、附件、打印
                        props.button.setButtonVisible(['Add', 'Copy', 'Uncommit', 'SendInstruction', 'Attachment', 'Linkedquery', 'LinkBook', 'ApproveDetail', 'LinkBudgetPlan', 'Print', 'Refresh'], visible);
                    }
                } else {
                    // 非网银
                    if (busistatus === 'has_collection') {
                        //已办理托收    
                        //确认收妥
                        props.button.setButtonVisible(['Add', 'Copy', 'Uncommit', 'Confirmreceipt', 'Attachment', 'Linkedquery', 'LinkBook', 'ApproveDetail', 'LinkBudgetPlan', 'Print', 'Refresh'], visible);
                    }
                    if (busistatus === 'has_collectionsettle') {
                        // 已托收结清
                        if (voucher == null || !voucher) {
                            ...
                            // 新增、复制、收回、联查、附件、打印
                            props.button.setButtonVisible(['Add', 'Copy', 'CancelVoucher', 'Attachment', 'Linkedquery', 'LinkBook', 'ApproveDetail', 'LinkBudgetPlan', 'Voucher', 'Print', 'Refresh'], visible);
                        }
                    }
                }
                ...
                // 提交
                // 新增、复制、取消确认、取消制证、联查、附件、打印
                props.button.setButtonVisible(['Add', 'Copy', 'Uncommit', 'Attachment', 'Linkedquery', 'LinkBook', 'ApproveDetail', 'Print', 'Refresh'], visible);
            }
            props.button.setButtonVisible(['Add', 'Copy'], false);
        }
    } else {
        props.button.setButtonVisible(['Add'], visible);
        props.button.setMainButton(['Add'], true);
...
var _BaseCard = __webpack_require__(175);
...
function cardDidMount() {
    var status = this.props.getUrlParam("status");
    _page.initForm.call(this, status);
}
...
var Card = function (_Component) {
    ...
    _createClass(Card, [{
        ...
        value: function render() {
            ...
            var multiLang = this.props.MutiInit.getIntl(_constant.module_id); //this.moduleId
            //表头禁用字段
            var headDisabledItems = [{
                //币种为人民币时禁用组织本币汇率
                key: "olcrate",
                rules: function rules() {
                    var pk_currtype = _this3.props.form.getFormItemsValue(_constant.CARD.form_id, "pk_currtype");
                    return pk_currtype && pk_currtype.value === "1002Z0100000000001K1";
                }
            }];
            return _react2.default.createElement(_BaseCard2.default, _extends({
                constant: {
                    listPageCode: _constant.LIST.page_id,
                    //appcode: app_code,
                    pageId: _constant.TRAN_CARD_PAGE_INFO.PAGE_CODE,
                    moduleId: _constant.module_id,
                    formId: _constant.TRAN_CARD_PAGE_INFO.HEAD_CODE,
                    primaryId: _constant.CARD.primary_id, //主键ID
                    billNo: _constant.CARD.billno, //单据编号
                    // dataSource: DATA_SOURCE, //缓存key
                    nodekey: _constant.nodekey, //打印用
                    API_URL: _constant.API_URL, //接口地址
                    billtype: _constant.billtype, //单据类型，联查审批详情需要
                    disabledBtnsParam: _constant.DISABLE_BTN_PARAM, //根据选中数据判断对应按钮禁用状态
                    headDisabledItems: headDisabledItems, //表头禁用字段
                    pknotetype_bank: _constant.CARD.pknotetype_bank, // 银行承兑汇票
                    pknotetype_busi: _constant.CARD.pknotetype_busi, // 商业承兑汇票
                    pknotetype_ebank: _constant.CARD.pknotetype_ebank, // 电子银行承兑汇票
                    pknotetype_ebusi: _constant.CARD.pknotetype_ebusi, // 电子商业承兑汇票
                    cafalg: "true",
                    encryptVOClassName: "nccloud.itf.pfbm.consignbankinpool.vo.ConsignBankInPoolEncryptVO4NCC",
                    disableReason: _constant.disableReason,
                    fullAggClassName: _constant.fullAggClassName,
                    billInfo: _constant.CARD.billinfo,
                    confirmreceipt: _constant.confirmreceipt,
                    modulecode: "3620",
                    // 转单
                    dataSource: _const.REF21_CONST.Ref21DataSource, //缓存key
                    ldataSource: _constant.DATA_SOURCE, //应用原本的缓存key
                    searchId: _const.REF21_CONST.searchId,
                    transferQueryUrl: _constant.API_URL.transtocard, //转单卡片接口地址
                    transferCard: true, //是否是转单卡片页面
                    TRAN_LIST_PAGE_URL: "/ref21",
                    transferListId: _constant.TRAN_CARD_PAGE_INFO.LEFT_CODE, //转单列表id
                    srcbillpk: _const.REF21_CONST.pk_head //参照数据的主键pk_register
                },
                _initTemplate: this.getInitTemplate.call(this),
                _buttonVisible: _events.buttonVisible,
                _afterEvent: _events.afterEvent,
                _beforeEvent: _events.beforeEvent,
                pageTitle: multiLang && multiLang.get("36200BC-000003") //节点标题
                , headBtnArea: _constant.CARD.head_btn_code //表头按钮区域
                , formParams: {
                    //区域默认展开
                    expandArr: ["form_consignbank_01", "poolinfo", "issecurity"]
                } //表头form参数
...
Card = (0, _ncLightappFront.createPage)({
    billinfo: {
        billtype: "form",
        pagecode: _constant.TRAN_CARD_PAGE_INFO.PAGE_CODE,
        headcode: _constant.TRAN_CARD_PAGE_INFO.HEAD_CODE
    },
...
exports.default = function (props, templateCallback) {
	...
	var app_code = props.getSearchParam('c');
	props.createUIDom({
		pagecode: _constant.TRAN_CARD_PAGE_INFO.PAGE_CODE, //页面id
		appcode: app_code
	}, function (data) {
		if (data) {
			if (data.template) {
...
function modifierMeta(meta) {
	...
	meta[this.formId].items.map(function (item) {
		...
		if (item.attrcode == 'pk_register') {
			...
			item.queryCondition = function () {
				...
				var billpoolflag = _this2.props.form.getFormItemsValue(_this2.formId, 'billpoolflag') && _this2.props.form.getFormItemsValue(_this2.formId, 'billpoolflag').value;
				var opbilltype = _this2.props.form.getFormItemsValue(_this2.formId, 'opbilltype') && _this2.props.form.getFormItemsValue(_this2.formId, 'opbilltype').value;
				return {
					pk_register: pk_register,
					pk_org: pk_org,
		...
		if (item.attrcode === 'holderacc') {
			...
			item.queryCondition = function () {
				return {
					refnodename: _this2.props.MutiInit.getIntl("36200BC") && _this2.props.MutiInit.getIntl("36200BC").get('36200BC-000014'), /* 国际化处理： 使用权参照*/
					pk_org: _this2.props.form.getFormItemsValue(_this2.formId, 'pk_org').value,
					pk_curr: _this2.props.form.getFormItemsValue(_this2.formId, 'pk_curr') && _this2.props.form.getFormItemsValue(_this2.formId, 'pk_curr').value,
	...
	//保证金
	meta['issecurity'].items.map(function (item) {
		if (item.attrcode === 'securityaccount') {
			//保证金账户过滤
			item.checkStrictly = false;
			item.queryCondition = function () {
				return {
					pk_org: _this2.props.form.getFormItemsValue(_this2.formId, 'pk_org').value, //组织
					pk_curr: _this2.props.form.getFormItemsValue(_this2.formId, 'pk_curr') && _this2.props.form.getFormItemsValue(_this2.formId, 'pk_curr').value,
...
function afterEvent(props, moduleId, key, value, oldValue) {
	...
	var eventData = void 0,
	    ...
	    oldvalue = void 0,
	    extParam = void 0;
	var currentItem = { props: props, moduleId: moduleId, key: key, value: value, oldValue: oldValue };
	var eventDataOld = this.props.createHeadAfterEventData(this.pageId, this.formId, '', moduleId, key, value);
	...
	if (key === 'pk_org') {
		if (!oldValue.value) {
			...
			(0, _ncLightappFront.promptBox)({
				...
				beSureBtnClick: function beSureBtnClick() {
					changeOrg.call(_this, value, eventData);
				},
				cancelBtnClick: function cancelBtnClick() {
					props.form.setFormItemsValue(_this.formId, { 'pk_org': oldValue });
				}
			});
		}
	} else if (key === 'pk_register') {
		// 票据编号
		var _newvalue = eventDataOld.newvalue.value;
		if (_newvalue) {
			(0, _ncLightappFront.ajax)({
				async: false,
				...
				success: function success(res) {
					...
					(0, _FBMAfterEditUtil.setHeadItemProp)(props, _this.formId, headItemProps);
				}
			});
		} else {
			_EmptyAreaValueUtil.EmptyAreaValue.call(this, this.billInfo, this.formId, "pk_register.");
		...
		var accpk = value.refpk;
		var acccode = value.refcode;
		var bankpk = value.values['bd_bankdoc.pk_bankdoc'];
		var bankname = value.values['bd_bankdoc.name'].value;
		bankpk['display'] = bankname;
		// 给银行赋值
		var discount_bank = props.form.getFormItemsValue(this.formId, 'pk_holderbank');
		props.form.setFormItemsValue(this.formId, { 'pk_holderbank': bankpk });
	} else if (key === 'money') {
		//委托金额
		var _newvalue2 = eventDataOld.newvalue.value;
		if (_newvalue2) {
			(0, _ncLightappFront.ajax)({
				async: false,
				url: this.API_URL.afterEvent,
		...
		//组织本币汇率
		var _newvalue3 = eventDataOld.newvalue.value;
		if (_newvalue3) {
			(0, _ncLightappFront.ajax)({
				async: false,
				url: this.API_URL.afterEvent,
		...
		//集团汇率
		var _newvalue4 = eventDataOld.newvalue.value;
		if (_newvalue4) {
			(0, _ncLightappFront.ajax)({
				async: false,
				url: this.API_URL.afterEvent,
		...
		//全局汇率
		var _newvalue5 = eventDataOld.newvalue.value;
		if (_newvalue5) {
			(0, _ncLightappFront.ajax)({
				async: false,
				url: this.API_URL.afterEvent,
	...
	} else if (key === 'securitymoney') {
		//保证金额
		var _newvalue6 = eventDataOld.newvalue.value;
		if (_newvalue6) {
			(0, _ncLightappFront.ajax)({
				async: false,
				url: this.API_URL.afterEvent,
	...
	} else if (key === 'dcollectiondate') {
		//款项收妥日期应大于等于委托日期dconsigndate
		var dcollectiondate = eventDataOld.newvalue.value;
		var dconsigndate = props.form.getFormItemsValue(this.formId, 'dconsigndate') && props.form.getFormItemsValue(this.formId, 'dconsigndate').value;
		if (dcollectiondate && dconsigndate) {
			if (dcollectiondate < dconsigndate) {
				props.form.setFormItemsValue(this.formId, { 'dcollectiondate': { value: '', display: null } });
				(0, _ncLightappFront.toast)({ color: 'warning', content: multiLang && multiLang.get('36200BC-000002') }); /* 国际化处理： 款项收妥日期应大于等于委托日期*/
			}
		}
	} else if (key === 'dconsigndate') {
		//款项收妥日期应大于等于委托日期dconsigndate
		var _dconsigndate = eventDataOld.newvalue.value;
		var _dcollectiondate = props.form.getFormItemsValue(this.formId, 'dcollectiondate') && props.form.getFormItemsValue(this.formId, 'dcollectiondate').value;
		if (_dconsigndate && _dcollectiondate) {
			if (_dconsigndate > _dcollectiondate) {
				props.form.setFormItemsValue(this.formId, { 'dconsigndate': { value: '', display: null } });
				(0, _ncLightappFront.toast)({ color: 'warning', content: multiLang && multiLang.get('36200BC-000002') }); /* 国际化处理： 款项收妥日期应大于等于委托日期*/
			}
		}
	} else if (key === 'securityaccount') {
		//保证金账户有值，保证金设为必输项
		var _newvalue7 = eventDataOld.newvalue.value;
		if (_newvalue7) {
	...
	_index.cardEvent.creditAfterEvent.call(this, currentItem, {
...
function setAfterEditFormValue(props, res) {
	...
	props.form.setAllFormValue(_defineProperty({}, this.formId, head[this.formId]));
...
function changeOrg(value, eventData) {
	...
	_index.cardEvent.changeOrg.call(this, value).then(function () {
		if (value.value) {
			_index.cardEvent.getAfterEventData.call(_this2, eventData).then(function (res) {
				setAfterEditFormValue.call(_this2, _this2.props, res);
			}).then(function () {});
		}
	});
}
...
function beforeEvent(props, moduleId, key, value, data) {
	var currType = ['olcrate', 'discountinterest', 'onlinebankflag'];
	if (currType.includes(key)) {
		...
		//主键，判断是否是新增还是修改
		var pk_consignbank = props.form.getFormItemsValue(this.formId, this.primaryId).value;
		if (!pk_consignbank) {
			// 新增，能进来的即可修改
			return true;
		}
