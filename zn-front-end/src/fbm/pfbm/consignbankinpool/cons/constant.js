...
//小应用编码
export const app_code = '36200BC';
//联查小应用编码
export const link_app_code = '36200BCL';
//审批小应用编码
export const approve_app_code = '36200BCA';
//请求基础路径
export const base_path = '/nccloud/pfbm/consignbankinpool';
//按钮平铺显示数量
export const button_limit = 3;
//打印输出编码
export const nodekey = '36200BC';

export const module_id = '36200BC';
//单据类型
export const billtype = '36HI';
...
//缓存标示
export const DATA_SOURCE = 'tm.pfbm.consignbank.datasource';
//转单缓存
export const DATA_SOURCE_TRANS = 'fbm.pfbm.consignbank.transfer';
