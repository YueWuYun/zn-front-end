...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/pfbm/consignbankinpool/list/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/pfbm/consignbankinpool/list/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
var _initTemplate = __webpack_require__(279);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _searchBtnClick = __webpack_require__(280);

var _searchBtnClick2 = _interopRequireDefault(_searchBtnClick);

var _buttonDisable = __webpack_require__(281);
...
var List = function (_Component) {
    ...
    function List(props) {
        ...
        _this.myRenderCompleteEvent = function () {
            var muti = this.props.MutiInit.getIntl('36200BC'); //this.moduleId
            var money = muti && muti.get("36200BC-000011") /* 国际化处理： 票据金额*/;
            var start = muti && muti.get("36200BC-000012") /* 国际化处理： 开始*/;
            var end = muti && muti.get("36200BC-000013") /* 国际化处理： 结束*/;
        ...
        value: function render() {
            ...
            var tabs = {
                ...
                items: [{
                    key: "-1",
                    name: "tab01",
                    title: multiLang && multiLang.get("36200BC-000006") /* 国际化处理： 待提交*/
                }, {
                    key: "2,3",
                    name: "tab02",
                    title: multiLang && multiLang.get("36200BC-000007") /* 国际化处理： 审批中*/
                }, {
                    key: "10",
                    name: "tab03",
                    title: multiLang && multiLang.get("36200BC-000008") /* 国际化处理： 指令处理中*/
                }, {
                    key: "11",
                    name: "tab04",
                    title: multiLang && multiLang.get("36200BC-000009") /* 国际化处理： 待确认收妥*/
                }, {
                    key: "all",
                    title: multiLang && multiLang.get("36200BC-000010") /* 国际化处理： 全部*/
                }],
            ...
            return _react2.default.createElement(_BaseList2.default, _extends({
                constant: {
                    ...
                    dataSourceTrans: _constant.DATA_SOURCE_TRANS, //转单缓存
                    tranListPageInfo: _constant.TRAN_LIST_PAGE_INFO, //转单列表信息
                    tranCardPageInfo: _constant.TRAN_CARD_PAGE_INFO, //转单卡片信息
                    ...
                    tabStatus: _constant.LIST.tabStatus,
                    paymentstatus: _constant.LIST.paymentstatus,
                    busistatus: _constant.LIST.busistatus,
                    vbillstatus: _constant.LIST.vbillstatus,
...
exports.default = function (props) {
    ...
    var app_code = props.getSearchParam("c");
    var excelimportconfig = (0, _ncLightappFront.excelImportconfig)(props, "fbm", "36HI", true, "", {
        appcode: app_code,
    ...
    props.createUIDom({
        ...
        if (data) {
            if (data.button) {
                ...
                props.button.setButtons(button);
                props.button.setPopContent("DeleteInner", _this.props.MutiInit.getIntl("36200BC") && _this.props.MutiInit.getIntl("36200BC").get("36200BC-000004")); /* 国际化处理： 确认要删除吗?*/
...
function modifierMeta(props, meta) {
    ...
    meta[this.tableId].items.push({
        itemtype: "customer",
        attrcode: "opr",
        label: this.props.MutiInit.getIntl("36200BC") && this.props.MutiInit.getIntl("36200BC").get("36200BC-000005") /* 国际化处理： 操作*/
        , width: 200,
        fixed: "right",
        className: "table-opr",
        visible: true,
        render: function render(text, record, index) {
            ...
            var busistatus = record.busistatus && record.busistatus.value;
            ...
            if (vbillstatus == '-1') {
                ...
                if (onlinebankflag) {
                    ...
                    if (paymentstatus == '2') {
                        ...
                        } else if (busistatus === 'has_collection') {
                            // 已办理托收
                    ...
                    if (busistatus === 'has_collectionsettle' && !voucher) {
                        // 已托收结清
...
var filterSearchValue = function filterSearchValue(searchVal) {
    ...
    if (tabKey == '11') {
        // 待确认收妥
        condition.field = 'busistatus';
        condition.value.firstvalue = 'has_collection';
    }
