...
import { initTemplate, searchBtnClick, selectedEvent,buttonDisable } from "./events";
...
class List extends Component {
    ...
    myRenderCompleteEvent = function () {
        let muti = this.props.MutiInit.getIntl('36200BC'); //this.moduleId
        let money = muti && muti.get("36200BC-000011") /* 国际化处理： 票据金额*/;
        let start = muti && muti.get("36200BC-000012") /* 国际化处理： 开始*/;
        let end = muti && muti.get("36200BC-000013") /* 国际化处理： 结束*/;
            ...
            items: [
                {
                    key: "-1",
                    name: "tab01",
                    title: multiLang && multiLang.get("36200BC-000006")
                } /* 国际化处理： 待提交*/,
                {
                    key: "2,3",
                    name: "tab02",
                    title: multiLang && multiLang.get("36200BC-000007")
                } /* 国际化处理： 审批中*/,
                {
                    key: "10",
                    name: "tab03",
                    title: multiLang && multiLang.get("36200BC-000008")
                } /* 国际化处理： 指令处理中*/,
                {
                    key: "11",
                    name: "tab04",
                    title: multiLang && multiLang.get("36200BC-000009")
                } /* 国际化处理： 待确认收妥*/,
                {
                    key: "all",
                    title: multiLang && multiLang.get("36200BC-000010")
                } /* 国际化处理： 全部*/
            ],
