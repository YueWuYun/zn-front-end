...
//小应用编码
export const app_code = '36200BR';
//联查小应用编码
export const link_app_code = '36200BRL';
//审批小应用编码
export const approve_app_code = '36200BRA';
//请求基础路径
export const base_path = '/nccloud/fbm/exitpool';
//按钮平铺显示数量
export const button_limit = 3;  
//打印输出编码
export const nodekey = '36200BRP_02';
//联查预算aggVO
export const fullAggClassName = 'nc.vo.fbm.storage.AggStorageVO';
export const module_id = '';
//单据类型
export const billtype = '36HH';
// 作废原因区域
 ...
 */
export const LIST = {
    disabled_btn: ['Delete', 'Copy', 'Union', 'Balance', 'ApproveDetail', 'Commit','Uncommit','SendInstruction','Invalid','CancelInvalid', 
...
//缓存标示
export const DATA_SOURCE = 'tm.fbm.exitpool.datasource';
