...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/pfbm/exitpool/card/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/pfbm/exitpool/card/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
//小应用编码
var app_code = exports.app_code = '36200BR';
//联查小应用编码
var link_app_code = exports.link_app_code = '36200BRL';
//审批小应用编码
var approve_app_code = exports.approve_app_code = '36200BRA';
//请求基础路径
var base_path = exports.base_path = '/nccloud/fbm/exitpool';
//按钮平铺显示数量
var button_limit = exports.button_limit = 3;
//打印输出编码
var nodekey = exports.nodekey = '36200BRP_02';
//联查预算aggVO
var fullAggClassName = exports.fullAggClassName = 'nc.vo.fbm.storage.AggStorageVO';
var module_id = exports.module_id = '';
//单据类型
var billtype = exports.billtype = '36HH';
// 作废原因区域
var disableReason = exports.disableReason = 'disablenote';
// 业务对应表名，修改按钮点击时用来saga校验
var tableName = exports.tableName = 'fbm_storage';
/**
 * 列表
 */
var LIST = exports.LIST = {
    disabled_btn: ['Delete', 'Copy', 'Union', 'Balance', 'ApproveDetail', 'Commit', 'Uncommit', 'SendInstruction', 'Invalid', 'CancelInvalid', 'Print', 'Output', 'Attachment', 'Voucher', 'LinkBudgetPlan'], //默认禁用按钮
    disabled_btn_one: ['Copy'], //只有列表只有一条数据的时候，按钮才可用     
    page_id: '36200BR_LIST', //页面编码
    page_id_link: '36200BRL_LIST', //联查页面编码
    search_id: 'search', //查询区域编码
    table_id: 'table', //表格区域编码
    head_btn_code: 'list_head', //表头按钮区域
    search_oid: '1001Z61000000000YTPF', //查询区域oid
    ...
    billno: 'vbillno', //单据编号
    page_id: '36200BR_CARD', //页面编码 
    page_id_link: '36200BRL_CARD', //联查页面编码
    page_id_approve: '36200BRA_CARD', //审批页面编码
    form_id: 'head', //表头表单编码
    ...
    //缓存标示
};var DATA_SOURCE = exports.DATA_SOURCE = 'tm.fbm.exitpool.datasource';

//查询区域缓存
var searchCache = exports.searchCache = {
    key: 'fbm.fbm.exitpool.searchCache', //查询区域缓存Key
    dataSource: 'fbm.fbm.exitpool.searchSpace' //查询区域缓存数据的名称空间
    ...
    // key: 'voucher', //授信协议编号
    // btnName: ['MakeVoucher','CancelVoucher']    //联查授信额度
}];
...
exports.bodySelectedAllEvent = exports.bodySelectedEvent = exports.afterTableEvent = exports.beforeEvent = exports.afterEvent = exports.buttonVisible = exports.initTemplate2 = exports.initTemplate1 = exports.initTemplate = exports.buttonClick = exports.bodyButtonClick = undefined;

var _buttonClick = __webpack_require__(151);

var _buttonClick2 = _interopRequireDefault(_buttonClick);

var _initTemplate = __webpack_require__(361);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(362);

var _initTemplate4 = _interopRequireDefault(_initTemplate3);

var _initTemplate5 = __webpack_require__(363);

var _initTemplate6 = _interopRequireDefault(_initTemplate5);

var _bodyButtonClick = __webpack_require__(251);

var _buttonVisible = __webpack_require__(250);

var _afterEvent = __webpack_require__(364);

var _beforeEvent = __webpack_require__(365);

var _afterTableEvent = __webpack_require__(366);

var _bodySelectedEvent = __webpack_require__(367);
...
exports.afterTableEvent = _afterTableEvent.afterTableEvent;
exports.bodySelectedEvent = _bodySelectedEvent.bodySelectedEvent;
exports.bodySelectedAllEvent = _bodySelectedEvent.bodySelectedAllEvent;
...
function buttonVisible(props) {
    ...
    var currTab = this.props.cardTable.getCurTabKey();
    var paymentstatus = props.cardTable.getColValue(currTab, 'paymentstatus') && props.cardTable.getColValue(currTab, 'paymentstatus').map(function (item) {
        return item.value;
    });
    //判断子表中用途包含质押，则表头质押率可以编辑
    var flagPay = false;
    var candisable = false;
    if (paymentstatus && paymentstatus.includes('1')) {
        //1 代表发送指令成功 且是网银的话  可以制证
        flagPay = true;
    };
    if (paymentstatus && paymentstatus.includes('2')) {
        //2 代表发送指令失败
        candisable = true;
    };
    var btnObj = {};
    var showBtn = [];
    var editBtn = ['save_group', 'SaveCommit', 'Cancel', 'addRow', 'deleteRow', 'insertRow', 'delRow', 'expand'];
    var unionBtn = ['BondIssue', 'ApproveDetail', 'FundPlan'];
    var allBtns = [].concat(_toConsumableArray(buttons), editBtn, unionBtn, ['Add', 'Edit', 'Delete', 'Copy']);
    var disabledBtn = ['deleteRow', 'copyRow'];
    if (!status) {
        showBtn = ['Add'];
    } else if (!isBrowse) {
        ...
        if (!id) {
            ...
            //单据浏览态
            var commonBtn = [].concat(unionBtn, ['Union', 'Print', 'Output', 'Refresh', 'Attachment', 'fold', 'unfold']);
            var auitBtn = ['SendInstruction', 'CancelInstruction', 'Invalid', 'CancelInvalid', 'MakeVoucher', 'CancelVoucher'];
            if (voucher) {
                auitBtn = auitBtn.filter(function (item) {
                    return item !== 'MakeVoucher';
                });
            } else {
                auitBtn = auitBtn.filter(function (item) {
                    return item !== 'CancelVoucher';
                });
            }
            if (disableflag) {
                auitBtn = auitBtn.filter(function (item) {
            ...
            if (onlinebankflag) {
                ...
                auitBtn = auitBtn.filter(function (item) {
                    return item !== 'CancelInstruction' && item !== 'SendInstruction';
                });
            }
            switch (vbillstatus) {
                case '-1':
                    ...
                    showBtn = ['Add', 'Edit', 'Delete', 'Copy', 'Commit'].concat(_toConsumableArray(commonBtn));
                    //设置新增按钮为灰，提交为红色
                ...
                case '3':
                    ...
                    showBtn = ['Add', 'Copy', 'Uncommit'].concat(_toConsumableArray(commonBtn));
                    break;
                case '1':
                    //审批通过
                    if (!onlinebankflag) {
                        auitBtn = auitBtn.filter(function (item) {
                            return item !== 'SendInstruction' && item !== 'CancelInstruction' && item !== 'Invalid' && item !== 'CancelInvalid';
                        });
                    } else {
                        if (!flagPay) {
                            auitBtn = auitBtn.filter(function (item) {
                                return item !== 'MakeVoucher' && item !== 'CancelVoucher';
                            });
                        }
                        if (!candisable) {
                            auitBtn = auitBtn.filter(function (item) {
                    ...
                    showBtn = ['Add', 'Copy', 'Uncommit'].concat(_toConsumableArray(commonBtn), _toConsumableArray(auitBtn));
                    //设置新增按钮为灰，提交为红色
                    props.button.setMainButton(['Add'], false);
...
function bodyButtonClick(props, key, text, record, index) {
    ...
    var currTableId = this.tabCode;
    var curTabKey = this.props.cardTable.getCurTabKey();
    switch (key) {
        //行 新增
        case 'addRow':
            _index.card.addRow.call(this);
            _common.clsRowno.call(this, curTabKey);
            break;
        //行 删除
        case 'deleteRow':
            _index.card.deleteRow.call(this);
            var eventData = this.props.createTabsBodyAfterEventData(this.pageId, this.formId, this.tabOrder, 'pfbm', 'delrow', null); //编辑后事件整单数据
            _index.cardEvent.setBodyAfterEventData.call(this, eventData).then(function (res) {
                props.form.setAllFormValue(_defineProperty({}, _this.formId, res.data.head && res.data.head[_this.formId]));
            });
            break;
        //插行
        case 'insertRow':
            _index.card.insertRow.call(this, index);
            _common.clsRowno.call(this, curTabKey);
            break;
        //删行
        case 'delRow':
            _index.card.delRow.call(this, index);
            var eventData1 = this.props.createTabsBodyAfterEventData(this.pageId, this.formId, this.tabOrder, 'pfbm', 'delrow', null); //编辑后事件整单数据
            _index.cardEvent.setBodyAfterEventData.call(this, eventData1).then(function (res) {
                props.form.setAllFormValue(_defineProperty({}, _this.formId, res.data.head && res.data.head[_this.formId]));
            });
            break;
        //展开（编辑态）
        case 'expand':
            _index.card.openTabModal.call(this, record, index);
            break;
        //展开（浏览态）
        case 'unfold':
        //收起
        case 'fold':
            _index.card.toggleRowView.call(this, record);
            break;
    }
}
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_BaseCard2.default, _extends({
                ...
                constant: {
                    ...
                    tabCode: _constant.CARD.tab_code, //tab区域code编码
                    tabOrder: _constant.CARD.tab_order, //tab排序
                    tabId: _constant.CARD.tab_id, //tab主键
                    nodekey: _constant.nodekey, //打印用
                    API_URL: _constant.API_URL, //接口地址
                    billtype: _constant.billtype, //单据类型，联查审批详情需要
                    fields: _constant.COMMON.fields, //字段名
                    tableTypeObj: {
                        guarantee: "cardTable"
                    },
                    disabledBtnsParam: _constant.DISABLE_BTN_PARAM, //根据选中数据判断对应按钮禁用状态
                    encryptVOClassName: "nccloud.itf.pfbm.exitpool.ExitpoolEncryptVO4NCC",
                    headDisabledItems: headDisabledItems, //表头禁用字段
                    cafalg: "true",
                    fullAggClassName: _constant.fullAggClassName, //联查预算
                ...
                _afterTableEvent: _events.afterTableEvent,
                _bodyButtonClick: _events.bodyButtonClick,
                _bodySelectedEvent: _events.bodySelectedEvent,
                _bodySelectedAllEvent: _events.bodySelectedAllEvent,
                pageTitle: this.props.MutiInit.getIntl("36200BR") && this.props.MutiInit.getIntl("36200BR").get("36200BR-000003") //页面标题/* 国际化处理： 票据出池*/
                , headBtnArea: _constant.CARD.head_btn_code //表头按钮区域
                , shoulderBtnArea: _constant.CARD.shoulder_btn_code //表体tab区域肩部区域按钮code
...
Card = (0, _ncLightappFront.createPage)({
    billinfo: {
        ...
        bodycode: _constant.CARD.tab_order
    },
	...
	props.createUIDom({
		...
		if (data) {
			if (data.template) {
				...
				props.meta.renderTabs(meta, _constant.CARD.tab_order, _constant.CARD.tab_order);
				// props.meta.setMeta(meta);
...
function modifierMeta(meta) {
	...
	//表体票据编号参照过滤
	meta['guarantee'].items.map(function (item) {
		if (item.attrcode == 'pk_register') {
			item.isMultiSelectedEnabled = true;
			item.queryCondition = function () {
				var guaData = _this2.props.cardTable.getColValue('guarantee', 'pk_register').filter(function (item) {
					return item.value !== '' && item.value !== null;
				}).map(function (item) {
					return item.value;
				});
				var guaDatas = guaData.toString();
				return {
					pk_register: guaDatas,
					pk_org: _this2.props.form.getFormItemsValue(_this2.formId, 'pk_org').value, // 财务组织
					pk_curr: _this2.props.form.getFormItemsValue(_this2.formId, 'pk_curr').value, //币种 
					billpoolflag: _this2.props.form.getFormItemsValue(_this2.formId, 'billpoolflag').value, //票据池
	...
	//侧拉表体页面的参照过滤
	meta['guarantee2'].items.map(function (item) {
		if (item.attrcode == 'pk_register') {
			item.isMultiSelectedEnabled = true;
			item.queryCondition = function () {
				var guaData = _this2.props.cardTable.getColValue('guarantee', 'pk_register').filter(function (item) {
	...
	try {
		for (var _iterator = Object.keys(meta.gridrelation)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
			var item = _step.value;
			...
			meta[item].items.push({
				...
				render: function render(text, record, index) {
					var buttonAry = [];
					if (_this2.props.getUrlParam('status') === 'browse') {
						//浏览态
						buttonAry = [record.expandRowStatus ? 'fold' : 'unfold'];
					} else {
						buttonAry = ['expand', 'insertRow', 'delRow'];
					}
					return _this2.props.button.createOprationButton(buttonAry, {
						area: _constant.CARD.body_btn_code,
						onButtonClick: function onButtonClick(props, key) {
							return _bodyButtonClick.bodyButtonClick.call(_this2, props, key, text, record, index);
						}
					});
				}
			});
...
function afterEvent(props, moduleId, key, value, oldValue) {
	...
	var eventData = this.props.createTabsAfterEventData(this.pageId, this.formId, this.tabOrder, moduleId, key, value); //编辑后事件整单数据
	var commonAfterEventArr = ['repprcact', 'olcrate', 'creditamount', 'glcrate', 'gllcrate']; //还本金额/本币汇率/释放授信额度
	if (key === 'pk_org') {
		...
		if (!oldValue || !oldValue.value) {
			...
			_index.cardEvent.changeOrg.call(this, value, function () {}).then(function () {
				if (value.value) {
					// clsRowno.call(this, curTabKey); 
					_index.cardEvent.getAfterEventData.call(_this, eventData).then(function (res) {
						props.form.setAllFormValue(_defineProperty({}, _this.formId, res.data.head && res.data.head[_this.formId]));
						_common.clsRowno.call(_this, curTabKey);
					});
					_index.cardEvent.setBodyAfterEventData.call(_this, eventData).then(function (res) {
						props.cardTable.addRow(_this.tabCode, undefined, {}, true);
					});
				}
			});
		} else {
			(0, _ncLightappFront.promptBox)({
				color: "warning",
				title: this.props.MutiInit.getIntl("36200BR") && this.props.MutiInit.getIntl("36200BR").get('36200BR-000000'), /* 国际化处理： 修改财务组织*/
				content: this.props.MutiInit.getIntl("36200BR") && this.props.MutiInit.getIntl("36200BR").get('36200BR-000001'), /* 国际化处理： 确认修改财务组织, 这样会清空您录入的信息?*/
				beSureBtnClick: _index.cardEvent.changeOrg.call(this, value).then(function () {
					if (value.value) {
						_index.cardEvent.getAfterEventData.call(_this, eventData).then(function (res) {
							props.form.setAllFormValue(_defineProperty({}, _this.formId, res.data.head && res.data.head[_this.formId]));
				...
				cancelBtnClick: function cancelBtnClick() {
					return props.form.setFormItemsValue(moduleId, {
						pk_org: oldValue,
						pk_org_v: oldValue
					});
				}
		...
		if (value.value !== oldValue.value) {
			_index.cardEvent.getAfterEventData.call(this, eventData).then(function (res) {
				props.form.setAllFormValue(_defineProperty({}, _this.formId, res.data.head && res.data.head[_this.formId]));
				props.cardTable.setAllTabsData(res.data.bodys, _this.tabOrder);
				var setEditable = res.data.userjson;
...
function beforeEvent(props, moduleId, key, value, data) {
	var currType = ['olcrate', 'glcrate', 'gllcrate'];
	if (currType.includes(key)) {
		var pk_org = props.form.getFormItemsValue(this.formId, 'pk_org').value; //财务组织
		var pk_currtype = props.form.getFormItemsValue(this.formId, 'pk_currtype').value; //源币
		var rateType = '';
		if (key === 'olcrate') {
			rateType = 'rate';
		} else if (key === 'glcrate') {
		...
		var editTable = _index.cardEvent.getBeforeEventCurrtype.call(this, CurrtypeData).then(function (res) {
			if (res.data) {
				return true;
			} else {
				return false;
...
exports.afterTableEvent = afterTableEvent;
...
function afterTableEvent(props, moduleId, key, value, changedrows, index, record, type, method) {
	...
	var eventData = this.props.createTabsBodyAfterEventData(this.pageId, this.formId, this.tabOrder, moduleId, key, changedrows); //编辑后事件整单数据
	var repAfterKeys = ['realrepaymny', 'grtrelease']; //还款计划编辑后事件字段 实还本金/释放担保金额
	if (key === 'pk_register') {
		_index.cardEvent.setBodyAfterEventData.call(this, eventData).then(function (res) {
			props.form.setAllFormValue(_defineProperty({}, _this.formId, res.data.head && res.data.head[_this.formId]));
		});
	} else if (repAfterKeys.includes(key)) {
		_index.cardEvent.setBodyAfterEventData.call(this, eventData);
	}
}
...
exports.bodySelectedEvent = bodySelectedEvent;
exports.bodySelectedAllEvent = bodySelectedAllEvent;
...
function bodySelectedEvent(props, moduleId, record, index, status) {
    var checkedRows = props.cardTable.getCheckedRows(this.tabCode);
    _page.disabledBodyButton.call(this);
}
