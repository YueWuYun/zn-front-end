...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/pfbm/exitpool/list/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/pfbm/exitpool/list/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
var _searchBtnClick = __webpack_require__(184);

var _buttonClick = __webpack_require__(185);

var _selectedEvent = __webpack_require__(186);

var _bodyButtonClick = __webpack_require__(187);
...
var _index6 = __webpack_require__(181);
...
exports.buttonDisable = exports.getListData = exports.selectedEvent = exports.pageInfoClick = exports.bodyBtnOperation = exports.buttonClick = exports.initTemplate1 = exports.initTemplate = exports.searchBtnClick = exports.bodyButtonClick = undefined;

var _initTemplate = __webpack_require__(369);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(370);

var _initTemplate4 = _interopRequireDefault(_initTemplate3);

var _buttonDisable = __webpack_require__(371);
...
exports.buttonDisable = _buttonDisable.buttonDisable;
...
var disabledBtnsParam = [].concat(_toConsumableArray(_constant2.DISABLE_BTN_PARAM)); //复制数组，不然会共用卡片页disabledBtnsParam的引用
disabledBtnsParam.push({
    btnName: ["Delete", "Commit"],
    rules: function rules(current) {
        return current.vbillstatus && current.vbillstatus.value !== "-1";
    } //待提交才可以删除
});
disabledBtnsParam.push({
    btnName: "Uncommit",
    rules: function rules(current) {
        return current.vbillstatus && current.vbillstatus.value !== "3" && current.vbillstatus.value !== "1";
    }
});
disabledBtnsParam.push({
    btnName: ["SendInstruction", "Invalid", "CancelInvalid", "MakeVoucher", "CancelVoucher"],
    rules: function rules(current) {
        return current.vbillstatus && current.vbillstatus.value !== "1";
    }
});
...
var List = function (_Component) {
    ...
    function List(props) {
        ...
        _this.myselectedEvent = function (props, moduleId, record, index, status) {
            _events.buttonDisable.call(this);
        };

        _this.API_URL = _constant2.API_URL;
        _this.state = {
            json: {},
            inlt: null
        };
        ...
        value: function render() {
            var tabs = {
                ...
                items: [{
                    key: "-1",
                    name: "numZY",
                    title: this.props.MutiInit.getIntl("36200BR") && this.props.MutiInit.getIntl("36200BR").get("36200BR-000006") /* 国际化处理： 待提交*/
                }, {
                    key: "2,3",
                    name: "numTJ",
                    title: this.props.MutiInit.getIntl("36200BR") && this.props.MutiInit.getIntl("36200BR").get("36200BR-000007") /* 国际化处理： 审批中*/
                }, {
                    key: "4",
                    name: "numZLCLZ",
                    title: this.props.MutiInit.getIntl("36200BR") && this.props.MutiInit.getIntl("36200BR").get("36200BR-000009") /* 国际化处理： 指令处理中*/
                }, {
                    key: "all",
                    title: this.props.MutiInit.getIntl("36200BR") && this.props.MutiInit.getIntl("36200BR").get("36200BR-000008") /* 国际化处理： 全部*/ /* 国际化处理： 全部*/
                }],
            ...
            return _react2.default.createElement(_BaseList2.default, _extends({
                ...
                constant: {
                    modulecode: "3620",
                    appcode: _constant2.app_code,
                    cardPageCode: _constant.CARD.page_id,
                    moduleId: _constant2.module_id,
                    searchId: _constant2.LIST.search_id,
                    tableId: _constant2.LIST.table_id,
                    pageId: _constant2.LIST.page_id,
                    cardpageId: _constant.CARD.page_id,
                    nodekey: _constant2.nodekey, //打印输出编码
                    dataSource: _constant2.DATA_SOURCE, //缓存key
                    searchCache: _constant2.searchCache, //查询区缓存
                    // oid: LIST.search_oid, //查询区oid
                    primaryId: _constant2.LIST.primary_id,
                    billNo: _constant2.LIST.billno, //单据编号
                    modelname: _constant2.modelname, //模块名称
                    billstatus: _constant2.LIST.billstatus, //单据状态
                    tabStatus: _constant2.LIST.tabStatus, //列表特殊页签规则
                    paymentstatus: _constant2.LIST.paymentstatus, // 特殊页签对应的条件
                    API_URL: _constant2.API_URL, //接口地址
                    disabledBtn: _constant2.LIST.disabled_btn, //默认禁用按钮
                    disabledBtnOne: _constant2.LIST.disabled_btn_one, //列表只有一条数据的条件，按钮才可用
                    billtype: _constant2.billtype, //单据类型，联查审批详情需要
                    disabledBtnsParam: disabledBtnsParam, //根据选中数据判断对应按钮禁用状态
                    fields: _constant2.COMMON.fields, //字段名
                    fullAggClassName: _constant2.fullAggClassName, //联查预算
                    disableReason: _constant2.disableReason,
                    tableName: _constant2.tableName
                ...
                , headBtnArea: _constant2.LIST.head_btn_code //表头按钮区域
...
exports.default = function (props) {
	...
	var pagecode = _constant.LIST.page_id;
	var scene = this.props.getUrlParam("scene");
	var pk_ntbparadimvo = this.props.getUrlParam("pk_ntbparadimvo"); //预算反联查
	...
	props.createUIDom({
		...
		if (data) {
			if (data.button) {
				...
				props.button.setButtons(button);
				props.button.setPopContent('DeleteInner', _this.props.MutiInit.getIntl("36200BR") && _this.props.MutiInit.getIntl("36200BR").get('36200BR-000004')); /* 国际化处理： 确认要删除吗?*/ /* 国际化处理： 确认要删除吗?*/
			...
			return React.createElement(
				...
				props.button.createErrorButton({
					...
					sucessCallBack: function sucessCallBack() {
						var buttonAry = [];
						var busistatus = record.vbillstatus && record.vbillstatus.value;
						var onlinebankflag = record.onlinebankflag.value;
						var disableflag = record.disableflag.value;
						var voucher = record.voucher.value;
						switch (busistatus) {
							case '-1':
								//待提交
...
function buttonDisable() {
    var selectedData = this.props.table.getCheckedRows(this.tableId);
    if (selectedData.length == 1) {
        var vbillstatus = selectedData[0].data.values.vbillstatus.value;
        var voucher = selectedData[0].data.values.voucher.value;
        var disableflag = selectedData[0].data.values.disableflag.value;
        var onlinebankflag = selectedData[0].data.values.onlinebankflag.value;
        switch (vbillstatus) {
            case '-1':
                //待提交
                this.props.button.setButtonDisabled(['Add', 'Delete', 'Copy', 'Commit', 'Attachment', 'Union', 'Balance', 'ApproveDetail', 'Voucher', 'LinkBudgetPlan', 'Print', 'Output'], false);
                this.props.button.setButtonDisabled(['Uncommit', 'SendInstruction', 'Invalid', 'CancelInvalid', 'MakeVoucher', 'CancelVoucher'], true);
                break;
            case '2': //待审批
            case '3':
                //提交
                this.props.button.setButtonDisabled(['Add', 'Copy', 'Uncommit', 'Attachment', 'Union', 'Balance', 'ApproveDetail', 'Voucher', 'LinkBudgetPlan', 'Print', 'Output'], false);
                this.props.button.setButtonDisabled(['Delete', 'Commit', 'Delete', 'SendInstruction', 'Invalid', 'CancelInvalid', 'MakeVoucher', 'CancelVoucher'], true);
                break;
            case '1':
                //审批通过
                if (voucher) {
                    this.props.button.setButtonDisabled(['Add', 'Copy', 'CancelVoucher', 'Attachment', 'Union', 'Balance', 'ApproveDetail', 'Voucher', 'LinkBudgetPlan', 'Print', 'Output', 'Invalid', 'CancelInvalid'], false);
                    this.props.button.setButtonDisabled(['Delete', 'Commit', 'Uncommit', 'SendInstruction', 'MakeVoucher'], true);
                } else {
                    this.props.button.setButtonDisabled(['Add', 'Copy', 'Uncommit', 'SendInstruction', 'Invalid', 'CancelInvalid', 'MakeVoucher', 'Attachment', 'Union', 'Balance', 'ApproveDetail', 'Voucher', 'LinkBudgetPlan', 'Print', 'Output'], false);
                    this.props.button.setButtonDisabled(['Delete', 'Commit', 'CancelVoucher'], true);
                }
                if (onlinebankflag) {
                    this.props.button.setButtonDisabled(['SendInstruction'], false);
                } else {
                    this.props.button.setButtonDisabled(['SendInstruction'], true);
                }
                break;
        }
    } else if (selectedData.length == 0) {
        this.props.button.setButtonDisabled(['Delete', 'Copy', 'Union', 'Balance', 'ApproveDetail', 'Commit', 'Uncommit', 'SendInstruction', 'Invalid', 'CancelInvalid', 'MakeVoucher', 'CancelVoucher', 'Print', 'Output', 'Attachment', 'Voucher', 'LinkBudgetPlan'], true);
    } else {
        this.props.button.setButtonDisabled(['Delete', 'Copy', 'Union', 'Balance', 'ApproveDetail', 'Commit', 'Uncommit', 'SendInstruction', 'Invalid', 'CancelInvalid', 'MakeVoucher', 'CancelVoucher', 'Print', 'Output', 'Attachment', 'Voucher', 'LinkBudgetPlan'], false);
    }
}
