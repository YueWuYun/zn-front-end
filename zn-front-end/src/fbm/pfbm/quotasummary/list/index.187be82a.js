...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/pfbm/quotasummary/list/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/pfbm/quotasummary/list/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
var _initTemplate = __webpack_require__(427);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _buttonDisable = __webpack_require__(428);
    ...
    _createClass(List, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_BaseList2.default, _extends((_extends2 = {
                ...
                pageTitle: this.props.MutiInit.getIntl("36185540") && this.props.MutiInit.getIntl("36185540").get("36185540-000000") //节点标题/* 国际化处理： 单位下拨可用额度*/
                , headBtnArea: _constant.LIST.head_btn_code //表头按钮区域
            }, _defineProperty(_extends2, "_selectedEvent", this.myselectedEvent), _defineProperty(_extends2, "listDidMount", listDidMount), _defineProperty(_extends2, "linkItems", ["approveDetail", "creditBalance"]), _defineProperty(_extends2, "initImport", false), _extends2), this.props));
        }
    }]);
	...
	props.createUIDom({
		...
		if (data) {
			if (data.button) {
				...
				props.button.setButtons(button);
				props.button.setPopContent('DeleteInner', _this.props.MutiInit.getIntl("36185540") && _this.props.MutiInit.getIntl("36185540").get('36185540-000001')); /* 国际化处理： 确认要删除吗?*/
