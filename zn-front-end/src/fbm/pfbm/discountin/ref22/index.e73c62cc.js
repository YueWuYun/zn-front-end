...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/pfbm/discountin/ref22/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/pfbm/discountin/ref22/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
var _initTemplate = __webpack_require__(345);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(346);

var _initTemplate4 = _interopRequireDefault(_initTemplate3);

var _initTemplate5 = __webpack_require__(347);

var _initTemplate6 = _interopRequireDefault(_initTemplate5);

var _buttonVisible = __webpack_require__(226);

var _afterEvent = __webpack_require__(348);

var _beforeEvent = __webpack_require__(349);
...
function buttonVisible(props) {
    ...
    var editBtn = ['Save', 'SaveAdd', 'SaveCommit', 'Cancel', 'CancelTransfer']; //编辑态显示按钮
    ...
    if (!status) {
        ...
        if (!id) {
            ...
            showBtn.push(_constant.btns.CancelTransfer);
            if (pk_discount) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_BaseCard2.default, _extends({
                constant: (_ref = {
                    ...
                    // 转单
                    ldataSource: _constant.DATA_SOURCE }, _defineProperty(_ref, "dataSource", _const.REF21_CONST.Ref21DataSource), _defineProperty(_ref, "searchId", _const.REF21_CONST.searchId), _defineProperty(_ref, "transferQueryUrl", _constant.API_URL.transtocard), _defineProperty(_ref, "transferCard", true), _defineProperty(_ref, "TRAN_LIST_PAGE_URL", "/ref21"), _defineProperty(_ref, "transferListId", _constant.TRAN_CARD_PAGE_INFO.LEFT_CODE), _defineProperty(_ref, "srcbillpk", _const.REF21_CONST.pk_head), _ref),
...
function afterEvent(props, moduleId, key, value, oldValue) {
	...
	} else if (key === 'ddiscountdate' || key === 'discountdelaydaynum' || key === 'ratedaynum' || key === 'discountyrate' || key === 'discountcharge' || key === 'buyerinterest' || key === 'olcrate') {
		//
		if (value.value !== oldValue.value) {
			_index.cardEvent.getAfterEventData.call(this, eventData).then(function (res) {
				// props.form.setAllFormValue({
