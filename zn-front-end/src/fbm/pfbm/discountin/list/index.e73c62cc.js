...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/pfbm/discountin/list/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/pfbm/discountin/list/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
var _initTemplate = __webpack_require__(331);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _events = __webpack_require__(174);

var _searchBtnClick = __webpack_require__(332);

var _searchBtnClick2 = _interopRequireDefault(_searchBtnClick);

var _buttonDisable = __webpack_require__(333);
...
var List = function (_Component) {
    ...
    function List(props) {
        ...
        _this.myRenderCompleteEvent = function () {
            ...
            var money = muti && muti.get("36200DT-000010") /* 国际化处理： 票据金额*/;
            var start = muti && muti.get("36200DT-000011") /* 国际化处理： 开始*/;
            var end = muti && muti.get("36200DT-000012") /* 国际化处理： 结束*/;
            this.props.search.setTemlateByField(this.searchId, 'discountmoney', 'defaultPlaceholder', { start: money + start, end: money + end });
        ...
        value: function render() {
            ...
            var tabs = {
                ...
                items: [{
                    key: "-1",
                    name: "tab01",
                    title: multiLang && multiLang.get("36200DT-000006") /* 国际化处理： 待提交*/
                }, {
                    key: "2,3",
                    name: "tab02",
                    title: multiLang && multiLang.get("36200DT-000007") /* 国际化处理： 审批中*/
                }, {
                    key: "10",
                    name: "tab03",
                    title: multiLang && multiLang.get("36200DT-000008") /* 国际化处理： 指令处理中*/
                }, {
                    key: "all",
                    title: multiLang && multiLang.get("36200DT-000009") /* 国际化处理： 全部*/
                }],
	...
	props.createUIDom({
		...
		if (data) {
			if (data.button) {
				...
				props.button.setPopContent('DeleteInner', multiLang && multiLang.get('36200DT-000004')); /* 国际化处理： 确认要删除吗?*/
...
function modifierMeta(props, meta) {
	...
	meta[this.tableId].items.push({
		itemtype: 'customer',
		attrcode: 'opr',
		label: multiLang && multiLang.get('36200DT-000005'), /* 国际化处理： 操作*/
		width: 200,
		fixed: 'right',
		className: "table-opr",
		visible: true,
		render: function render(text, record, index) {
			...
			if (vbillstatus == '-1') {
				...
				if (paymentstatus && paymentstatus == '1') {
					...
					// // 撤回指令状态
					// if (ecdswithdrawstatus && ecdswithdrawstatus=='2') {
					// 	// 撤回失败才可以再次撤回
...
var setDefData = _ncLightappFront.cardCache.setDefData,
    getDefData = _ncLightappFront.cardCache.getDefData;
// let querytype = constant.list_querytype;
//点击查询，获取查询区数据
...
function clickSearchBtn(props, searchVal) {
    ...
    // 用于查询页签数量
    // let tabSearchVal = deepClone(searchVal.conditions);
    var searchdata = this.props.search.getQueryInfo(this.searchId);
