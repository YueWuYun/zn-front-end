...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/pfbm/discountin/ref21/index"] = factory(require("nc-lightapp-front"), require("react"));
	else
		root["fbm/pfbm/discountin/ref21/index"] = factory(root["nc-lightapp-front"], root["React"]);
...
var _btn_Controller = __webpack_require__(335);
...
var _search_btnClick = __webpack_require__(338);
...
var _btnClicks = __webpack_require__(224);
...
var _referEvent = __webpack_require__(339);

var _referEvent2 = _interopRequireDefault(_referEvent);

var _search21_afterEvent = __webpack_require__(340);
...
var _init = __webpack_require__(341);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              createBillHeadInfo({
                title: multiLang && multiLang.get("36200DT-000013") /* 国际化处理： 选择票据号码 */
        ...
        _react2.default.createElement(
          ...
          createTransferTable({
            ...
            transferBtnText: this.props.MutiInit.getIntl("36200DT") && this.props.MutiInit.getIntl("36200DT").get("36200DT-000014"), //转单按钮显示文字/* 国际化处理： 确认*/
...
var _refresh_BtnClick = __webpack_require__(337);
...
var _commonSearch_BtnClick = __webpack_require__(247);
...
function referEvent(props, meta) {
  ...
  meta[_const.REF21_CONST.searchId].items.map(function (item) {
    ...
    if (item.attrcode == "invoiceunit") {
      ...
      item.queryCondition = function () {
        return {
          pk_org: _this.props.search.getSearchValByField(_const.REF21_CONST.searchId, 'pk_org').value.firstvalue, //组织
          pk_group: _this.props.search.getSearchValByField(_const.REF21_CONST.searchId, 'pk_group').value.firstvalue //集团
        };
      };
    }
  });
...
var _initSingleTemplate = __webpack_require__(342);

var _initSingleTemplate2 = _interopRequireDefault(_initSingleTemplate);

var _initTemplate = __webpack_require__(343);
