...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/pfbm/report/BankPoolQuery/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("nc-report"));
	else
		root["fbm/pfbm/report/BankPoolQuery/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["nc-report"]);
...
var Test = function (_Component) {
  ...
  _createClass(Test, [{
    ...
    */
    ...
    key: 'advSearchClearEve',
    value: function advSearchClearEve(props, searchId) {
    ...
    value: function setConnectionSearch(transSaveObject, obj, data, props, url, urlParams, sessonKey, rowdata) {
      if (obj && obj.key) {
        if (obj.key == 'linkbill') {
          ...
          (0, _DrillUtil.drillToBill)(props, data, 'pk_protocol', 'pk_billtypecode');
        } else {
