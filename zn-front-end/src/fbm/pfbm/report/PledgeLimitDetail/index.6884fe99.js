...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/pfbm/report/PledgeLimitDetail/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("nc-report"));
	else
		root["fbm/pfbm/report/PledgeLimitDetail/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["nc-report"]);
  ...
  _createClass(Test, [{
    ...
    value: function disposeSearch(meta, props) {
      ...
      items.forEach(function (item) {
        ...
        //     return {
        //       systemcode:'FBM',
        //       GridRefActionExt: 'nccloud.web.fbm.report.filter.FbmBillTypeFilter4PledgeLimit'
        //     }
        //   }        
        // }
      });
