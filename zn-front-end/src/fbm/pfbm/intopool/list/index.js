...
import { initTemplate, initTemplate1,buttonDisable } from "./events";
...
disabledBtnsParam.push({
    btnName: ["Voucher"],
    rules: current => !current.voucher.value
});
            ...
            items: [
                {
                    ...
                    title:
                        ...
                        this.props.MutiInit.getIntl("36200BT").get(
                            "36200BT-000007"
                        )
                ...
                } //* 国际化处理： 全部*//* 国际化处理： this.props.MutiInit.getIntl("36200BT") && this.props.MutiInit.getIntl("36200BT").get('36200BT-000009')*/* 国际化处理： 国际化处理,全部*/
            ],
