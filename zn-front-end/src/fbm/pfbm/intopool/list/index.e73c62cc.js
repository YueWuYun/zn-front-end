...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/pfbm/intopool/list/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/pfbm/intopool/list/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
//小应用编码
var app_code = exports.app_code = '36200BT';
//联查小应用编码
var link_app_code = exports.link_app_code = '36200BTA';
//审批小应用编码
var approve_app_code = exports.approve_app_code = '36200BTA';
//请求基础路径
var base_path = exports.base_path = '/nccloud/fbm/intopool';
//按钮平铺显示数量
var button_limit = exports.button_limit = 3;
//打印输出编码
var nodekey = exports.nodekey = '36200BTPA';

var module_id = exports.module_id = '36200BT';
//单据类型
var billtype = exports.billtype = '36HG';
// 作废原因区域
...
var LIST = exports.LIST = {
    //page_title: this.props.MutiInit.getIntl("36200BT") && this.props.MutiInit.getIntl("36200BT").get('36200BT-000004'),                          //页面标题/* 国际化处理： 页面标题*//* 国际化处理： 票据入池*/
    disabled_btn: ['Delete', 'Commit', 'Uncommit', 'Print', 'Output', 'Attachment', 'ApproveDetail', 'CreditAmount', 'Copy', 'SendInstruction', 'CancelInstruction', 'Invalid', 'CancelInvalid', 'MakeVoucher', 'CancelVoucher', 'LinkSDBook', 'Voucher', 'LinkBudgetPlan'], //默认禁用按钮
    disabled_btn_one: [],
    page_id: '36200BT_LIST', //页面编码
...
var btns = exports.btns = {
    ...
    billno: 'vbillno',
    billstatus: 'vbillstatus', //单据编号
    page_id: '36200BT_CARD', //页面编码
    page_id_link: '36200BT_CARDL', //联查页面编码
    page_id_approve: '36200BT_CARD', //审批页面编码
    form_id: 'head', //表头表单编码
    ...
    //缓存标示
};var DATA_SOURCE = exports.DATA_SOURCE = 'tm.fbm.intopool.datasource';

//查询区域缓存
var searchCache = exports.searchCache = {
    key: 'fbm.fbm.intopool.searchCache', //查询区域缓存Key
    dataSource: 'fbm.fbm.intopool.searchSpace' //查询区域缓存数据的名称空间
...
var _initTemplate = __webpack_require__(402);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(403);

var _initTemplate4 = _interopRequireDefault(_initTemplate3);

var _buttonDisable = __webpack_require__(404);
...
var _constant = __webpack_require__(201);
...
disabledBtnsParam.push({
    btnName: ["SendInstruction", "CancelInstruction", "Invalid", "CancelInvalid", "MakeVoucher", "CancelVoucher"],
    rules: function rules(current) {
        return current.vbillstatus && current.vbillstatus.value !== "1";
    }
});
disabledBtnsParam.push({
    ...
    rules: function rules(current) {
        return current.onlinebankflag && !current.onlinebankflag.value;
    }
});
// disabledBtnsParam.push({
        ...
        value: function render() {
            var tabs = {
                ...
                items: [{
                    key: "-1",
                    name: "DTJ",
                    title: this.props.MutiInit.getIntl("36200BT") && this.props.MutiInit.getIntl("36200BT").get("36200BT-000007")
                }, //* 国际化处理： 待提交*//* 国际化处理： this.props.MutiInit.getIntl("36200BT") && this.props.MutiInit.getIntl("36200BT").get('36200BT-000007')*/* 国际化处理： 国际化处理,待提交*/
                {
                    key: "2,3",
                    name: "SPZ",
                    title: this.props.MutiInit.getIntl("36200BT") && this.props.MutiInit.getIntl("36200BT").get("36200BT-000008")
                }, //* 国际化处理： 审批中*//* 国际化处理： this.props.MutiInit.getIntl("36200BT") && this.props.MutiInit.getIntl("36200BT").get('36200BT-000008')*/* 国际化处理： 国际化处理,审批中*/
                {
                    key: "4",
                    name: "numZLCLZ",
                    title: this.props.MutiInit.getIntl("36200BT") && this.props.MutiInit.getIntl("36200BT").get("36200BT-000010") /* 国际化处理： 指令处理中*/
                }, {
                    key: "all",
                    title: this.props.MutiInit.getIntl("36200BT") && this.props.MutiInit.getIntl("36200BT").get("36200BT-000009") //* 国际化处理： 全部*//* 国际化处理： this.props.MutiInit.getIntl("36200BT") && this.props.MutiInit.getIntl("36200BT").get('36200BT-000009')*/* 国际化处理： 国际化处理,全部*/
                }],
            ...
            return _react2.default.createElement(_BaseList2.default, _extends({
                ...
                pageTitle: this.props.MutiInit.getIntl("36200BT") && this.props.MutiInit.getIntl("36200BT").get("36200BT-000004") //节点标题
...
exports.default = function (props) {
	...
	var excelimportconfig = (0, _ncLightappFront.excelImportconfig)(props, "fbm", '36HF', true, "", { "appcode": _constant.app_code, "pagecode": _constant.CARD.page_id });
	var excelimportconfigq = (0, _ncLightappFront.excelImportconfig)(props, "fbm", '36HF1', true, "", { "appcode": _constant.app_code, "pagecode": _constant.CARD.page_id });
	...
	props.createUIDom({
		...
		if (data) {
			if (data.button) {
				...
				props.button.setButtons(button);
				props.button.setPopContent('delete', _this.props.MutiInit.getIntl("36200BT") && _this.props.MutiInit.getIntl("36200BT").get('36200BT-000005')); //* 国际化处理： 确认要删除吗?*//* 国际化处理： 确认要删除吗?*/* 国际化处理： 国际化处理,确认要删除吗*/
				props.button.setPopContent('terminate', _this.props.MutiInit.getIntl("36200BT") && _this.props.MutiInit.getIntl("36200BT").get('36200BT-000006')); //* 国际化处理： 确认要终止吗?*//* 国际化处理： 确认要终止吗?*/* 国际化处理： 国际化处理,确认要终止吗*/
				...
				props.button.setPopContent('DeleteInner', _this.props.MutiInit.getIntl("36200BT") && _this.props.MutiInit.getIntl("36200BT").get('36200BT-000005')); /* 国际化处理： 确认要删除吗?*/
			}
			if (data.template) {
				var meta = data.template;
...
function modifierMeta(props, meta) {
	...
	meta[this.tableId].items.push({
		itemtype: 'customer',
		attrcode: 'opr',
		label: this.props.MutiInit.getIntl("36200BT") && this.props.MutiInit.getIntl("36200BT").get('36200BT-000003'), //* 国际化处理： 操作*//* 国际化处理： this.props.MutiInit.getIntl("36200BT") && this.props.MutiInit.getIntl("36200BT").get('36200BT-000003')*/* 国际化处理： 国际化处理,操作*/
		width: 200,
		fixed: 'right',
		className: "table-opr",
		visible: true,
					...
					sucessCallBack: function sucessCallBack() {
						...
						switch (busistatus) {
							...
							case '1':
								...
								if (onlinebankflag) {
									// 网银
									buttonAry = ['UnCommitInner', 'CommandInner', 'CancelCommandInner'];
								} else {
									// 非网银
...
function buttonDisable() {
    ...
    if (selectDatas.length == 1) {
        ...
        var onlinebankflag = item.data.values.onlinebankflag.value;
