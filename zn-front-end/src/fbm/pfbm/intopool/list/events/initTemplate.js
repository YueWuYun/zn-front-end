		...
		(data) => {
			if (data) {
				if (data.button) {
					...
					props.button.setPopContent('delete', this.props.MutiInit.getIntl("36200BT") && this.props.MutiInit.getIntl("36200BT").get('36200BT-000005'));//* 国际化处理： 确认要删除吗?*//* 国际化处理： 确认要删除吗?*/* 国际化处理： 国际化处理,确认要删除吗*/
					props.button.setPopContent('terminate', this.props.MutiInit.getIntl("36200BT") && this.props.MutiInit.getIntl("36200BT").get('36200BT-000006'));//* 国际化处理： 确认要终止吗?*//* 国际化处理： 确认要终止吗?*/* 国际化处理： 国际化处理,确认要终止吗*/
					...
					props.button.setPopContent('DeleteInner', this.props.MutiInit.getIntl("36200BT") && this.props.MutiInit.getIntl("36200BT").get('36200BT-000005'));/* 国际化处理： 确认要删除吗?*/
				}
				if (data.template) {
