...
//小应用编码
export const app_code = '36200BT';
//联查小应用编码
export const link_app_code = '36200BTA';
//审批小应用编码
export const approve_app_code = '36200BTA';
//请求基础路径
export const base_path = '/nccloud/fbm/intopool';
//按钮平铺显示数量
export const button_limit = 3;
//打印输出编码
export const nodekey = '36200BTPA';

export const module_id = '36200BT';
//单据类型
export const billtype = '36HG';
// 作废原因区域
...
//缓存标示
export const DATA_SOURCE = 'tm.fbm.intopool.datasource';
