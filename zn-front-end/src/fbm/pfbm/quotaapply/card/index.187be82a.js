...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/pfbm/quotaapply/card/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/pfbm/quotaapply/card/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
//小应用编码
var app_code = exports.app_code = '36180QA';
//联查小应用编码
var link_app_code = exports.link_app_code = '36180QA';
//审批小应用编码
var approve_app_code = exports.approve_app_code = '36180QAA';
//请求基础路径
var base_path = exports.base_path = '/nccloud/fbm/quotaapply';
//按钮平铺显示数量
var button_limit = exports.button_limit = 3;
//打印输出编码
var nodekey = exports.nodekey = 'NCC36180QA_01';

var module_id = exports.module_id = '36180QA';
//单据类型
var billtype = exports.billtype = '36HQ';
// 作废原因区域
...
var LIST = exports.LIST = {
    disabled_btn: ['Delete', 'Copy', 'Commit', 'Uncommit', 'SendInstruction', 'ImpawnBackInstr', 'CancelImpawnBack', 'WithdrawImpawn', 'Invalid', 'CancelInvalid', 'Attachment', 'LinkSDBook', 'Voucher', 'LinkBudgetPlan', 'ApproveDetail', 'Print', 'Output', 'Commission', 'CommissionCancel', 'UnitQuota'], //默认禁用按钮
    ...
    //缓存标示
};var DATA_SOURCE = exports.DATA_SOURCE = 'tm.fbm.quotaapply.datasource';
...
var _initTemplate = __webpack_require__(406);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(407);

var _initTemplate4 = _interopRequireDefault(_initTemplate3);

var _initTemplate5 = __webpack_require__(408);

var _initTemplate6 = _interopRequireDefault(_initTemplate5);

var _buttonVisible = __webpack_require__(265);

var _afterEvent = __webpack_require__(409);
...
var _constant = __webpack_require__(202);
...
function buttonVisible(props) {
    ...
    //银行类别
    var pk_banktype = props.form.getFormItemsValue(this.formId, 'pk_banktype') && props.form.getFormItemsValue(this.formId, 'pk_banktype').value;
    var btnObj = {};
    var showBtn = [];
    var disabledBtn = ['deleteRow'];
    var unionBtn = ['LinkSDBook', 'Voucher', 'LinkBudgetPlan', 'ApproveDetail', 'UnitQuota']; //联查按钮
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_BaseCard2.default, _extends({
                constant: {
                    ...
                    encryptVOClassName: "nccloud.itf.fbm.quotaapply.vo.QuotaapplyEncryptVO4NCC", //ca
                    cafalg: "true", //ca
                ...
                pageTitle: this.props.MutiInit.getIntl("36180QA") && this.props.MutiInit.getIntl("36180QA").get("36180QA-000002") //页面标题/* 国际化处理： 额度申请*/
...
function afterEvent(props, moduleId, key, value, oldValue) {
	...
	} else if (key === 'pk_currtype' || key === "applydate" || key === 'applymoney' || key === "olcrate" || key === "glcrate" || key === "gllcrate") {
		//币种 + 申请日期
		if (!value.value) {
			return;
		}
