...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/pfbm/quotaapply/list/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/pfbm/quotaapply/list/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
var _initTemplate = __webpack_require__(411);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _buttonDisable = __webpack_require__(412);
...
var List = function (_Component) {
    ...
    function List(props) {
        ...
        _this.myRenderCompleteEvent = function () {
            var muti = this.props.MutiInit.getIntl('36180QA'); //this.moduleId
            var money = muti && muti.get("36180QA-000009") /* 国际化处理： 申请额度*/;
            var start = muti && muti.get("36180QA-000010") /* 国际化处理： 开始*/;
            var end = muti && muti.get("36180QA-000011") /* 国际化处理： 结束*/;
        ...
        value: function render() {
            var tabs = {
                ...
                items: [{
                    key: "-1",
                    name: "numZY",
                    title: this.props.MutiInit.getIntl("36180QA") && this.props.MutiInit.getIntl("36180QA").get("36180QA-000005") /* 国际化处理： 待提交*/
                }, {
                    key: "2,3",
                    name: "numTJ",
                    title: this.props.MutiInit.getIntl("36180QA") && this.props.MutiInit.getIntl("36180QA").get("36180QA-000006") /* 国际化处理： 审批中*/
                }, {
                    key: "36180QADWT",
                    name: "numDWT",
                    title: this.props.MutiInit.getIntl("36180QA") && this.props.MutiInit.getIntl("36180QA").get("36180QA-000008") /* 国际化处理： 待委托办理（即审批通过之后）*/
                }, {
                    key: "all",
                    title: this.props.MutiInit.getIntl("36180QA") && this.props.MutiInit.getIntl("36180QA").get("36180QA-000007") /* 国际化处理： 全部*/
                }],
            ...
            return _react2.default.createElement(_BaseList2.default, _extends({
                ...
                pageTitle: this.props.MutiInit.getIntl("36180QA") && this.props.MutiInit.getIntl("36180QA").get("36180QA-000002") //节点标题 //页面标题/* 国际化处理： 额度申请*/
	...
	props.createUIDom({
		...
		if (data) {
			if (data.button) {
				...
				props.button.setButtons(button);
				props.button.setPopContent('DeleteInner', _this.props.MutiInit.getIntl("36180QA") && _this.props.MutiInit.getIntl("36180QA").get('36180QA-000003')); /* 国际化处理： 确认要删除吗?*/
...
function modifierMeta(props, meta) {
	...
	meta[this.tableId].items.push({
		...
		render: function render(text, record, index) {
			...
			var pk_banktype = record.pk_banktype && record.pk_banktype.value;
			switch (vbillstatus) {
				case '-1':
					//待提交
...
function buttonDisable() {
    ...
    if (selectedData.length == 1) {
        ...
        var pk_banktype = selectedData[0].data.values.pk_banktype.value;
        switch (vbillstatus) {
            case '-1':
                //待提交
                this.props.button.setButtonDisabled(['Add', 'Delete', 'Copy', 'Commit', 'Attachment', 'LinkSDBook', 'Voucher', 'LinkBudgetPlan', 'ApproveDetail', 'UnitQuota', 'Print', 'Output'], false);
            ...
            case '3':
                //提交
                this.props.button.setButtonDisabled(['Add', 'Copy', 'Uncommit', 'Attachment', 'LinkSDBook', 'Voucher', 'LinkBudgetPlan', 'ApproveDetail', 'UnitQuota', 'Print', 'Output'], false);
            ...
            case '1':
                //审批通过                
                this.props.button.setButtonDisabled(['Add', 'Copy', 'ImpawnBackInstr', 'CancelImpawnBack', 'WithdrawImpawn', 'Attachment', 'LinkSDBook', 'Voucher', 'LinkBudgetPlan', 'ApproveDetail', 'UnitQuota', 'Print', 'Output'], false);
                // 未发送过指令可以收回，否则不可以收回
                if (paymentstatus == null || paymentstatus == undefined || paymentstatus == '') {
        ...
        this.props.button.setButtonDisabled(['Delete', 'Copy', 'Commit', 'Uncommit', 'Commission', 'CommissionCancel', 'Disabled', 'CancelInvalid', 'Attachment', 'LinkSDBook', 'Voucher', 'LinkBudgetPlan', 'ApproveDetail', 'UnitQuota', 'Print', 'Output'], true);
    } else {
        var tabKey = this.state.activeTab;
        if (tabKey == 'all') {
            this.props.button.setButtonDisabled(['Delete', 'Copy', 'Commit', 'Uncommit', 'Commission', 'CommissionCancel', 'Disabled', 'CancelInvalid', 'Attachment', 'LinkSDBook', 'Voucher', 'LinkBudgetPlan', 'ApproveDetail', 'UnitQuota', 'Print', 'Output'], false);
        } else if (tabKey == '-1') {
            this.props.button.setButtonDisabled(['Delete', 'Copy', 'Commit', 'Disabled', 'CancelInvalid', 'Attachment', 'LinkSDBook', 'Voucher', 'LinkBudgetPlan', 'ApproveDetail', 'UnitQuota', 'Print', 'Output'], false);
        } else if (tabKey == '2,3') {
            this.props.button.setButtonDisabled(['Delete', 'Copy', 'Uncommit', 'Disabled', 'CancelInvalid', 'Attachment', 'LinkSDBook', 'Voucher', 'LinkBudgetPlan', 'ApproveDetail', 'UnitQuota', 'Print', 'Output'], false);
        } else if (tabKey == '36180QADWT') {
            this.props.button.setButtonDisabled(['Delete', 'Copy', 'Uncommit', 'Commission', 'Disabled', 'CancelInvalid', 'Attachment', 'LinkSDBook', 'Voucher', 'LinkBudgetPlan', 'ApproveDetail', 'UnitQuota', 'Print', 'Output'], false);
        }
    }
}
