...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/pfbm/discountapplyinpool/ref21/index"] = factory(require("nc-lightapp-front"), require("react"));
	else
		root["fbm/pfbm/discountapplyinpool/ref21/index"] = factory(root["nc-lightapp-front"], root["React"]);
...
var _btn_Controller = __webpack_require__(309);

var _btn_Controller2 = _interopRequireDefault(_btn_Controller);

var _buttonClick = __webpack_require__(310);

var _buttonClick2 = _interopRequireDefault(_buttonClick);

var _search_btnClick = __webpack_require__(312);
...
var _btnClicks = __webpack_require__(218);
...
function clickSerachBtn(props, queryInfo) {
  ...
  (0, _ncLightappFront.ajax)({
    ...
    success: function success(res) {
      ...
      if (success) {
        if (data) {
          var multiLang = _this.props.MutiInit.getIntl("36200DA");
          if (data.grid) {
            /* 国际化处理： 查询成功!*/
            (0, _ncLightappFront.toast)({ color: 'success', content: multiLang && multiLang.get('36200DA-000017') });
            ...
            /* 国际化处理： 未查询出数据!*/
            (0, _ncLightappFront.toast)({ color: 'warning', content: multiLang && multiLang.get('36200DA-000018') });
...
var _referEvent = __webpack_require__(313);

var _referEvent2 = _interopRequireDefault(_referEvent);

var _search21_afterEvent = __webpack_require__(314);
...
var _init = __webpack_require__(315);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              createBillHeadInfo({
                title: this.props.MutiInit.getIntl("36200DA") && this.props.MutiInit.getIntl("36200DA").get("36200DA-000014") /* 国际化处理： 选择票据号码 */
        ...
        _react2.default.createElement(
          ...
          createTransferTable({
            ...
            transferBtnText: this.props.MutiInit.getIntl("36200DA") && this.props.MutiInit.getIntl("36200DA").get("36200DA-000013"), //转单按钮显示文字/* 国际化处理： 确认*/
...
var _refresh_BtnClick = __webpack_require__(311);
...
var _commonSearch_BtnClick = __webpack_require__(245);
...
var _initSingleTemplate = __webpack_require__(316);

var _initSingleTemplate2 = _interopRequireDefault(_initSingleTemplate);

var _initTemplate = __webpack_require__(317);
