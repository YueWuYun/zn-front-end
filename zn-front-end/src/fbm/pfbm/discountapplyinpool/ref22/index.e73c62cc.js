...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/pfbm/discountapplyinpool/ref22/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/pfbm/discountapplyinpool/ref22/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
//联查小应用编码
var link_app_code = exports.link_app_code = '36200DALINK';
//审批小应用编码
var approve_app_code = exports.approve_app_code = '36200DAAPPR';
//请求基础路径
var base_path = exports.base_path = '/nccloud/fbm/discountapplyinpool';
//按钮平铺显示数量
var button_limit = exports.button_limit = 3;
//打印输出编码
var nodekey = exports.nodekey = '36200DANCC';

var module_id = exports.module_id = '36200DA';
//单据类型
var billtype = exports.billtype = '36HL';
...
var LIST = exports.LIST = {
    ...
    disabled_btn: ['Delete', 'Copy', 'Commit', 'Uncommit', 'Attachment', 'Print', 'Output', 'ApproveDetail',, 'LinkSDBook', 'discountTransact'], //默认禁用按钮
...
var btns = exports.btns = {
    ...
    refreshBtn: 'Refresh'
    //缓存标示
};var DATA_SOURCE = exports.DATA_SOURCE = 'fbm.pfbm.discountapplyinpool.datasource';
...
var REF21_CONST = {
  ...
  formId: "36200DA_TL01_Table", //列表 查询结果区域编码
  tableId: "", //表体区域
  transPageId: "36200DA_TL01", //列表pagecode
  transCardId: "36200DA_TC01", //卡片pagecode
  searchId: "36200DA_TL01_query", //查询区域编码
  destPageUrl: "/ref22",
  serachUrl: "/nccloud/fbm/discountapplyinpool/transquery.do",
...
var _initTemplate = __webpack_require__(319);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(320);

var _initTemplate4 = _interopRequireDefault(_initTemplate3);

var _initTemplate5 = __webpack_require__(321);

var _initTemplate6 = _interopRequireDefault(_initTemplate5);

var _buttonVisible = __webpack_require__(220);

var _afterEvent = __webpack_require__(322);

var _beforeEvent = __webpack_require__(323);
...
function buttonVisible(props) {
    ...
    var editBtn = ['Save', 'SaveCommit', 'Cancel', 'CancelTransfer']; //编辑态显示按钮
    var allBtns = [].concat(_toConsumableArray(buttons), editBtn, unionBtn, ['Add', 'Copy', 'Edit', 'Delete', 'Uncommit', 'Commit', 'discountTransact']);
    ...
    var receiptflag = this.props.form.getFormItemsValue(this.formId, 'receiptflag').value;
    // 先设为false
    ...
    if (!status) {
        ...
        if (!id) {
            ...
            if (vbillstatus == '-1') {
                ...
                props.button.setMainButton(_constant.btns.commitBtn, true);
                ...
                if (!receiptflag) {
                    showBtn.push(_constant.btns.uncommitBtn);
                    showBtn.push(_constant.btns.discountTransact);
                    showBtn.push(_constant.btns.linkApproveBtn);
                }
...
var _const = __webpack_require__(196);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_BaseCard2.default, _extends({
                constant: {
                    ...
                    baseinfo: _constant.CARD.baseinfo,
                    ...
                    billInfo: _constant.CARD.form_tbillinfo,
                    modulecode: "3618",
                    // 转单
                ...
                , formParams: {
                    expandArr: [_constant.CARD.form_id, _constant.CARD.form_billinfo]
                } //表头form参数
	...
	meta[this.formId].items.map(function (item) {
		...
		if (item.attrcode == 'pk_register') {
			...
			return item.queryCondition = function () {
				...
				var pk_billtypecode = _this2.props.form.getFormItemsValue(_this2.formId, 'pk_billtypecode');
				var opbilltype = _this2.props.form.getFormItemsValue(_this2.formId, 'opbilltype');
				var pk_register = _this2.props.form.getFormItemsValue(_this2.formId, 'pk_register');
				return {
		...
		// 贴现银行账户
				...
				return item.queryCondition = function () {
					var pk_org = _this2.props.form.getFormItemsValue(_this2.formId, 'pk_org');
					var pk_currtype = _this2.props.form.getFormItemsValue(_this2.formId, 'pk_curr');
					var pk_discount_bank = _this2.props.form.getFormItemsValue(_this2.formId, 'pk_discount_bank');
...
function afterEvent(props, moduleId, key, value, oldValue) {
	...
	if (key === 'pk_org') {
		...
		if (!oldValue.value) {
			...
			var lang = this.props.MutiInit.getIntl(this.moduleId);
			(0, _ncLightappFront.promptBox)({
				color: "warning",
				title: lang && lang.get('36200DA-000000'), /* 国际化处理： 确认*/
				content: lang && lang.get('36200DA-000001'), /* 国际化处理： 切换组织将会清空您录入的信息，请确认?*/
				beSureBtnClick: function beSureBtnClick() {
	...
	// 贴现银行
		...
		// 重算金额，币种及精度处理
		else if (key === 'applydate' || key === 'discountdelaydaynum' || key === 'ratedaynum' || key === 'discountyrate' || key === 'discountcharge' || key === 'buyerinterest' || key === 'olcrate' || key === 'discountinterest' || key === 'glcrate' || key === 'gllcrate') {
				//
				if (value.value !== oldValue.value) {
					_index.cardEvent.getAfterEventData.call(this, eventData).then(function (res) {
						setAfterEditFormValue.call(_this, props, res);
...
function beforeEvent(props, moduleId, key, value, data) {
	var currType = ['olcrate', 'glcrate', 'gllcrate', 'discountinterest', 'onlinebankflag'];
	if (currType.includes(key)) {
		var pk_org = props.form.getFormItemsValue(this.formId, 'pk_org'); //财务组织
		var pk_currtype = props.form.getFormItemsValue(this.formId, 'pk_curr'); //源币
		//主键，判断是否是新增还是修改
		var pk_discount = props.form.getFormItemsValue(this.formId, this.primaryId).value;
		var status = props.getUrlParam('status') === 'add' ? false : true;
		if (!pk_discount && status) {
			// 新增，能进来的即可修改
			return true;
		}
