...
class List extends Component {
    ...
    myRenderCompleteEvent = function() {
        ...
        let moneystart = muti && muti.get("36200DA-000011") /* 国际化处理： 票据金额由*/;
        let moneyend  = muti && muti.get("36200DA-000012") /* 国际化处理： 票据金额至*/;
        this.props.search.setTemlateByField(this.searchId,
            'money','defaultPlaceholder',{start: moneystart,end: moneyend})
        let discountmoneystart = muti && muti.get("36200DA-000015") /* 国际化处理： 贴现余额由*/;
        let discountmoneyend = muti && muti.get("36200DA-000016") /* 国际化处理： 贴现余额至*/;
        this.props.search.setTemlateByField(this.searchId,
            ...
            items: [
                {
                    key: "-1",
                    name: "tab01",
                    title: multiLang && multiLang.get("36200DA-000006")
                } /* 国际化处理： 待提交*/,
                {
                    key: "2,3",
                    name: "tab02",
                    title: multiLang && multiLang.get("36200DA-000007")
                } /* 国际化处理： 审批中*/,
                {
                    key: "all",
                    title: multiLang && multiLang.get("36200DA-000009")
                } /* 国际化处理： 全部*/
            ],
