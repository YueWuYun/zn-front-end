...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/pfbm/discountapplyinpool/list/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/pfbm/discountapplyinpool/list/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
var _initTemplate = __webpack_require__(305);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _events = __webpack_require__(174);

var _searchBtnClick = __webpack_require__(306);

var _searchBtnClick2 = _interopRequireDefault(_searchBtnClick);

var _buttonDisable = __webpack_require__(307);
...
var List = function (_Component) {
    ...
    function List(props) {
        ...
        _this.myRenderCompleteEvent = function () {
            ...
            // let money = muti && muti.get("36200DA-000010") /* 国际化处理： 票据金额*/;
            var moneystart = muti && muti.get("36200DA-000011") /* 国际化处理： 票据金额由*/;
            var moneyend = muti && muti.get("36200DA-000012") /* 国际化处理： 票据金额至*/;
            this.props.search.setTemlateByField(this.searchId, 'money', 'defaultPlaceholder', { start: moneystart, end: moneyend });
            var discountmoneystart = muti && muti.get("36200DA-000015") /* 国际化处理： 贴现余额由*/;
            var discountmoneyend = muti && muti.get("36200DA-000016") /* 国际化处理： 贴现余额至*/;
            this.props.search.setTemlateByField(this.searchId, 'discountmoney', 'defaultPlaceholder', { start: discountmoneystart, end: discountmoneyend });
        ...
        value: function render() {
            ...
            var tabs = {
                ...
                items: [{
                    key: "-1",
                    name: "tab01",
                    title: multiLang && multiLang.get("36200DA-000006") /* 国际化处理： 待提交*/
                }, {
                    key: "2,3",
                    name: "tab02",
                    title: multiLang && multiLang.get("36200DA-000007") /* 国际化处理： 审批中*/
                }, {
                    key: "all",
                    title: multiLang && multiLang.get("36200DA-000009") /* 国际化处理： 全部*/
                }],
...
exports.default = function (props) {
	...
	var scene = this.props.getUrlParam("scene"); // 凭证,报表联查
	var pk_ntbparadimvo = this.props.getUrlParam("pk_ntbparadimvo"); //预算反联查
	...
	props.createUIDom({
		...
		if (data) {
			if (data.button) {
				...
				props.button.setButtons(button);
				var multiLang = _this.props.MutiInit.getIntl(_this.moduleId); //this.moduleId multiLang.get('36200DA-000004')
				var lang = multiLang && multiLang.get('36200DA-000004');
...
function modifierMeta(props, meta) {
	...
	meta[this.tableId].items.push({
		itemtype: 'customer',
		attrcode: 'opr',
		label: multiLang && multiLang.get('36200DA-000005'), /* 国际化处理： 操作*/
		width: 200,
		fixed: 'right',
		className: "table-opr",
		visible: true,
		render: function render(text, record, index) {
			...
			var receiptflag = record.receiptflag.value; // true or false
			var buttonAry = [];
			if (!vbillstatus) {
				vbillstatus == -1;
			}
...
function buttonDisable() {
    ...
    if (selectDatas.length == 1) {
        ...
        // 回单 票据池中心票据贴现生成审批通过的贴现申请回单
        var receiptflag = item.data.values.receiptflag.value;
        // 0=审批未通过，1=审批通过，2=审批进行中，3=提交，-1=自由，
        if (vbillstatus == -1) {
            disBtn.push(_constant.btns.uncommitBtn);
            disBtn.push(_constant.btns.discountTransact);
