...
import {
    API_URL, billtype, CARD, DATA_SOURCE, disableReason,
    DISABLE_BTN_PARAM, fullAggClassName, LIST,
    modelname, module_id, nodekey, searchCache,tableName
} from "../cons/constant";
...
class List extends Component {
    ...
    myRenderCompleteEvent = function () {
        ...
        let money = muti && muti.get("36200ET-000010") /* 国际化处理： 票据金额*/;
        let moneystart = muti && muti.get("36200ET-000011") /* 国际化处理： 票据金额由*/;
        let moneyend = muti && muti.get("36200ET-000012") /* 国际化处理： 票据金额至*/;
            ...
            items: [
                {
                    key: "-1",
                    name: "tab01",
                    title: multiLang && multiLang.get("36200ET-000006")
                } /* 国际化处理： 待提交*/,
                {
                    key: "2,3",
                    name: "tab02",
                    title: multiLang && multiLang.get("36200ET-000007")
                } /* 国际化处理： 审批中*/,
                {
                    key: "10",
                    name: "tab03",
                    title: multiLang && multiLang.get("36200ET-000008")
                } /* 国际化处理： 指令处理中*/,
                {
                    key: "all",
                    title: multiLang && multiLang.get("36200ET-000009")
                } /* 国际化处理： 全部*/
            ],
