...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/pfbm/endoreinpool/list/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/pfbm/endoreinpool/list/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
exports.buttonDisable = exports.getListData = exports.selectedEvent = exports.pageInfoClick = exports.bodyBtnOperation = exports.buttonClick = exports.initTemplate = exports.searchBtnClick = exports.bodyButtonClick = undefined;

var _initTemplate = __webpack_require__(357);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _events = __webpack_require__(174);

var _searchBtnClick = __webpack_require__(358);

var _searchBtnClick2 = _interopRequireDefault(_searchBtnClick);

var _buttonDisable = __webpack_require__(359);
    ...
    function List(props) {
        ...
        _this.tabChangeServal = function (status, callback) {
            ...
            this.setState({
                ...
                var searchdata = _this2.props.search.getQueryInfo(_this2.searchId);
                var searchCache = getDefData(_this2.searchCache.key, _this2.searchCache.dataSource);
                if (searchCache && searchdata) {
                    // 去查询
                    _events.searchBtnClick.call(_this2, _this2.props, searchdata.querycondition);
                }
                _this2.props.table.selectAllRows(_this2.tableId, false);
                _events.buttonDisable.call(_this2);
            });
        };
        ...
        _this.myRenderCompleteEvent = function () {
            ...
            var money = muti && muti.get("36200ET-000010") /* 国际化处理： 票据金额*/;
            var moneystart = muti && muti.get("36200ET-000011") /* 国际化处理： 票据金额由*/;
            var moneyend = muti && muti.get("36200ET-000012") /* 国际化处理： 票据金额至*/;
            this.props.search.setTemlateByField(this.searchId, 'money', 'defaultPlaceholder', { start: moneystart, end: moneyend });
        ...
        value: function render() {
            ...
            var tabs = {
                ...
                items: [{
                    key: "-1",
                    name: "tab01",
                    title: multiLang && multiLang.get("36200ET-000006") /* 国际化处理： 待提交*/
                }, {
                    key: "2,3",
                    name: "tab02",
                    title: multiLang && multiLang.get("36200ET-000007") /* 国际化处理： 审批中*/
                }, {
                    key: "10",
                    name: "tab03",
                    title: multiLang && multiLang.get("36200ET-000008") /* 国际化处理： 指令处理中*/
                }, {
                    key: "all",
                    title: multiLang && multiLang.get("36200ET-000009") /* 国际化处理： 全部*/
                }],
            ...
            return _react2.default.createElement(_BaseList2.default, _extends({
                constant: {
                    ...
                    tabStatus: _constant.LIST.tabStatus, //列表特殊页签规则
                    paymentstatus: _constant.LIST.paymentstatus, // 特殊页签对应的条件
                    showIndex: true,
                    fullAggClassName: _constant.fullAggClassName, // aggvo全路径名
                    disableReason: _constant.disableReason,
                    modulecode: "3620",
                    disableflag: _constant.LIST.disableflag,
                    tableName: _constant.tableName
                },
                _initTemplate: _events.initTemplate,
                ...
                , initImport: true // 是否初始化导入组件，true:是；不写或false:否;
            }, this.props));
        }
    }]);
...
exports.default = function (props) {
	...
	var app_code = props.getSearchParam('c');
	var excelimportconfig = (0, _ncLightappFront.excelImportconfig)(props, "fbm", '36HT', true, "", { "appcode": app_code, "pagecode": _constant.CARD.page_id });
	...
	props.createUIDom({
		...
		if (data) {
			if (data.button) {
				...
				props.button.setButtons(button);
				var multiLang = _this.props.MutiInit.getIntl(_this.moduleId); //this.moduleId
	...
	meta[this.tableId].items = meta[this.tableId].items.map(function (item, key) {
		...
		if (item.attrcode == _this2.billNo) {
			item.render = function (text, record, index) {
				...
				var pk_ntbparadimvo = _this2.props.getUrlParam("pk_ntbparadimvo"); //预算反联查
		...
		render: function render(text, record, index) {
			return props.button.createErrorButton({
				...
				sucessCallBack: function sucessCallBack() {
					var vbillstatus = record.vbillstatus.value;
					var paymentstatus = record.paymentstatus.value;
					var onlinebankflag = record.onlinebankflag.value; // true or false
					var disableflag = record.disableflag.value; // true or false
					var voucher = record.voucher.value; // true or false
					//  syscode 来源系统  INPUT=手工录入，CMP=现金管理，FTS=资金结算，ARAP=应收应付，
					var syscode = record.syscode.value;
					var ecdswithdrawstatus = record.ecdswithdrawstatus.value;
...
exports.default = clickSearchBtn;
...
var table_id = _constant.LIST.table_id;
var page_code = _constant.LIST.page_id;
var search_id = _constant.LIST.search_id;
var setDefData = _ncLightappFront.cardCache.setDefData,
    getDefData = _ncLightappFront.cardCache.getDefData;
//点击查询，获取查询区数据

function clickSearchBtn(props, searchVal) {
    var _this2 = this;
    ...
    var pageInfo = props.table.getTablePageInfo(table_id);
    pageInfo.pageIndex = 0;
    searchdata['custcondition'] = {
        logic: 'and', //逻辑操作符，and、or
        conditions: conditions
    ...
    (0, _ncLightappFront.ajax)({
        url: _constant.API_URL['queryList'],
        data: searchdata,
        success: function success(res) {
            var success = res.success,
                data = res.data;
            ...
            if (success) {
                var selectedData = props.table.getCheckedRows(_this2.tableId);
...
function filterSearchValue(searchVal) {
    ...
    var conditions = [];
    var orgcondition = searchVal.conditions.find(function (e) {
        return e.field === 'pk_org';
    });
    var condition = (0, _ncLightappFront.deepClone)(orgcondition);
    ...
    if (tabKey == '10') {
        ...
        condition.value.firstvalue = '2,3';
        condition.oprtype = 'in';
        var disablecondition = (0, _ncLightappFront.deepClone)(orgcondition);
...
function buttonDisable() {
    _index.selectedEvent.call(this);
    var tabKey = this.state.activeTab;
    var disBtn = [_constant.btns.editBtn, _constant.btns.deleteBtn, _constant.btns.commitBtn, _constant.btns.uncommitBtn, _constant.btns.sendCommandBtn, _constant.btns.takeCommandBtn, _constant.btns.disabledBtn, _constant.btns.unDisabledBtn, _constant.btns.voucherBtn, _constant.btns.cancelVoucherBtn, _constant.btns.linkApproveBtn, _constant.btns.linkVoucherBtn, _constant.btns.LinkReceAndPaybillBtn];
    // 先禁用所有需要判断的按钮
    ...
    if (selectDatas.length == 1) {
        // 进行遍历一下
        var itemValues = selectDatas[0].data.values;
        //  syscode 来源系统  INPUT=手工录入，CMP=现金管理，FTS=资金结算，ARAP=应收应付， 
        var syscode = itemValues.syscode && itemValues.syscode.value;
        // 0=审批未通过，1=审批通过，2=审批进行中，3=提交，-1=自由，
        var vbillstatus = itemValues.vbillstatus && itemValues.vbillstatus.value;
        // 交易成功 1; 交易失败 2; 交易不明 3.
        var paymentstatus = itemValues.paymentstatus && itemValues.paymentstatus.value;
        var onlinebankflag = itemValues.onlinebankflag && itemValues.onlinebankflag.value;
        var disableflag = itemValues.disableflag && itemValues.disableflag.value;
        var voucher = itemValues.voucher && itemValues.voucher.value;
        var ecdswithdrawstatus = itemValues.ecdswithdrawstatus && itemValues.ecdswithdrawstatus.value;
        if (syscode == 'INPUT') {
            // 自由
            if (vbillstatus == -1) {
    ...
    if (tabKey == '-1') {
        ...
        // 全部
        if (selectDatas.length > 1) {
            disBtn.push(_constant.btns.LinkSDBookBtn);
            disBtn.push(_constant.btns.linkBudgetPlanBtn);
