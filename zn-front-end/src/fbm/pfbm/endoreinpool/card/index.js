...
import {
    API_URL, billtype, CARD, LIST, DATA_SOURCE, disableReason,
    DISABLE_BTN_PARAM, fullAggClassName, module_id, nodekey,tableName
        ...
        return (
            <BaseCard
                constant={{
                    ...
                    cafalg: "true",
                    encryptVOClassName:
                        "nccloud.itf.pfbm.endoreinpool.vo.EndoreInPoolEncryptVO4NCC",
