...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/pfbm/endoreinpool/card/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/pfbm/endoreinpool/card/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
//联查小应用编码
var link_app_code = exports.link_app_code = '36200ET';
//审批小应用编码
var approve_app_code = exports.approve_app_code = '36200ETAPPR';
//请求基础路径
var base_path = exports.base_path = '/nccloud/fbm/endoreinpool';
//按钮平铺显示数量
var button_limit = exports.button_limit = 3;
//打印输出编码,对应轻量端应用默认输出模板设置的应用标识
var nodekey = exports.nodekey = '36200ETNCC';

var module_id = exports.module_id = '36200ET';
//单据类型
var billtype = exports.billtype = '36HT';
// 全路径名
var fullAggClassName = exports.fullAggClassName = 'nc.vo.fbm.endore.AggEndoreVO';
// 作废原因区域
var disableReason = exports.disableReason = 'disablenote';
// 业务对应表名，修改按钮点击时用来saga校验
var tableName = exports.tableName = 'fbm_endore';
/**
 * 列表
 */
var LIST = exports.LIST = {
    // 默认禁用按钮
    disabled_btn: ['Delete', 'Copy', 'Commit', 'Uncommit', 'Attachment', 'Print', 'Output', 'SendInstruction', 'CancelInstruction', 'Disabled', 'CancelDisabled', 'Voucher', 'ApproveDetail', 'LinkBudgetPlan', 'LinkSDBook', 'LinkReceAndPaybill'],
...
var btns = exports.btns = {
    ...
    refreshBtn: 'Refresh'
    //缓存标示
};var DATA_SOURCE = exports.DATA_SOURCE = 'tm.pfbm.endoreinpool.datasource';
...
var _initTemplate = __webpack_require__(351);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(352);

var _initTemplate4 = _interopRequireDefault(_initTemplate3);

var _initTemplate5 = __webpack_require__(353);

var _initTemplate6 = _interopRequireDefault(_initTemplate5);

var _buttonVisible = __webpack_require__(228);

var _afterEvent = __webpack_require__(354);

var _beforeEvent = __webpack_require__(355);
...
function buttonVisible(props) {
    ...
    var pk_endore = this.props.form.getFormItemsValue(this.formId, 'pk_endore').value;
    //  syscode 来源系统  INPUT=手工录入，CMP=现金管理，FTS=资金结算，ARAP=应收应付，
    var syscode = this.props.form.getFormItemsValue(this.formId, 'syscode').value;
    ...
    if (!status) {
        ...
        if (!id) {
            ...
            if (pk_endore) {
                ...
                showBtn.push(_constant.btns.LinkReceAndPaybillBtn);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_BaseCard2.default, _extends({
                constant: {
                    ...
                    cafalg: "true",
                    encryptVOClassName: "nccloud.itf.pfbm.endoreinpool.vo.EndoreInPoolEncryptVO4NCC",
                ...
                pageTitle: multiLang && multiLang.get("36200ET-000003") //节点标题
                , headBtnArea: _constant.CARD.head_btn_code //表头按钮区域
                , formParams: {
                    expandArr: [_constant.CARD.form_id, _constant.CARD.form_ebankinfo]
                } //表头form参数
...
function modifierMeta(meta) {
	...
	meta[this.formId].items.map(function (item) {
		...
		// 被背书单位
			...
			//参照过滤-票据编号
					...
					item.queryCondition = function () {
						var pk_org = _this2.props.form.getFormItemsValue(_this2.formId, 'pk_org');
						var busdate = _this2.props.form.getFormItemsValue(_this2.formId, 'busdate');
	...
	// 网银信息页签
	meta[_constant.CARD.form_ebankinfo].items.map(function (item) {
		// 背书单位账户
		...
		// 被背书单位账户
				...
				return item.queryCondition = function () {
					var endorsee = _this2.props.form.getFormItemsValue(_this2.formId, 'endorsee');
					var pk_curr = _this2.props.form.getFormItemsValue(_this2.formId, 'pk_curr');
					var busdate = _this2.props.form.getFormItemsValue(_this2.formId, 'busdate');
					return {
...
function beforeEvent(props, moduleId, key, value, data) {
	var rateFileds = ['olcrate', 'glcrate', 'gllcrate'];
	if (rateFileds.includes(key)) {
		...
		//主键，判断是否是新增还是修改
		var pk_endore = props.form.getFormItemsValue(this.formId, this.primaryId);
