...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/cfbm/signback/card/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/cfbm/signback/card/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
 ...
 */
//模块名称
var modelname = exports.modelname = 'cfbm';
//小应用编码
var app_code = exports.app_code = '36370BSR';
//联查小应用编码
var link_app_code = exports.link_app_code = '36370BSR';
//审批小应用编码
var approve_app_code = exports.approve_app_code = '36370BSRA';
//请求基础路径
var base_path = exports.base_path = '/nccloud/cfbm/signback';
//按钮平铺显示数量
var button_limit = exports.button_limit = 3;
//打印输出编码
var nodekey = exports.nodekey = '36370BSRP_01';
//联查预算aggVO
var fullAggClassName = exports.fullAggClassName = 'nc.vo.cfbm.signback.AggSignBackVO';
var module_id = exports.module_id = '36370BSR';
//单据类型
var billtype = exports.billtype = '36ND';
// 业务对应表名，修改按钮点击时用来saga校验
var tableName = exports.tableName = 'fbm_register';
//记账区域
var tallyPlan = exports.tallyPlan = 'tallyplan';
...
var LIST = exports.LIST = {
    ...
    //缓存标示
};var DATA_SOURCE = exports.DATA_SOURCE = 'tm.cfbm.signback.datasource';
...
exports.bodySelectedAllEvent = exports.bodySelectedEvent = exports.afterEvent = exports.buttonVisible = exports.initTemplate1 = exports.initTemplate = exports.buttonClick = exports.bodyButtonClick = undefined;

var _buttonClick = __webpack_require__(172);

var _buttonClick2 = _interopRequireDefault(_buttonClick);

var _initTemplate = __webpack_require__(244);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(245);

var _initTemplate4 = _interopRequireDefault(_initTemplate3);

var _bodyButtonClick = __webpack_require__(209);

var _buttonVisible = __webpack_require__(208);

var _afterEvent = __webpack_require__(246);

var _bodySelectedEvent = __webpack_require__(247);
...
function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } } //卡片按钮显隐性控制
...
function buttonVisible(props) {
    ...
    var btnObj = {};
    var showBtn = [];
    var unionBtn = ['RegisterBillLink', 'Voucher', 'LinkBudgetPlan', 'LinkInnerAccount', 'LQueryInSecurityAcc']; //联查按钮
    var allBtns = [].concat(_toConsumableArray(buttons), unionBtn);
    // 是否制证
    var voucher = props.form.getFormItemsValue(this.formId, 'voucher') && props.form.getFormItemsValue(this.formId, 'voucher').value;
    //是否记账
    var tallyflag = props.form.getFormItemsValue(this.formId, 'tallyflag') && props.form.getFormItemsValue(this.formId, 'tallyflag').value;
    //内部结算账户
    var LinkInnerAccount = props.form.getFormItemsValue(this.formId, 'pk_inbalaacc') && props.form.getFormItemsValue(this.formId, 'pk_inbalaacc').value;
    //内部保证金账户
    var LQueryInSecurityAcc = props.form.getFormItemsValue(this.formId, 'pk_insecurityacc') && props.form.getFormItemsValue(this.formId, 'pk_insecurityacc').value;

    if (isBrowse) {
        //编辑态
        var commonBtn = [].concat(unionBtn, ['Union', 'Print', 'Output', 'Refresh', 'Attachment', 'OffiPrint', 'InOffiPrint']);
        if (voucher) {
            showBtn = ['CancelVoucher'].concat(_toConsumableArray(commonBtn));
        } else {
            showBtn = ['MakeVoucher'].concat(_toConsumableArray(commonBtn));
        }
        //根据记账与否显示按钮
        if (tallyflag) {
            //记账为红色
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_BaseCard2.default, _extends({
                ...
                constant: {
                    ...
                    tallyPlan: _constant.LIST.tallyPlan,
                    pk_inbalaacc: _constant.CARD.pk_inbalaacc, //内部结算账户
                ...
                pageTitle: this.props.MutiInit.getIntl("36370BSR") && this.props.MutiInit.getIntl("36370BSR").get("36370BSR-000003") //页面标题/* 国际化处理*/
...
exports.default = function (props, templateCallback) {
	...
	props.createUIDom({
		...
		if (data) {
			...
			(0, _index2.orgVersionView)(props, _this.formId, "pk_signorg", "pk_signorg_v");
