...
import { CARD } from "../../signback/cons/constant";
import {
    API_URL,
    app_code,
    billtype,
...
class List extends Component {
    ...
    myRenderCompleteEvent = function () {
        ...
        let money = muti && muti.get("36370BSR-000008") /* 国际化处理： 退票金额*/;
        let start = muti && muti.get("36370BSR-000009") /* 国际化处理： 开始*/;
        let end = muti && muti.get("36370BSR-000010") /* 国际化处理： 结束*/;
