...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/cfbm/acceptback/card/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/cfbm/acceptback/card/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
//小应用编码
var app_code = exports.app_code = '36370BPR';
//联查小应用编码
var link_app_code = exports.link_app_code = '36370BPR';
//审批小应用编码
var approve_app_code = exports.approve_app_code = '36370BPRA';
//请求基础路径
var base_path = exports.base_path = '/nccloud/cfbm/acceptback';
//按钮平铺显示数量
var button_limit = exports.button_limit = 3;
//打印输出编码
var nodekey = exports.nodekey = '36370BPRP_01';
//联查预算aggVO
var fullAggClassName = exports.fullAggClassName = 'nc.vo.cfbm.acceptback.AggAcceptBackVO';
var module_id = exports.module_id = '36370BPR';
//单据类型
var billtype = exports.billtype = '36NF';
// 业务对应表名，修改按钮点击时用来saga校验
var tableName = exports.tableName = 'fbm_accept';
//记账区域
...
var LIST = exports.LIST = {
    ...
    //缓存标示
};var DATA_SOURCE = exports.DATA_SOURCE = 'tm.cfbm.acceptback.datasource';
...
var _initTemplate = __webpack_require__(212);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(213);

var _initTemplate4 = _interopRequireDefault(_initTemplate3);

var _bodyButtonClick = __webpack_require__(197);

var _buttonVisible = __webpack_require__(196);

var _afterEvent = __webpack_require__(214);

var _bodySelectedEvent = __webpack_require__(215);
...
var _constant = __webpack_require__(189);
...
function buttonVisible(props) {
    ...
    var btnObj = {};
    var showBtn = [];
    var unionBtn = ['SignBillLink', 'Voucher', 'LinkBudgetPlan', 'LinkInnerAccount', 'LQueryInSecurityAcc']; //联查按钮
 ...
 * 电子签章打印
 */
var elecSignPrint = function elecSignPrint(props, offical) {
    (0, _util.elecSignCardPrint)(props, {
        ...
        getOrgFunc: function getOrgFunc() {
            var pk_delgoorg = props.form.getFormItemsValue(card_from_id, 'pk_delgoorg') && props.form.getFormItemsValue(card_from_id, 'pk_delgoorg').value;
            if (pk_delgoorg) {
                return pk_delgoorg;
            } else {
        ...
        validateFunc: function validateFunc() {
            var busistatus = props.form.getFormItemsValue(card_from_id, 'billstatus').value;
    ...
    _createClass(Card, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_BaseCard2.default, _extends({
                ...
                pageTitle: this.props.MutiInit.getIntl("36370BPR") && this.props.MutiInit.getIntl("36370BPR").get("36370BPR-000003") //页面标题/* 国际化处理*/
...
function afterEvent(props, moduleId, key, value, oldValue) {} //票据付款回单——表头编辑后事件
