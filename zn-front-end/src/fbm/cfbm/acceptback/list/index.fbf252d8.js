...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/cfbm/acceptback/list/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/cfbm/acceptback/list/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
var _initTemplate = __webpack_require__(217);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(218);
...
var _constant2 = __webpack_require__(189);
...
var List = function (_Component) {
    ...
    function List(props) {
        ...
        _this.myRenderCompleteEvent = function () {
            ...
            var money = muti && muti.get("36370BPR-000008") /* 国际化处理： 退票金额*/;
            var start = muti && muti.get("36370BPR-000009") /* 国际化处理： 开始*/;
            var end = muti && muti.get("36370BPR-000010") /* 国际化处理： 结束*/;
...
function modifierMeta(props, meta) {
	...
	meta[this.searchId].items.map(function (item) {
		...
		if (item.attrcode === 'pk_notetype') {
			item.queryCondition = function () {
				var orgpk = props.form.getFormItemsValue(CARD_FORMCODE, PK_ORG).value;
				var currency = props.form.getFormItemsValue(CARD_FORMCODE, 'gz_bz').value;
				return {
					pk_org: orgpk, pk_currtype: currency,
					test: 'test',
	...
	meta[this.tableId].items.push({
		itemtype: 'customer',
		attrcode: 'opr',
		label: this.props.MutiInit.getIntl("36370BPR") && this.props.MutiInit.getIntl("36370BPR").get('36370BPR-000002'), /* 国际化处理： 操作*/ /* 国际化处理： 操作*/
		width: 200,
		fixed: 'right',
		className: "table-opr",
		visible: true,
