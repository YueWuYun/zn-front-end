/*M5psfT1sstzfITsa7W0792mkcDhS4u8b2jDTUcOzxFaxYYDoRbSAgAinjISvEemE*/
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/cfbm/signapply/card/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/cfbm/signapply/card/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
})(window, function(__WEBPACK_EXTERNAL_MODULE__1__, __WEBPACK_EXTERNAL_MODULE__2__, __WEBPACK_EXTERNAL_MODULE__6__, __WEBPACK_EXTERNAL_MODULE__10__) {
...
var _cardEvent = __webpack_require__(164);
...
var _constant = __webpack_require__(161);
...
var _initTemplate = __webpack_require__(153);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _balance = __webpack_require__(11);
...
var _initTemplate = __webpack_require__(155);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _restmoney = __webpack_require__(12);
...
var _ca = __webpack_require__(13);
...
var _EmptyAreaValueUtil = __webpack_require__(176);
...
var _AcceptModal = __webpack_require__(151);
...
//小应用编码
var app_code = exports.app_code = '36370IFBA';
//联查小应用编码
var link_app_code = exports.link_app_code = '36370IFBA';
//审批小应用编码
var approve_app_code = exports.approve_app_code = '36370IFBAA';
//请求基础路径
var base_path = exports.base_path = '/nccloud/fbm/signapply';
//按钮平铺显示数量
var button_limit = exports.button_limit = 3;
//打印输出编码
var nodekey = exports.nodekey = '36370IFBA';

var module_id = exports.module_id = '36370IFBA';
//单据类型
var billtype = exports.billtype = '36NA';
/**
 * 列表
 */
var LIST = exports.LIST = {
    page_title: '开票申请', //页面标题
    disabled_btn: ['Delete', 'Commit', 'Uncommit', 'Print', 'Output', 'Attachment', 'ApproveDetail', 'Commission', 'CommissionCancel', 'Copy', 'LinkInnerAccount', 'LQueryInSecurityAcc'], //默认禁用按钮
    ...
    //缓存标示
};var DATA_SOURCE = exports.DATA_SOURCE = 'tm.fbm.signapply.datasource';
...
var _initTemplate = __webpack_require__(235);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(236);

var _initTemplate4 = _interopRequireDefault(_initTemplate3);

var _initTemplate5 = __webpack_require__(237);

var _initTemplate6 = _interopRequireDefault(_initTemplate5);

var _buttonVisible = __webpack_require__(206);

var _afterEvent = __webpack_require__(238);
...
function buttonVisible(props) {
    ...
    // 指令类型 ： 交易成功 = 1
    var pk_acceptorg = props.form.getFormItemsValue(this.formId, 'pk_acceptorg') && props.form.getFormItemsValue(this.formId, 'pk_acceptorg').value;
    var btnObj = {};
    var showBtn = [];
    var disabledBtn = ['deleteRow'];
    var unionBtn = ['LinkSDBook', 'Voucher', 'LinkBudgetPlan', 'ApproveDetail', 'UnitQuota', 'LinkInnerAccount', 'LQueryInSecurityAcc']; //联查按钮
...
var _BaseCard = __webpack_require__(174);
        ...
        value: function render() {
            ...
            var headDisabledItems = [{
                ...
                rules: function rules() {
                    var pk_acceptorg = _this2.props.form.getFormItemsValue(_constant.CARD.form_id, 'pk_acceptorg');
                    return pk_acceptorg && !pk_acceptorg.value;
                }
            }, {
                //币种为人民币时禁用组织本币汇率
                key: 'pk_applybank',
            ...
            return _react2.default.createElement(_BaseCard2.default, _extends({
                constant: {
                    ...
                    pk_insecurityacc: _constant.CARD.pk_insecurityacc, //内部保证金账户ID
                    pk_inbalaacc: _constant.CARD.pk_inbalaacc,
                    ...
                    // encryptVOClassName:
                    //     "nccloud.itf.fbm.quotaapply.vo.QuotaapplyEncryptVO4NCC", //ca
                    // cafalg: "true", //ca
                ...
                pageTitle: this.props.MutiInit.getIntl("36370IFBA") && this.props.MutiInit.getIntl("36370IFBA").get("36370IFBA-000002") //页面标题/* 国际化处理： 额度申请*/
...
exports.default = function (props, templateCallback) {
	...
	props.createUIDom({
		...
		if (data) {
			...
			(0, _index2.orgVersionView)(props, _this.formId, "pk_acceptorg", "pk_acceptorg_v");
			(0, _index2.orgVersionView)(props, _this.formId, "pk_applyorg", "pk_applyorg_v");
...
var _index2 = __webpack_require__(142);
...
function modifierMeta(meta) {
	...
	meta[this.formId].items.map(function (item) {
		...
		if (item.attrcode.indexOf("def") > -1) {
			...
			item.queryCondition = function (p) {
				...
				var pk_group = _this2.props.form.getFormItemsValue(_this2.formId, 'pk_group') && _this2.props.form.getFormItemsValue(_this2.formId, 'pk_group').value;
				return {
					pk_org: pk_org,
					pk_group: pk_group
				};
	...
	meta['issecurity'].items.map(function (item) {
		...
		if (item.attrcode === 'pk_banksecurityacc') {
			//保证金账户
			item.queryCondition = function () {
				var pk_org = _this2.props.form.getFormItemsValue(_this2.formId, 'pk_acceptorg') && _this2.props.form.getFormItemsValue(_this2.formId, 'pk_acceptorg').value;
				var pk_currtype = _this2.props.form.getFormItemsValue(_this2.formId, 'pk_currtype') && _this2.props.form.getFormItemsValue(_this2.formId, 'pk_currtype').value;
		...
		if (item.attrcode === 'pk_applybankacc') {
			item.queryCondition = function () {
				var pk_acceptorg = _this2.props.form.getFormItemsValue(_this2.formId, 'pk_acceptorg') && _this2.props.form.getFormItemsValue(_this2.formId, 'pk_acceptorg').value;
				var pk_currtype = _this2.props.form.getFormItemsValue(_this2.formId, 'pk_currtype') && _this2.props.form.getFormItemsValue(_this2.formId, 'pk_currtype').value;
				var pk_bankdoc = _this2.props.form.getFormItemsValue(_this2.formId, 'pk_applybank') && _this2.props.form.getFormItemsValue(_this2.formId, 'pk_applybank').value;
				return {
	...
	//申请财务组织信息
	meta['acceptor'].items.map(function (item) {
		//内部保证金账户
	...
	//票据基本信息
	meta['register'].items.map(function (item) {
		//票据类型
		...
		if (item.attrcode === 'pk_receivebankacc') {
			item.queryCondition = function () {
				var pk_receiveunit = _this2.props.form.getFormItemsValue(_this2.formId, 'pk_receiveunit') && _this2.props.form.getFormItemsValue(_this2.formId, 'pk_receiveunit').value;
				var pk_currtype = _this2.props.form.getFormItemsValue(_this2.formId, 'pk_currtype') && _this2.props.form.getFormItemsValue(_this2.formId, 'pk_currtype').value;
				return {
...
exports.default = function (props, templateCallback) {
	...
	props.createUIDom({
		...
		if (data) {
			...
			(0, _index.orgVersionView)(props, _this.formId, "pk_acceptorg", "pk_acceptorg_v");
			(0, _index.orgVersionView)(props, _this.formId, "pk_applyorg", "pk_applyorg_v");
			props.form.openArea('issecurity');
			props.form.openArea('acceptor');
			templateCallback && templateCallback();
		}
...
exports.afterEventEdit = afterEventEdit;

var _ncLightappFront = __webpack_require__(1);

var _index = __webpack_require__(4);

var _FBMAfterEditUtil = __webpack_require__(239);
...
function afterEvent(props, moduleId, key, value, oldValue) {
	...
	var eventData = { 'eventPosition': 'head', 'eventType': 'card', 'eventData': JSON.stringify(eventDataOld) };
	if (key === 'pk_org') {
		//财务组织
		if (!oldValue.value) {
			// 老数据为空，直接请求
	...
	} else if (key === 'securityrate' || key === "securityamount" || key === 'amount' || key === "olcrate" || key === "glcrate" || key === "gllcrate" || key === "pk_currtype" || key === "poundageamount" || key === "applydate") {
		//币种 + 申请日期
		if (!value.value) {
			return;
		}
		if (value.value !== oldValue.value) {
			_index.cardEvent.getAfterEventData.call(this, eventData).then(function (res) {
				setAfterEditFormValue.call(_this, _this.props, res);
			});
		}
	...
	} else if (key === 'pk_applybank') {
		//申请银行  修改后，清空出票人账号
		if (value.value !== oldValue.value && value.value) {} else {
			this.props.form.setFormItemsValue(this.formId, {
				'pk_applybankacc': {
					display: '',
					value: ''
	...
	} else if (key === 'pk_applybankacc' || key === 'pk_receivebankacc') {
		//银行账户 /收款人账户
		if (!value.value) {
			return;
		}
		...
		if (value.value !== oldValue.value && value.value) {
			...
			this.props.form.setFormItemsValue(this.formId, (_props$form$setFormIt = {
				olcinnersecurityamount: ''
			}, _defineProperty(_props$form$setFormIt, 'olcinnersecurityamount', ''), _defineProperty(_props$form$setFormIt, 'gllcinnersecurityamount', ''), _props$form$setFormIt));
		}
		_index.cardEvent.getAfterEventData.call(this, eventData).then(function (res) {
			setAfterEditFormValue.call(_this, _this.props, res);
		});
...
function afterEventEdit(props, moduleId, key, value) {
	...
	_index.cardEvent.changeOrg.call(this, value).then(function () {
		if (value.value) {
			_index.cardEvent.getAfterEventData.call(_this2, eventData).then(function (res) {
				...
				_this2.props.cardTable.addRow(_this2.tabCode, undefined, {}, true);
			});
		}
	});
}
...
function setAfterEditFormValue(props, res) {
	...
	props.form.setAllFormValue(_defineProperty({}, this.formId, card.head[this.formId]));
...
//# sourceMappingURL=index.fbf252d8.js.map
/*M5psfT1sstzfITsa7W0792mkcDhS4u8b2jDTUcOzxFaxYYDoRbSAgAinjISvEemE*/