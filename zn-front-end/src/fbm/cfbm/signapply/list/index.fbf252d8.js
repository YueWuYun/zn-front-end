...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/cfbm/signapply/list/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/cfbm/signapply/list/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
var _searchBtnClick = __webpack_require__(183);

var _buttonClick = __webpack_require__(184);

var _selectedEvent = __webpack_require__(185);

var _bodyButtonClick = __webpack_require__(186);
...
var _index6 = __webpack_require__(180);
...
var _initTemplate = __webpack_require__(241);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _buttonDisable = __webpack_require__(242);
...
var _BaseList = __webpack_require__(179);
...
var List = function (_Component) {
    ...
    function List(props) {
        ...
        _this.tabChangeServal = function (status, callback) {
            ...
            callback(serval);
            _events.buttonDisable.call(_this);
            return serval;
        };
        ...
        _this.myRenderCompleteEvent = function () {
            var muti = this.props.MutiInit.getIntl('36370IFBA'); //this.moduleId
            var money = muti && muti.get("36370IFBA-000009") /* 国际化处理： 申请额度*/;
            var start = muti && muti.get("36370IFBA-000010") /* 国际化处理： 开始*/;
            var end = muti && muti.get("36370IFBA-000011") /* 国际化处理： 结束*/;
            this.props.search.setTemlateByField(this.searchId, 'applymoney', 'defaultPlaceholder', { start: money + start, end: money + end });
        ...
        value: function render() {
            var tabs = {
                ...
                items: [{
                    key: "-1",
                    name: "DTJ",
                    title: this.props.MutiInit.getIntl("36370IFBA") && this.props.MutiInit.getIntl("36370IFBA").get("36370IFBA-000005") /* 国际化处理： 待提交*/
                }, {
                    key: "2,3",
                    name: "SPZ",
                    title: this.props.MutiInit.getIntl("36370IFBA") && this.props.MutiInit.getIntl("36370IFBA").get("36370IFBA-000006") /* 国际化处理： 审批中*/
                }, {
                    key: "sub1",
                    name: "DWT",
                    title: this.props.MutiInit.getIntl("36370IFBA") && this.props.MutiInit.getIntl("36370IFBA").get("36370IFBA-000008") /* 国际化处理： 待委托办理（即审批通过之后）*/
                }, {
                    key: "all",
                    title: this.props.MutiInit.getIntl("36370IFBA") && this.props.MutiInit.getIntl("36370IFBA").get("36370IFBA-000007") /* 国际化处理： 全部*/
                }],
            ...
            return _react2.default.createElement(_BaseList2.default, _extends({
                ...
                pageTitle: this.props.MutiInit.getIntl("36370IFBA") && this.props.MutiInit.getIntl("36370IFBA").get("36370IFBA-000002") //节点标题 //页面标题/* 国际化处理： 额度申请*/
	...
	props.createUIDom({
		...
		if (data) {
			if (data.button) {
				...
				props.button.setButtons(button);
				props.button.setPopContent('DeleteInner', _this.props.MutiInit.getIntl("36370IFBA") && _this.props.MutiInit.getIntl("36370IFBA").get('36370IFBA-000003')); /* 国际化处理： 确认要删除吗?*/
...
function modifierMeta(props, meta) {
	...
	meta[this.searchId].items.map(function (item) {
		...
		if (item.attrcode === 'pk_acceptorg') {
			//申请单财务组织
			item.queryCondition = function () {
				var pk_org = _this2.props.search.getSearchValByField('search', 'pk_org');
				return {
...
function buttonDisable() {
    ...
    if (selectedData.length == 1) {
        ...
        var busistatus = selectedData[0].data.values.busistatus.value;

        switch (vbillstatus) {
            case '-1':
                //待提交
                this.props.button.setButtonDisabled(['Add', 'Delete', 'Copy', 'Commit', 'Attachment', 'LinkSDBook', 'Voucher', 'LinkBudgetPlan', 'UnitQuota', 'Print', 'Output', 'LinkInnerAccount', 'LQueryInSecurityAcc'], false);
                this.props.button.setButtonDisabled(['SendInstruction', 'ImpawnBackInstr', 'CancelImpawnBack', 'WithdrawImpawn', 'Disabled', 'CancelInvalid'], true);
                break;
            case '2': //待审批
            case '3':
                //提交
                this.props.button.setButtonDisabled(['Add', 'Copy', 'Uncommit', 'Attachment', 'LinkSDBook', 'Voucher', 'LinkBudgetPlan', 'ApproveDetail', 'UnitQuota', 'Print', 'Output', 'LinkInnerAccount', 'LQueryInSecurityAcc'], false);
                this.props.button.setButtonDisabled(['Delete', 'Commit', 'SendInstruction', 'ImpawnBackInstr', 'CancelImpawnBack', 'WithdrawImpawn', 'Disabled', 'CancelInvalid'], true);
                break;
            case '1':
                //审批通过                
                this.props.button.setButtonDisabled(['Add', 'Copy', 'SendInstruction', 'ImpawnBackInstr', 'CancelImpawnBack', 'WithdrawImpawn', 'Disabled', 'LinkInnerAccount', 'LQueryInSecurityAcc', 'CancelInvalid', 'Attachment', 'LinkSDBook', 'Voucher', 'LinkBudgetPlan', 'ApproveDetail', 'UnitQuota', 'Print', 'Output'], false);
        ...
        this.props.button.setButtonDisabled(['Delete', 'Copy', 'Commit', 'Uncommit', 'Commission', 'CommissionCancel', 'Disabled', 'CancelInvalid', 'Attachment', 'LinkSDBook', 'Voucher', 'LinkBudgetPlan', 'ApproveDetail', 'UnitQuota', 'Print', 'Output', 'LinkInnerAccount', 'LQueryInSecurityAcc'], true);
    } else {
        var tabKey = this.state.activeTab;
        if (tabKey == 'all') {
            this.props.button.setButtonDisabled(['Delete', 'Copy', 'Commit', 'Uncommit', 'Commission', 'CommissionCancel', 'Disabled', 'CancelInvalid', 'Attachment', 'LinkSDBook', 'Voucher', 'LinkBudgetPlan', 'ApproveDetail', 'UnitQuota', 'Print', 'Output', 'LinkInnerAccount', 'LQueryInSecurityAcc'], false);
        } else if (tabKey == '-1') {
            this.props.button.setButtonDisabled(['Delete', 'Copy', 'Commit', 'Disabled', 'CancelInvalid', 'Attachment', 'LinkSDBook', 'Voucher', 'LinkBudgetPlan', 'UnitQuota', 'Print', 'Output', 'LinkInnerAccount', 'LQueryInSecurityAcc'], false);
        } else if (tabKey == '2,3') {
            this.props.button.setButtonDisabled(['Delete', 'Copy', 'Uncommit', 'Disabled', 'CancelInvalid', 'Attachment', 'LinkSDBook', 'Voucher', 'LinkBudgetPlan', 'ApproveDetail', 'UnitQuota', 'Print', 'Output', 'LinkInnerAccount', 'LQueryInSecurityAcc'], false);
        } else if (tabKey == 'sub1') {
            this.props.button.setButtonDisabled(['Delete', 'Copy', 'Uncommit', 'Commission', 'Disabled', 'CancelInvalid', 'Attachment', 'LinkSDBook', 'Voucher', 'LinkBudgetPlan', 'ApproveDetail', 'UnitQuota', 'Print', 'Output', 'LinkInnerAccount', 'LQueryInSecurityAcc'], false);
        }
    }
}
