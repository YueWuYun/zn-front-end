...
class List extends Component {
    ...
    myRenderCompleteEvent = function () {
        let muti = this.props.MutiInit.getIntl('36370IFBA'); //this.moduleId
        let money = muti && muti.get("36370IFBA-000009") /* 国际化处理： 申请额度*/;
        let start = muti && muti.get("36370IFBA-000010") /* 国际化处理： 开始*/;
        let end = muti && muti.get("36370IFBA-000011") /* 国际化处理： 结束*/;
    ...
    render() {
            ...
            items: [
                {
                    ...
                    name: "DTJ",
                    title:
                        this.props.MutiInit.getIntl("36370IFBA") &&
                        this.props.MutiInit.getIntl("36370IFBA").get(
                            "36370IFBA-000005"
                        )
                } /* 国际化处理： 待提交*/,
                {
        ...
        return (
            <BaseList
                ...
                pageTitle={
                    this.props.MutiInit.getIntl("36370IFBA") &&
                    this.props.MutiInit.getIntl("36370IFBA").get("36370IFBA-000002")
