...
//小应用编码
export const app_code = '36370PDTR';
//联查小应用编码
export const link_app_code = '36370PDTR';
//审批小应用编码
export const approve_app_code = '36370PDTRA';
//请求基础路径
export const base_path = '/nccloud/cfbm/buyerdisback';
//按钮平铺显示数量
export const button_limit = 3;  
//打印输出编码
export const nodekey = '36370PDTRP_01';
//联查预算aggVO
export const fullAggClassName = 'nc.vo.cfbm.buyerdisback.AggBuyerDisBackVO';
export const module_id = '36370PDTR';
//单据类型
export const billtype = '36NG';
...
//缓存标示
export const DATA_SOURCE = 'tm.cfbm.buyerdisback.datasource';
