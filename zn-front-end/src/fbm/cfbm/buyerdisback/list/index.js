...
import { CARD } from "../../buyerdisback/cons/constant";
import {
    API_URL,
    app_code,
    billtype,
...
class List extends Component {
    ...
    myRenderCompleteEvent = function () {
        ...
        let money = muti && muti.get("36370PDTR-000008") /* 国际化处理： 退票金额*/;
        let start = muti && muti.get("36370PDTR-000009") /* 国际化处理： 开始*/;
        let end = muti && muti.get("36370PDTR-000010") /* 国际化处理： 结束*/;
    ...
    render() {
        ...
        return (
            <BaseList
                ...
                pageTitle={
                    this.props.MutiInit.getIntl("36370PDTR") &&
                    this.props.MutiInit.getIntl("36370PDTR").get("36370PDTR-000003")
                } //页面标题/* 国际化处理*/
