...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/cfbm/buyerdisback/list/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/cfbm/buyerdisback/list/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
exports.getListData = exports.selectedEvent = exports.pageInfoClick = exports.buttonClick = exports.initTemplate1 = exports.initTemplate = exports.searchBtnClick = exports.bodyButtonClick = undefined;

var _initTemplate = __webpack_require__(225);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(226);
...
var _constant2 = __webpack_require__(190);
...
var List = function (_Component) {
    ...
    function List(props) {
        ...
        _this.myRenderCompleteEvent = function () {
            var muti = this.props.MutiInit.getIntl(_constant2.module_id);
            var money = muti && muti.get("36370PDTR-000008") /* 国际化处理： 退票金额*/;
            var start = muti && muti.get("36370PDTR-000009") /* 国际化处理： 开始*/;
            var end = muti && muti.get("36370PDTR-000010") /* 国际化处理： 结束*/;
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_BaseList2.default, _extends({
                ...
                constant: {
                    ...
                    tallyPlan: _constant2.LIST.tallyPlan
                },
                _initTemplate: this.getInitTemplate.call(this),
                _renderCompleteEvent: this.myRenderCompleteEvent,
                pageTitle: this.props.MutiInit.getIntl("36370PDTR") && this.props.MutiInit.getIntl("36370PDTR").get("36370PDTR-000003") //页面标题/* 国际化处理*/
		...
		render: function render(text, record, index) {
			return props.button.createErrorButton({
				...
				sucessCallBack: function sucessCallBack() {
					...
					var tallyflag = record.tallyflag && record.tallyflag.value;
					//根据制证与否显示按钮
					if (voucher) {
