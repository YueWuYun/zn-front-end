...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/cfbm/buyerdisback/card/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/cfbm/buyerdisback/card/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
//小应用编码
var app_code = exports.app_code = '36370PDTR';
//联查小应用编码
var link_app_code = exports.link_app_code = '36370PDTR';
//审批小应用编码
var approve_app_code = exports.approve_app_code = '36370PDTRA';
//请求基础路径
var base_path = exports.base_path = '/nccloud/cfbm/buyerdisback';
//按钮平铺显示数量
var button_limit = exports.button_limit = 3;
//打印输出编码
var nodekey = exports.nodekey = '36370PDTRP_01';
//联查预算aggVO
var fullAggClassName = exports.fullAggClassName = 'nc.vo.cfbm.buyerdisback.AggBuyerDisBackVO';
var module_id = exports.module_id = '36370PDTR';
//单据类型
var billtype = exports.billtype = '36NG';
...
var LIST = exports.LIST = {
    disabled_btn: ['Attachment', 'LinKGroup', 'BuyerDiscountBillLink', 'Voucher', 'LinkBudgetPlan', 'LinkInnerAccount', 'LQueryInSecurityAcc', 'Print', 'Output', 'OffiPrint', 'InOffiPrint'], //默认禁用按钮
    page_id: '36370PDTR_LIST', //页面编码
    app_code: '36370PDTR', //应用编码
    page_id_link: '36370PDTRL_LIST', //联查页面编码
    ...
    billno: 'vbillno', //单据编号
    page_id: '36370PDTR_CARD', //页面编码 
    page_id_link: '36370PDTRL_CARD', //联查页面编码
    page_id_approve: '36370PDTRA_CARD', //审批页面编码
    form_id: 'head', //表头表单编码
    ...
    //缓存标示
};var DATA_SOURCE = exports.DATA_SOURCE = 'tm.cfbm.buyerdisback.datasource';

//查询区域缓存
var searchCache = exports.searchCache = {
    key: 'fbm.cfbm.buyerdisback.searchCache', //查询区域缓存Key
    dataSource: 'fbm.cfbm.buyerdisback.searchSpace' //查询区域缓存数据的名称空间
...
exports.bodySelectedAllEvent = exports.bodySelectedEvent = exports.afterEvent = exports.buttonVisible = exports.initTemplate1 = exports.initTemplate = exports.buttonClick = undefined;

var _buttonClick = __webpack_require__(172);

var _buttonClick2 = _interopRequireDefault(_buttonClick);

var _initTemplate = __webpack_require__(220);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(221);

var _initTemplate4 = _interopRequireDefault(_initTemplate3);

var _buttonVisible = __webpack_require__(200);

var _afterEvent = __webpack_require__(222);

var _bodySelectedEvent = __webpack_require__(223);
...
function buttonVisible(props) {
    ...
    var btnObj = {};
    var showBtn = [];
    var unionBtn = ['BuyerDiscountBillLink', 'Voucher', 'LinkBudgetPlan', 'LinkInnerAccount', 'LQueryInSecurityAcc']; //联查按钮
    ...
    _createClass(Card, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_BaseCard2.default, _extends({
                ...
                pageTitle: this.props.MutiInit.getIntl("36370PDTR") && this.props.MutiInit.getIntl("36370PDTR").get("36370PDTR-000003") //页面标题/* 国际化处理： 票据贴现回单*/
