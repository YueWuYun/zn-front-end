...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/cfbm/signaccept/card/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/cfbm/signaccept/card/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
//小应用编码
var app_code = exports.app_code = '36370IFBAD';
//联查小应用编码
var link_app_code = exports.link_app_code = '36370IFBAD';
//审批小应用编码
var approve_app_code = exports.approve_app_code = '36370IFBADA';
//请求基础路径
var base_path = exports.base_path = '/nccloud/cfbm/signaccept';
//按钮平铺显示数量
var button_limit = exports.button_limit = 3;
//打印输出编码
var nodekey = exports.nodekey = '36370IFBAD';

var module_id = exports.module_id = '36370IFBAD';
//单据类型
var billtype = exports.billtype = '36NB';
...
var LIST = exports.LIST = {
    ...
    //缓存标示
};var DATA_SOURCE = exports.DATA_SOURCE = 'tm.fbm.signaccept.datasource';
...
var _initTemplate = __webpack_require__(228);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(229);

var _initTemplate4 = _interopRequireDefault(_initTemplate3);

var _initTemplate5 = __webpack_require__(230);

var _initTemplate6 = _interopRequireDefault(_initTemplate5);

var _buttonVisible = __webpack_require__(203);

var _afterEvent = __webpack_require__(231);
...
function buttonVisible(props) {
    ...
    var dealsign = props.form.getFormItemsValue(this.formId, 'dealsign') && props.form.getFormItemsValue(this.formId, 'dealsign').value;
    var isacceptednow = props.form.getFormItemsValue(this.formId, 'isacceptednow') && props.form.getFormItemsValue(this.formId, 'isacceptednow').value;
    ...
    var signflag = props.form.getFormItemsValue(this.formId, 'signflag') && props.form.getFormItemsValue(this.formId, 'signflag').value;
    var btnObj = {};
    var showBtn = [];
    var disabledBtn = [];
    var unionBtn = ['ApproveDetail', 'LQueryInSecurityAcc', 'LinkInnerAccount', 'SignApplyLink', 'SignBillLink']; //联查按钮
    var allBtns = [].concat(_toConsumableArray(buttons), unionBtn, ['Uncommit', 'Commit']);
    var fbmbilltype = props.form.getFormItemsValue(this.formId, 'fbmbilltype').value;
    var commonBtn = ['Print', 'Output', 'Attachment', 'Refresh', 'LQueryInSecurityAcc', 'LinkInnerAccount', 'SignApplyLink'];
    switch (vbillstatus) {
        case '-1':
            //待提交
            if (dealsign) {
                showBtn = ['Commit', 'UnAccept'].concat(commonBtn);
            } else {
                showBtn = ['Accept', 'Return'].concat(commonBtn);
            }
            break;
        case '2': //审批进行中
        case '3':
            //提交
            showBtn = ['Uncommit', 'ApproveDetail'].concat(commonBtn);
            break;
        case '1':
            //已审批
            if (isacceptednow) {
                ...
                if (!signflag) {
                    ...
                    showBtn = ['Uncommit', 'SignLink', 'ApproveDetail'].concat(commonBtn);
                } else {
                    //已签发的不能收回和签发,可以联查票据签发单
                    showBtn = ['SignBillLink', 'ApproveDetail'].concat(commonBtn);
                }
            } else {
                ...
                switch (busistatus) {
                    case '3':
                        //已委托办理态
                        showBtn = ['CommissionCancel', 'ApproveDetail'].concat(commonBtn);
                        break;
                    default:
                        //未委托办理态
                        showBtn = ['Uncommit', 'Commission', 'ApproveDetail'].concat(commonBtn);
                        break;
                }
            }
        default:
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_BaseCard2.default, _extends({
                constant: {
                    ...
                    pk_inbalaacc: _constant.LIST.pk_inbalaacc, //内部结算账户的主键
                    ...
                    pk_insecurityacc: _constant.LIST.pk_securityacc,
                    cafalg: "false",
                    returnReason: _constant.LIST.returnReason,
                ...
                pageTitle: this.props.MutiInit.getIntl("36370IFBAD") && this.props.MutiInit.getIntl("36370IFBAD").get("36370IFBAD-000002") //页面标题/* 国际化处理： 开票申请受理*/
...
function afterEvent(props, moduleId, key, value, oldValue) {} //表头编辑后事件
