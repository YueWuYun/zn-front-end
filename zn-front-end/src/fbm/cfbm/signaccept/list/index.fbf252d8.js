...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/cfbm/signaccept/list/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/cfbm/signaccept/list/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
exports.getListData = exports.selectedEvent = exports.pageInfoClick = exports.bodyBtnOperation = exports.buttonClick = exports.initTemplate = exports.searchBtnClick = exports.bodyButtonClick = undefined;

var _initTemplate = __webpack_require__(233);
...
disabledBtnsParam.push({
    ...
    rules: function rules(current) {
        return current.dealsign.value || current.busistatus.value == "6";
    }
...
disabledBtnsParam.push({
    btnName: ["UnAccept"],
    rules: function rules(current) {
        return !(current.dealsign.value && current.vbillstatus.value == "-1");
    }
});
...
disabledBtnsParam.push({
    btnName: ["Return"],
    rules: function rules(current) {
        return !(current.busistatus.value == "6" || current.dealsign.value == false);
    }
});
...
disabledBtnsParam.push({
    btnName: ["Commission"],
    rules: function rules(current) {
        return !(current.vbillstatus.value == "1" && current.isacceptednow.value == false && current.busistatus.value != "3");
    }
});
...
disabledBtnsParam.push({
    ...
    rules: function rules(current) {
        return !(current.busistatus.value == "3");
    }
});
...
disabledBtnsParam.push({
    btnName: ["Commit"],
    rules: function rules(current) {
        return !(current.vbillstatus.value == "-1" && current.dealsign.value);
    }
});
disabledBtnsParam.push({
    btnName: ["Uncommit"],
    rules: function rules(current) {
        return !((current.vbillstatus.value == "3" || current.vbillstatus.value == "1") && !current.signflag.value && current.busistatus.value != "3");
    }
});
...
disabledBtnsParam.push({
    btnName: ["SignLink"],
    rules: function rules(current) {
        return !(current.isacceptednow.value && current.vbillstatus.value == "1" && !current.signflag.value);
    }
});
...
var List = function (_Component) {
    ...
    function List(props) {
        ...
        _this.myRenderCompleteEvent = function () {
            ...
            var amount = muti && muti.get("36370IFBAD-000008") /* 国际化处理： 申请金额*/;
            var start = muti && muti.get("36370IFBAD-000009") /* 国际化处理： 开始*/;
            var end = muti && muti.get("36370IFBAD-000010") /* 国际化处理： 结束*/;
            this.props.search.setTemlateByField(this.searchId, 'amount', 'defaultPlaceholder', { start: amount + start, end: amount + end });
        ...
        value: function render() {
            ...
            var tabs = {
                ...
                items: [{
                    key: "10",
                    name: "tab03",
                    title: multiLang && multiLang.get("36370IFBAD-000011") /* 国际化处理： 待受理*/
                }, {
                    key: "11",
                    name: "tab01",
                    title: multiLang && multiLang.get("36370IFBAD-000005") /* 国际化处理： 待提交*/
                }, {
                    key: "2,3",
                    name: "tab02",
                    title: multiLang && multiLang.get("36370IFBAD-000006") /* 国际化处理： 审批中*/
                }, {
                    key: "all",
                    title: multiLang && multiLang.get("36370IFBAD-000007") /* 国际化处理： 全部*/
                }],
            ...
            return _react2.default.createElement(_BaseList2.default, _extends({
                constant: {
                    ...
                    tabStatus: _constant.LIST.tabStatus, //用于待受理页签
                    dealsign: _constant.LIST.dealsign,
                    vbillstatus: _constant.LIST.vbillstatus,
                    dealsignY: _constant.LIST.dealsignY,
	...
	props.createUIDom({
		...
		if (data) {
			if (data.button) {
				...
				props.button.setButtons(button);
				props.button.setPopContent('DeleteInner', _this.props.MutiInit.getIntl("36370IFBAD") && _this.props.MutiInit.getIntl("36370IFBAD").get('36370IFBAD-000003')); /* 国际化处理： 确认要删除吗?*/
...
function modifierMeta(props, meta) {
	...
	meta[this.tableId].items.push({
		...
		render: function render(text, record, index) {
			...
			var dealsign = record.dealsign && record.dealsign.value;
			var isacceptednow = record.isacceptednow && record.isacceptednow.value;
			var busistatus = record.busistatus && record.busistatus.value;
			var signflag = record.signflag && record.signflag.value;
