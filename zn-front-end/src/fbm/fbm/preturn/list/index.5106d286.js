...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/fbm/preturn/list/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/fbm/preturn/list/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
var _buttonDisable = __webpack_require__(677);

var _initTemplate = __webpack_require__(678);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(679);
...
var _constant2 = __webpack_require__(214);

var _events = __webpack_require__(347);
...
var List = function (_Component) {
  ...
  function List(props) {
    ...
    _this.myRenderCompleteEvent = function () {
      var muti = this.props.MutiInit.getIntl("36180PRR");
      var money = muti && muti.get("36180PRR-000010"); /* 国际化处理： 票据金额*/
      var start = muti && muti.get("36180PRR-000011"); /* 国际化处理： 开始*/
      var end = muti && muti.get("36180PRR-000012"); /* 国际化处理： 结束*/
    ...
    value: function render() {
      var tabs = {
        ...
        items: [{
          key: "-1",
          name: "numZY",
          title: this.props.MutiInit.getIntl("36180PRR") && this.props.MutiInit.getIntl("36180PRR").get("36180PRR-000006") /* 国际化处理： 待提交*/
        }, {
          key: "2,3",
          name: "numTJ",
          title: this.props.MutiInit.getIntl("36180PRR") && this.props.MutiInit.getIntl("36180PRR").get("36180PRR-000007") /* 国际化处理： 审批中*/
        }, {
          key: "all",
          title: this.props.MutiInit.getIntl("36180PRR") && this.props.MutiInit.getIntl("36180PRR").get("36180PRR-000008") /* 国际化处理： 全部*/
        }],
      ...
      return _react2.default.createElement(_BaseList2.default, _extends({
        ...
        constant: {
          modulecode: _constant2.modulecode,
...
function buttonDisable() {
  ...
  var otherBtn = ["Delete", "Copy", "Commit", "Uncommit", "MakeVoucher", "CancelVoucher", "Transform", "CancelTransform", "Attachment", "Union", "LinkSDBook", "Voucher", "LinkBudgetPlan", "LinkReceAndPaybill", "ApproveDetail", "Print", "Output"];
  if (selectedData.length == 1) {
    var vbillstatus = selectedData[0].data.values.vbillstatus.value;
    var voucher = selectedData[0].data.values.voucher.value;
    var transform = selectedData[0].data.values.transform.value;
    switch (vbillstatus) {
      case "-1":
        //待提交
        this.props.button.setButtonDisabled(["Add", "Delete", "Copy", "Commit", "Attachment", "Union", "LinkSDBook", "LinkBudgetPlan", "LinkReceAndPaybill", "ApproveDetail", "Print", "Output"], false);
        this.props.button.setButtonDisabled(["Uncommit"], true);
        break;
      case "2": //待审批
      case "3":
        //提交
        this.props.button.setButtonDisabled(["Add", "Copy", "Uncommit", "Attachment", "Union", "LinkSDBook", "LinkBudgetPlan", "LinkReceAndPaybill", "ApproveDetail", "Print", "Output"], false);
      ...
      case "1":
        ...
        var showBtn = [];
        if (voucher) {
          showBtn = otherBtn.filter(function (item) {
            return item !== "Delete" && item !== "Uncommit" && item !== "MakeVoucher" && item !== "Commit";
          });
          showBtn = ["Add"].concat(_toConsumableArray(showBtn));
          this.props.button.setButtonDisabled(showBtn, false);
          this.props.button.setButtonDisabled(["Delete", "Commit", "Uncommit"], true);
        } else {
          showBtn = otherBtn.filter(function (item) {
            return item !== "Delete" && item !== "Commit" && item !== "CancelVoucher";
          });
          showBtn = ["Add"].concat(_toConsumableArray(showBtn));
          this.props.button.setButtonDisabled(showBtn, false);
          this.props.button.setButtonDisabled(["Delete", "Commit"], true);
        ...
        if (transform) {
          ...
          this.props.button.setButtonDisabled(showBtn, false);
          this.props.button.setButtonDisabled(["Delete", "Commit", "Uncommit", "Transform"], true);
        } else {
          showBtn = showBtn.filter(function (item) {
            return item !== "CancelTransform";
          });
          this.props.button.setButtonDisabled(showBtn, false);
  ...
  props.createUIDom({
    ...
    if (data) {
      if (data.button) {
        ...
        props.button.setButtons(button);
        props.button.setPopContent("DeleteInner", _this.props.MutiInit.getIntl("36180PRR") && _this.props.MutiInit.getIntl("36180PRR").get("36180PRR-000004")); /* 国际化处理： 确认要删除吗?*/
...
var _index2 = __webpack_require__(347);
    ...
    render: function render(text, record, index) {
      return props.button.createErrorButton({
        ...
        sucessCallBack: function sucessCallBack() {
          ...
          var transform = record.transform && record.transform.value;
          switch (busistatus) {
            case "-1":
              //待提交
