...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/fbm/preturn/card/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/fbm/preturn/card/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
//模块code
var modulecode = exports.modulecode = "3618";
//小应用编码
var app_code = exports.app_code = "36180PRR";
//联查小应用编码
var link_app_code = exports.link_app_code = "36180PRR";
//审批小应用编码
var approve_app_code = exports.approve_app_code = "36180PRRA";
//请求基础路径
var base_path = exports.base_path = "/nccloud/fbm/preturn";
//按钮平铺显示数量
var button_limit = exports.button_limit = 3;
//打印输出编码
var nodekey = exports.nodekey = "36180preturn";
//联查预算aggVO
var fullAggClassName = exports.fullAggClassName = "nc.vo.fbm.preturn.AggPReturnVO";
//单据类型
var billtype = exports.billtype = "36HE";

// 业务对应表名，修改按钮点击时用来saga校验
var tableName = exports.tableName = 'fbm_preturn';
/**
 * 列表
 */
var LIST = exports.LIST = {
  disabled_btn: ["Delete", "Copy", "Commit", "MakeVoucher", "CancelVoucher", "Transform", "CancelTransform", "Uncommit", "Attachment", "LinkSDBook", "Voucher", "LinkBudgetPlan", "LinkReceAndPaybill", "ApproveDetail", "Print", "Output"], //默认禁用按钮
  disabled_btn_one: ["Copy"], //只有列表只有一条数据的时候，按钮才可用
  page_id: "36180PRR_LIST", //页面编码
  page_id_link: "36180PRRL_LIST", //联查页面编码
  search_id: "search", //查询区域编码
  table_id: "table", //表格区域编码
  head_btn_code: "list_head", //表头按钮区域
  search_oid: "1001Z61000000000V0IQ", //查询区域oid
  primary_id: "pk_preturn", //列表页面主键
  billno: "vbillno", //单据编号
...
var CARD = exports.CARD = {
  primary_id: "pk_preturn", //表头主键
  billno: "vbillno", //单据编号
  page_id: "36180PRR_CARD", //页面编码
  page_id_link: "36180PRRL_CARD", //联查页面编码
  page_id_approve: "36180PRRA_CARD", //审批页面编码
  form_id: "head", //表头表单编码
  ...
  //表体主键
  tab_id: {
    registerbill: "pk_preturn_b"
  }
};

//缓存标示
var DATA_SOURCE = exports.DATA_SOURCE = "tm.fbm.preturn.datasource";

//查询区域缓存
var searchCache = exports.searchCache = {
  key: "fbm.fbm.preturn.searchCache", //查询区域缓存Key
  dataSource: "fbm.fbm.preturn.searchSpace" //查询区域缓存数据的名称空间
};
...
exports.bodySelectedAllEvent = exports.bodySelectedEvent = exports.afterTableEvent = exports.afterEvent = exports.buttonVisible = exports.initTemplate2 = exports.initTemplate1 = exports.initTemplate = exports.buttonClick = exports.bodyButtonClick = undefined;

var _buttonClick = __webpack_require__(167);

var _buttonClick2 = _interopRequireDefault(_buttonClick);

var _afterEvent = __webpack_require__(670);

var _afterTableEvent = __webpack_require__(671);

var _bodyButtonClick = __webpack_require__(345);

var _bodySelectedEvent = __webpack_require__(672);

var _buttonVisible = __webpack_require__(346);

var _initTemplate = __webpack_require__(673);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(674);

var _initTemplate4 = _interopRequireDefault(_initTemplate3);

var _initTemplate5 = __webpack_require__(675);
...
var _constant = __webpack_require__(214);
...
function bodyButtonClick(props, key, text, record, index) {
  ...
  switch (key) {
    ...
    case "deleteRow":
      ...
      var eventData = this.props.createTabsBodyAfterEventData(this.pageId, this.formId, this.tabOrder, _constant.modelname, "delrow", null); //编辑后事件整单数据
    ...
    case "delRow":
      ...
      var eventData1 = this.props.createTabsBodyAfterEventData(this.pageId, this.formId, this.tabOrder, _constant.modelname, "delrow", null); //编辑后事件整单数据
...
function buttonVisible(props) {
  ...
  var transform = props.form.getFormItemsValue(this.formId, "transform") && props.form.getFormItemsValue(this.formId, "transform").value;
  var btnObj = {};
  var showBtn = [];
  var editBtn = ["save_group", "SaveCommit", "Cancel", "addRow", "deleteRow", "insertRow", "delRow", "expand"];
  var unionBtn = ["ApproveDetail", "Voucher"];
      ...
      switch (vbillstatus) {
        case "-1":
          ...
          commonBtn = commonBtn.filter(function (item) {
            return item !== "ApproveDetail" && item !== "Voucher";
          });
        ...
        case "1":
          ...
          showBtn = ["Add", "Copy", "Uncommit"].concat(_toConsumableArray(commonBtn));
          if (voucher) {
            showBtn.push("Voucher");
            showBtn.push("CancelVoucher");
            showBtn = showBtn.filter(function (item) {
              return item !== "Uncommit";
            });
            props.button.setButtonDisabled("Voucher", false);
          } else {
            showBtn.push("MakeVoucher");
            props.button.setButtonDisabled("Voucher", true);
          }
          if (transform) {
            showBtn.push("CancelTransform");
            showBtn = showBtn.filter(function (item) {
              return item !== "Uncommit";
            });
          } else {
            showBtn.push("Transform");
          }
          //设置新增按钮为灰，提交为红色
...
function saveBefore(saveAction) {
  if (!this.props.cardTable.checkTabRequired(_constant.CARD.tab_code)) {
    return;
  }
  saveAction();
}
  ...
  _createClass(Card, [{
    ...
    value: function render() {
      return _react2.default.createElement(_BaseCard2.default, _extends({
        ...
        constant: {
          modulecode: _constant.modulecode,
        ...
        pageTitle: this.props.MutiInit.getIntl("36180PRR") && this.props.MutiInit.getIntl("36180PRR").get("36180PRR-000003") //页面标题/* 国际化处理： 应付票据退票*/
...
Card = (0, _ncLightappFront.createPage)({
  ...
  orderOfHotKey: [_constant.CARD.form_id, _constant.CARD.tab_code], //定义页面渲染完成后自动聚焦的区域
...
function afterEvent(props, moduleId, key, value, oldValue) {
  ...
  var eventData = this.props.createTabsAfterEventData(this.pageId, this.formId, this.tabOrder, moduleId, key, value);
  if (key === "pk_org") {
    ...
    if (!oldValue || !oldValue.value) {
      ...
      (0, _ncLightappFront.promptBox)({
        color: "warning",
        title: this.props.MutiInit.getIntl("36180PRR") && this.props.MutiInit.getIntl("36180PRR").get("36180PRR-000000") /* 国际化处理： 修改财务组织*/
        , content: this.props.MutiInit.getIntl("36180PRR") && this.props.MutiInit.getIntl("36180PRR").get("36180PRR-000001") /* 国际化处理： 确认修改财务组织, 这样会清空您录入的信息?*/
...
function afterTableEvent(props, moduleId, key, value, changedrows, index, record, type, method) {
  ...
  var eventData = this.props.createTabsBodyAfterEventData(this.pageId, this.formId, this.tabOrder, moduleId, key, changedrows);
  if (key === "pk_register") {
    _index.cardEvent.setBodyAfterEventData.call(this, eventData).then(function (res) {
      props.form.setAllFormValue(_defineProperty({}, _this.formId, res.data.head && res.data.head[_this.formId]));
    });
...
exports.default = function (props, templateCallback) {
  ...
  var app_code = props.getSearchParam("c") || props.getUrlParam("c");
  props.createUIDom({
...
function modifierMeta(meta) {
  ...
  //表体票据编号参照过滤
  meta[_constant.CARD.tab_code].items.map(function (item) {
    if (item.attrcode == "pk_register") {
      item.isMultiSelectedEnabled = true;
      item.queryCondition = function () {
        var registerbillData = _this2.props.cardTable.getColValue(_constant.CARD.tab_code, "pk_register").filter(function (item) {
          return item.value !== "" && item.value !== null;
        }).map(function (item) {
          return item.value;
        });
        var registerbillDatas = registerbillData.toString();
        return {
          ...
          returntype: _this2.props.form.getFormItemsValue(_this2.formId, "returntype").value, //退票类型
          GridRefActionExt: "nccloud.web.fbm.fbm.preturn.filter.PreturnRegisterStatusFilter"
        };
      };
    }
  });
  //表体侧拉票据编号参照过滤
  meta[_constant.CARD.tab_code2].items.map(function (item) {
    if (item.attrcode == "pk_register") {
      item.isMultiSelectedEnabled = true;
      item.queryCondition = function () {
        var registerbillData = _this2.props.cardTable.getColValue(_constant.CARD.tab_code, "pk_register").filter(function (item) {
  ...
  try {
    for (var _iterator = Object.keys(meta.gridrelation)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      meta[item].items.push({
        attrcode: "opr",
        label: this.props.MutiInit.getIntl("36180PRR") && this.props.MutiInit.getIntl("36180PRR").get("36180PRR-000002") /* 国际化处理： 操作*/
        , itemtype: "customer",
        fixed: "right",
        className: "table-opr",
        visible: true,
...
exports.default = function (props, templateCallback) {
  var app_code = props.getSearchParam("c") || props.getUrlParam("c");
  props.createUIDom({
    pagecode: _constant.CARD.page_id_link,
    appcode: app_code
  }, function (data) {
    if (data) {
      if (data.template) {
