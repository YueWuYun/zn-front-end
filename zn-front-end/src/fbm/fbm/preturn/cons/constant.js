...
//小应用编码
export const app_code = "36180PRR";
//联查小应用编码
export const link_app_code = "36180PRR";
//审批小应用编码
export const approve_app_code = "36180PRRA";
//请求基础路径
export const base_path = "/nccloud/fbm/preturn";
//按钮平铺显示数量
export const button_limit = 3;
//打印输出编码
export const nodekey = "36180preturn";
//联查预算aggVO
export const fullAggClassName = "nc.vo.fbm.preturn.AggPReturnVO";
//单据类型
export const billtype = "36HE";

// 业务对应表名，修改按钮点击时用来saga校验
export const tableName = 'fbm_preturn';
/**
 * 列表
 */
export const LIST = {
...
//缓存标示
export const DATA_SOURCE = "tm.fbm.preturn.datasource";
