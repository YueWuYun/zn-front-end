...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/fbm/payregister/list/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/fbm/payregister/list/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
//小应用编码
var app_code = exports.app_code = '36180BPB';
//联查小应用编码
var link_app_code = exports.link_app_code = '36180BPBA';
//审批小应用编码
var approve_app_code = exports.approve_app_code = '36180BPBA';
//请求基础路径
var base_path = exports.base_path = '/nccloud/fbm/payregister';
//按钮平铺显示数量
var button_limit = exports.button_limit = 3;
//打印输出编码
var nodekey = exports.nodekey = '36180BPBP';

var module_id = exports.module_id = '36180BPB';
//单据类型
var billtype = exports.billtype = '36HF';
...
var LIST = exports.LIST = {
    ...
    disabled_btn: ['Delete', 'Commit', 'Uncommit', 'Print', 'Output', 'Attachment', 'ApproveDetail', 'CreditAmount', 'Copy', 'LinkSDBook'], //默认禁用按钮
...
var _initTemplate = __webpack_require__(667);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(668);
...
var _constant = __webpack_require__(217);

var _constant2 = __webpack_require__(217);
...
disabledBtnsParam.push({
    ...
    rules: function rules(current) {
        return current.vbillstatus && current.vbillstatus.value !== "3" && current.vbillstatus.value !== "1" && current.vbillstatus.value !== "2";
    }
});
...
var List = function (_Component) {
    ...
    function List(props) {
        ...
        _this.myRenderCompleteEvent = function () {
            ...
            var money = muti && muti.get("36180BPB-000013") /* 国际化处理： 票据金额*/;
            var start = muti && muti.get("36180BPB-000014") /* 国际化处理： 开始*/;
            var end = muti && muti.get("36180BPB-000015") /* 国际化处理： 结束*/;
        ...
        value: function render() {
            var tabs = {
                ...
                items: [{
                    key: "-1",
                    name: "DTJ",
                    title: this.props.MutiInit.getIntl("36180BPB") && this.props.MutiInit.getIntl("36180BPB").get("36180BPB-000009") /* 国际化处理： 待提交*/ /* 国际化处理： 待提交*/
                }, {
                    key: "2,3",
                    name: "SPZ",
                    title: this.props.MutiInit.getIntl("36180BPB") && this.props.MutiInit.getIntl("36180BPB").get("36180BPB-000010") /* 国际化处理： 审批中*/ /* 国际化处理： 审批中*/
                }, {
                    key: "all",
                    title: this.props.MutiInit.getIntl("36180BPB") && this.props.MutiInit.getIntl("36180BPB").get("36180BPB-000011") /* 国际化处理： 全部*/ /* 国际化处理： 全部*/
                }],
            ...
            return _react2.default.createElement(_BaseList2.default, _extends({
                ...
                constant: {
                    cardpageId: _constant2.CARD.page_id,
                    ...
                    cardPageCode: _constant2.CARD.page_id,
                ...
                pageTitle: this.props.MutiInit.getIntl("36180BPB") && this.props.MutiInit.getIntl("36180BPB").get("36180BPB-000007") //节点标题
	...
	props.createUIDom({
		...
		if (data) {
			if (data.button) {
				...
				props.button.setButtons(button);
				props.button.setPopContent('delete', _this.props.json['36650BRP-000002']); /* 国际化处理： 确认要删除吗?*/
				props.button.setPopContent('terminate', _this.props.json['36650BRP-000003']); /* 国际化处理： 确认要终止吗?*/
				...
				props.button.setPopContent('DeleteInner', _this.props.MutiInit.getIntl("36180BPB") && _this.props.MutiInit.getIntl("36180BPB").get('36180BPB-000008')); /* 国际化处理： 确认要删除吗?*/
			}
			if (data.template) {
				var meta = data.template;
