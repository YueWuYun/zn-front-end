...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/fbm/acceptAppr/card/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/fbm/acceptAppr/card/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
var _initTemplate = __webpack_require__(717);

var _buttonVisiable = __webpack_require__(718);

var _buttonClick = __webpack_require__(719);

var _pageInfoClick = __webpack_require__(720);

var _afterEvent = __webpack_require__(721);
...
var _index2 = __webpack_require__(714);
    ...
    function Card(props) {
        ...
        _this.toggleShow = function () {
            ...
            if (status === "browse") {
                ...
                _this.props.form.setFormStatus(_const.CARD_FORM_CODE, "edit");
                _this.props.BillHeadInfo.setBillHeadInfoVisible({
                    //控制显示返回按钮: true为显示,false为隐藏
                    showBackBtn: false,
                    //控制显示单据号：true为显示,false为隐藏
                ...
                _this.props.form.setFormStatus(_const.CARD_FORM_CODE, "add");
                _this.props.BillHeadInfo.setBillHeadInfoVisible({
                    //控制显示返回按钮: true为显示,false为隐藏
                    showBackBtn: false,
                    //控制显示单据号：true为显示,false为隐藏
            ...
            _index2.afterEvent.call(_this, _this.props, _const.CARD_FORM_CODE, "isagent", isagent, null, null, null, null, true);
            _index2.buttonVisiable.call(_this, _this.props);
        };
        ...
        _this.getAssginUsedr = function (userObj) {
            var mutiInit = _this.props.MutiInit.getIntl("36180BPA");
                ...
                if (res.data && res.data.errMsg) {
                    ...
                    if (res.data.workflow && (res.data.workflow == "approveflow" || res.data.workflow == "workflow") && !userObj) {
                        ...
                        if (res.data.card.head) {
                            ...
                            (0, _ncLightappFront.toast)({
                                color: "success",
                                content: mutiInit && mutiInit.get("36180BPA-000009") /* 国际化处理： 提交成功！*/
                            });
                        }
                    }
                }
        ...
        _index2.initTemplate.call(_this, _this.props);
        return _this;
    }
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            createBillHeadInfo({
                                title: mutiInit && mutiInit.get("36180BPA-000014") /* 国际化处理： 票据付款*/
                        ...
                        _react2.default.createElement(
                            ...
                            this.props.button.createButtonApp({
                                area: "card_head",
                                buttonLimit: 7,
                                onButtonClick: _index2.buttonClick.bind(this),
                        ...
                        _react2.default.createElement(
                            ...
                            createCardPagination({
                                handlePageInfoChange: _index2.pageInfoClick.bind(this),
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        createForm(_const.CARD_FORM_CODE, {
                            ...
                            onAfterEvent: _index2.afterEvent.bind(this)
                            ...
                            saveCallback = function saveCallback(res) {
                                if (res.data.card.head) {
                                    ...
                                    if (showToast) {
                                        (0, _ncLightappFront.toast)({
                                            color: "success",
                                            content: this.props.MutiInit.getIntl("36180BPA") && this.props.MutiInit.getIntl("36180BPA").get("36180BPA-000006") /* 国际化处理： 保存成功*/
                                        });
                                    }
                                }
                            };
...
var _const2 = __webpack_require__(202);
...
function buttonClick(props, id) {
    ...
    switch (id) {
        ...
        case _const2.CARD_BTN.CANCEL:
            (0, _ncLightappFront.promptBox)({
                title: mutiInit && mutiInit.get("36180BPA-000002") /* 国际化处理： 取消*/
                , color: "warning",
                content: mutiInit && mutiInit.get("36180BPA-000003") /* 国际化处理： 是否确认要取消?*/
        ...
        case _const2.CARD_BTN.DELETE:
            (0, _ncLightappFront.promptBox)({
                ...
                , color: "warning",
                content: mutiInit && mutiInit.get("36180BPA-000005") /* 国际化处理： 是否确任要删除?*/
...
function doDelete(props) {
    ...
    var successCallback = function successCallback(res) {
        (0, _ncLightappFront.toast)({
            color: "success",
            content: this.props.MutiInit.getIntl("36180BPA") && this.props.MutiInit.getIntl("36180BPA").get("36180BPA-000007")
        }); /* 国际化处理： 删除成功!*/
...
function doCopy(props) {
    ...
    if (!pk) {
        (0, _ncLightappFront.toast)({
            color: "error",
            content: this.props.MutiInit.getIntl("36180BPA") && this.props.MutiInit.getIntl("36180BPA").get("36180BPA-000008") /* 国际化处理： URL中没有主键*/
        });
        return;
    }
    ...
    var successCallback = function successCallback(res) {
        if (res.data) {
            ...
            if (showToast) {
                (0, _ncLightappFront.toast)({
                    color: "success",
                    content: this.props.MutiInit.getIntl("36180BPA") && this.props.MutiInit.getIntl("36180BPA").get("36180BPA-000010") /* 国际化处理： 刷新成功！*/
                });
            }
        }
    };
    ...
    var successCallback = function successCallback(res) {
        if (res.success) {
            ...
            if ("_LinkVouchar2019" == srcCode) {
                    ...
                    if (res.data.pklist) {
                        if (res.data.pklist.length == 1) {
                            ...
                            this.props.openTo(res.data.url, {
                                ...
                                n: this.props.MutiInit.getIntl("36180BPA") && this.props.MutiInit.getIntl("36180BPA").get("36180BPA-000031"), //'联查凭证'/* 国际化处理： 联查凭证*/
                                backflag: "noback"
                            });
                            return;
                        } else {
                ...
                (0, _ncLightappFront.toast)({
                    color: "warning",
                    content: this.props.MutiInit.getIntl("36180BPA") && this.props.MutiInit.getIntl("36180BPA").get("36180BPA-000032")
                }); /* 国际化处理： 未查到凭证*/
                return;
            }
        }
...
function pkorgAfterEvent(props, data, isinit) {
	...
	if (newvalue == oldvalue) {
		...
		if (!oldvalue) {
			...
			(0, _ncLightappFront.promptBox)({
				color: "warning",
				title: this.props.MutiInit.getIntl("36180BPA") && this.props.MutiInit.getIntl("36180BPA").get('36180BPA-000000'), /* 国际化处理： 确认修改*/
				content: this.props.MutiInit.getIntl("36180BPA") && this.props.MutiInit.getIntl("36180BPA").get('36180BPA-000001'), /* 国际化处理： 是否修改组织，这样会清空您录入的信息?*/
