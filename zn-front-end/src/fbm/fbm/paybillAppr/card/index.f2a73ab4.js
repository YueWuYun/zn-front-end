...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/fbm/paybillAppr/card/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"));
	else
		root["fbm/fbm/paybillAppr/card/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"]);
...
/** 模块编码 */
var APP_CODE = exports.APP_CODE = "36180PBR_APPR";
/** 单据类型 */
var BILL_TYPE = exports.BILL_TYPE = "36HC";
/** 列表页面主键 ID */
var PRIMARY_ID = exports.PRIMARY_ID = "pk_paybill";
/** 打印模板节点标识nodekey */
var NODE_KEY = exports.NODE_KEY = "36180PBRPRINTNEWA";
 ...
 */
/** 页面编码 */
var CARD_PAGE_CODE = exports.CARD_PAGE_CODE = "36180PBR_APPR_C01";
/** 表头编码 */
...
var _afterEvent = __webpack_require__(631);

var _beforeEvent = __webpack_require__(632);

var _bodyButtonClick = __webpack_require__(633);

var _buttonClick = __webpack_require__(332);

var _buttonVisiable = __webpack_require__(634);

var _pageInfoClick = __webpack_require__(635);

var _initTemplate = __webpack_require__(636);
...
var _commonUtil = __webpack_require__(201);
...
function buttonClick(props, id) {
  ...
  switch (id) {
    ...
    case _constant.BTN_CARD.UN_COMMIT:
      ...
      doAjaxAndReturn.call(this, props, this.props.MutiInit.getIntl("36180PBR_APPR") && this.props.MutiInit.getIntl("36180PBR_APPR").get('36180PBR_APPR-000006'), _constant.URL_LIST.UN_COMMIT); /* 国际化处理： 收回成功！*/
      break;

    //制证
    case _constant.BTN_CARD.MAKE_VOUCHER:
      doAjaxAndReturn.call(this, props, this.props.MutiInit.getIntl("36180PBR_APPR") && this.props.MutiInit.getIntl("36180PBR_APPR").get('36180PBR_APPR-000007'), _constant.URL_LIST.VOUCHER); /* 国际化处理： 制证成功！*/
      break;

    //取消制证
    case _constant.BTN_CARD.VOUCHER_CANCEL:
      doAjaxAndReturn.call(this, props, this.props.MutiInit.getIntl("36180PBR_APPR") && this.props.MutiInit.getIntl("36180PBR_APPR").get('36180PBR_APPR-000008'), /* 国际化处理： 取消制证成功！*/
      _constant.URL_LIST.VOUCHER_CANCEL);
      break;

    //发送指令
    case _constant.BTN_CARD.SEND_CMD:
      doAjaxAndReturn.call(this, props, this.props.MutiInit.getIntl("36180PBR_APPR") && this.props.MutiInit.getIntl("36180PBR_APPR").get('36180PBR_APPR-000009'), _constant.URL_LIST.SEND_CMD); /* 国际化处理： 发送指令成功！*/
      break;

    //撤回指令
    case _constant.BTN_CARD.WITHDRAW_CMD:
      doAjaxAndReturn.call(this, props, this.props.MutiInit.getIntl("36180PBR_APPR") && this.props.MutiInit.getIntl("36180PBR_APPR").get('36180PBR_APPR-000010'), /* 国际化处理： 撤销指令成功！*/
    ...
    case _constant.BTN_CARD.CANCEL_DISABLE:
      doAjaxAndReturn.call(this, props, this.props.MutiInit.getIntl("36180PBR_APPR") && this.props.MutiInit.getIntl("36180PBR_APPR").get('36180PBR_APPR-000011'), /* 国际化处理： 取消作废成功！*/
...
function doDelete(props) {
  ...
  var successCallback = function successCallback(res) {
    (0, _ncLightappFront.toast)({ color: "success", content: this.props.MutiInit.getIntl("36180PBR_APPR") && this.props.MutiInit.getIntl("36180PBR_APPR").get('36180PBR_APPR-000013') }); /* 国际化处理： 删除成功!*/
  ...
  var successCallback = function successCallback(res) {
    if (res.success) {
      ...
      if ("_LinkVouchar2019" == srcCode) {
        ...
        (0, _ncLightappFront.toast)({ color: "warning", content: this.props.MutiInit.getIntl("36180PBR_APPR") && this.props.MutiInit.getIntl("36180PBR_APPR").get('36180PBR_APPR-000018') }); /* 国际化处理： 未查到凭证*/
        return;
      }
    }
  };
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            createBillHeadInfo({
                                title: this.props.MutiInit.getIntl("36180PBR_APPR") && this.props.MutiInit.getIntl("36180PBR_APPR").get("36180PBR_APPR-000020") /* 国际化处理： 付票登记*/
                ...
                compositedisplay && _react2.default.createElement(ApprovalTrans, {
                    title: this.props.MutiInit.getIntl("36180PBR_APPR") && this.props.MutiInit.getIntl("36180PBR_APPR").get("36180PBR_APPR-000021") /* 国际化处理： 指派*/
                    , data: compositedata,
                ...
                _react2.default.createElement(_DisabledCom2.default, {
                    ...
                    title: this.props.MutiInit.getIntl("36180PBR_APPR") && this.props.MutiInit.getIntl("36180PBR_APPR").get("36180PBR_APPR-000022") /* 国际化处理： 作废原因*/
...
function doPkOrgEvent(props, data, isInit) {
  ...
  if (newvalue == oldvalue) {
    ...
    if (!oldvalue) {
      ...
      (0, _ncLightappFront.promptBox)({
        color: "warning",
        title: this.props.MutiInit.getIntl("36180PBR_APPR") && this.props.MutiInit.getIntl("36180PBR_APPR").get('36180PBR_APPR-000000'), /* 国际化处理： 确认修改*/
        content: this.props.MutiInit.getIntl("36180PBR_APPR") && this.props.MutiInit.getIntl("36180PBR_APPR").get('36180PBR_APPR-000001'), /* 国际化处理： 是否修改组织，这样会清空您录入的信息?*/
