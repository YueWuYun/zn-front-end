...
class List extends Component {
    ...
    render() {
        ...
        let mutiInit = this.props.MutiInit.getIntl("36180PBR_APPR");
        ...
        return (
            <div className="nc-bill-list">
                    ...
                    {NCCreateSearch(
                        LIST_SEARCH_CODE, //模块id
                        {
                            clickSearchBtn: searchButtonClick.bind(
                                this,
                                mutiInit && mutiInit.get("36180PBR_APPR-000037")
                            ), //   点击按钮事件/* 国际化处理： 查询成功*/
                ...
                <div className="tab-definInfo-area">
                    ...
                    >
                        ...
                        <NCTabPane
                            key={"0"}
                            tab={
                                mutiInit && mutiInit.get("36180PBR_APPR-000040")
                            }
                        />
                        /* 国际化处理： 全部*/
                    </NCTabs>
                ...
                {compositedisplay && (
                    <ApprovalTrans
                        title={
                            mutiInit && mutiInit.get("36180PBR_APPR-000021")
                        } /* 国际化处理： 指派*/
                        data={compositedata}
                ...
                <div>
                    <DisabledCom
                        ...
                        title={
                            mutiInit && mutiInit.get("36180PBR_APPR-000022")
                        } /* 国际化处理： 作废原因*/
