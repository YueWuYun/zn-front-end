...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/fbm/paybillAppr/listlinkq/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"));
	else
		root["fbm/fbm/paybillAppr/listlinkq/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"]);
...
var _searchButtonClick = __webpack_require__(340);
...
var _events = __webpack_require__(654);

var _buttonClick = __webpack_require__(339);
...
var List = (_temp = _class = function (_Component) {
    ...
    _createClass(List, [{
        ...
        value: function render() {
            ...
            var mutiInit = this.props.MutiInit.getIntl("36180PBR_APPR");
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    {
                        clickSearchBtn: _events.searchButtonClick.bind(this, mutiInit && mutiInit.get("36180PBR_APPR-000037")), //   点击按钮事件/* 国际化处理： 查询成功*/
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(NCTabPane, {
                            key: "-1",
                            tab: mutiInit && mutiInit.get("36180PBR_APPR-000038") /* 国际化处理： 待提交*/ + "(" + (numvalues && numvalues.NOT_COMMIT || 0) + ")"
                        }),
                        _react2.default.createElement(NCTabPane, {
                            key: "2,3",
                            tab: mutiInit && mutiInit.get("36180PBR_APPR-000039") /* 国际化处理： 审批中*/ + "(" + (numvalues && numvalues.IN_APPROVE || 0) + ")"
                        }),
                        _react2.default.createElement(NCTabPane, {
                            key: "0",
                            tab: mutiInit && mutiInit.get("36180PBR_APPR-000040")
                        }),
                        "/* \u56FD\u9645\u5316\u5904\u7406\uFF1A \u5168\u90E8*/"
                    )
                ),
                ...
                compositedisplay && _react2.default.createElement(ApprovalTrans, {
                    title: mutiInit && mutiInit.get("36180PBR_APPR-000021") /* 国际化处理： 指派*/
                    , data: compositedata,
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_DisabledCom2.default, {
                        ...
                        title: mutiInit && mutiInit.get("36180PBR_APPR-000022") /* 国际化处理： 作废原因*/
...
var _bodyButtonClick = __webpack_require__(338);

var _buttonClick = __webpack_require__(339);

var _buttonVisiable = __webpack_require__(655);

var _pageInfoClick = __webpack_require__(656);

var _searchButtonClick = __webpack_require__(340);

var _initTemplate = __webpack_require__(657);
