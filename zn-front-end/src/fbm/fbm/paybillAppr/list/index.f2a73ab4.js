...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/fbm/paybillAppr/list/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"));
	else
		root["fbm/fbm/paybillAppr/list/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"]);
...
var BatchToast = exports.BatchToast = function BatchToast(op, status, total, successIndex, failIndex, message, content, props) {
  var operate = "";
  var mutiInit = props.MutiInit.getIntl("36180PBR_APPR");
  if (op === "DELETE") {
  ...
  var title = operate + mutiInit && mutiInit.get('36180PBR_APPR-000050'); /* 国际化处理： 完毕*/
  var color = "success";
  ...
  if (!content) {
    content = mutiInit && mutiInit.get('36180PBR_APPR-000054') + /* 国际化处理： 共*/
    operate + total + mutiInit && mutiInit.get('36180PBR_APPR-000055') + /* 国际化处理： 条*/
    "," + mutiInit && mutiInit.get('36180PBR_APPR-000056') + /* 国际化处理： 成功*/
    successIndex + mutiInit && mutiInit.get('36180PBR_APPR-000055') + /* 国际化处理： 条*/
    "," + mutiInit && mutiInit.get('36180PBR_APPR-000057') + /* 国际化处理： 失败*/
    failIndex + mutiInit && mutiInit.get('36180PBR_APPR-000055'); /* 国际化处理： 条*/
  }
...
function bodyButtonClick(props, key, text, record, index) {
  ...
  switch (key) {
    ...
    // 收回
    case "InnerUnCommit":
      doListInnerAjaxAndReturn.call(this, props, record, index, this.props.MutiInit.getIntl("36180PBR_APPR") && this.props.MutiInit.getIntl("36180PBR_APPR").get('36180PBR_APPR-000006'), /* 国际化处理： 收回成功！*/
      _constant.URL_LIST.UN_COMMIT);
      break;
    // 制证
    case "InnerMakeVoucher":
      doListInnerAjaxAndReturn.call(this, props, record, index, this.props.MutiInit.getIntl("36180PBR_APPR") && this.props.MutiInit.getIntl("36180PBR_APPR").get('36180PBR_APPR-000007'), /* 国际化处理： 制证成功！*/
      _constant.URL_LIST.VOUCHER);
      break;
    //取消制证
    case "InnerCancelVoucher":
      doListInnerAjaxAndReturn.call(this, props, record, index, this.props.MutiInit.getIntl("36180PBR_APPR") && this.props.MutiInit.getIntl("36180PBR_APPR").get('36180PBR_APPR-000008'), /* 国际化处理： 取消制证成功！*/
    ...
    case "InnerCancelDisable":
      doListInnerAjaxAndReturn.call(this, props, record, index, this.props.MutiInit.getIntl("36180PBR_APPR") && this.props.MutiInit.getIntl("36180PBR_APPR").get('36180PBR_APPR-000011'), /* 国际化处理： 取消作废成功！*/
      _constant.URL_LIST.CANCEL_DISABLE);
      break;
    // 发送指令
    case "InnerSendCmd":
      doListInnerAjaxAndReturn.call(this, props, record, index, this.props.MutiInit.getIntl("36180PBR_APPR") && this.props.MutiInit.getIntl("36180PBR_APPR").get('36180PBR_APPR-000009'), /* 国际化处理： 发送指令成功！*/
      _constant.URL_LIST.SEND_CMD);
      break;
    // 撤回指令
    case "InnerWithdrawCmd":
      doListInnerAjaxAndReturn.call(this, props, record, index, this.props.MutiInit.getIntl("36180PBR_APPR") && this.props.MutiInit.getIntl("36180PBR_APPR").get('36180PBR_APPR-000023'), /* 国际化处理： 撤回指令成功！*/
...
var _messageUtil = __webpack_require__(228);

var _searchButtonClick = __webpack_require__(337);
...
function doDelete(props) {
  ...
  if (selectedData.length == 0) {
    (0, _ncLightappFront.toast)({ color: "warning", content: this.props.MutiInit.getIntl("36180PBR_APPR") && this.props.MutiInit.getIntl("36180PBR_APPR").get('36180PBR_APPR-000026') }); /* 国际化处理： 请选择至少一条数据！*/
    return;
 ...
 */
function doRefresh() {
  _searchButtonClick.searchButtonClick.call(this, this.props.MutiInit.getIntl("36180PBR_APPR") && this.props.MutiInit.getIntl("36180PBR_APPR").get('36180PBR_APPR-000019')); /* 国际化处理： 刷新成功！*/
}
      ...
      if (success) {
        ...
        if (data.numvalues) {
          ...
          if (parseInt(data.numvalues.ALL) < 1) {
            (0, _ncLightappFront.toast)({ color: "warning", content: _this.props.MutiInit.getIntl("36180PBR_APPR") && _this.props.MutiInit.getIntl("36180PBR_APPR").get('36180PBR_APPR-000035') }); /* 国际化处理： 未查询出数据！*/
          } else {
...
var _buttonClick = __webpack_require__(336);
    ...
    _createClass(List, [{
        ...
        value: function getAssginUserCard(userObj) {
            ...
            if (selectDatas && selectDatas.length > 0) {
                ...
                (0, _ncLightappFront.toast)({
                    color: "waring",
                    content: this.props.MutiInit.getIntl("36180PBR_APPR") && this.props.MutiInit.getIntl("36180PBR_APPR").get("36180PBR_APPR-000036") /* 国际化处理： 指派传参，获取pk失败！*/
                });
                return;
            }
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    {
                        clickSearchBtn: _events.searchButtonClick.bind(this, this.props.MutiInit.getIntl("36180PBR_APPR") && this.props.MutiInit.getIntl("36180PBR_APPR").get("36180PBR_APPR-000037")), //   点击按钮事件/* 国际化处理： 查询成功*/
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(NCTabPane, {
                            key: "-1",
                            tab: this.props.MutiInit.getIntl("36180PBR_APPR") && this.props.MutiInit.getIntl("36180PBR_APPR").get("36180PBR_APPR-000038") /* 国际化处理： 待提交*/ + "(" + (numvalues && numvalues.NOT_COMMIT || 0) + ")"
                        }),
                        _react2.default.createElement(NCTabPane, {
                            key: "2,3",
                            tab: this.props.MutiInit.getIntl("36180PBR_APPR") && this.props.MutiInit.getIntl("36180PBR_APPR").get("36180PBR_APPR-000039") /* 国际化处理： 审批中*/ + "(" + (numvalues && numvalues.IN_APPROVE || 0) + ")"
                        }),
                        _react2.default.createElement(NCTabPane, {
                            key: "0",
                            tab: this.props.MutiInit.getIntl("36180PBR_APPR") && this.props.MutiInit.getIntl("36180PBR_APPR").get("36180PBR_APPR-000040")
                        }),
                        "/* \u56FD\u9645\u5316\u5904\u7406\uFF1A \u5168\u90E8*/"
                    )
                ),
...
var _bodyButtonClick = __webpack_require__(335);

var _buttonClick = __webpack_require__(336);

var _buttonVisiable = __webpack_require__(650);

var _pageInfoClick = __webpack_require__(651);

var _searchButtonClick = __webpack_require__(337);

var _initTemplate = __webpack_require__(652);
  ...
  props.createUIDom({
    ...
    if (data) {
      ...
      if (data.button) {
        ...
        props.button.setPopContent('InnerDelete', _this.props.MutiInit.getIntl("36180PBR_APPR") && _this.props.MutiInit.getIntl("36180PBR_APPR").get('36180PBR_APPR-000029')); /* 国际化处理： 确定要删除吗?*/
      }
      if (data.template) {
        var meta = data.template;
        //高级查询区域加载默认业务单元
