...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/fbm/bankback/card/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/fbm/bankback/card/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
//小应用编码
var app_code = exports.app_code = '36180BR';
//联查小应用编码
var link_app_code = exports.link_app_code = '36180BRL';
//审批小应用编码
var approve_app_code = exports.approve_app_code = '36180BRA';
//请求基础路径
var base_path = exports.base_path = '/nccloud/fbm/bankback';
//按钮平铺显示数量
var button_limit = exports.button_limit = 3;
//打印输出编码
var nodekey = exports.nodekey = '36180brprint';
//联查预算aggVO
var fullAggClassName = exports.fullAggClassName = 'nc.vo.fbm.storage.AggStorageVO';
//商业汇票基础模块code
var modulecode = exports.modulecode = '3618';
//单据类型
var billtype = exports.billtype = '36H4';
// 作废原因区域
...
var LIST = exports.LIST = {
    disabled_btn: ['Delete', 'Copy', 'Balance', 'ApproveDetail', 'Commit', 'Uncommit', 'MakeVoucher', 'Print', 'Output', 'Attachment', 'Voucher', 'LinkBudgetPlan'], //默认禁用按钮
...
//缓存标示
var DATA_SOURCE = exports.DATA_SOURCE = 'tm.fbm.bankback.datasource';
...
var _afterEvent = __webpack_require__(394);

var _afterTableEvent = __webpack_require__(395);

var _bodyButtonClick = __webpack_require__(272);

var _bodySelectedEvent = __webpack_require__(396);

var _buttonVisible = __webpack_require__(273);

var _initTemplate = __webpack_require__(397);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(398);

var _initTemplate4 = _interopRequireDefault(_initTemplate3);

var _initTemplate5 = __webpack_require__(399);
...
var _constant = __webpack_require__(212);
    ...
    if (!id) {
      ...
      switch (vbillstatus) {
        ...
        case "1":
          ...
          if (voucher) {
            showBtn = ["Add", "Copy", "CancelVoucher", "Voucher"].concat(_toConsumableArray(commonBtn));
          } else {
            showBtn = ["Add", "Copy", "Uncommit", "MakeVoucher"].concat(_toConsumableArray(commonBtn));
          }
          //设置新增按钮为灰，提交为红色
  ...
  _createClass(Card, [{
    ...
    value: function render() {
      return _react2.default.createElement(_BaseCard2.default, _extends({
        ...
        constant: {
          modulecode: _constant.modulecode, //商业汇票模块编码
          pageId: _constant.CARD.page_id, //卡片页面的应用编码，用以跳转页面传参
          listPageCode: _constant.LIST.page_id, //列表页面的应用编码
          formId: _constant.CARD.form_id, //卡片表头区域编码
          primaryId: _constant.CARD.primary_id, //当前单据的元数据主键字段名称
          billNo: _constant.CARD.billno, //单据编号字段名称
          dataSource: _constant.DATA_SOURCE, //缓存key
          tabCode: _constant.CARD.tab_code, //卡片子表列表区域code编码
          ...
          disableReason: _constant.disableReason, //作废区域编码
        ...
        pageTitle: this.props.MutiInit.getIntl("36180BR") && this.props.MutiInit.getIntl("36180BR").get("36180BR-000003") //页面标题/* 国际化处理： 银行领用*/
...
function afterEvent(props, moduleId, key, value, oldValue) {
  ...
  if (key === "pk_org") {
    ...
    if (!oldValue || !oldValue.value) {
      ...
      (0, _ncLightappFront.promptBox)({
        color: "warning",
        title: this.props.MutiInit.getIntl("36180BR") && this.props.MutiInit.getIntl("36180BR").get("36180BR-000000") /* 国际化处理： 修改财务组织*/
        , content: this.props.MutiInit.getIntl("36180BR") && this.props.MutiInit.getIntl("36180BR").get("36180BR-000001") /* 国际化处理： 确认修改财务组织, 这样会清空您录入的信息?*/
...
function modifierMeta(meta) {
  ...
  meta[_constant.CARD.tab_code].items.map(function (item) {
    if (item.attrcode == "pk_register") {
      ...
      item.queryCondition = function () {
        var guaData = _this2.props.cardTable.getColValue(_constant.CARD.tab_code, "pk_register").filter(function (item) {
        ...
        return {
          ...
          GridRefActionExt: "nccloud.web.fbm.fbm.bankback.filter.BankbackRegisterStatusFilter"
        };
      };
    }
  });
  ...
  try {
    for (var _iterator = Object.keys(meta.gridrelation)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      meta[item].items.push({
        attrcode: "opr",
        label: this.props.MutiInit.getIntl("36180BR") && this.props.MutiInit.getIntl("36180BR").get("36180BR-000002") /* 国际化处理： 操作*/
        , itemtype: "customer",
        fixed: "right",
        className: "table-opr",
        visible: true,
