...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/fbm/bankback/list/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/fbm/bankback/list/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
var _buttonDisable = __webpack_require__(401);
...
var _constant2 = __webpack_require__(212);
...
var List = function (_Component) {
  ...
  function List(props) {
    ...
    _this.myRenderCompleteEvent = function () {
      var muti = this.props.MutiInit.getIntl("36180BR");
      var money = muti && muti.get("36180BR-000010"); /* 国际化处理： 票据金额*/
      var start = muti && muti.get("36180BR-000011"); /* 国际化处理： 开始*/
      var end = muti && muti.get("36180BR-000012"); /* 国际化处理： 结束*/
      this.props.search.setTemlateByField(this.searchId, "glgx.pk_register.money", "defaultPlaceholder", { start: money + start, end: money + end });
    ...
    value: function render() {
      var tabs = {
        ...
        items: [{
          key: "-1",
          name: "numZY",
          title: this.props.MutiInit.getIntl("36180BR") && this.props.MutiInit.getIntl("36180BR").get("36180BR-000006") /* 国际化处理： 待提交*/
        }, {
          key: "2,3",
          name: "numTJ",
          title: this.props.MutiInit.getIntl("36180BR") && this.props.MutiInit.getIntl("36180BR").get("36180BR-000007") /* 国际化处理： 审批中*/
        }, {
          key: "all",
          title: this.props.MutiInit.getIntl("36180BR") && this.props.MutiInit.getIntl("36180BR").get("36180BR-000008") /* 国际化处理： 全部*/
        }],
      ...
      return _react2.default.createElement(_BaseList2.default, _extends({
        ...
        constant: {
          modulecode: _constant2.modulecode, //商业汇票模块编码
          cardPageCode: _constant.CARD.page_id, //卡片页面的应用编码，用以跳转页面传参
          searchId: _constant2.LIST.search_id, //列表查询区域编码，用以获取查询条件
          tableId: _constant2.LIST.table_id, //列表表格区域编码，用以获取多选选中数据
          pageId: _constant2.LIST.page_id, //列表页面的应用编码
          nodekey: _constant2.nodekey, //打印输出编码
          dataSource: _constant2.DATA_SOURCE, //设置页面使用的页面缓存key
          searchCache: _constant2.searchCache, //设置列表页面中查询区缓存
          // oid: LIST.search_oid, //查询区的数据库中的主键
          primaryId: _constant2.LIST.primary_id, //当前单据的元数据主键字段名称
          billNo: _constant2.LIST.billno, //单据编号字段名称
          modelname: _constant2.modelname, //商业汇票模块名称
          billstatus: _constant2.LIST.billstatus, //单据状态字段名称
          ...
          fullAggClassName: _constant2.fullAggClassName, //联查预算全类名
          disableReason: _constant2.disableReason, //作废区域编码
        ...
        , pageTitle: this.props.MutiInit.getIntl("36180BR") && this.props.MutiInit.getIntl("36180BR").get("36180BR-000003") //页面标题
        , headBtnArea: _constant2.LIST.head_btn_code //列表肩部按钮区域编码
...
List = (0, _ncLightappFront.createPage)({
  mutiLangCode: _constant2.app_code
})(List);
  ...
  props.createUIDom({
    ...
    if (data) {
      if (data.button) {
        ...
        props.button.setButtons(button);
        props.button.setPopContent("DeleteInner", _this.props.MutiInit.getIntl("36180BR") && _this.props.MutiInit.getIntl("36180BR").get("36180BR-000004")); /* 国际化处理： 确认要删除吗?*/
        props.button.setPopContent("terminate", _this.props.MutiInit.getIntl("36180BR") && _this.props.MutiInit.getIntl("36180BR").get("36180BR-000005")); /* 国际化处理： 确认要终止吗?*/
...
var _index2 = __webpack_require__(274);
