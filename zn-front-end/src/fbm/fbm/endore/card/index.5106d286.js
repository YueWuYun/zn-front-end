...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/fbm/endore/card/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"));
	else
		root["fbm/fbm/endore/card/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"]);
 ...
 */
var EmptyAreaValue = exports.EmptyAreaValue = function EmptyAreaValue(areaCode, formCode, containsAttrcode) {
  var meta = this.props.meta.getMeta();
  var attrcodes = {};
  meta[areaCode].items.forEach(function (item) {
    var attrcode = item.attrcode;
    if (containsAttrcode != undefined && containsAttrcode != "" && containsAttrcode.length > 0) {
...
//小应用ID(??, 多语使用)
var MODULE_ID = exports.MODULE_ID = '36180ET';
/** 模块编码 */
...
var URI = exports.URI = {
	...
	headbefore: BASE_URL + 'headbefore.do' //编辑前
};
...
var LIST = exports.LIST = {
	btnCode: 'list_head', //列表页面按钮区域 code
	searchCode: 'search', // 列表页面查询区域 code
	tableCode: 'table', // 列表页面表格区域 code
	bodyCode: 'list_inner', //列表页面表格区域按钮 code
	disableNote: 'disablenote', // 作废原因区域 code

	pageCode: '36180ET_LIST', //列表页面 code
	pageCode_link: '36180ET_LIST_LINK', //联查页面 code
	primaryId: 'pk_endore', //列表页面主键 ID
	tabStatus: ['-1', '0', 'all'] //状态页签的 key
};
...
var LIST_BTN = exports.LIST_BTN = {
	...
	commandSend: 'BankSend', // 指令发送
	commandCancel: 'BankBack', // 指令撤回

	nullify: 'Disable', // 作废
	nullifyCancel: 'UnDisable', // 取消作废
...
var LIST_BODY_BTN = exports.LIST_BODY_BTN = {

	edit: 'edit_inner', // 修改
	delete: 'del_inner', // 删除

	commit: 'commit_inner', // 提交
	uncommit: 'uncommit_inner', // 收回

	voucherMake: 'voucher_inner', // 制证
	voucherCancel: 'unVoucher_inner', // 取消制证

	commandSend: 'bankSend_inner', // 指令发送
	commandCancel: 'bankBack_inner', // 指令撤回

	nullify: 'disable_inner', // 作废
	nullifyCancel: 'unDisable_inner' // 取消作废
};
var CARD_BTN = exports.CARD_BTN = {
	...
	commandSend: 'CommandSend', // 指令发送
	commandCancel: 'CommandCancel', // 指令撤回

	nullify: 'Nullify', // 作废
	nullifyCancel: 'NullifyCancel', // 取消作废
...
exports.setHeadItemProp = undefined;
...
exports.getAssginUserCard = exports.compositeTurnOff = exports.billInitDataRule = exports.pageInfoClick = exports.setEditStatus = exports.afterEvent = exports.beforeEvent = exports.confirmOfDisableOnCard = exports.buttonClick = exports.buttonVisible = exports.initTemplate1 = exports.initTemplate = undefined;

var _initTemplate = __webpack_require__(522);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(523);

var _buttonVisible = __webpack_require__(524);

var _buttonVisible2 = _interopRequireDefault(_buttonVisible);

var _buttonClick = __webpack_require__(525);

var _beforeEvent = __webpack_require__(526);

var _beforeEvent2 = _interopRequireDefault(_beforeEvent);

var _afterEvent = __webpack_require__(300);

var _afterEvent2 = _interopRequireDefault(_afterEvent);

var _eventsUtils = __webpack_require__(527);

var _pageInfoClick = __webpack_require__(528);

var _pageInfoClick2 = _interopRequireDefault(_pageInfoClick);

var _billRule = __webpack_require__(299);

var _approvalEvent = __webpack_require__(529);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.initTemplate = _initTemplate2.default;
exports.initTemplate1 = _initTemplate3.initTemplate1;
...
var _commonUtil = __webpack_require__(199);
	...
	if (data) {
		...
		var getDataCallback = function getDataCallback(res) {
			if (res.data.head) {
				...
				this.props.form.setFormItemsDisabled(_constant.CARD.formHeadCode, { 'endorserbankacc': true });
				// 先把被背书单位账户设为不可编辑，勾选网银后才能编辑
				this.props.form.setFormItemsDisabled(_constant.CARD.formHeadCode, { 'endorseebankacc': true });
				// 勾选网银后才能编辑
				this.props.form.setFormItemsDisabled(this.formId, {
					'banksubcompany': true
				});
				...
				var userJsonObj = JSON.parse(res.data.userjson);
				if (userJsonObj && userJsonObj.ISEBILL && 'true' == userJsonObj.ISEBILL) {
					// 是电票，设置网银可编辑
					this.props.form.setFormItemsDisabled(_constant.CARD.formHeadCode, { 'onlinebankflag': false });
					var onlinebankflag = this.props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'onlinebankflag') && this.props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'onlinebankflag').value;
					if (onlinebankflag) {
						// 勾选网银后才能编辑同行标志设
						this.props.form.setFormItemsDisabled(_constant.CARD.formHeadCode, { 'issamebank': false });
						// 勾选网银后才能编辑背书单位账户
						this.props.form.setFormItemsDisabled(_constant.CARD.formHeadCode, { 'endorserbankacc': false });
						// 勾选网银后才能编辑被背书单位账户
						this.props.form.setFormItemsDisabled(_constant.CARD.formHeadCode, { 'endorseebankacc': false });
						// 接口行,勾选网银后才能编辑
						this.props.form.setFormItemsDisabled(_constant.CARD.formHeadCode, {
...
var copyFormValues = function copyFormValues(id) {
	...
	var getDataCallback = function getDataCallback(res) {
		if (res.data.head) {
			...
			var endorserbankacc = values['endorserbankacc']; // 背书单位账户
			...
			var copyCallback = function copyCallback(res) {
				...
				if (fieldsEditable) {
					...
					_commonUtil.setHeadItemProp.call(this, this.props, _constant.CARD.formHeadCode, items);
				}
			};
...
var _commonUtil2 = __webpack_require__(199);

var _EmptyAreaValueUtil = __webpack_require__(157);
			...
			if (!oldvalue.value) {
				...
				(0, _ncLightappFront.promptBox)({
					...
					cancelBtnClick: function cancelBtnClick() {
						return _this.props.form.setFormItemsValue(moduleId, { pk_org: oldvalue });
					}
				});
			}
		}
...
function changeOrgConfirm(eventdata, value) {
	this.props.form.setFormItemsValue(_constant.CARD.formHeadCode, { 'note': { value: '', display: '' } });
	this.props.form.EmptyAllFormValue(_constant.CARD.formHeadCode);
...
function getNewOrgInfo(eventdata) {
	...
	getDataAfterEvent.call(this, eventdata, function (res) {
		...
		//选择主组织以后，恢复其他字段的编辑性
		_this2.props.resMetaAfterPkorgEdit();
		// 先把网银标志设为不可编辑，票据为电票时才能编辑
		_this2.props.form.setFormItemsDisabled(_constant.CARD.formHeadCode, { 'onlinebankflag': true });
		// 先把同行标志设为不可编辑，勾选网银后才能编辑
		_this2.props.form.setFormItemsDisabled(_constant.CARD.formHeadCode, { 'issamebank': true });
		// 勾选网银后才可编辑
		_this2.props.form.setFormItemsDisabled(_constant.CARD.formHeadCode, {
			'banksubcompany': true
		});
		// 控制字段的编辑性
		var fieldsEditable = res.data.fieldsEditable;
		if (fieldsEditable) {
			...
			_commonUtil2.setHeadItemProp.call(_this2, _this2.props, _constant.CARD.formHeadCode, items);
		}
	});
}
...
function pk_registerAfterEdit(moduleId, key, value, oldvalue) {
	...
	if ((0, _commonUtil.isEmptyObject)(value.values)) {
		...
		_EmptyAreaValueUtil.EmptyAreaValue.call(this, _constant.CARD.billBasicInfoCode, _constant.CARD.formHeadCode);
		_EmptyAreaValueUtil.EmptyAreaValue.call(this, _constant.CARD.clearInfoCode, _constant.CARD.formHeadCode);
		this.props.form.setFormItemsDisabled(_constant.CARD.formHeadCode, {
			pk_outorg: true,
			pk_outorg_inneracc: true,
			pk_outpayorg: true,
	...
	if (value.value !== oldvalue.value) {
		getDataAfterEvent.call(this, eventdata, function (res) {
			...
			// 票据类型为电票时，网银标识可编辑
			if (isEbill == true) {
				_this3.props.form.setFormItemsDisabled(_constant.CARD.formHeadCode, { 'onlinebankflag': false });
				// 电票时被背书单位账户必填
				_this3.props.form.setFormItemsDisabled(_constant.CARD.formHeadCode, { 'endorseebankacc': false });
				_this3.props.form.setFormItemsRequired(_constant.CARD.formHeadCode, { 'endorseebankacc': true });
			} else {
				// 不为电票时清空网银相关值
				_this3.props.form.setFormItemsValue(_constant.CARD.formHeadCode, { 'endorserbankacc': { value: '', display: '' } });
				_this3.props.form.setFormItemsValue(_constant.CARD.formHeadCode, { 'endorseebankacc': { value: '', display: '' } });
				_this3.props.form.setFormItemsValue(_constant.CARD.formHeadCode, { 'banksubcompany': { value: '', display: '' } });
				_this3.props.form.setFormItemsValue(_constant.CARD.formHeadCode, { 'issamebank': { value: '', display: '' } });
				_this3.props.form.setFormItemsValue(_constant.CARD.formHeadCode, { 'onlinebankflag': { value: '', display: '' } });
				// 非电票不可勾选网银
				_this3.props.form.setFormItemsDisabled(_constant.CARD.formHeadCode, { 'onlinebankflag': true });
				// 同行标志，取消勾选网银后不能编辑
				_this3.props.form.setFormItemsDisabled(_constant.CARD.formHeadCode, { 'issamebank': true });
				// 背书单位账户，取消勾选网银后不能编辑
				_this3.props.form.setFormItemsDisabled(_constant.CARD.formHeadCode, { 'endorserbankacc': true });
				// 非电票时被背书单位账户不能编辑
				_this3.props.form.setFormItemsDisabled(_constant.CARD.formHeadCode, { 'endorseebankacc': true });
				_this3.props.form.setFormItemsRequired(_constant.CARD.formHeadCode, { 'endorseebankacc': false });
				// 接口行,取消勾选网银后不能编辑
				_this3.props.form.setFormItemsDisabled(_constant.CARD.formHeadCode, {
					'banksubcompany': true
				});
			}
			//设置汇率编辑性
			...
			if (fieldsEditable) {
				...
				_commonUtil2.setHeadItemProp.call(_this3, _this3.props, _constant.CARD.formHeadCode, items);
			}
		});
	}
}
...
function olcrateAfterEdit(moduleId, key, value, oldvalue) {
	...
	if (value.value !== oldvalue.value) {
		getDataAfterEvent.call(this, eventdata, function (res) {
			_this4.props.form.setAllFormValue(_defineProperty({}, _constant.CARD.formHeadCode, res.data.card && res.data.card.head[_constant.CARD.formHeadCode]));
		});
	}
}
...
function busdateAfterEdit(moduleId, key, value, oldvalue) {
	...
	if (value.value !== oldvalue.value) {
		getDataAfterEvent.call(this, eventdata, function (res) {
			_this5.props.form.setAllFormValue(_defineProperty({}, _constant.CARD.formHeadCode, res.data.card && res.data.card.head[_constant.CARD.formHeadCode]));
		});
	}
}
...
function onlinebankflagAfterEdit(moduleId, key, value, oldvalue) {
	...
	if (value.value) {
		...
		// 清空网银相关值
		this.props.form.setFormItemsValue(_constant.CARD.formHeadCode, { 'endorserbankacc': { value: '', display: '' } });
		this.props.form.setFormItemsValue(_constant.CARD.formHeadCode, { 'banksubcompany': { value: '', display: '' } });
		this.props.form.setFormItemsValue(_constant.CARD.formHeadCode, { 'issamebank': { value: '', display: '' } });
		// 同行标志，取消勾选网银后不能编辑
		this.props.form.setFormItemsDisabled(_constant.CARD.formHeadCode, { 'issamebank': true });
		// 背书单位账户，取消勾选网银后不能编辑
		this.props.form.setFormItemsDisabled(_constant.CARD.formHeadCode, { 'endorserbankacc': true });
...
function opbilltypeAfterEdit(moduleId, key, value, oldvalue) {
	if (value.value !== oldvalue.value) {
		...
		// 清空了票据信息
		_EmptyAreaValueUtil.EmptyAreaValue.call(this, _constant.CARD.billBasicInfoCode, _constant.CARD.formHeadCode, "pk_register.");
		this.props.form.setFormItemsDisabled(_constant.CARD.formHeadCode, {
			pk_outorg: true,
			pk_outorg_inneracc: true,
			pk_outpayorg: true,
...
var Card = function (_Component) {
    ...
    function Card(props) {
        ...
        _this.handleBackBtnClick = function () {
            if (_this.pageId == _constant.CARD.pageCode_link) {
                _this.props.pushTo("/list", {
                    status: "browse",
                    scene: "linksce",
                    pagecode: _constant.LIST.pageCode_link,
                    backFromCard: true
                });
                //
            } else {
        ...
        _this.controlPartPageDisplay = function () {
            ...
            _index.orgVersionView.call(_this, _this.props, _constant.CARD.formHeadCode);
            if (status === "browse") {
                _this.props.form.setFormStatus(_this.formHeadId, "browse");
                var id = _this.props.getUrlParam("id");
                if (id) {
                ...
                if (status == "copy") {
                    _this.props.form.setFormItemsDisabled(_this.formHeadId, {
                        'pk_org': true
                    });
                } else {
                    _this.props.form.setFormItemsDisabled(_this.formHeadId, {
        ...
        _this.primaryId = "pk_endore"; //主键ID
        ...
        if (_this.props.getUrlParam("scene") === "linksce") {
            _events.initTemplate1.call(_this, props);
        } else {
    ...
    _createClass(Card, [{
        ...
        value: function componentWillMount() {
            ...
            window.onbeforeunload = function () {
                if (!["browse"].includes(_this2.props.getUrlParam("status"))) {
                    return _this2.props.MutiInit.getIntl("36180ET") && _this2.props.MutiInit.getIntl("36180ET").get("36180ET-000021"); /* 国际化处理： 当前单据未保存, 您确定离开此页面？*/
                }
            };
        }
    }, {
        ...
        value: function setUIDisplay() {
            ...
            if (id) {
                // 在缓存中查询id对应数据
                var cardData = getCacheById(id, _constant.DATASOURCE);
                if (cardData) {
                    if (cardData.head) {
                        // 页面赋值
                        this.props.form.setAllFormValue(_defineProperty({}, _constant.CARD.formHeadCode, cardData.head[_constant.CARD.formHeadCode]));
                        this.props.BillHeadInfo.setBillHeadInfoVisible({
                            billCode: cardData.head[_constant.CARD.formHeadCode].rows[0].values.vbillno.value
                        });
                        var status = this.props.getUrlParam("status");
                        // 与数据无关的画面显示
                        ...
                        _events.billInitDataRule.call(this, status, cardData.head[_constant.CARD.formHeadCode]);
                    }
                } else {
                    var getDataCallback = function getDataCallback(res) {
                        if (res.data.head) {
                            ...
                            // 增加缓存
                            updateCache('pk_endore', res.data.head[_constant.CARD.formHeadCode].rows[0].values.pk_endore.value, res.data, _constant.CARD.formHeadCode, _constant.DATASOURCE);
                            this.props.BillHeadInfo.setBillHeadInfoVisible({
                            ...
                            _events.buttonVisible.call(this, this.props);
                            // 根据数据与业务规则，对数据部分画面进行初始化
                            _events.billInitDataRule.call(this, _status, res.data.head[_constant.CARD.formHeadCode]);
                        }
                    };
                    var _cardData = { pk: id };
                    _commonUtil.doAjax.call(this, _cardData, _constant.URI.endoreCardMainQuery, getDataCallback);
                }
            } else {
                var _status2 = this.props.getUrlParam("status");
                // 与数据无关的画面显示
                this.controlPartPageDisplay();
                // 控制按钮显示与数据相关
                _events.buttonVisible.call(this, this.props);
                // 根据数据与业务规则，对数据部分画面进行初始化
                _events.billInitDataRule.call(this, _status2);
            }
        }
    }, {
        key: "render",
        value: function render() {
            ...
            var browseStatus = this.props.getUrlParam("status") === "browse";
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            createBillHeadInfo({
                                title: this.props.MutiInit.getIntl("36180ET") && this.props.MutiInit.getIntl("36180ET").get("36180ET-000022") /* 国际化处理： 背书办理*/
                        ...
                        browseStatus && !isLink && _react2.default.createElement(
                            "div",
                            {
                ...
                disabledComShow && _react2.default.createElement(_DisabledCom2.default, {
                    ...
                    title: this.props.MutiInit.getIntl("36180ET") && this.props.MutiInit.getIntl("36180ET").get("36180ET-000023") /* 国际化处理： 作废原因*/
                ...
                compositedisplay && _react2.default.createElement(ApprovalTrans, {
                    title: this.props.MutiInit.getIntl("36180ET") && this.props.MutiInit.getIntl("36180ET").get("36180ET-000024") /* 国际化处理： 指派*/
                    , data: compositedata,
...
function modifierMeta(meta, props) {
	...
	meta[_constant.CARD.formHeadCode].items.map(function (item) {
		...
		if (item.attrcode === 'pk_register') {
			item.queryCondition = function () {
				...
				var opbilltype = props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'opbilltype') && props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'opbilltype').value;
				return {
					pk_org: pk_org,
	...
	meta[_constant.CARD.onlineBankBillPoolCode].items.map(function (item) {
		if (item.attrcode === 'endorebankacc') {
			item.showHistory = true;
			item.queryCondition = function () {
				return {
					isenableelecbill: 'Y',
					pk_org: props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'pk_org') && props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'pk_org').value,
		...
		if (item.attrcode === 'endorseebankacc') {
			item.showHistory = true;
			item.refName_db = _this2.props.MutiInit.getIntl("36180ET") && _this2.props.MutiInit.getIntl("36180ET").get('36180ET-000064') /* 国际化处理： 客商银行账户*/;
			item.queryCondition = function () {
				return {
					accclass: _this2.state.CUS_SUP_TYPE, // 1=客户银行账户，2=客商银行账户，3=供应商银行账户
					pk_cust: props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'endorsee') && props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'endorsee').value
				};
			};
		}
	});
	//清算信息
	meta[_constant.CARD.clearInfoCode].items.map(function (item) {
		...
		if (item.attrcode === 'pk_outorg_inneracc' || item.attrcode === 'pk_outpayorg_inneracc') {
			//财务组织
			item.queryCondition = function () {
				var pk_org = props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'pk_org');
				var pk_curr = props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'pk_curr');
				return {
...
exports.initTemplate1 = initTemplate1;

var _constant = __webpack_require__(194);

function initTemplate1(props) {
	var _this = this;

	var appcode = props.getSearchParam("c") || props.getUrlParam("c");
	props.createUIDom({
		pagecode: _constant.CARD.pageCode_link, //页面id
		appcode: appcode
	}, function (data) {
		if (data) {
			if (data.template) {
...
// 浏览审批进行中
var BROWSE_APPROVE_ON = [_constant.CARD_BTN.add, _constant.CARD_BTN.copy, _constant.CARD_BTN.uncommit, _constant.CARD_BTN.union, _constant.CARD_BTN.unionBillAccount, _constant.CARD_BTN.unionApprovalDetails, _constant.CARD_BTN.attackment, _constant.CARD_BTN.print, _constant.CARD_BTN.output, _constant.CARD_BTN.refresh];
// 浏览审批通过
var BROWSE_APPROVE_PASS = [_constant.CARD_BTN.add, _constant.CARD_BTN.copy, _constant.CARD_BTN.union, _constant.CARD_BTN.unionBillAccount, _constant.CARD_BTN.unionApprovalDetails, _constant.CARD_BTN.attackment, _constant.CARD_BTN.print, _constant.CARD_BTN.output, _constant.CARD_BTN.refresh];
// 浏览审批未通过
...
// 浏览非手动输入单据
var BROWSE_SYSTEM_BILL = [_constant.CARD_BTN.add, _constant.CARD_BTN.copy, _constant.CARD_BTN.union, _constant.CARD_BTN.unionBillAccount, _constant.CARD_BTN.attackment, _constant.CARD_BTN.print, _constant.CARD_BTN.output, _constant.CARD_BTN.refresh];
function buttonVisible(props) {
	...
	if (status === 'browse') {
		...
		if (status === undefined || status === null || status === '') {
			...
			props.button.setMainButton([_constant.CARD_BTN.add], true);
		} else {
			// 编辑态
			props.button.setMainButton([_constant.CARD_BTN.add], false);
...
var vbillstatusControl = function vbillstatusControl(props) {
	...
	var syscode1 = props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'syscode') && props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'syscode').value;
	props.button.setMainButton([_constant.CARD_BTN.add, _constant.CARD_BTN.commit, _constant.CARD_BTN.commandSend, _constant.CARD_BTN.voucherMake], false);
	// 系统制单
	if (syscode1 != 'INPUT') {
		...
		if (billstatus) {
			if (billstatus != '-1') {
				visibleBtn.push(_constant.CARD_BTN.unionApprovalDetails);
			}
			switch (billstatus) {
				case '-1':
					//自由态
					...
					if (onlinebankflag) {
						...
						if ('1' === paymentstatus) {
							...
							if (nullify) {
								// 已作废
								props.button.setMainButton([_constant.CARD_BTN.add], true);
								visibleBtn.push(_constant.CARD_BTN.nullifyCancel);
							} else {
								// 未作废
								visibleBtn.push(_constant.CARD_BTN.nullify);
								// 支付指令失败且未作废，可以再次发送支付指令
								visibleBtn.push(_constant.CARD_BTN.commandSend);
								props.button.setMainButton([_constant.CARD_BTN.commandSend], true);
							}
							...
							if ((0, _commonUtil.isEmptyObject)(ecdswithdrawstatus) || (0, _commonUtil.isEmptyStr)(ecdswithdrawstatus) || '2' == ecdswithdrawstatus) {
								//撤回指令为空或失败可以发送撤回指令
								visibleBtn.push(_constant.CARD_BTN.commandCancel);
							}
						} else {
							// 支付指令为空，没发过指令
							props.button.setMainButton([_constant.CARD_BTN.commandSend], true);
	...
	if (billstatus) {
		switch (billstatus) {
			case '-1':
				...
				props.button.setMainButton([_constant.CARD_BTN.commit], true);
				break;
			case '0':
				//审批不通过
			...
			case '1':
				//审批通过
				var afterApprove = BROWSE_APPROVE_PASS.slice();
				if (onlinebankflag) {
					// 网银
					if ('1' === paymentstatus) {
						// 支付指令成功
						if (voucher) {
							...
							// 未制证
							props.button.setMainButton([_constant.CARD_BTN.voucherMake], true);
						...
						// 支付指令为空，没发过指令
						props.button.setMainButton([_constant.CARD_BTN.commandSend], true);
						afterApprove.push(_constant.CARD_BTN.uncommit);
						afterApprove.push(_constant.CARD_BTN.commandSend);
					}
				} else {
					// 非网银
...
var doSave = function () {
	var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(props, showToast, isAdd, isCommit) {
		var cardData, result, saveBeforePk, saveCallback;
		return regeneratorRuntime.wrap(function _callee$(_context) {
			while (1) {
				switch (_context.prev = _context.next) {
					case 0:
						...
						saveCallback = function saveCallback(res) {
							if (res.data.head) {
								...
								if (saveBeforePk && saveBeforePk.value) {
									...
									addCache(res.data.head[_constant.CARD.formHeadCode].rows[0].values.pk_endore.value, res.data, _constant.CARD.formHeadCode, _constant.DATASOURCE);
								}
								var tbbMsg = res.data.head[_constant.CARD.formHeadCode].rows[0].values.tbbmessage;
								if (tbbMsg.value) (0, _ncLightappFront.toast)({ color: "warning", content: tbbMsg.value }); //预算提示tbbmessage
								if (showToast) {
									(0, _ncLightappFront.toast)({
										color: 'success',
...
function buttonClick(props, id) {
	...
	switch (id) {
		...
		case _constant.CARD_BTN.save:
			...
			if (saveCheck) {
				var saveAllData = props.form.getAllFormValue(_constant.CARD.formHeadCode);
				var savedata = {
					pageid: _constant.CARD.pageCode,
					model: {
						areacode: _constant.CARD.formHeadCode,
		...
		case _constant.CARD_BTN.saveAdd:
			saveCheck = beforeSave.call(this, props);
			if (saveCheck) {
				var _saveAllData = props.form.getAllFormValue(_constant.CARD.formHeadCode);
				var _savedata = {
					pageid: _constant.CARD.pageCode,
					model: {
						areacode: _constant.CARD.formHeadCode,
						rows: _saveAllData.rows,
						areaType: 'form'
					}
				};
				// 验证公式
				props.validateToSave(_savedata, doSaveAdd.bind(this, props), '', 'form');
			}
			break;
		...
		case _constant.CARD_BTN.saveCommit:
			saveCheck = beforeSave.call(this, props);
			if (saveCheck) {
				var _saveAllData2 = props.form.getAllFormValue(_constant.CARD.formHeadCode);
				var _savedata2 = {
					pageid: _constant.CARD.pageCode,
					model: {
						areacode: _constant.CARD.formHeadCode,
						rows: _saveAllData2.rows,
						areaType: 'form'
					}
				};
				// 验证公式
				props.validateToSave(_savedata2, doSaveCommit.bind(this, props), '', 'form');
			}
			break;
...
function doDelete(props) {
	...
	var successCallback = function successCallback(res) {
		if (res.data && res.data.errMsgs && res.data.errMsgs.length > 0) {
			...
			(0, _ncLightappFront.toast)({ color: 'success', content: this.props.MutiInit.getIntl("36180ET") && this.props.MutiInit.getIntl("36180ET").get('36180ET-000009') }); /* 国际化处理： 删除成功!*/
			// 删除成功后，先清空画面所有数据
			this.props.form.EmptyAllFormValue(_constant.CARD.formHeadCode);
...
function doCancel(props) {
	...
	if (status === 'edit') {
		...
		var _id = props.getUrlParam('oldId');
		//保存中的取消操作
		this.props.setUrlParam({
			status: 'browse',
			id: _id,
...
function doEdit(props) {
	...
	var tableName = "fbm_endore";
	var primaryId = "pk_endore";
	var pk = props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'pk_endore') && props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'pk_endore').value;
	...
	_common.apiSaga.call(this, {
		...
		success: function success(res) {
			...
			//成功进入编辑态，说明事务已经解冻，需要将saga_frozen和saga_status设置为0
			if (_this.props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'saga_frozen')) {
				_this.props.form.setFormItemsValue(_constant.CARD.formHeadCode, { 'saga_frozen': { value: '0' } });
			}
			if (_this.props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'saga_status')) {
				_this.props.form.setFormItemsValue(_constant.CARD.formHeadCode, { 'saga_status': { value: '0' } });
			}
			_this.setUIDisplay();
		}
	});
		...
		if (res.data && res.data.errMsg) {
			...
			if (res.data.workflow && (res.data.workflow === 'approveflow' || res.data.workflow === 'workflow')) {
				...
				if (res.data.card.head) {
					...
					} else if (_constant.CARD_BTN.saveCommit == callWay) {
						(0, _ncLightappFront.toast)({
							color: 'success',
...
function doDisable() {
	...
	this.setState({
		...
		_this2.props.form.setFormStatus(_this2.disableNote, 'edit');
	});
}
	...
	var successCallback = function successCallback(res) {
		if (res.success) {
			...
			if ('_LinkVouchar2019' == srcCode) {
				...
				(0, _ncLightappFront.toast)({ color: 'warning', content: this.props.MutiInit.getIntl("36180ET") && this.props.MutiInit.getIntl("36180ET").get('36180ET-000019') }); /* 国际化处理： 未查到凭证*/
				return;
			}
		}
	};
...
function doRefresh(props, showToast) {
	...
	var successCallback = function successCallback(res) {
		if (res.data) {
			...
			var pk = res.data.head[_constant.CARD.formHeadCode].rows[0].values.pk_endore;
...
function beforeEvent(params) {
	var currType = ['olcrate', 'onlinebankflag'];
	if (currType.includes(key)) {
		var pk_org = props.form.getFormItemsValue(this.formId, 'pk_org').value; //财务组织
		var pk_currtype = props.form.getFormItemsValue(this.formId, 'pk_curr').value; //源币
		//主键，判断是否是新增还是修改
		var pk_endore = props.form.getFormItemsValue(this.formId, this.primaryId).value;
		if (!pk_endore) {
			// 新增，能进来的即可修改
			return true;
		}
