...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/fbm/rreturn/card/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/fbm/rreturn/card/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
//小应用编码
var app_code = exports.app_code = '36180BRR';
//联查小应用编码
var link_app_code = exports.link_app_code = '36180BRR';
//审批小应用编码
var approve_app_code = exports.approve_app_code = '36180BRRA';
//请求基础路径
var base_path = exports.base_path = '/nccloud/fbm/rreturn';
//按钮平铺显示数量
var button_limit = exports.button_limit = 3;
//打印输出编码
var nodekey = exports.nodekey = '36180BRRP_07';
//联查预算aggVO
var fullAggClassName = exports.fullAggClassName = 'nc.vo.fbm.rreturn.AggRReturnVO';
var module_id = exports.module_id = '36180BRR';
//单据类型
var billtype = exports.billtype = '36HB';
// 业务对应表名，修改按钮点击时用来saga校验
var tableName = exports.tableName = 'fbm_rreturn';
/**
 * 列表
 */
var LIST = exports.LIST = {
    ...
    //缓存标示
};var DATA_SOURCE = exports.DATA_SOURCE = 'tm.fbm.rreturn.datasource';
...
var _initTemplate = __webpack_require__(689);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(690);

var _initTemplate4 = _interopRequireDefault(_initTemplate3);

var _initTemplate5 = __webpack_require__(691);

var _initTemplate6 = _interopRequireDefault(_initTemplate5);

var _bodyButtonClick = __webpack_require__(354);

var _buttonVisible = __webpack_require__(353);

var _afterEvent = __webpack_require__(692);

var _beforeEvent = __webpack_require__(693);

var _afterTableEvent = __webpack_require__(694);

var _bodySelectedEvent = __webpack_require__(695);
...
function buttonVisible(props) {
    ...
    var unionBtn = ['LinkSDBook', 'Voucher', 'LinkBudgetPlan', 'LinkReceAndPaybill', 'ApproveDetail'];
            ...
            switch (vbillstatus) {
                case '-1':
                    ...
                    commonBtn = commonBtn.filter(function (item) {
                        ...
                        return item !== 'LinkReceAndPaybill';
                    }).filter(function (item) {
                        return item !== 'Voucher';
                    });
...
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; } //应收票据退票——表体编辑后事件
...
var _constant = __webpack_require__(218);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_BaseCard2.default, _extends({
                ...
                constant: {
                    ...
                    encryptVOClassName: "nccloud.itf.pfbm.exitpool.ExitpoolEncryptVO4NCC", //加签类 设置加签字段等
                ...
                pageTitle: this.props.MutiInit.getIntl("36180BRR") && this.props.MutiInit.getIntl("36180BRR").get("36180BRR-000003") //页面标题/* 国际化处理： 应收票据退票*/
...
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; } //应收票据退票——表头编辑后事件
