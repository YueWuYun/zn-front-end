...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/fbm/rreturn/list/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/fbm/rreturn/list/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
var _initTemplate = __webpack_require__(697);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(698);

var _initTemplate4 = _interopRequireDefault(_initTemplate3);

var _buttonDisable = __webpack_require__(699);
...
var _constant2 = __webpack_require__(218);
...
var List = function (_Component) {
    ...
    function List(props) {
        ...
        _this.myRenderCompleteEvent = function () {
            ...
            var money = muti && muti.get("36180BRR-000008") /* 国际化处理： 退票金额*/;
            var start = muti && muti.get("36180BRR-000009") /* 国际化处理： 开始*/;
            var end = muti && muti.get("36180BRR-000010") /* 国际化处理： 结束*/;
        ...
        value: function render() {
            var tabs = {
                ...
                items: [{
                    key: "-1",
                    name: "numZY",
                    title: this.props.MutiInit.getIntl("36180BRR") && this.props.MutiInit.getIntl("36180BRR").get("36180BRR-000005") /* 国际化处理： 待提交*/
                }, {
                    key: "2,3",
                    name: "numTJ",
                    title: this.props.MutiInit.getIntl("36180BRR") && this.props.MutiInit.getIntl("36180BRR").get("36180BRR-000006") /* 国际化处理： 审批中*/
                }, {
                    key: "all",
                    title: this.props.MutiInit.getIntl("36180BRR") && this.props.MutiInit.getIntl("36180BRR").get("36180BRR-000007") /* 国际化处理： 全部*/
                }],
...
function buttonDisable() {
    ...
    var otherBtn = ['Delete', 'Copy', 'Commit', 'Uncommit', 'Attachment', 'Union', 'Voucher', 'LinkBudgetPlan', 'ApproveDetail', 'Print', 'Output'];
    if (selectedData.length == 1) {
        ...
        switch (vbillstatus) {
            case '-1':
                //待提交
                this.props.button.setButtonDisabled(['Add', 'Delete', 'Copy', 'Commit', 'Attachment', 'Union', 'LinkBudgetPlan', 'Print', 'Output'], false);
                this.props.button.setButtonDisabled(['Uncommit', 'ApproveDetail'], true);
                break;
            case '2': //待审批
            case '3':
                //提交
                this.props.button.setButtonDisabled(['Add', 'Copy', 'Uncommit', 'Attachment', 'Union', 'LinkBudgetPlan', 'ApproveDetail', 'Print', 'Output'], false);
                this.props.button.setButtonDisabled(['Delete', 'Commit'], true);
                break;
            case '1':
                //审批通过
                if (voucher) {
                    this.props.button.setButtonDisabled(['Add', 'Copy', 'CancelVoucher', 'Attachment', 'Union', 'Voucher', 'LinkBudgetPlan', 'ApproveDetail', 'Print', 'Output'], false);
