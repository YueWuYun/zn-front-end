...
import { CARD } from "../../rreturn/cons/constant";
import {
    API_URL,
    app_code,
    billtype,
...
class List extends Component {
    ...
    myRenderCompleteEvent = function () {
        ...
        let money = muti && muti.get("36180BRR-000008") /* 国际化处理： 退票金额*/;
        let start = muti && muti.get("36180BRR-000009") /* 国际化处理： 开始*/;
        let end = muti && muti.get("36180BRR-000010") /* 国际化处理： 结束*/;
    ...
    render() {
            ...
            items: [
                {
                    ...
                    name: "numZY",
                    title:
                        this.props.MutiInit.getIntl("36180BRR") &&
                        this.props.MutiInit.getIntl("36180BRR").get(
                            "36180BRR-000005"
                        )
                } /* 国际化处理： 待提交*/,
                {
        ...
        return (
            <BaseList
                ...
                pageTitle={
                    this.props.MutiInit.getIntl("36180BRR") &&
                    this.props.MutiInit.getIntl("36180BRR").get("36180BRR-000003")
                } //页面标题/* 国际化处理： 应收票据退票*/
