...
/** 打印模板节点标识nodekey */
export const NODE_KEY = "36180PBRPRINTNEW";
/** 小应用编码 */
export const APP_CODE = "36180PBR";
 ...
 */
/** 页面编码 */
export const CARD_PAGE_CODE = "36180PBR_C01";
/** 表头编码 */
...
/** 缓存相关 */
export const DATASOURCELINK = "fbm.fbm.paybill.dataSourceLink";
