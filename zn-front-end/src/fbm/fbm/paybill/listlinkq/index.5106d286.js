...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/fbm/paybill/listlinkq/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"));
	else
		root["fbm/fbm/paybill/listlinkq/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"]);
...
function bodyButtonClick(props, key, text, record, index) {
  ...
  switch (key) {
    ...
    // 收回
    case "InnerUnCommit":
      doListInnerAjaxAndReturn.call(this, props, record, index, this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get('36180PBR-000006'), /* 国际化处理： 收回成功！*/
      _constant.URL_LIST.UN_COMMIT);
      break;
    // 制证
    case "InnerMakeVoucher":
      doListInnerAjaxAndReturn.call(this, props, record, index, this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get('36180PBR-000007'), /* 国际化处理： 制证成功！*/
      _constant.URL_LIST.VOUCHER);
      break;
    //取消制证
    case "InnerCancelVoucher":
      doListInnerAjaxAndReturn.call(this, props, record, index, this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get('36180PBR-000008'), /* 国际化处理： 取消制证成功！*/
    ...
    case "InnerCancelDisable":
      doListInnerAjaxAndReturn.call(this, props, record, index, this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get('36180PBR-000011'), /* 国际化处理： 取消作废成功！*/
      _constant.URL_LIST.CANCEL_DISABLE);
      break;
    // 发送指令
    case "InnerSendCmd":
      doListInnerAjaxAndReturn.call(this, props, record, index, this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get('36180PBR-000009'), /* 国际化处理： 发送指令成功！*/
      _constant.URL_LIST.SEND_CMD);
      break;
    // 撤回指令
    case "InnerWithdrawCmd":
      doListInnerAjaxAndReturn.call(this, props, record, index, this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get('36180PBR-000023'), /* 国际化处理： 撤回指令成功！*/
...
function doListInnerAjaxAndReturn(props, record, index, toastContent, url) {
  ...
  var sendData = _defineProperty({
    pageid: _constant.LINK_LIST_PAGE_CODE,
    pks: [pk],
    tss: [ts],
    isCardOpt: false
  }, "pageid", _constant.LINK_LIST_PAGE_CODE);
...
function doInnerDelete(props, record, index) {
  ...
  var successCallback = function successCallback(res) {
    if (res.data.errMsg) {
      ...
      (0, _ncLightappFront.toast)({
        color: "success",
        content: this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get('36180PBR-000024') /* 国际化处理： 删除成功！*/
      });
...
var _searchButtonClick = __webpack_require__(330);
...
function disableListConfirm(value) {
  ...
  if (this.state.operateType == "listInner") {
    ...
    if (_pks.length == 0) {
      (0, _ncLightappFront.toast)({
        color: "error",
        content: this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get('36180PBR-000025') /* 国际化处理： 请选择至少一条数据！！*/
      });
      return;
    }
...
function doCopy(props) {
  ...
  if (selectedRows.length > 1) {
    var _minIndex = getMinIndex(selectedRows);
    copyid = selectedRows[_minIndex].data.values.pk_paybill.value;
  }
...
function doDelete(props) {
  ...
  if (selectedData.length == 0) {
    (0, _ncLightappFront.toast)({ color: "warning", content: mutiInit && mutiInit.get('36180PBR-000026') }); /* 国际化处理： 请选择至少一条数据！*/
    return;
...
function doLinkPlan(props) {
  ...
  // 当选中条数大于 1 条数据时 取下标最小的一条数据
  if (selectedRows.length > 1) {
    var _minIndex2 = getMinIndex(selectedRows);
    pk = selectedRows[_minIndex2].data.values.pk_paybill.value;
    paybillplanitem = selectedRows[_minIndex2].data.values.paybillplanitem.value;
  }
  // 选中一条时
  if (selectedRows.length == 1) {
  ...
  if (paybillplanitem == "" || paybillplanitem == undefined) {
    (0, _ncLightappFront.toast)({
      color: "warning",
      content: this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get('36180PBR-000031') /* 国际化处理： 没有选择付票计划项目，不能联查计划预算！*/
    });
    return;
  }
...
function doLinkBook(props) {
  ...
  // 当选中条数大于 1 条数据时 取下标最小的一条数据
  if (selectedRows.length > 1) {
    var _minIndex3 = getMinIndex(selectedRows);
    pk_register = selectedRows[_minIndex3].data.values.pk_register.value;
  }
  // 选中一条时
  if (selectedRows.length == 1) {
    pk_register = selectedRows[0].data.values.pk_register.value;
  ...
  var successCallback = function successCallback(res) {
    if (res.success) {
      ...
      if ("_LinkVouchar2019" == srcCode) {
        ...
        (0, _ncLightappFront.toast)({ color: "warning", content: mutiInit && mutiInit.get('36180PBR-000018') }); /* 国际化处理： 未查到凭证*/
        return;
      }
    }
  };
...
function doLinkApprove(props) {
  ...
  // 当选中条数大于 1 条数据时 复制下标最小的一条数据
  if (selectedRows.length > 1) {
    var _minIndex4 = getMinIndex(selectedRows);
    id = selectedRows[_minIndex4].data.values.pk_paybill.value;
    vbillstatus = selectedRows[_minIndex4].data.values.vbillstatus.value;
  }
  // 选中一条时直接跳转卡片页并传递选中行pk
  if (selectedRows.length == 1) {
...
function doOutput(props) {
  ...
  if (!outputData || outputData.length == 0) {
    (0, _ncLightappFront.toast)({ color: "warning", content: this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get('36180PBR-000026') }); /* 国际化处理： 请选择至少一条数据！*/
    return;
  }
  var outputpks = [];
...
function doField(props) {
  ...
  // 当选中条数大于 1 条数据时 复制下标最小的一条数据
  if (selectedRows.length > 1) {
    var _minIndex5 = getMinIndex(selectedRows);
    var billno = selectedRows[_minIndex5].data.values.vbillno.value;
    var pk_paybill = selectedRows[_minIndex5].data.values.pk_paybill.value;
...
function searchButtonClick(content, props, searchVal) {
  ...
  var querystatus = this.state.activeKey && 0;
  ...
  if (!searchVal || !searchVal.conditions || searchVal.conditions.length == 0) {
    searchVal = getDefData("searchVal", _constant.DATASOURCELINK);
    if (!searchVal) {
      return;
    }
  } else {
    setDefData("searchVal", _constant.DATASOURCELINK, searchVal); //放入缓存
  }
  var data = {
    ...
    success: function success(res) {
      ...
      if (success) {
        ...
        if (data.numvalues) {
          ...
          //放入缓存
          setDefData("numvalues", _constant.DATASOURCELINK, data.numvalues);
          setDefData("activeKey", _constant.DATASOURCELINK, querystatus);

          if (parseInt(data.numvalues.ALL) < 1) {
            (0, _ncLightappFront.toast)({ color: "warning", content: _this.props.MutiInit.getIntl("36180PBR") && _this.props.MutiInit.getIntl("36180PBR").get('36180PBR-000035') }); /* 国际化处理： 未查询出数据！*/
          } else {
        ...
        setDefData(_constant.LIST_TABLE_CODE, _constant.DATASOURCELINK, data.grid); //放入缓存
      }
    }
  });
}
...
var _buttonClick = __webpack_require__(329);
...
var List = (_temp = _class = function (_Component) {
    ...
    function List(props) {
        ...
        _this.pageId = _constant.LINK_LIST_PAGE_CODE;
        _this.API_URL = {
    ...
    _createClass(List, [{
        ...
        value: function componentDidMount() {
            ...
            //src修改为scene
            var src = this.props.getUrlParam("scene");
            if (src) {
                //fip代表会计平台
                if ("fip" == src) {
        ...
        value: function getAssginUserCard(userObj) {
            ...
            if (selectDatas && selectDatas.length > 0) {
                ...
                (0, _ncLightappFront.toast)({
                    color: "waring",
                    content: this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get("36180PBR-000036") /* 国际化处理： 指派传参，获取pk失败！*/
                });
                return;
            }
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(NCTabPane, {
                        key: "-1",
                        tab: this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get("36180PBR-000038") /* 国际化处理： 待提交*/ + "(" + (numvalues && numvalues.NOT_COMMIT || 0) + ")"
                    }),
                    _react2.default.createElement(NCTabPane, {
                        key: "2,3",
                        tab: this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get("36180PBR-000039") /* 国际化处理： 审批中*/ + "(" + (numvalues && numvalues.IN_APPROVE || 0) + ")"
                    }),
                    _react2.default.createElement(NCTabPane, {
                        key: "0",
                        tab: this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get("36180PBR-000040")
                    })
                ),
                _react2.default.createElement(
                    "div",
                    ...
                    createSimpleTable(_constant.LIST_TABLE_CODE, {
                        dataSource: _constant.DATASOURCELINK,
    ...
    this.getNtbLinkBillData = function (serval) {
        var pageInfo = _this3.props.table.getTablePageInfo(_constant.LIST_TABLE_CODE);
        var data = {
            pk: _this3.props.getUrlParam("pk_ntbparadimvo"),
            pageCode: _this3.pageId,
            pageInfo: pageInfo,
            modulecode: "3618"
        };
        ...
        var successCallback = function successCallback(res) {
            ...
            if (success) {
                if (data) {
                    _this3.props.table.setAllTableData(_constant.LIST_TABLE_CODE, data.grid[_constant.LIST_TABLE_CODE]);
                    var rowlenght = data.grid[_constant.LIST_TABLE_CODE].rows;
                    if (rowlenght.length == 1) {
                        setDefData(_constant.LIST_TABLE_CODE, _constant.DATASOURCELINK, data.grid[_constant.LIST_TABLE_CODE]);
                        var record = rowlenght[0];
                        //1条数据跳转到卡片页面
                        _this3.props.pushTo("/cardlinkq", {
                            status: "browse",
                            id: record.values.pk_paybill && record.values.pk_paybill.value,
                    ...
                    (0, _ncLightappFront.toast)({
                        color: "warning",
                        content: _this3.props.MutiInit.getIntl("36180PBR") && _this3.props.MutiInit.getIntl("36180PBR").get("36180PBR-000061")
                    });
                    _this3.props.table.setAllTableData(_constant.LIST_TABLE_CODE, {
                        rows: []
                    });
                }
            } else {
                ...
                _this3.props.table.setAllTableData(_constant.LIST_TABLE_CODE, { rows: [] });
            }
            _events.buttonVisiable.call(_this3, _this3.props);
        };
        _commonUtil.doAjax.call(_this3, data, _constant.URL_LIST.PLAN_LINK_PAYBILL, successCallback);
    };

    this.getLinkQueryBillData = function () {
        var srckey = _this3.props.getUrlParam("srckey");
        var id = _this3.props.getUrlParam("id");
        var pk = void 0;
        if (srckey) {
            pk = srckey;
        } else {
        ...
        if (pk) {
            ...
            var successCallback = function successCallback(res) {
                ...
                if (success) {
                    if (data) {
                        _this3.props.table.setAllTableData(_constant.LIST_TABLE_CODE, data[_constant.LIST_TABLE_CODE]);
                        var rowlenght = data[_constant.LIST_TABLE_CODE].rows;
                        if (rowlenght.length == 1) {
                            setDefData(_constant.LIST_TABLE_CODE, _constant.DATASOURCELINK, data[_constant.LIST_TABLE_CODE]);
                            var record = rowlenght[0];
                            //1条数据跳转到卡片页面
                            _this3.props.pushTo("/cardlinkq", {
                                status: "browse",
            ...
            _commonUtil.doAjax.call(_this3, data, _constant.URL_LIST.CARD_QUERY, successCallback);
        }
    };

    this.restoreData = function () {
        //获取页签数据
        var numvalues = getDefData("numvalues", _constant.DATASOURCELINK);
        var activeKey = getDefData("activeKey", _constant.DATASOURCELINK);
    ...
    this.voucherLinkBill = function () {
        ...
        if (checkedData && checkedData.length > 0) {
            ...
            _commonUtil.doAjax.call(_this3, data, _constant.URL_LIST.VOUCHER_LINK_PAYBILL, successCallback);
        }
    };
...
var _bodyButtonClick = __webpack_require__(328);

var _buttonClick = __webpack_require__(329);

var _buttonVisiable = __webpack_require__(627);

var _pageInfoClick = __webpack_require__(628);

var _searchButtonClick = __webpack_require__(330);

var _initTemplate = __webpack_require__(629);
...
function buttonVisiable(props) {
  ...
  if (!checkRows || checkRows.length == 1) {
    checkRows.forEach(function (e) {
      ...
      var paybillplanitem = e.data.values.paybillplanitem.value;
  ...
  props.button.setButtonDisabled(_constant.BTN_GROUP.LINK_PLAN, disableLinkPlan);
  ...
  if (this.state.activeTab == "cmd2,3") {
    this.props.button.setButtonDisabled([_constant.BTN_GROUP.COMMIT, _constant.BTN_GROUP.DELETE, _constant.BTN_GROUP.UN_COMMIT, _constant.BTN_GROUP.DISABLE, _constant.BTN_GROUP.CANCEL_DISABLE], true);
  }
}
  ...
  props.createUIDom({
    ...
    if (data) {
      ...
      if (data.button) {
        ...
        props.button.setPopContent('InnerDelete', _this.props.MutiInit.getIntl("36180PBR") && _this.props.MutiInit.getIntl("36180PBR").get('36180PBR-000029')); /* 国际化处理： 确定要删除吗?*/
      }
      if (data.template) {
        var meta = data.template;
        //高级查询区域加载默认业务单元
...
function modifierMeta(props, meta, lineButton) {
  ...
  //   label: this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get('36180PBR-000034'),/* 国际化处理： 操作*/
  //   itemtype: "customer",
  //   attrcode: "opr",
  //   width: 200,
  //   visible: true,
