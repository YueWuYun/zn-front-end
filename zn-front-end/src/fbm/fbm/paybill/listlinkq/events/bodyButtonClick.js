...
import { CARD_PAGE_CODE, LIST_DISABLENOTE_CODE, LINK_LIST_PAGE_CODE, LIST_TABLE_CODE, URL_LIST } from "./../../cons/constant";
  ...
  switch (key) {
    ...
    case "InnerUnCommit":
      doListInnerAjaxAndReturn.call(
        ...
        record,
        index,
        this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get('36180PBR-000006'),/* 国际化处理： 收回成功！*/
        URL_LIST.UN_COMMIT
      );
      break;
    // 制证
    case "InnerMakeVoucher":
      doListInnerAjaxAndReturn.call(
        ...
        record,
        index,
        this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get('36180PBR-000007'),/* 国际化处理： 制证成功！*/
        URL_LIST.VOUCHER
      );
      break;
    //取消制证
    case "InnerCancelVoucher":
      doListInnerAjaxAndReturn.call(
        ...
        record,
        index,
        this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get('36180PBR-000008'),/* 国际化处理： 取消制证成功！*/
    ...
    case "InnerCancelDisable":
      doListInnerAjaxAndReturn.call(
        ...
        record,
        index,
        this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get('36180PBR-000011'),/* 国际化处理： 取消作废成功！*/
    ...
    case "InnerSendCmd":
      doListInnerAjaxAndReturn.call(
        ...
        record,
        index,
        this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get('36180PBR-000009'),/* 国际化处理： 发送指令成功！*/
        URL_LIST.SEND_CMD
      );
      break;
    // 撤回指令
    case "InnerWithdrawCmd":
      doListInnerAjaxAndReturn.call(
        ...
        record,
        index,
        this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get('36180PBR-000023'),/* 国际化处理： 撤回指令成功！*/
