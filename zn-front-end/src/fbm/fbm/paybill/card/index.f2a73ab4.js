...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/fbm/paybill/card/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"));
	else
		root["fbm/fbm/paybill/card/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"]);
...
exports.pageInfoClick = exports.initTemplate = exports.buttonVisiable = exports.buttonClick = exports.bodyButtonClick = exports.beforeEvent = exports.afterEvent = undefined;

var _afterEvent = __webpack_require__(603);

var _beforeEvent = __webpack_require__(604);

var _bodyButtonClick = __webpack_require__(605);

var _buttonClick = __webpack_require__(322);

var _buttonVisiable = __webpack_require__(606);

var _pageInfoClick = __webpack_require__(607);

var _initTemplate = __webpack_require__(608);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            // let cardData = this.props.createMasterChildData(this.pageId, CARD_FORM_CODE, this.tableId);
          ...
          case 9:
            ...
            saveBeforePk = this.props.form.getFormItemsValue(_constant.CARD_FORM_CODE, _constant.PRIMARY_ID);
            ...
            saveCallback = function saveCallback(res) {
              if (res.data.card.head) {
                ...
                //页签赋值
                var pk_paybill = res.data.card.head[_constant.CARD_FORM_CODE].rows[0].values.pk_paybill;
                ...
                var headData = res.data.card.head[_constant.CARD_FORM_CODE].rows[0].values;
                var tbbMsg = headData && headData["tbbmessage"] && headData["tbbmessage"].value;
                if (tbbMsg) (0, _ncLightappFront.toast)({ color: "warning", content: tbbMsg }); //预算提示
                if (saveBeforePk && saveBeforePk.value) {
                  updateCache(_constant.PRIMARY_ID, res.data.card.head[_constant.CARD_FORM_CODE].rows[0].values.pk_paybill.value, res.data.card, _constant.CARD_FORM_CODE, _constant.DATASOURCE, res.data.card.head[_constant.CARD_FORM_CODE].rows[0].values);
                } else {
                  addCache(res.data.card.head[_constant.CARD_FORM_CODE].rows[0].values.pk_paybill.value, res.data.card, _constant.CARD_FORM_CODE, _constant.DATASOURCE, res.data.card.head[_constant.CARD_FORM_CODE].rows[0].values);
                }
                ...
                if (showToast) {
                  (0, _ncLightappFront.toast)({
                    color: "success",
                    content: this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get("36180PBR-000012") /* 国际化处理： 保存成功*/
                  });
                }
              }
            };
...
exports.disableCardConfirm = disableCardConfirm;
...
function buttonClick(props, id) {
  ...
  var nowId = props.getUrlParam("id");
  ...
  switch (id) {
    ...
    case _constant.BTN_CARD.SAVE:
      if (props.form.isCheckNow([_constant.CARD_FORM_CODE, _constant.CARD_TABLE_CODE1, _constant.CARD_TABLE_CODE2, _constant.CARD_TABLE_CODE3], "warning")) {
        ...
        // 验证公式
        props.validateToSave(savedata, doSave.bind(this, props, true, null, null), "", "form");
      }
    ...
    case _constant.BTN_CARD.SAVE_ADD:
      if (props.form.isCheckNow(_constant.CARD_FORM_CODE)) {
        ...
        // 验证公式
        props.validateToSave(saveadddata, doSaveAdd.bind(this, props), "", "form");
      }
    ...
    case _constant.BTN_CARD.SAVE_COMMIT:
      if (props.form.isCheckNow(_constant.CARD_FORM_CODE)) {
        ...
        // 验证公式
        props.validateToSave(_saveadddata, doSaveCommit.bind(this, props), "", "form");
      }
    ...
    case _constant.BTN_CARD.CANCEL:
      (0, _ncLightappFront.promptBox)({
        title: mutiInit && mutiInit.get("36180PBR-000002") /* 国际化处理： 取消*/
        , color: "warning",
        content: mutiInit && mutiInit.get("36180PBR-000003") /* 国际化处理： 是否确认要取消?*/
    ...
    case _constant.BTN_CARD.DELETE:
      (0, _ncLightappFront.promptBox)({
        ...
        , color: "warning",
        content: mutiInit && mutiInit.get("36180PBR-000005") /* 国际化处理： 是否确认要删除?*/
    ...
    case _constant.BTN_CARD.UN_COMMIT:
      ...
      doAjaxAndReturn.call(this, props, mutiInit && mutiInit.get("36180PBR-000006"), _constant.URL_LIST.UN_COMMIT); /* 国际化处理： 收回成功！*/
      break;

    //制证
    case _constant.BTN_CARD.MAKE_VOUCHER:
      doAjaxAndReturn.call(this, props, mutiInit && mutiInit.get("36180PBR-000007"), _constant.URL_LIST.VOUCHER); /* 国际化处理： 制证成功！*/
      break;

    //取消制证
    case _constant.BTN_CARD.VOUCHER_CANCEL:
      doAjaxAndReturn.call(this, props, mutiInit && mutiInit.get("36180PBR-000008") /* 国际化处理： 取消制证成功！*/
      , _constant.URL_LIST.VOUCHER_CANCEL);
      break;

    //发送指令
    case _constant.BTN_CARD.SEND_CMD:
      doAjaxAndReturn.call(this, props, mutiInit && mutiInit.get("36180PBR-000009"), _constant.URL_LIST.SEND_CMD); /* 国际化处理： 发送指令成功！*/
      break;

    //撤回指令
    case _constant.BTN_CARD.WITHDRAW_CMD:
      doAjaxAndReturn.call(this, props, mutiInit && mutiInit.get("36180PBR-000010") /* 国际化处理： 撤销指令成功！*/
      , _constant.URL_LIST.WITHDRAW_CMD);
      break;

    //作废
    case _constant.BTN_CARD.DISABLE:
      //设置作废输入框可见并可编辑
      this.setState({ disabledComShow: true }, function () {
        _this.props.form.setFormStatus(_constant.CARD_DISABLENOTE_CODE, "edit");
      });
      break;

    //取消作废
    case _constant.BTN_CARD.CANCEL_DISABLE:
      doAjaxAndReturn.call(this, props, mutiInit && mutiInit.get("36180PBR-000011") /* 国际化处理： 取消作废成功！*/
...
function doAdd(props) {
  ...
  this.props.setUrlParam({
    status: "add",
    oldId: this.props.getUrlParam('id'),
    id: ""
  });
  this.props.form.setFormStatus(_constant.CARD_FORM_CODE, "add");
...
function doDelete(props) {
  ...
  var successCallback = function successCallback(res) {
    if (res.data && res.data.errMsg) {
      ...
      (0, _ncLightappFront.toast)({
        color: "success",
        content: this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get("36180PBR-000013")
      }); /* 国际化处理： 删除成功!*/

      var deleteid = this.props.getUrlParam("id");
      var deletenextId = getNextId(deleteid, _constant.DATASOURCE);
      deleteCacheById(_constant.PRIMARY_ID, deleteid, _constant.DATASOURCE);
...
function doCopy(props) {
  ...
  if (!pk) {
    (0, _ncLightappFront.toast)({
      color: "error",
      content: this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get("36180PBR-000014") /* 国际化处理： URL中没有主键*/
    });
    return;
  }
  ...
  //复制的时候清空票据基本信息
  _EmptyAreaValueUtil.EmptyAreaValue.call(this, _constant.CARD_TABLE_CODE1, _constant.CARD_FORM_CODE, "pk_register.");
  //清空票面金额和票面备注
  this.props.form.setFormItemsValue(_constant.CARD_FORM_CODE, {
    money: { value: "" },
...
function doEdit(props) {
  ...
  var pk = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, "pk_paybill") && props.form.getFormItemsValue(_constant.CARD_FORM_CODE, "pk_paybill").value;
  ...
  _common.apiSaga.call(this, {
    ...
    success: function success(res) {
      props.pushTo("/card", {
        ...
        oldId: _this2.props.getUrlParam('id'),
        pagecode: _constant.CARD_PAGE_CODE
      });
      //成功进入编辑态，说明事务已经解冻，将saga_frozen和saga_status设置为0
      if (_this2.props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'saga_frozen') && _this2.props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'saga_status')) {
        _this2.props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'saga_frozen': { value: '0' }, 'saga_status': { value: '0' } });
      }
...
function doCommit(props) {
  var pk = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, _constant.PRIMARY_ID);
    ...
    if (res.data && res.data.errMsg) {
      ...
      if (res.data.workflow && (res.data.workflow == "approveflow" || res.data.workflow == "workflow")) {
        ...
        if (res.data.card.head) {
          ...
          updateCache(_constant.PRIMARY_ID, pk && pk.value, res.data.card, _constant.CARD_FORM_CODE, _constant.DATASOURCE);
          (0, _ncLightappFront.toast)({
            color: "success",
            content: this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get("36180PBR-000015") /* 国际化处理： 提交成功！*/
          });
        }
      }
    }
 ...
 * @param {*} url
 */
function disableCardConfirm(value) {
  var pk = this.props.form.getFormItemsValue(_constant.CARD_FORM_CODE, _constant.PRIMARY_ID);
  var ts = this.props.form.getFormItemsValue(_constant.CARD_FORM_CODE, "ts");
  var disablenote = this.props.form.getFormItemsValue(_constant.LIST_DISABLENOTE_CODE, _constant.LIST_DISABLENOTE_CODE);
  ...
  var successCallback = function successCallback(res) {
    if (res.data && res.data.errMsg) {
      ...
      if (res.data.card.head) {
        ...
        (0, _ncLightappFront.toast)({
          color: "success",
          content: this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get("36180PBR-000016") /* 国际化处理： 作废成功！*/
        });
      }
    }
    doRefresh.call(this, this.props, false);
...
function doLinkVoucher(props) {
  ...
  var pk_paybill = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, _constant.PRIMARY_ID) && props.form.getFormItemsValue(_constant.CARD_FORM_CODE, _constant.PRIMARY_ID).value;
  var sendData = [{
    pk_group: pk_group, //集团主键
    pk_org: pk_org, //组织主键
    relationID: pk_paybill, //单据主键
    pk_billtype: _constant.BILL_TYPE //交易类型
  }];
  var successCallback = function successCallback(res) {
    if (res.success) {
      ...
      if ("_LinkVouchar2019" == srcCode) {
          ...
          if (res.data.pklist) {
            if (res.data.pklist.length == 1) {
              ...
              this.props.openTo(res.data.url, {
                ...
                pagekey: 'link',
                n: this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get("36180PBR-000017"), //'联查凭证'/* 国际化处理： 联查凭证*/
                backflag: "noback"
              });
              return;
            } else {
        ...
        (0, _ncLightappFront.toast)({
          color: "warning",
          content: this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get("36180PBR-000018")
        }); /* 国际化处理： 未查到凭证*/
        return;
      }
    }
  };
  _commonUtil.doAjax.call(this, sendData, _constant.URL_LIST.PAYBILL_Link_Voucher, successCallback);
}
...
function doLinkBook(props) {
  var pk_register = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, "pk_register").value;
...
function doLinkBill(props) {
  var pk_paybill = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, _constant.PRIMARY_ID);
  pk_paybill = pk_paybill && pk_paybill.value;
  var pk_register = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, "pk_register");
...
function doLinkPlan(props) {
  var pk = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, _constant.PRIMARY_ID).value;
  var successCallback = function successCallback(res) {
    var data = res.data;
    if (data.hint) {
...
function doLinkApprove(props) {
  var billid = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, _constant.PRIMARY_ID);
  this.setState({
...
function doFiled(props) {
  ...
  var pk_paybill = props.getUrlParam("id");
  ...
  var successCallback = function successCallback(res) {
    if (res.data) {
      ...
      if (showToast) {
        (0, _ncLightappFront.toast)({
          color: "success",
          content: this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get("36180PBR-000019") /* 国际化处理： 刷新成功！*/
        });
      }
    }
  };
...
var Card = function (_Component) {
    ...
    function Card(props) {
        ...
        _this.refresh = function () {
            var pk_paybill = _this.props.getUrlParam("id");
        ...
        _this.toggleShow = function () {
            ...
            //重新设置卡片页面中财务组织多版本的显示
            (0, _index.orgVersionView)(_this.props, _constant.CARD_FORM_CODE);
        ...
        _this.backList = function () {
            if (_this.props.getUrlParam("scene") == "linksce" || _this.props.getUrlParam("scene") == "fip") {
                _this.props.pushTo("/listlinkq", {
                    pagecode: _constant.LINK_LIST_PAGE_CODE,
                    scene: "linksce"
                });
            } else {
        ...
        _this.initTemplate = _events.initTemplate.bind(_this, props);
        _this.titleno = "";
        _this.state = {
            // 作废弹框
        ...
        value: function componentWillMount() {
            ...
            window.onbeforeunload = function () {
                if (!["browse"].includes(_this2.props.getUrlParam("status"))) {
                    return _this2.props.MutiInit.getIntl("36180PBR") && _this2.props.MutiInit.getIntl("36180PBR").get("36180PBR-000063"); /* 国际化处理： 当前单据未保存, 您确定离开此页面？*/
                }
            };
        }
    }, {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                compositedisplay && _react2.default.createElement(ApprovalTrans, {
                    title: this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get("36180PBR-000021") /* 国际化处理： 指派*/
                    , data: compositedata,
                ...
                _react2.default.createElement(_DisabledCom2.default, {
                    ...
                    title: this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get("36180PBR-000022") /* 国际化处理： 作废原因*/
                    , signCode: _constant.CARD_DISABLENOTE_CODE,
                    onSureCallback: _buttonClick.disableCardConfirm.bind(this, this.props)
                })
            );
        }
    }]);
...
function afterEvent(props, moduleId, key, value, changedrows, i, s, g, isInit) {
  ...
  switch (key) {
    ...
    // 票据编号
    case "pk_register":
      doPKRegister.call(this, props, data);
      break;
    // 付票时间
    case "paybilldate":
      doPaybilldate.call(this, props, data);
      break;
    // 网银
    case "cyberbankflag":
    ...
    // 组织本币汇率
    case "olcrate":
      doOlcrate.call(this, props, data);
      break;
    default:
      break;
  }
 ...
 * @param {*} data
 */
function doPaybilldate(props, data) {
  ...
  if (newvalue == oldvalue) {
    ...
    // 后台查询
    _commonUtil.doAfterAjax.call(this, data, _constant.URL_LIST.AFTER_EVENT, successCallback);
  }
}
/**
 * 票据编号：
 ...
 * @param {*} data
 */
function doPKRegister(props, data) {
  var newvalue = data.newvalue.value;
  var oldvalue = data.oldvalue.value;
...
function doPkOrgEvent(props, data, isInit) {
  ...
  if (newvalue == oldvalue) {
    ...
    if (!oldvalue) {
      ...
      (0, _ncLightappFront.promptBox)({
        color: "warning",
        title: this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get("36180PBR-000000") /* 国际化处理： 确认修改*/
        , content: this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get("36180PBR-000001") /* 国际化处理： 是否修改组织，这样会清空您录入的信息?*/
...
function bodyButtonClick(that, props, key, text, record, index) {
    switch (key) {
        // 表格操修改
...
function buttonVisiable(props) {
  ...
  // 是否作废
  var disableflag = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, "disableflag") && props.form.getFormItemsValue(_constant.CARD_FORM_CODE, "disableflag").value;
  // 是否网银
  var cyberbankflag = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, "cyberbankflag") && props.form.getFormItemsValue(_constant.CARD_FORM_CODE, "cyberbankflag").value;
  // 指令状态
  var paymentstatus = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, "paymentstatus") && props.form.getFormItemsValue(_constant.CARD_FORM_CODE, "paymentstatus").value;
  // 撤回指令状态
  var recallstatus = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, "recallstatus") && props.form.getFormItemsValue(_constant.CARD_FORM_CODE, "recallstatus").value;

  // 付票来源系统
  var syscode = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, "syscode") && props.form.getFormItemsValue(_constant.CARD_FORM_CODE, "syscode").value;
  ...
  if (!status) {
    ...
    props.button.setButtonVisible(_constant.BTN_CARD.LINK_PLAN, true);

    //付票来源系统不是手工录入 则显示联查付款单据按钮则不显示收回修改删除制证取消制证作废取消作废发送指令撤回指令
    if (syscode != "" && syscode != undefined && syscode != "INPUT") {
      props.button.setButtonVisible(_constant.BTN_CARD.LINK_BILL, true);
...
// 非手工录入 不可显示的操作按钮
var notInput = [_constant.BTN_CARD.COMMIT, _constant.BTN_CARD.UN_COMMIT, _constant.BTN_CARD.DELETE, _constant.BTN_CARD.EDIT, _constant.BTN_CARD.MAKE_VOUCHER, _constant.BTN_CARD.VOUCHER_CANCEL, _constant.BTN_CARD.DISABLE, _constant.BTN_CARD.CANCEL_DISABLE, _constant.BTN_CARD.SEND_CMD, _constant.BTN_CARD.WITHDRAW_CMD];
// 新增态 编辑态 按钮组
...
//附件 打印 输出
_constant.BTN_CARD.FILED, _constant.BTN_CARD.PRINT, _constant.BTN_CARD.OUTPUT, _constant.BTN_CARD.REFRESH];
...
// 联查
_constant.BTN_CARD.LINK, _constant.BTN_CARD.LINK_BOOK, _constant.BTN_CARD.LINK_APPROVE,
//BTN_CARD.LINK_PLAN,
...
// 联查
_constant.BTN_CARD.LINK, _constant.BTN_CARD.LINK_VOUCHER, _constant.BTN_CARD.LINK_APPROVE, _constant.BTN_CARD.LINK_BOOK,
//BTN_CARD.LINK_PLAN,
...
//审批通过 网银 发送指令成功 未制证
var voucher = [_constant.BTN_CARD.ADD, _constant.BTN_CARD.COPY, _constant.BTN_CARD.MAKE_VOUCHER,
...
//审批通过 网银 发送指令失败 已作废
var cancelDisable = [_constant.BTN_CARD.ADD, _constant.BTN_CARD.COPY, _constant.BTN_CARD.CANCEL_DISABLE,

// 联查
_constant.BTN_CARD.LINK, _constant.BTN_CARD.LINK_APPROVE, _constant.BTN_CARD.LINK_BOOK,
//BTN_CARD.LINK_PLAN,
...
//审批通过 网银 发送指令失败 未作废
var sendCmdDisable = [_constant.BTN_CARD.ADD, _constant.BTN_CARD.COPY, _constant.BTN_CARD.DISABLE, _constant.BTN_CARD.SEND_CMD,
...
//审批通过 网银 发送指令不明
var withdrawCmd = [_constant.BTN_CARD.ADD, _constant.BTN_CARD.COPY, _constant.BTN_CARD.WITHDRAW_CMD,
...
//审批通过 网银 未发送指令
var unCommitSendCmd = [_constant.BTN_CARD.ADD, _constant.BTN_CARD.COPY, _constant.BTN_CARD.UN_COMMIT, _constant.BTN_CARD.SEND_CMD,
...
//审批通过 非网银 未制证
var unCommitVoucher = [_constant.BTN_CARD.ADD, _constant.BTN_CARD.COPY, _constant.BTN_CARD.UN_COMMIT, _constant.BTN_CARD.MAKE_VOUCHER,
...
//审批通过 没有其他操作的
var noOperate = [_constant.BTN_CARD.ADD, _constant.BTN_CARD.COPY,
...
function pageInfoClick(props, pk) {
  ...
  if (cardData) {
    ...
    var callback = function callback(res) {
      if (res.data.card) {
        this.props.form.setAllFormValue(_defineProperty({}, _constant.CARD_FORM_CODE, res.data.card.head[_constant.CARD_FORM_CODE]));
        _ncLightappFront.cardCache.updateCache(_constant.PRIMARY_ID, pk, res.data.card, _constant.CARD_FORM_CODE, _constant.DATASOURCE);
        this.titleno = res.data.card.head[_constant.CARD_FORM_CODE].rows[0].values.vbillno.value;
        ...
        if (status === "add") {
          ...
          if (data.context) {
            ...
            if (context.pk_org) {
              ...
              that.props.form.setFormItemsDisabled(_constant.CARD_FORM_CODE, {
                pk_org: false
              });
            }
          }
...
function modifierMeta(that, props, meta) {
  ...
  meta[_constant.CARD_FORM_CODE].items.map(function (item) {
    ...
    if (item.attrcode == "pk_register") {
      item.queryCondition = function () {
        ...
        return {
          ...
          pk_register: pk_register && pk_register.value,
          GridRefActionExt: "nccloud.web.fbm.fbm.paybill.filter.PaybillFilterByOrg4NCC"
        };
      };
    }
    //资金计划项目过滤
    ...
    if (item.attrcode == "receiveunit") {
      ...
      item.queryCondition = function () {
        var pk_org = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, "pk_org");
        var pk_group = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, "pk_group");
        return {
