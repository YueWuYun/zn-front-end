...
import { APP_CODE, BILL_TYPE, CARD_DISABLENOTE_CODE, CARD_FORM_CODE, CARD_PAGE_CODE, LINK_LIST_PAGE_CODE, LIST_PAGE_CODE, CARD_TABLE_CODE1, CARD_TABLE_CODE2, DATASOURCE, PRIMARY_ID, URL_LIST } from "./../cons/constant";
import { doAjax } from "./../utils/commonUtil";
import { afterEvent, buttonClick, buttonVisiable, initTemplate, pageInfoClick } from "./events";
