...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/fbm/paybill/cardlinkq/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"));
	else
		root["fbm/fbm/paybill/cardlinkq/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"]);
...
var _afterEvent = __webpack_require__(612);

var _beforeEvent = __webpack_require__(613);

var _bodyButtonClick = __webpack_require__(614);

var _buttonClick = __webpack_require__(324);

var _buttonVisiable = __webpack_require__(615);

var _pageInfoClick = __webpack_require__(616);

var _initTemplate = __webpack_require__(617);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            cardData = (0, _index.createSimpleBillData)(props, _constant.LINK_CARD_PAGE_CODE, _constant.CARD_FORM_CODE, [], false);
            ...
            saveCallback = function saveCallback(res) {
              if (res.data.card.head) {
                ...
                if (saveBeforePk && saveBeforePk.value) {
                  updateCache(_constant.PRIMARY_ID, res.data.card.head[_constant.CARD_FORM_CODE].rows[0].values.pk_paybill.value, res.data.card, _constant.CARD_FORM_CODE, _constant.DATASOURCELINK, res.data.card.head[_constant.CARD_FORM_CODE].rows[0].values);
                } else {
                  addCache(res.data.card.head[_constant.CARD_FORM_CODE].rows[0].values.pk_paybill.value, res.data.card, _constant.CARD_FORM_CODE, _constant.DATASOURCELINK, res.data.card.head[_constant.CARD_FORM_CODE].rows[0].values);
                }
  ...
  switch (id) {
    ...
    case _constant.BTN_CARD.SAVE:
      if (props.form.isCheckNow([_constant.CARD_FORM_CODE, _constant.CARD_TABLE_CODE1, _constant.CARD_TABLE_CODE2, _constant.CARD_TABLE_CODE3], "warning")) {
        ...
        var savedata = {
          pageid: _constant.LINK_CARD_PAGE_CODE,
          model: {
    ...
    case _constant.BTN_CARD.SAVE_ADD:
      if (props.form.isCheckNow(_constant.CARD_FORM_CODE)) {
        var saveadddata = props.createFormAfterEventData(_constant.LINK_CARD_PAGE_CODE, _constant.CARD_FORM_CODE);
        // 验证公式
    ...
    case _constant.BTN_CARD.SAVE_COMMIT:
      if (props.form.isCheckNow(_constant.CARD_FORM_CODE)) {
        var _saveadddata = props.createFormAfterEventData(_constant.LINK_CARD_PAGE_CODE, _constant.CARD_FORM_CODE);
        // 验证公式
...
function doDelete(props) {
  ...
  var successCallback = function successCallback(res) {
    (0, _ncLightappFront.toast)({ color: "success", content: this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get('36180PBR-000013') }); /* 国际化处理： 删除成功!*/

    var deleteid = this.props.getUrlParam("id");
    var deletenextId = getNextId(deleteid, _constant.DATASOURCELINK);
    deleteCacheById(_constant.PRIMARY_ID, deleteid, _constant.DATASOURCELINK);
...
function doCancel(props) {
  ...
  if (status === "edit") {
    ...
    this.props.pushTo("/card", {
      status: "browse",
      id: id,
      pagecode: _constant.LINK_CARD_PAGE_CODE
    });
    this.componentDidMount();
  }
  //保存中的取消操作
    ...
    if (res.data && res.data.errMsg) {
      ...
      if (res.data.workflow && (res.data.workflow == "approveflow" || res.data.workflow == "workflow")) {
        ...
        if (res.data.card.head) {
          ...
          updateCache(_constant.PRIMARY_ID, pk && pk.value, res.data.card, _constant.CARD_FORM_CODE, _constant.DATASOURCELINK);
          (0, _ncLightappFront.toast)({
            color: "success",
  ...
  var successCallback = function successCallback(res) {
    if (res.success) {
      ...
      if ("_LinkVouchar2019" == srcCode) {
        ...
        (0, _ncLightappFront.toast)({ color: "warning", content: this.props.MutiInit.getIntl("36180PBR") && this.props.MutiInit.getIntl("36180PBR").get('36180PBR-000018') }); /* 国际化处理： 未查到凭证*/
        return;
      }
    }
  };
...
var Card = function (_Component) {
    ...
    function Card(props) {
        ...
        _this.pageId = _constant.LINK_CARD_PAGE_CODE;
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            createBillHeadInfo({
                                title: mutiInit && mutiInit.get("36180PBR-000020") /* 国际化处理： 付票登记*/
...
function afterEvent(props, moduleId, key, value, changedrows, i, s, g, isInit) {
  console.log(key);
  var data = props.createHeadAfterEventData(_constant.LINK_CARD_PAGE_CODE, moduleId, [], moduleId, key, value);
  switch (key) {
    //财务组织
    case "pk_org":
...
function doPkOrgEvent(props, data, isInit) {
  ...
  if (newvalue == oldvalue) {
    ...
    if (!oldvalue) {
      ...
      (0, _ncLightappFront.promptBox)({
        color: "warning",
        title: mutiInit && mutiInit.get("36180PBR-000000") /* 国际化处理： 确认修改*/
        , content: mutiInit && mutiInit.get("36180PBR-000001") /* 国际化处理： 是否修改组织，这样会清空您录入的信息?*/
...
function buttonVisiable(props) {
  ...
  // 付票计划项目
  var paybillplanitem = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, "paybillplanitem") && props.form.getFormItemsValue(_constant.CARD_FORM_CODE, "paybillplanitem").value;
  ...
  if (status == "add") {
    ...
    //付票来源系统不是手工录入 则显示联查付款单据按钮
    if (syscode != "" && syscode != undefined && syscode != "INPUT" && syscode != "ARAP") {
      props.button.setButtonVisible(_constant.BTN_CARD.LINK_BILL, true);
    }
    //付票来源系统不是手工录入 则不显示收回修改删除制证取消制证作废取消作废发送指令撤回指令
...
function pageInfoClick(props, pk) {
  ...
  var cardData = _ncLightappFront.cardCache.getCacheById(pk, _constant.DATASOURCELINK);
  ...
  if (cardData) {
    ...
    var callback = function callback(res) {
      if (res.data.card) {
        this.props.form.setAllFormValue(_defineProperty({}, _constant.CARD_FORM_CODE, res.data.card.head[_constant.CARD_FORM_CODE]));
        _ncLightappFront.cardCache.updateCache(_constant.PRIMARY_ID, pk, res.data.card, _constant.CARD_FORM_CODE, _constant.DATASOURCELINK);
        this.titleno = res.data.card.head[_constant.CARD_FORM_CODE].rows[0].values.vbillno.value;
    ...
    _commonUtil.doAjax.call(this, data, _constant.URL_LIST.LINK_CARD_QUERY, callback);
  }
}
