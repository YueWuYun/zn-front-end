...
import { CARD_FORM_CODE,PRIMARY_ID, DATASOURCELINK, URL_LIST } from "./../../cons/constant";
...
export function pageInfoClick(props, pk) {
  ...
  let cardData = cardCache.getCacheById(pk, DATASOURCELINK);
  ...
  if (cardData) {
    ...
    doAjax.call(this, data, URL_LIST.LINK_CARD_QUERY, callback);
  }
}
