...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/fbm/buyerdiscount/card/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/fbm/buyerdiscount/card/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
var _initTemplate = __webpack_require__(417);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(418);

var _initTemplate4 = _interopRequireDefault(_initTemplate3);

var _initTemplate5 = __webpack_require__(419);

var _initTemplate6 = _interopRequireDefault(_initTemplate5);

var _buttonVisible = __webpack_require__(278);

var _afterEvent = __webpack_require__(420);
...
function buttonVisible(props) {
  //获取表头区域编码
  var FORM_ID = _constant.CARD.form_id;
  // 先设置所有按钮不可见
  var allBtn = [];
  ...
  // 取消后，是否是空白页
  var isBlank = props.getUrlParam('id');

  // 浏览态根据单据状态设置按钮组
  var billstatus = props.form.getFormItemsValue(FORM_ID, "vbillstatus") && props.form.getFormItemsValue(FORM_ID, "vbillstatus").value;

  // 是否制证
  var isMakeVoucher = props.form.getFormItemsValue(FORM_ID, "voucher") && props.form.getFormItemsValue(FORM_ID, "voucher").value;
  ...
  if (!status) {
    ...
    props.button.setMainButton(_constant.BTN_CARD.ADD, true);
  } else if (status == "add") {
    props.button.setButtonVisible(status_add, true);
    props.button.setMainButton(_constant.BTN_CARD.SAVE, true);
  } else if (status == "browse") {
    if (!isBlank) {
      props.button.setButtonVisible(status_isBlank, true);
      props.button.setMainButton(_constant.BTN_CARD.ADD, true);
      ...
      switch (billstatus) {
        case "-1":
          ...
          props.button.setMainButton(_constant.BTN_CARD.COMMIT, true);
          break;
        case "2": //审批进行中
        case "3":
          //提交
...
var commonBtn = [
//附件 打印 输出
_constant.BTN_CARD.PRINTGROUP, _constant.BTN_CARD.PRINT, _constant.BTN_CARD.OUTPUT, _constant.BTN_CARD.ATTACHMENT, _constant.BTN_CARD.REFRESH];
...
// 联查
_constant.BTN_CARD.LINK, _constant.BTN_CARD.LINK_PLAN, _constant.BTN_CARD.LINK_INNERACCOUNT].concat(commonBtn);
...
// 收回
_constant.BTN_CARD.UNCOMMIT,

// 联查
_constant.BTN_CARD.LINK, _constant.BTN_CARD.LINK_PLAN, _constant.BTN_CARD.LINK_INNERACCOUNT, _constant.BTN_CARD.LINK_APPROVE].concat(commonBtn);
...
// 联查
_constant.BTN_CARD.LINK, _constant.BTN_CARD.LINK_VOUCHER, _constant.BTN_CARD.LINK_APPROVE, _constant.BTN_CARD.LINK_INNERACCOUNT, _constant.BTN_CARD.LINK_PLAN].concat(commonBtn);

//审批通过  未制证
var voucher = [_constant.BTN_CARD.ADD, _constant.BTN_CARD.COPY, _constant.BTN_CARD.UNCOMMIT, _constant.BTN_CARD.MAKE_VOUCHER,

// 联查
_constant.BTN_CARD.LINK, _constant.BTN_CARD.LINK_APPROVE, _constant.BTN_CARD.LINK_INNERACCOUNT, _constant.BTN_CARD.LINK_PLAN].concat(commonBtn);
...
function modifierMeta(meta) {
  ...
  meta[this.formId].items.map(function (item) {
    ...
    if (item.attrcode === "pk_register") {
      ...
      item.queryCondition = function () {
        var pk_org = props.form.getFormItemsValue(_constant.CARD.form_id, "pk_org") && props.form.getFormItemsValue(_constant.CARD.form_id, "pk_org").value;
        var isagent = props.form.getFormItemsValue(_constant.CARD.form_id, "isagent") && props.form.getFormItemsValue(_constant.CARD.form_id, "isagent").value;
        var pk_register = props.form.getFormItemsValue(_constant.CARD.form_id, "pk_register") && props.form.getFormItemsValue(_constant.CARD.form_id, "pk_register").value;

        return {
          pk_org: pk_org,
          isagent: isagent,
          pk_signorg: pk_register,
          GridRefActionExt: "nccloud.web.fbm.fbm.buyerdiscount.filter.BuyerDiscoutRegisterFilter"
        };
      };
    }
    ...
    if (item.attrcode == "discount_account") {
      ...
      return item.queryCondition = function () {
        var pk_org = _props.form.getFormItemsValue(_constant.CARD.form_id, "pk_org") && _props.form.getFormItemsValue(_constant.CARD.form_id, "pk_org").value;
        var pk_discount_bank = _props.form.getFormItemsValue(_constant.CARD.form_id, "pk_discount_bank") && _props.form.getFormItemsValue(_constant.CARD.form_id, "pk_discount_bank").value;
        var pk_curr = _props.form.getFormItemsValue(_constant.CARD.form_id, "pk_curr") && _props.form.getFormItemsValue(_constant.CARD.form_id, "pk_curr").value;
    ...
    if (item.attrcode == "pk_discount_bank") {
      ...
      return item.queryCondition = function () {
        var pk_org = _props2.form.getFormItemsValue(_constant.CARD.form_id, "pk_org") && _props2.form.getFormItemsValue(_constant.CARD.form_id, "pk_org").value;
        var pk_currtype = _props2.form.getFormItemsValue(_constant.CARD.form_id, "pk_curr") && _props2.form.getFormItemsValue(_constant.CARD.form_id, "pk_curr").value;
        return {
          pk_org: pk_org, // 组织
    ...
    if (item.attrcode == "interestplanitem") {
      ...
      return item.queryCondition = function () {
        var pk_org = _props3.form.getFormItemsValue(_constant.CARD.form_id, "pk_org") && _props3.form.getFormItemsValue(_constant.CARD.form_id, "pk_org").value;
        return {
          pk_org: pk_org // 组织
        };
      };
    ...
    if (item.attrcode == "holdunit") {
      ...
      return item.queryCondition = function () {
        var pk_org = _props4.form.getFormItemsValue(_constant.CARD.form_id, "pk_org") && _props4.form.getFormItemsValue(_constant.CARD.form_id, "pk_org").value;
        return {
          pk_org: pk_org
        };
      };
    ...
    if (item.attrcode == "pk_costcenter") {
      ...
      return item.queryCondition = function () {
        var pk_org = _props5.form.getFormItemsValue(_constant.CARD.form_id, "pk_org") && _props5.form.getFormItemsValue(_constant.CARD.form_id, "pk_org").value;
        return {
          pk_org: pk_org
        };
      };
    ...
    if (item.attrcode.indexOf("def") > -1) {
      ...
      item.queryCondition = function (p) {
        var pk_org = _props6.form.getFormItemsValue(_constant.CARD.form_id, "pk_org") && _props6.form.getFormItemsValue(_constant.CARD.form_id, "pk_org").value;
        var pk_group = _props6.form.getFormItemsValue(_constant.CARD.form_id, "pk_group") && _props6.form.getFormItemsValue(_constant.CARD.form_id, "pk_group").value;
        return {
          pk_org: pk_org,
          pk_group: pk_group
        };
  ...
  //清算信息
  meta["signapplyinfo"].items.map(function (item) {
    // 内部结算账户
    if (item.attrcode == "pk_inbalaacc") {
      var props = _this2.props;
      return item.queryCondition = function () {
        var pk_org = props.form.getFormItemsValue(_constant.CARD.form_id, "pk_org") && props.form.getFormItemsValue(_constant.CARD.form_id, "pk_org").value;
        var pk_curr = props.form.getFormItemsValue(_constant.CARD.form_id, "pk_curr") && props.form.getFormItemsValue(_constant.CARD.form_id, "pk_curr").value;
        var pk_usebillorg = props.form.getFormItemsValue(_constant.CARD.form_id, "pk_usebillorg") && props.form.getFormItemsValue(_constant.CARD.form_id, "pk_usebillorg").value;
        return {
          pk_org: pk_org, // 受理资金组织
          pk_curr: pk_curr,
          pk_usebillorg: pk_usebillorg,
          GridRefActionExt: "nccloud.web.fbm.fbm.buyerdiscount.filter.BuyerDiscountInbalaAccRefFilter"
        };
      };
    }
  });
...
function afterEvent(props, moduleId, key, value, oldValue) {
  ...
  if (key === "pk_org") {
    ...
    if (!oldValue.value) {
      ...
      (0, _ncLightappFront.promptBox)({
        ...
        , content: lang && lang.get("36180PDT-000001") /* 国际化处理： 切换组织将会清空您录入的信息，请确认?*/
        , beSureBtnClick: function beSureBtnClick() {
  ...
  //票据号码
      ...
      if (!value.value) {
        // 清空票据信息
        _EmptyAreaValueUtil.EmptyAreaValue.call(this, "baseinfo", this.formId, "pk_register.");
      }
    }
    ...
    // 贴现银行账户，需要给银行赋值
      ...
      //银行
        ...
        //代理
          ...
          } else if (key == "discountinterest" || key == "discountdelaydaynum" || key == "ddiscountdate" || key == "discountyrate" || key == "ratedaynum") {
            if (value.value !== oldValue.value) {
              _index.cardEvent.getAfterEventData.call(this, eventData).then(function (res) {
                setAfterEditFormValue.call(_this, props, res);
              });
  ...
  _index.cardEvent.changeOrg.call(this, value).then(function () {
    if (value.value) {
      _index.cardEvent.getAfterEventData.call(_this2, eventData).then(function (res) {
        _this2.props.form.setAllFormValue(_defineProperty({}, _this2.formId, res.data.card.head[_this2.formId]));
      });
    }
  });
}
