...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/fbm/impawn/card/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/fbm/impawn/card/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
//小应用编码
var app_code = exports.app_code = '36180BI';
//联查小应用编码
var link_app_code = exports.link_app_code = '36180BI';
//审批小应用编码
var approve_app_code = exports.approve_app_code = '36180BIA';
//请求基础路径
var base_path = exports.base_path = '/nccloud/fbm/impawn';
//按钮平铺显示数量
var button_limit = exports.button_limit = 3;
//打印输出编码
var nodekey = exports.nodekey = '36180BIPRINT';

var module_id = exports.module_id = '36180BI';
//单据类型
var billtype = exports.billtype = '36HA';
...
var LIST = exports.LIST = {
    ...
    disabled_btn: ['Delete', 'Copy', 'Commit', 'Uncommit', 'Import', 'QuickImport', 'ExportTemplate', 'DataImport', 'Attachment', 'Print', 'ApproveDetail', 'SendInstruction', 'ImpawnBackInstr', 'CancelImpawnBack', 'WithdrawImpawn', 'Invalid', 'CancelInvalid', 'Output', 'LinkSDBook'], //默认禁用按钮
    ...
    //缓存标示
};var DATA_SOURCE = exports.DATA_SOURCE = 'tm.fbm.impawn.datasource';
...
var _afterEvent = __webpack_require__(595);

var _buttonVisible = __webpack_require__(319);

var _initTemplate = __webpack_require__(596);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(597);

var _initTemplate4 = _interopRequireDefault(_initTemplate3);

var _initTemplate5 = __webpack_require__(598);
...
function buttonVisible(props) {
    ...
    var scene = props.getUrlParam('scene');
    var isBrowse = status === 'browse';
    var buttons = props.button.getButtons().map(function (item) {
        return item.key;
    });
    var busistatus = props.form.getFormItemsValue(this.formId, 'vbillstatus') && props.form.getFormItemsValue(this.formId, 'vbillstatus').value;
    ...
    var unionBtn = ['BondIssue', 'ApproveDetail', 'FundPlan', 'Voucher'];
    var allBtns = [].concat(_toConsumableArray(buttons), editBtn, unionBtn, ['Add', 'Edit', 'Copy', 'Delete']);
    var disabledBtn = ['deleteRow', 'copyRow'];
    if (!status) {
        showBtn = ['Add'];
        ...
        if (!id) {
            ...
            var auitBtn = ['SendInstruction', 'CancelInstruction', 'Invalid', 'CancelInvalid'];
            if (disableflag) {
                    ...
                    if (onlinebankflag) {
                        ...
                        if (backimpawnstatus == null) {
                            ...
                            if (paymentstatus == null) {
                                ...
                                if (disableflag) {
                                    showBtn = ["Add", "Copy", "CancelInvalid"].concat(_toConsumableArray(commonBtn));
                                } else {
                                    if (paymentstatus == 1) {
                                        //成功显示质押收回
                                        ...
                                        //失败显示发送指令
                                        showBtn = ["Add", "Copy", "SendInstruction", "Invalid"].concat(_toConsumableArray(commonBtn));
                                    } else if (paymentstatus == 3) {
                                        //不明显示质押收回撤回
                                        showBtn = ["Add", "Copy", "WithdrawImpawn"].concat(_toConsumableArray(commonBtn));
                                    }
                                }
                            }
                        } else {
    ...
    if ('linksce' == scene) {
        ...
        var linkShowBtn = [].concat(unionBtn, ['Attachment', 'Print', 'Output', 'Refresh']);
...
var _constant = __webpack_require__(219);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_BaseCard2.default, _extends({
                constant: {
                    ...
                    encryptVOClassName: "nccloud.itf.fbm.impawn.ImpawnEncryptVO4NCC",
                ...
                pageTitle: this.props.MutiInit.getIntl("36180BI") && this.props.MutiInit.getIntl("36180BI").get("36180BI-000004") //节点标题
...
function afterEvent(props, moduleId, key, value, oldValue) {
	...
	if (key === 'pk_org') {
	...
	} else if (key === 'evaluatevalue') {
		//评估价值
		if (parseInt(value.value) <= 0) {
			return (0, _ncLightappFront.toast)({
				color: "danger",
				content: this.props.MutiInit.getIntl("36180BI") && this.props.MutiInit.getIntl("36180BI").get("36180BI-000011") /* 国际化处理： 评估价值应大于0*/
			});
		}
		if (value.value !== oldValue.value) {
		...
		//票据编号
		if (!value.value) {
			_EmptyAreaValueUtil.EmptyAreaValue.call(this, _constant.CARD.baseinfo, this.formId);
			...
			var onlinebankflag = this.props.form.getFormItemsDisabled(this.formId, "onlinebankflag").value;
...
function modifierMeta(meta) {
  ...
  meta["ebank"].items.map(function (item) {
