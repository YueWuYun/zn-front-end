...
import { API_URL, app_code, billtype, CARD, DATA_SOURCE, LIST,DISABLE_BTN_PARAM, impawnbackAreaCode, module_id, nodekey, tableName} from "../cons/constant.js";
        ...
        return (
            <BaseCard
                constant={{
                    ...
                    encryptVOClassName:
                        "nccloud.itf.fbm.impawn.ImpawnEncryptVO4NCC",
