...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/fbm/discountapply/list/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/fbm/discountapply/list/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
var _initTemplate = __webpack_require__(500);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _events = __webpack_require__(177);

var _searchBtnClick = __webpack_require__(501);

var _searchBtnClick2 = _interopRequireDefault(_searchBtnClick);

var _buttonDisable = __webpack_require__(502);
...
var List = function (_Component) {
    ...
    function List(props) {
        ...
        _this.myRenderCompleteEvent = function () {
            ...
            var moneystart = muti && muti.get("36180DA-000011") /* 国际化处理： 票据金额由*/;
            var moneyend = muti && muti.get("36180DA-000012") /* 国际化处理： 票据金额至*/;
            this.props.search.setTemlateByField(this.searchId, 'money', 'defaultPlaceholder', { start: moneystart, end: moneyend });
            var discountmoneystart = muti && muti.get("36180DA-000015") /* 国际化处理： 贴现余额由*/;
            var discountmoneyend = muti && muti.get("36180DA-000016") /* 国际化处理： 贴现余额至*/;
        ...
        value: function render() {
            ...
            var tabs = {
                ...
                items: [{
                    key: "-1",
                    name: "tab01",
                    title: multiLang && multiLang.get("36180DA-000006") /* 国际化处理： 待提交*/
                }, {
                    key: "2,3",
                    name: "tab02",
                    title: multiLang && multiLang.get("36180DA-000007") /* 国际化处理： 审批中*/
                }, {
                    key: "all",
                    title: multiLang && multiLang.get("36180DA-000009") /* 国际化处理： 全部*/
                }],
	...
	props.createUIDom({
		...
		if (data) {
			if (data.button) {
				...
				props.button.setButtons(button);
				var multiLang = _this.props.MutiInit.getIntl(_this.moduleId); //this.moduleId multiLang.get('36180DA-000004')
				var lang = multiLang && multiLang.get('36180DA-000004');
