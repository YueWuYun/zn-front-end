      ...
      <div id="transferList" className="nc-bill-list">
        <NCAffix>
          <NCDiv areaCode={NCDiv.config.HEADER} className="nc-bill-header-area">
            <div className="header-title-search-area">
              {createBillHeadInfo({
                title:
                  this.props.MutiInit.getIntl("36180BC") &&
                  this.props.MutiInit.getIntl("36180BC").get("36180BC-000015"), /* 国际化处理： 选择票据号码 */
        ...
        <div className="nc-bill-transferTable-area">
          {createTransferTable({
            ...
            transferBtnText:
              this.props.MutiInit.getIntl("36180BC") &&
              this.props.MutiInit.getIntl("36180BC").get("36180BC-000000"), //转单按钮显示文字/* 国际化处理： 确认*/
