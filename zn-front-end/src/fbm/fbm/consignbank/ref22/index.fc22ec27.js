...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/fbm/consignbank/ref22/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/fbm/consignbank/ref22/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
var _buttonClick = __webpack_require__(167);
...
var _initTemplate = __webpack_require__(450);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(451);

var _initTemplate4 = _interopRequireDefault(_initTemplate3);

var _initTemplate5 = __webpack_require__(452);

var _initTemplate6 = _interopRequireDefault(_initTemplate5);

var _buttonVisible = __webpack_require__(288);

var _afterEvent = __webpack_require__(453);

var _beforeEvent = __webpack_require__(454);
    ...
    if (status === 'edit' || status === 'add' || status === 'copy') {
        ...
        if (!id) {
            ...
            if (vbillstatus == '-1') {
                ...
                props.button.setButtonVisible(['Add', 'Edit', 'Delete', 'Copy', 'Commit', 'Attachment', 'Linkedquery', 'LinkBook', 'Print', 'Refresh'], visible);
                //设置新增按钮为灰，提交为红色
...
var _BaseCard = __webpack_require__(178);
...
var _events = __webpack_require__(287);
    ...
    _createClass(Card, [{
        ...
        value: function render() {
            ...
            var headDisabledItems = [{
                ...
                key: "onlinebankflag",
                rules: function rules() {
                    var fbmbillno = _this3.props.form.getFormItemsValue(_constant.CARD.form_id, "fbmbillno") && _this3.props.form.getFormItemsValue(_constant.CARD.form_id, "fbmbillno").value;
                    var length = fbmbillno && fbmbillno.length;
                    if (length == 30) {
                        // 网银 可编辑
                        return false;
                    } else {
            ...
            return _react2.default.createElement(_BaseCard2.default, _extends({
                constant: {
                    ...
                    cafalg: "true",
                    encryptVOClassName: "nccloud.itf.fbm.consignbank.vo.ConsignBankEncryptVO4NCC",
                    ...
                    modulecode: "3618",
                    // 转单
                    dataSource: _const.REF21_CONST.Ref21DataSource, //转单页面的缓存key
                ...
                , formParams: {
                    //区域默认展开
                    expandArr: ["form_consignbank_01", "fbm_consignbank_01", "issecurity"]
                } //表头form参数
...
function modifierMeta(meta) {
	...
	meta[this.formId].items.map(function (item) {
		...
		if (item.attrcode === 'holderacc') {
			...
			item.queryCondition = function () {
				return {
					refnodename: _this2.props.MutiInit.getIntl("36180BC") && _this2.props.MutiInit.getIntl("36180BC").get('36180BC-000014'), /* 国际化处理： 使用权参照*/
...
function afterEvent(props, moduleId, key, value, oldValue) {
	...
	if (key === 'pk_org') {
		if (!oldValue.value) {
			...
			(0, _ncLightappFront.promptBox)({
				color: "warning",
				title: multiLang && multiLang.get('36180BC-000000'), /* 国际化处理： 确认*/
				content: multiLang && multiLang.get('36180BC-000001'), /* 国际化处理： 切换组织将会清空您录入的信息，请确认?*/
				beSureBtnClick: function beSureBtnClick() {
		...
		if (dcollectiondate && dconsigndate) {
			if (dcollectiondate < dconsigndate) {
				...
				(0, _ncLightappFront.toast)({ color: 'warning', content: multiLang && multiLang.get('36180BC-000002') }); /* 国际化处理： 款项收妥日期应大于等于委托日期*/
			}
		}
		...
		//网银
		var _newvalue8 = eventDataOld.newvalue.value;

		if (_newvalue8) {
			//线上清算、预约付款日期，只有勾选网银后才可编辑
			this.props.form.setFormItemsDisabled(this.formId, { 'isonlinesettle': false });
			this.props.form.setFormItemsDisabled(this.formId, { 'appointdate': false });
		} else {
			this.props.form.setFormItemsDisabled(this.formId, { 'isonlinesettle': true });
			this.props.form.setFormItemsDisabled(this.formId, { 'appointdate': true });
		}
	} // 票据类别
