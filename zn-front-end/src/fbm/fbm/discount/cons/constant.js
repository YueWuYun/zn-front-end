...
//联查小应用编码
export const link_app_code = '36180DTL';
//审批小应用编码
export const approve_app_code = '36180DTA';
//请求基础路径
export const base_path = '/nccloud/fbm/discount';
//按钮平铺显示数量
export const button_limit = 3;
//打印输出编码
export const nodekey = '36180DTP_02';

export const module_id = '36180DT';
//单据类型
export const billtype = '36H7';
...
//缓存标示
export const DATA_SOURCE = 'tm.fbm.discount.datasource';
