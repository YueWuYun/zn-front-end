...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/fbm/discount/list/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/fbm/discount/list/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
var LIST = exports.LIST = {
  // page_title: this.state.json['36180DT-000003'],    //页面标题/* 国际化处理： 贴现办理*/
  ...
  page_id: '36180DT_L01', //页面编码
  page_id_link: '36180DTLINK_L01',
  // app_code:'36180BRB',                             //应用编码
  search_id: 'search_discount_01', //查询区域编码
  table_id: 'table_discount_01', //表格区域编码
  ...
  billno: 'vbillno', //单据编号
  page_id: '36180DT_C01', //页面编码
  page_id_link: '36180DTLINK_C01', //联查页面编码
  page_id_approve: '36180DTA_C01', //审批页面编码
...
var searchCache = exports.searchCache = {
  key: 'fbm.fbm.discount.searchCache', //查询区域缓存Key
  dataSource: 'fbm.fbm.discount.searchSpace' //查询区域缓存数据的名称空间
...
var REF21_CONST = {
  ...
  formId: "table_discount_01", //列表 查询结果区域编码
  tableId: "", //表体区域
  transPageId: "36180DT_TL01", //列表pagecode
  transCardId: "36180DT_TC01", //卡片pagecode
  searchId: "search_discount_01", //查询区域编码
  destPageUrl: "/ref22",
...
var _initTemplate = __webpack_require__(474);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _events = __webpack_require__(177);

var _searchBtnClick = __webpack_require__(475);

var _searchBtnClick2 = _interopRequireDefault(_searchBtnClick);

var _buttonDisable = __webpack_require__(476);
...
var List = function (_Component) {
    ...
    function List(props) {
        ...
        _this.myRenderCompleteEvent = function () {
            ...
            var money = muti && muti.get("36180DT-000010") /* 国际化处理： 票据金额*/;
            var start = muti && muti.get("36180DT-000011") /* 国际化处理： 开始*/;
            var end = muti && muti.get("36180DT-000012") /* 国际化处理： 结束*/;
        ...
        value: function render() {
            ...
            var tabs = {
                ...
                items: [{
                    key: "-1",
                    name: "tab01",
                    title: multiLang && multiLang.get("36180DT-000006") /* 国际化处理： 待提交*/
                }, {
                    key: "2,3",
                    name: "tab02",
                    title: multiLang && multiLang.get("36180DT-000007") /* 国际化处理： 审批中*/
                }, {
                    key: "10",
                    name: "tab03",
                    title: multiLang && multiLang.get("36180DT-000008") /* 国际化处理： 指令处理中*/
                }, {
                    key: "all",
                    title: multiLang && multiLang.get("36180DT-000009") /* 国际化处理： 全部*/
                }],
	...
	props.createUIDom({
		...
		if (data) {
			if (data.button) {
				...
				props.button.setButtons(button);
				var multiLang = _this.props.MutiInit.getIntl(_this.moduleId); //this.moduleId multiLang.get('36180DT-000004')
				var lang = multiLang && multiLang.get('36180DT-000004');
...
function modifierMeta(props, meta) {
	...
	meta[this.tableId].items.push({
		itemtype: 'customer',
		attrcode: 'opr',
		label: multiLang && multiLang.get('36180DT-000005'), /* 国际化处理： 操作*/
		width: 200,
		fixed: 'right',
		className: "table-opr",
		visible: true,
