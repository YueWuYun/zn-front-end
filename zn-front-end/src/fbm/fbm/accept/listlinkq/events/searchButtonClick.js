...
import { LIST_TABLE_CODE,DATASOURCE,LIST_SEARCH_CODE,LIST_LINK_PAGE,URL_LIST } from "./../../cons/const";
            ...
            if (success) {
                ...
                if(data.numvalues){
                    ...
                    if (parseInt(data.numvalues.ALL) < 1) {
                        ...
                        if (isSearchBtn == 1)
                            toast({ color: 'success', content: mutiInit && mutiInit.get('36180BP-000025') })/* 国际化处理： 查询成功!*/
