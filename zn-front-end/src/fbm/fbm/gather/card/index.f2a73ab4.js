...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/fbm/gather/card/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"));
	else
		root["fbm/fbm/gather/card/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"]);
...
/******/ 	return __webpack_require__(__webpack_require__.s = 796);
/******/ })
/************************************************************************/
/******/ ({
...
var URL_LIST = exports.URL_LIST = {
     ...
     */
    /** 页面模板编码 */
};var LIST_MODEL_CODE = exports.LIST_MODEL_CODE = "36180RBR_list";
/** 页面编码 */
...
/** 作废原因区域 */
var LIST_DISABLENOTE = exports.LIST_DISABLENOTE = 'disablenote';
/** 快捷贴现区域 */
var LIST_QUICKDISCOUNT = exports.LIST_QUICKDISCOUNT = 'quickdiscount';
/** 快捷质押区域 */
var LIST_QUICKIMPAWN = exports.LIST_QUICKIMPAWN = 'quickimpawn';

/**
 *  卡片 
 */
/** 页面编码 */
var CARD_PAGE_CODE = exports.CARD_PAGE_CODE = "36180RBR_C01";
/** 表头编码 */
...
/** 银行登记 */
var CARD_SEARCH_CODE = exports.CARD_SEARCH_CODE = "36180rbr_c01_search";
 ...
 * 被联查列表页面
 */
var LINK_LIST_PAGE_CODE = exports.LINK_LIST_PAGE_CODE = "36180RBR_LL01";
...
function doAjaxAE(sendData, url, successCallback) {
    (0, _ncLightappFront.ajax)({
        async: false,
        url: url,
        data: sendData,
...
var _constant = __webpack_require__(185);
...
var VOUCHER_INFO = {
  ...
  * @param {*} billNO 单据编号
  */
};var linkVoucherApp = exports.linkVoucherApp = function linkVoucherApp(props, billID, pk_group, pk_org, billOrTransType, billNO) {
	var base_url = '/nccloud/tmpub/pub/';
	var data = {
	...
	(0, _ncLightappFront.ajax)({
		...
		success: function success(res) {
			...
			if (!success || !data || !data.src || VOUCHER_INFO.LINK_VOUCHER != data.src || !data.pklist || data.pklist.length == 0) {
				(0, _ncLightappFront.toast)({
					'color': 'warning',
					"content": '' + (props.MutiInit.getIntl("36180RBR") && props.MutiInit.getIntl("36180RBR").get("36180RBR-000065")) + billNO + (props.MutiInit.getIntl("36180RBR") && props.MutiInit.getIntl("36180RBR").get("36180RBR-000066")) /* 国际化处理： 联查失败！原因是：不存在与单据号{0}关联的凭证！*/
			...
			if (data.des) {
				...
				if (pklist.length == 1) {
					props.openTo(url, {
						...
						n: '' + (props.MutiInit.getIntl("36180RBR") && props.MutiInit.getIntl("36180RBR").get("36180RBR-000067")) /* 国际化处理： 联查凭证*/
						, pagekey: 'link',
						backflag: 'noback'
					});
				}
				//多笔
						...
						//将主键信息存入缓存
						_ncLightappFront.cacheTools.set("checkedData", pklist);
...
exports.pageInfoClick = exports.initTemplate1 = exports.initTemplate = exports.confirmOfDisableOnCard = exports.buttonVisiable = exports.buttonClick = exports.bobyButtonClick = exports.beforeEvent = exports.afterEvent = undefined;

var _afterEvent = __webpack_require__(564);

var _beforeEvent = __webpack_require__(565);

var _bobyButtonClick = __webpack_require__(566);

var _buttonClick = __webpack_require__(309);

var _buttonVisiable = __webpack_require__(310);

var _pageInfoClick = __webpack_require__(567);

var _initTemplate = __webpack_require__(568);

var _initTemplate2 = __webpack_require__(569);
...
exports.initTemplate1 = _initTemplate2.initTemplate1;
...
var doSave = function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(props, showToast, isAdd, isCommit) {
        var toSave, temp, cardData, result, saveBeforePk, saveCallback;
        return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        temp = this.props.form.getFormItemsValue(_constant.CARD_FORM_CODE, "paybankacc");
                        ...
                        cardData = this.props.createMasterChildData(_constant.CARD_PAGE_CODE, _constant.CARD_FORM_CODE, null);
                    ...
                    case 11:
                        ...
                        saveCallback = function saveCallback(res) {
                            if (res.data.card.head) {
                                ...
                                var tbbMsg = res.data.card.head[_constant.CARD_FORM_CODE].rows[0].values.tbbmessage;
                                if (tbbMsg && tbbMsg.value) {
                                    (0, _ncLightappFront.toast)({ color: "warning", content: tbbMsg.value }); //预算提示
                                }
                                ...
                                if (showToast) {
                                    (0, _ncLightappFront.toast)({
                                        color: "success",
                                        content: this.props.MutiInit.getIntl("36180RBR") && this.props.MutiInit.getIntl("36180RBR").get("36180RBR-000011") /* 国际化处理： 保存成功*/
                                    });
                                }
                            }
                        };
...
exports.doBankRegisterComfirm = doBankRegisterComfirm;
...
var _LinkUtil = __webpack_require__(265);
...
function buttonClick(props, id) {
    switch (id) {
        ...
        case _constant.BTN_CARD.SAVE:
            if (props.form.isCheckNow([_constant.CARD_FORM_CODE, _constant.CARD_TABLE_CODE1, _constant.CARD_TABLE_CODE2, _constant.CARD_TABLE_CODE3], "warning")) {
                var saveAllData = props.form.getAllFormValue(_constant.CARD_FORM_CODE);
                var savedata = {
                    pageid: _constant.CARD_PAGE_CODE,
                    model: {
                        areacode: _constant.CARD_FORM_CODE,
        ...
        case _constant.BTN_CARD.SAVE_ADD:
            if (props.form.isCheckNow(_constant.CARD_FORM_CODE)) {
                var saveadddata = props.createFormAfterEventData(_constant.CARD_PAGE_CODE, _constant.CARD_FORM_CODE);
                // 验证公式
        ...
        case _constant.BTN_CARD.SAVE_COMMIT:
            if (props.form.isCheckNow(_constant.CARD_FORM_CODE)) {
                var _saveadddata = props.createFormAfterEventData(_constant.CARD_PAGE_CODE, _constant.CARD_FORM_CODE);
                // 验证公式
                props.validateToSave(_saveadddata, doSaveCommit.bind(this, props), "", "");
            }
        ...
        case _constant.BTN_CARD.CANCEL:
            (0, _ncLightappFront.promptBox)({
                title: this.props.MutiInit.getIntl("36180RBR") && this.props.MutiInit.getIntl("36180RBR").get("36180RBR-000003") /* 国际化处理： 取消*/
                , color: "warning",
                content: this.props.MutiInit.getIntl("36180RBR") && this.props.MutiInit.getIntl("36180RBR").get("36180RBR-000004") /* 国际化处理： 是否确任要取消?*/
        ...
        case _constant.BTN_CARD.DELETE:
            (0, _ncLightappFront.promptBox)({
                title: this.props.MutiInit.getIntl("36180RBR") && this.props.MutiInit.getIntl("36180RBR").get("36180RBR-000005") /* 国际化处理： 删除*/
                , color: "warning",
                content: this.props.MutiInit.getIntl("36180RBR") && this.props.MutiInit.getIntl("36180RBR").get("36180RBR-000006") /* 国际化处理： 是否确任要删除?*/
        ...
        // 银行登记
        case _constant.BTN_CARD.BANK_REGISTER:
            doBankRegister.call(this, props);
            break;

        // 作废
        case _constant.BTN_CARD.DISABLED:
            doDisabled.call(this, props);
            break;

        // 取消作废
        case _constant.BTN_CARD.CANCELDISABLED:
            doCancelDisabled.call(this, props);
            break;

        // 票据流转信息
        case _constant.BTN_CARD.LIKCIRCULATE:
            doCirculate.call(this, props);
            break;

        // 关联业务 收款单
        case _constant.BTN_CARD.GATHERINGBILL:
            doGatheringBill.call(this, props);
            break;
        // 关联业务 收款结算单
        case _constant.BTN_CARD.RECBILL:
            doRecbill.call(this, props);
            break;
        // 关联业务 委托收款单
        case _constant.BTN_CARD.COMMISSIONGATHERING:
...
function doCommissionGathering(props) {
    ...
    _commonUtil.doAjax.call(this, sendData, _constant.URL_LIST.COMMISSIONGATHERING, successCallback);
}
...
function doRecbill(props) {
    ...
    _commonUtil.doAjax.call(this, sendData, _constant.URL_LIST.RECBILL, successCallback);
}
...
function doGatheringBill(props) {
    ...
    var successCallback = function successCallback(res) {
        _ncLightappFront.cacheTools.set('H1ToF2Pks', pk);
    ...
    _commonUtil.doAjax.call(this, sendData, _constant.URL_LIST.GATHERINGBILL, successCallback);
}
...
function doDisabled() {
    ...
    this.setState({
        ...
        _this.props.form.setFormStatus(_constant.BTN_CARD.DISABLENOTE, "edit");
    });
}
...
function confirmOfDisableOnCard(disableReason) {
    var that = this;
    var pk = that.props.form.getFormItemsValue(_constant.CARD_FORM_CODE, "pk_register");
    var ts = that.props.form.getFormItemsValue(_constant.CARD_FORM_CODE, "ts");
    ...
    var sendData = {
        ...
        tss: [ts && ts.value],
        isCardOpt: true,
        disableReason: _constant.BTN_CARD.DISABLENOTE
    };
    ...
    _commonUtil.doAjax.call(this, sendData, _constant.URL_LIST.DISABLED, callback);
}
/**
 * 取消作废
 * @param {*} props
...
function doCancelDisabled(props) {
    ...
    _commonUtil.doAjax.call(this, sendData, _constant.URL_LIST.CANCELDISABLED, callback);
}
...
+ * @param {*} formData 
+ */
function doBankRegisterComfirm(formData) {
    var that = this;
    var pk = this.props.form.getFormItemsValue(_constant.CARD_FORM_CODE, "pk_register");
    var pk_bankdoc = formData.pk_bankdoc.value;
    var acceptorname = formData.acceptorname.value;
    var signagrbank = formData.signagrbank.value;

    var sendData = {
        pk: pk && pk.value,
        pk_bankdoc: pk_bankdoc,
        acceptorname: acceptorname,
        signagrbank: signagrbank
    };
    var success = function success(res) {
        if (res.data) {
            if (res.data.errMsg) {
                ...
                if (res.data.card.head) {
                    that.props.form.setAllFormValue(_defineProperty({}, _constant.CARD_FORM_CODE, res.data.card.head[_constant.CARD_FORM_CODE]));
                    updateCache("pk_register", pk && pk.value, res.data.card, _constant.CARD_PAGE_CODE, _constant.DATASOURCE);
                    (0, _ncLightappFront.toast)({
                        color: "success",
                        content: this.props.MutiInit.getIntl("36180RBR") && this.props.MutiInit.getIntl("36180RBR").get("36180RBR-000059") /* 国际化处理： 银行登记成功！*/
                    });
                }
            }
        }
    };
    _commonUtil.doAjax.call(this, sendData, _constant.URL_LIST.BANK_REGISTER, success);
}
    ...
    var successCallback = function successCallback(res) {
        if (res.data) {
            if (res.data.errMsg) {
                ...
                (0, _ncLightappFront.toast)({
                    color: "success",
                    content: this.props.MutiInit.getIntl("36180RBR") && this.props.MutiInit.getIntl("36180RBR").get("36180RBR-000007") /* 国际化处理： 签收成功！*/
                });
                // if(res.data.card){
...
function BankRejectConfirm(value) {
    if (!value) {
        (0, _ncLightappFront.toast)({
            color: "warning",
            content: this.props.MutiInit.getIntl("36180RBR") && this.props.MutiInit.getIntl("36180RBR").get("36180RBR-000008") /* 国际化处理： 拒签原因必输！*/
        });
        return;
    }
    ...
    var successCallback = function successCallback(res) {
        if (res.data) {
            if (res.data.errMsg) {
                ...
                (0, _ncLightappFront.toast)({
                    color: "success",
                    content: this.props.MutiInit.getIntl("36180RBR") && this.props.MutiInit.getIntl("36180RBR").get("36180RBR-000009") /* 国际化处理： 拒签成功！*/
                });
    ...
    var successCallback = function successCallback(res) {
        if (res.data) {
            if (res.data.errMsg) {
                ...
                (0, _ncLightappFront.toast)({
                    color: "success",
                    content: this.props.MutiInit.getIntl("36180RBR") && this.props.MutiInit.getIntl("36180RBR").get("36180RBR-000010") /* 国际化处理： 取消收票成功！*/
                });
                // if(res.data.card){
                //     this.props.form.setAllFormValue({ [CARD_FORM_CODE]: res.data.card.head[CARD_FORM_CODE] });
                // }
...
function doDelete(props) {
    ...
    var successCallback = function successCallback(res) {
        (0, _ncLightappFront.toast)({
            color: "success",
            content: this.props.MutiInit.getIntl("36180RBR") && this.props.MutiInit.getIntl("36180RBR").get("36180RBR-000012")
        }); /* 国际化处理： 删除成功!*/
...
function doCopy(props) {
    ...
    if (!pk) {
        (0, _ncLightappFront.toast)({
            color: "error",
            content: this.props.MutiInit.getIntl("36180RBR") && this.props.MutiInit.getIntl("36180RBR").get("36180RBR-000013") /* 国际化处理： URL中没有主键*/
        });
        return;
    }
...
function doEdit(props) {
    ...
    var tableName = "fbm_register";
    var primaryId = "pk_register";
    var pk = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, "pk_register") && props.form.getFormItemsValue(_constant.CARD_FORM_CODE, "pk_register").value;
    ...
    _common.apiSaga.call(this, {
        ...
        success: function success(res) {
            ...
            if (_this2.props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'saga_frozen')) {
                _this2.props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'saga_frozen': { value: '0' } });
            }
            if (_this2.props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'saga_status')) {
                _this2.props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'saga_status': { value: '0' } });
            }
        ...
        if (res.data && res.data.errMsg) {
            ...
            if (res.data.workflow && (res.data.workflow == "approveflow" || res.data.workflow == "workflow")) {
                ...
                if (res.data.card.head) {
                    ...
                    (0, _ncLightappFront.toast)({
                        color: "success",
                        content: this.props.MutiInit.getIntl("36180RBR") && this.props.MutiInit.getIntl("36180RBR").get("36180RBR-000014") /* 国际化处理： 提交成功！*/
                    });
    ...
    var successCallback = function successCallback(res) {
        ...
        if (res.data && res.data.errMsg) {
            ...
            if (res.data.card.head) {
                ...
                (0, _ncLightappFront.toast)({
                    color: "success",
                    content: this.props.MutiInit.getIntl("36180RBR") && this.props.MutiInit.getIntl("36180RBR").get("36180RBR-000015") /* 国际化处理： 收回成功！*/
                });
            }
        }
        doRefresh.call(this, this.props, false);
        ...
        if (res.data) {
            if (res.data.errMsg) {
                ...
                if (res.data.card.head) {
                    ...
                    (0, _ncLightappFront.toast)({
                        color: "success",
                        content: this.props.MutiInit.getIntl("36180RBR") && this.props.MutiInit.getIntl("36180RBR").get("36180RBR-000016") /* 国际化处理： 制证成功！*/
                    });
                }
            }
        }
        ...
        if (res.data) {
            if (res.data.errMsg) {
                ...
                if (res.data.card.head) {
                    ...
                    (0, _ncLightappFront.toast)({
                        color: "success",
                        content: this.props.MutiInit.getIntl("36180RBR") && this.props.MutiInit.getIntl("36180RBR").get("36180RBR-000017") /* 国际化处理： 取消制证成功！*/
                    });
                }
            }
        }
    ...
    var successCallback = function successCallback(res) {
        if (res.data) {
            if (res.data.errMsg) {
                ...
                this.props.form.EmptyAllFormValue({ CARD_FORM_CODE: _constant.CARD_FORM_CODE });
                // this.setState({
                //     isBlank:true
                // })
                this.toggleShow();
                ...
                updateCache('pk_register', pk.value, res.data.card, _constant.CARD_FORM_CODE, _constant.DATASOURCE);
                // addCache(
                ...
                if (showToast) {
                    (0, _ncLightappFront.toast)({
                        color: "success",
                        content: this.props.MutiInit.getIntl("36180RBR") && this.props.MutiInit.getIntl("36180RBR").get("36180RBR-000018") /* 国际化处理： 刷新成功！*/
                    });
                }
            }
        }
...
function buttonVisiable(props) {
    ...
    // 浏览态根据单据状态设置按钮组
    var billstatus = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'vbillstatus') && props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'vbillstatus').value;
    // 是否制证
    var isMakeVoucher = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'voucher') && props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'voucher').value;
    // 是否收票
    var sfflag = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'sfflag') && props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'sfflag').value;
    // 期初
    var initflag = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'initflag') && props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'initflag').value;
    // 电票指令状态
    var elcpaymentstatus = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'elcpaymentstatus') && props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'elcpaymentstatus').value;
    // 作废
    var disuseflag = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'disuseflag') && props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'disuseflag').value;
    // 取消后，是否是空白页
    var isBlank = this.state.isBlank;
    // 有没有勾选网银
    var onlinebankflag = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'onlinebankflag') && props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'onlinebankflag').value;
    //票据类型
    var fbmbilltype = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'fbmbilltype') && props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'fbmbilltype').value;
    //票据状态
    var registerstatus = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'registerstatus') && props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'registerstatus').value;
    //设置看片翻页的显隐性
    props.cardPagination.setCardPaginationVisible('cardPaginationBtn', !showPagination);

    if (!status) {
        props.button.setButtonVisible(_constant.BTN_CARD.ADD, true);
        props.button.setMainButton(['Add'], true);
    } else if (status == 'browse') {
        props.button.setButtonVisible(_constant.BTN_CARD.BANK_REGISTER_OK, true);
        props.button.setButtonVisible(_constant.BTN_CARD.BANK_REGISTER_CANCEL, true);
        props.form.setFormItemsVisible(_constant.CARD_FORM_CODE, {
            'pk_org': false,
            'pk_org_v': true
        });
        if (initflag) {
            ...
            if (isBlank) {
                ...
                // 网银的且电票的显示拒签
                if (onlinebankflag && (fbmbilltype == _constant.BANKINFO.EBANK || fbmbilltype == _constant.BANKINFO.EBUSI)) {
                    props.button.setButtonVisible(_constant.BTN_CARD.BANK_REJECT, true);
                } else {
                    props.button.setButtonVisible(_constant.BTN_CARD.BANK_REJECT, false);
                }
                //拒签按钮显示
                if (elcpaymentstatus == '3') {
                    //交易不明
                    props.button.setButtonVisible(_constant.BTN_CARD.EDIT, false);
                    props.button.setButtonVisible(_constant.BTN_CARD.DELETE, false);
                    props.button.setButtonVisible(_constant.BTN_CARD.BANK_REJECT, false);
                    props.button.setButtonVisible(_constant.BTN_CARD.COMMIT, false);
                ...
                if (sfflag) {
                    props.button.setButtonVisible(_constant.BTN_CARD.UN_COMMIT, false);
                }
            } else if (billstatus == '1') {
                // 审批通过
                props.button.setButtonVisible(_constant.BTN_CARD.LIKCIRCULATE, true);
                if (onlinebankflag) {
                    //勾选网银
                    if (elcpaymentstatus == null) {
                        props.button.setButtonVisible(status_hasApprove, true);
                        props.button.setButtonVisible(_constant.BTN_CARD.UN_COMMIT, true);
                        if (registerstatus == 'register') {
                            props.button.setButtonVisible(_constant.BTN_CARD.BANK_SIGN, true);
                        }
                    } else {
                        props.button.setButtonVisible(status_hasApprove, true);
                        if (elcpaymentstatus == '1') {
                            //签收成功
                            if (isMakeVoucher) {
                                props.button.setButtonVisible(_constant.BTN_CARD.VOUCHER_CANCEL, true);
                            } else {
                                props.button.setButtonVisible(_constant.BTN_CARD.MAKE_VOUCHER, true);
                            }
                        } else if (elcpaymentstatus == '2') {
                            //签收失败
                            if (disuseflag) {
                                props.button.setButtonVisible(_constant.BTN_CARD.CANCELDISABLED, true);
                            } else {
                                props.button.setButtonVisible(_constant.BTN_CARD.DISABLED, true);
                                if (registerstatus == 'register') {
                                    props.button.setButtonVisible(_constant.BTN_CARD.BANK_SIGN, true);
                                }
                            }
                    ...
                    if (registerstatus == 'register' && sfflag) {
                        props.button.setButtonVisible([_constant.BTN_CARD.GATHERINGBILL, _constant.BTN_CARD.RECBILL, _constant.BTN_CARD.COMMISSIONGATHERING], true);
                    }
                } else {
                    //没有勾选网银
                    props.button.setButtonVisible(status_hasApprove, true);
                    if (!sfflag) {
                        ...
                        if (isMakeVoucher) {
                            ...
                            props.button.setButtonVisible(_constant.BTN_CARD.MAKE_VOUCHER, true);
                            if (registerstatus == 'register') {
                                props.button.setButtonVisible(_constant.BTN_CARD.BANK_CANCEL, true);
                            }
                        }
                    }
                    // 已登记 + 未收票（非网银）
                ...
                //银行登记按钮逻辑控制 (纸票 + 已收票)
                if (sfflag && (fbmbilltype === _constant.BANKINFO.BANK || fbmbilltype === _constant.BANKINFO.BUSI)) {
                    props.button.setButtonVisible(_constant.BTN_CARD.BANK_REGISTER, true);
                }
                //设置新增按钮为灰，提交为红色
            ...
            //联查凭证按钮控制
            if (isMakeVoucher) {
                props.button.setButtonVisible(_constant.BTN_CARD.LINK_VOUCHER, true);
            } else {
                props.button.setButtonVisible(_constant.BTN_CARD.LINK_VOUCHER, false);
            }
        }
    } else {
        ...
        var _fbmbilltype = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'fbmbilltype');
        if (_fbmbilltype && _fbmbilltype.value) {
            var isBanktype = false;

            var sendData = {
                attrcode: 'fbmbilltype',
                billtypecode: _fbmbilltype.value
            };
            ...
            var success = function success(res) {
                if (res.data) {
                    ...
                    if (isEbill) {
                        props.form.setFormItemsDisabled(_constant.CARD_FORM_CODE, { 'onlinebankflag': false });
                    } else {
                        props.form.setFormItemsDisabled(_constant.CARD_FORM_CODE, { 'onlinebankflag': true });
                    }

                    //这里控制下推单某些字段的编辑性
                    var gathertype = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'gathertype').value;
            ...
            _commonUtil.doAjax.call(this, sendData, _constant.URL_LIST.QUERY_OTHER, success);
        }
    }
    //设置字段的显隐性
    if (fbmbilltype != null) {
        if (fbmbilltype == _constant.BANKINFO.BANK || fbmbilltype == _constant.BANKINFO.EBANK) {
            this.props.form.setFormItemsVisible(_constant.CARD_FORM_CODE, {
                pk_signagrbank: false,
                pk_acceptorbank: false,
                signagrbank: true,
                acceptorbank: true
    ...
    //复制设置财务组织
    if (status === 'copy') {
        props.form.setFormItemsDisabled(_constant.CARD_FORM_CODE, {
            'pk_org': true
        });
    }
}
...
// 联查
_constant.BTN_CARD.LINK, _constant.BTN_CARD.LINK_BOOK,
// BTN_CARD.LINK_BILL,
_constant.BTN_CARD.LINK_PLAN,
...
_constant.BTN_CARD.LINK, _constant.BTN_CARD.LINK_BOOK,
// BTN_CARD.LINK_BILL,
_constant.BTN_CARD.LINK_APPROVE, _constant.BTN_CARD.LINK_PLAN,
...
var status_common = [
//新增
_constant.BTN_CARD.ADD,
//复制
_constant.BTN_CARD.COPY,
// 联查
_constant.BTN_CARD.LINK, _constant.BTN_CARD.LINK_BOOK, _constant.BTN_CARD.LINK_BILL, _constant.BTN_CARD.LINK_APPROVE,
//BTN_CARD.LINK_PLAN,
...
var _BankRegisterCom = __webpack_require__(562);

var _BankRegisterCom2 = _interopRequireDefault(_BankRegisterCom);

var _events = __webpack_require__(308);
...
var Card = function (_Component) {
    ...
    function Card(props) {
        ...
        _this.backList = function () {
            ...
            } else if (_this.props.getUrlParam("pk_ntbparadimvo")) {
                // 预算反联查场景
                _this.props.pushTo("/list", {
                    pagecode: _constant.LIST_PAGE_CODE,
                    pk_ntbparadimvo: _this.props.getUrlParam("pk_ntbparadimvo")
                });
            } else {
                _this.props.pushTo("/list", {
                    pagecode: _constant.LIST_PAGE_CODE
        ...
        _this.handleBankRegister = function (formData) {
            _buttonClick.doBankRegisterComfirm.call(_this, formData);
        };
        ...
        _this.disableNote = _constant.LIST_DISABLENOTE; // 作废原因区域
        _this.titleno = "";
        _this.state = {
            outputData: {
                oids: [],
    ...
    _createClass(Card, [{
        ...
        value: function componentWillMount() {
            ...
            window.onbeforeunload = function () {
                if (!["browse"].includes(_this2.props.getUrlParam("status"))) {
                    return _this2.props.MutiInit.getIntl("36180RBR") && _this2.props.MutiInit.getIntl("36180RBR").get("36180RBR-000068"); /* 国际化处理： 当前单据未保存, 您确定离开此页面？*/
                }
            };
            ...
            if (scene == "linksce" || scene == "fip" || pk_ntbparadimvo) {
                ...
                _events.initTemplate.call(this, this.props);
            }
        }
        //关闭、刷新弹窗时
        // componentWillMount() {
        ...
        value: function render() {
            ...
            var _state = this.state,
                ...
                showBankRegisterCom = _state.showBankRegisterCom,
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            createBillHeadInfo({
                                title: this.props.MutiInit.getIntl("36180RBR") && this.props.MutiInit.getIntl("36180RBR").get("36180RBR-000019") /* 国际化处理： 收票登记*/
                ...
                _react2.default.createElement(
                    ...
                    /* 国际化处理： 指派*/
                    , { title: this.props.MutiInit.getIntl("36180RBR") && this.props.MutiInit.getIntl("36180RBR").get("36180RBR-000020") /* 国际化处理： 指派*/
                        ,
                ...
                _react2.default.createElement(Inspection, {
                ...
                _react2.default.createElement(_BankRegisterCom2.default, {
                    context: this,
                    show: showBankRegisterCom,
                    title: this.props.MutiInit.getIntl("36180RBR") && this.props.MutiInit.getIntl("36180RBR").get("36180RBR-000062"),
                    callBack: this.handleBankRegister,
                    signCode: _constant.CARD_SEARCH_CODE
                }),
                _react2.default.createElement(_index2.default, {
                    title: this.props.MutiInit.getIntl("36180RBR") && this.props.MutiInit.getIntl("36180RBR").get("36180RBR-000021") /* 国际化处理： 拒签原因*/
                    ,
                    label: this.props.MutiInit.getIntl("36180RBR") && this.props.MutiInit.getIntl("36180RBR").get("36180RBR-000021") /* 国际化处理： 拒签原因*/
                    ,
                    show: this.state.showRejectModel,
                    onOk: function onOk(value) {
                        //处理退回
                        _buttonClick.BankRejectConfirm.call(_this3, value);
                    },
                    onClose: function onClose() {
                        _this3.setState({ showRejectModel: false });
                    }
                }),
                _react2.default.createElement(
                    "div",
...
var _buttonClick = __webpack_require__(563);
...
var BankRegisterCom = function BankRegisterCom(props) {
	var context = props.context,
	    show = props.show,
	    title = props.title,
	    signCode = props.signCode,
	...
	return _react2.default.createElement(
		NCModal,
		{ fieldid: 'generateBankRegister', show: show, backdrop: "static", size: 'sm' },
		_react2.default.createElement(
			NCModal.Header,
			null,
			_react2.default.createElement(
		...
		_react2.default.createElement(
			...
			createButtonApp({
				...
				onButtonClick: function onButtonClick(props, key) {
					_buttonClick2.default.call(context, key, callBack);
				}
			})
		)
	);
...
exports.default = BankRegisterCom;
...
function buttonClick(key, callBack) {
    switch (key) {
        case "BankRegisterOK":
 ...
 * @param {*} key
 */
var onOKClick = function onOKClick(callBack) {
    var _props$form = this.props.form,
        isCheckNow = _props$form.isCheckNow,
        getAllFormValue = _props$form.getAllFormValue;

    if (!isCheckNow(_constant.CARD_SEARCH_CODE)) {
        return;
    }
    // 整理后台需要的数据结构
    var formData = getAllFormValue(_constant.CARD_SEARCH_CODE);
...
function doOnlinebankflag(props, data) {
	var value = data.newvalue.value;
	if (value) {
		// 勾选网银 设置已收票字段不可编辑并清空已收票字段值
		this.props.form.setFormItemsDisabled(_constant.CARD_FORM_CODE, { 'sfflag': true });
		props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'sfflag': { value: '' } });
		return;
	} else {
		this.props.form.setFormItemsDisabled(_constant.CARD_FORM_CODE, { 'sfflag': false });
	}
}
...
function doPaybillunit(props, data) {
  ...
  */
	if (newvalue == 'undefined' || newvalue == null) {
		// 清空 文本字段
		props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'hidepaybillunit': { value: '' } });
		return;
	} else {
		props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'hidepaybillunit': { value: data.newvalue.display } });
	}
}
...
function doPkSignagrBank(props, data) {
  ...
  */
	if (newvalue == 'undefined' || newvalue == null) {
		// 清空承兑人 文本字段
		props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'acceptorname': { value: '' } });
		return;
	} else {
		props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'acceptorname': { value: data.newvalue.display } });
...
function doPkAcceptorbank(props, data) {
  ...
  */
	if (newvalue == 'undefined' || newvalue == null) {
		// 清空承兑人 文本字段
		props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'signagrbankname': { value: '' } });
		return;
	} else {
		props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'signagrbankname': { value: data.newvalue.display } });
	}
}
...
function doAcceptorbankAccount(props, data) {
  ...
  */
	if (newvalue == 'undefined' || newvalue == null) {
		// 清空承兑人 文本字段
		props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'signagrbanknum': { value: '' } });
		return;
	} else {
		props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'signagrbanknum': { value: data.newvalue.display } });
	}
}
...
function doInvoicedate(props, data) {
  ...
  */
	...
	// 	}
	// }
	var fbmbilltype = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'fbmbilltype');
	if (fbmbilltype && fbmbilltype.value) {
		...
		_commonUtil.doAjaxAE.call(this, sendData, _constant.URL_LIST.QUERY_OTHER, success);
	}
}
...
function doEnddate(props, data) {
  ...
  */
	...
	if (invoicedate && invoicedate.value) {
		var invoicedatetemp = new Date(invoicedate.value.substring(0, 10));
		var enddateTemp = new Date(newvalue.substring(0, 10));
		if (enddateTemp.getTime() <= invoicedatetemp.getTime()) {
			(0, _ncLightappFront.toast)({ color: 'warning', content: this.props.MutiInit.getIntl("36180RBR") && this.props.MutiInit.getIntl("36180RBR").get('36180RBR-000000') }); /* 国际化处理： 到期日期必须大于出票日期*/
			props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'enddate': { value: '' } });
			return;
		}
	}
...
function doHidepayunit(props, data) {
  ...
  */
	if (newvalue == 'undefined' || newvalue == null || newvalue !== oldvalue) {
		...
		props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'paybank': { value: '' } });
		//收款人账号
		props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'hidepaybankacc': { value: '' } });
		props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'paybankacc': { value: '' } });
		// 重新设置文本格式的出票人字段值
		props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'payunit': { value: data.newvalue.display } });
		//清空承兑人
		props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'signagrbank': { value: '' } });
		return;
	}
}
...
function doHidereceiveunit(props, data) {
  ...
  */
	if (newvalue == 'undefined' || newvalue == null || newvalue !== oldvalue) {
		...
		props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'receivebank': { value: '' } });
		//收款人账号
		props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'hidereceivebankacc': { value: '' } });
		props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'receivebankacc': { value: '' } });
		// 重新设置文本格式的出票人字段值
		props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'receiveunit': { value: data.newvalue.display } });
		//清空承兑人开户行名
		props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'acceptorbank': { value: '' } });
		return;
	}
}
...
function doAcceptorbank(props, data) {
  ...
  */
	if (newvalue == oldvalue || newvalue == 'undefined' || newvalue == null) {
		...
		data.card.head[_constant.CARD_FORM_CODE].rows[0].values.signagrbankname.value = data.newvalue.display;
	}
	...
	// 后台查询
	_commonUtil.doAjaxAE.call(this, data, _constant.URL_LIST.AFTER_EVENT, successCallback);
}
...
function doHideReceiveBank(props, data) {
  ...
  */
	if (newvalue == 'undefined' || newvalue == null) {
		...
		props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'receivebank': { value: data.newvalue.display } });
	}
}
...
function doHidePayBank(props, data) {
  ...
  */
	if (newvalue == 'undefined' || newvalue == null) {
		...
		props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'paybank': { value: data.newvalue.display } });
	}
}
...
function doReceiveBankAcc(props, data) {
  ...
  */
	if (newvalue == 'undefined' || newvalue == null) {
		...
		data.card.head[_constant.CARD_FORM_CODE].rows[0].values.receivebankacc.value = data.newvalue.display;
	}
	...
	var successCallback = function successCallback(res) {
		...
		if (res.data.card.head) {
			...
			var hidereceivebank = this.props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'hidereceivebank');
			var receivebank = hidereceivebank && hidereceivebank.display;

			this.props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'receivebank': { value: receivebank } });
		}
	};
...
function doPayBankAcc(props, data) {
  ...
  */
	if (newvalue == 'undefined' || newvalue == null) {
		...
		data.card.head[_constant.CARD_FORM_CODE].rows[0].values.paybankacc.value = data.newvalue.display;
	}
	...
	var successCallback = function successCallback(res) {
		...
		if (res.data.card.head) {
			...
			var isBankType = res.data.isBankType;

			// 给出票人开户行、承兑人、承兑人开户行名设置文本值
			var hidepaybank = this.props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'hidepaybank');
			var paybank = hidepaybank && hidepaybank.display;
			...
			if (isBankType) {
				signagrbank = this.props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'signagrbank');
				acceptorbank = this.props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'acceptorbank');
			...
			// 商承：取pk_signagrbank 和 pk_acceptorbank
					...
					signagrbank = this.props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'pk_signagrbank');
					acceptorbank = this.props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'pk_acceptorbank');

					acceptorname = signagrbank && signagrbank.display;
					signagrbankname = acceptorbank && acceptorbank.display;
				}

			this, props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'paybank': { value: paybank } });
			this, props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'acceptorname': { value: acceptorname } });
			this, props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'signagrbankname': { value: signagrbankname } });
		}
	};
...
function doReceiveaccountEvent(props, data) {
  ...
  */
	...
	//连带清空签约账号开户行
	if (newvalue == 'undefined' || newvalue == null) {
		props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'receiveaccountname': { value: '' } });
		props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'pk_banktype': { value: '', display: '' } });
		return;
	}

	var bankname = data.newvalue.values['bd_bankdoc.name'].value;
	var pkbanktype = data.newvalue.values['bd_banktype.pk_banktype'].value;
	var pkbanktypeName = data.newvalue.values['bd_banktype.name'].value;
	props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'receiveaccountname': { value: bankname } });
	props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'pk_banktype': { value: pkbanktype, display: pkbanktypeName } });
}
	...
	if (newvalue == oldvalue || newvalue == 'undefined' || newvalue == null) {
		...
		var successCallback = function successCallback(res) {
			if (res.data.card.head) {
				//页面渲染,不能用这种方式，否则的话无法设置form和table的编辑性
				this.props.form.setAllFormValue(_defineProperty({}, _constant.CARD_FORM_CODE, res.data.card.head[_constant.CARD_FORM_CODE]));
				var result = res.data.quickMap;
				if (result.orgLocalCurrPK) {
					props.form.setFormItemsDisabled(_constant.CARD_FORM_CODE, { olcrate: false });
					props.form.setFormItemsDisabled(_constant.CARD_FORM_CODE, { olcmoney: false });
				} else {
					props.form.setFormItemsDisabled(_constant.CARD_FORM_CODE, { olcrate: true });
					props.form.setFormItemsDisabled(_constant.CARD_FORM_CODE, { olcmoney: true });
				}
				if (result.glcLocalCurrPK) {
					props.form.setFormItemsDisabled(_constant.CARD_FORM_CODE, { glcrate: false });
					props.form.setFormItemsDisabled(_constant.CARD_FORM_CODE, { glcmoney: false });
				} else {
					props.form.setFormItemsDisabled(_constant.CARD_FORM_CODE, { glcrate: true });
					props.form.setFormItemsDisabled(_constant.CARD_FORM_CODE, { glcmoney: true });
				}
				if (result.gllcgLocalCurrPK) {
					props.form.setFormItemsDisabled(_constant.CARD_FORM_CODE, { gllcrate: false });
					props.form.setFormItemsDisabled(_constant.CARD_FORM_CODE, { gllcmoney: false });
				} else {
					props.form.setFormItemsDisabled(_constant.CARD_FORM_CODE, { gllcrate: true });
					props.form.setFormItemsDisabled(_constant.CARD_FORM_CODE, { gllcmoney: true });
				}
				this.props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'hidepaybankacc': { value: "" } });
				this.props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'paybankacc': { value: "" } });

				this.props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'hidereceivebankacc': { value: "" } });
				this.props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'receivebankacc': { value: "" } });

				this.props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'hidereceivebank': { value: "" } });
				this.props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'receivebank': { value: "" } });

				this.props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'hidepaybank': { value: "" } });
				this.props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { 'paybank': { value: "" } });
			}
		};
...
function doFbmBilltypeEvent(props, data) {
  ...
  */
	if (newvalue == oldvalue) {
		...
		this.props.form.setFormItemsValue(_constant.CARD_FORM_CODE, { onlinebankflag: null });
		this.props.form.setFormItemsDisabled(_constant.CARD_FORM_CODE, { 'onlinebankflag': true });
		return;
	}
...
function modifierMeta(that, props, meta) {
	...
	meta[_constant.CARD_FORM_CODE].items.map(function (item) {
		...
		if (item.attrcode === 'paybillunit') {
			...
			item.queryCondition = function () {
				return {
					pk_org: props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'pk_org').value,
					pk_group: props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'pk_group').value
				};
			};
		}
		...
		if (item.attrcode == 'pk_entrustorg') {
			// item.showHistory = false;
			item.queryCondition = function () {
				var pk_org = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'pk_org');
				return {
		...
		if (item.attrcode == "gatherplanitem") {
			item.queryCondition = function () {
				var data = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, "pk_org").value;
				return { pk_org: data };
			};
		}
		...
		if (item.attrcode.indexOf("def") > -1) {
			item.queryCondition = function (p) {
				...
				var pk_org = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'pk_org').value;
				var pk_group = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'pk_group').value;
				return {
					pk_org: pk_org,
					pk_group: pk_group
	...
	meta[_constant.CARD_TABLE_CODE1].items.map(function (item) {
		...
		if (item.attrcode === 'payunit' || item.attrcode === 'receiveunit') {
			...
			item.queryCondition = function () {
				var pk_org = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'pk_org') && props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'pk_org').value;
				var pk_group = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'pk_group') && props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'pk_group').value;
				return {
					pk_org: pk_org,
					pk_group: pk_group
				};
	...
	meta[_constant.CARD_TABLE_CODE2].items.map(function (item) {
		...
		if (item.attrcode == 'receiveaccount') {
			...
			return item.queryCondition = function () {
				var pk_org = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'pk_org').value;
				var pk_currtype = props.form.getFormItemsValue(_constant.CARD_FORM_CODE, 'pk_curr').value;
				return {
					pk_org: pk_org, // 组织
					pk_curr: pk_currtype, //币种
...
function initTemplate1(props) {
	...
	props.createUIDom({
		pagecode: _constant.LINK_CARD_PAGE_CODE, //页面id
		appcode: appcode
	}, function (data) {
		if (data) {
			if (data.template) {
