...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/fbm/bankkeep/list/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/fbm/bankkeep/list/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
//小应用编码
var app_code = exports.app_code = '36180BT';
//联查小应用编码
var link_app_code = exports.link_app_code = '36180BTA';
//审批小应用编码
var approve_app_code = exports.approve_app_code = '36180BTA';
//请求基础路径
var base_path = exports.base_path = '/nccloud/fbm/bankkeep';
//按钮平铺显示数量
var button_limit = exports.button_limit = 3;
//打印输出编码
var nodekey = exports.nodekey = '36180BT';

var module_id = exports.module_id = '36180BT';
//单据类型
var billtype = exports.billtype = '36H3';
// 作废原因区域
...
var btns = exports.btns = {
    ...
    //缓存标示
};var DATA_SOURCE = exports.DATA_SOURCE = 'tm.fbm.bankkeep.datasource';
...
var _initTemplate = __webpack_require__(413);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(414);

var _initTemplate4 = _interopRequireDefault(_initTemplate3);

var _buttonDisable = __webpack_require__(415);
    ...
    value: function render() {
      var tabs = {
        ...
        items: [{
          key: "-1",
          name: "DTJ",
          title: this.props.MutiInit.getIntl("36180BT") && this.props.MutiInit.getIntl("36180BT").get("36180BT-000007")
        }, //* 国际化处理： 待提交*//* 国际化处理： this.props.MutiInit.getIntl("36180BT") && this.props.MutiInit.getIntl("36180BT").get('36180BT-000007')*/* 国际化处理： 国际化处理,待提交*/
        {
          key: "2,3",
          name: "SPZ",
          title: this.props.MutiInit.getIntl("36180BT") && this.props.MutiInit.getIntl("36180BT").get("36180BT-000008")
        ...
        {
          key: "all",
          title: this.props.MutiInit.getIntl("36180BT") && this.props.MutiInit.getIntl("36180BT").get("36180BT-000009") //* 国际化处理： 全部*//* 国际化处理： this.props.MutiInit.getIntl("36180BT") && this.props.MutiInit.getIntl("36180BT").get('36180BT-000009')*/* 国际化处理： 国际化处理,全部*/
        }],
      ...
      return _react2.default.createElement(_BaseList2.default, _extends({
        ...
        pageTitle: this.props.MutiInit.getIntl("36180BT") && this.props.MutiInit.getIntl("36180BT").get("36180BT-000004") //节点标题
...
exports.default = function (props) {
  ...
  var excelimportconfig = (0, _ncLightappFront.excelImportconfig)(props, "fbm", "36HF", true, "", {
    appcode: _constant.app_code,
    pagecode: _constant.CARD.page_id
  });
  var excelimportconfigq = (0, _ncLightappFront.excelImportconfig)(props, "fbm", "36HF1", true, "", {
    appcode: _constant.app_code,
    pagecode: _constant.CARD.page_id
  });
  ...
  props.createUIDom({
    ...
    if (data) {
      if (data.button) {
        ...
        props.button.setButtons(button);
        props.button.setPopContent("delete", _this.props.MutiInit.getIntl("36180BT") && _this.props.MutiInit.getIntl("36180BT").get("36180BT-000005")); //* 国际化处理： 确认要删除吗?*//* 国际化处理： 确认要删除吗?*/* 国际化处理： 国际化处理,确认要删除吗*/
        props.button.setPopContent("terminate", _this.props.MutiInit.getIntl("36180BT") && _this.props.MutiInit.getIntl("36180BT").get("36180BT-000006")); //* 国际化处理： 确认要终止吗?*//* 国际化处理： 确认要终止吗?*/* 国际化处理： 国际化处理,确认要终止吗*/
        ...
        props.button.setPopContent("DeleteInner", _this.props.MutiInit.getIntl("36180BT") && _this.props.MutiInit.getIntl("36180BT").get("36180BT-000005")); /* 国际化处理： 确认要删除吗?*/
      }
      if (data.template) {
        var meta = data.template;
...
function modifierMeta(props, meta) {
  ...
  meta[this.searchId].items.map(function (item) {
    ...
    if (item.attrcode === "glgx.pk_register.invoiceunit" || item.attrcode === "glgx.pk_register.hidereceiveunit") {
      item.queryCondition = function () {
        var pk_org = _this2.props.search.getSearchValByField(_this2.searchId, "pk_org");
