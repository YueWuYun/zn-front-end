...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/fbm/endoreAppr/main/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"));
	else
		root["fbm/fbm/endoreAppr/main/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"]);
        ...
        success: function success(res) {
            ...
            if (success) {
                ...
                if (_this.props.getUrlParam("status") === 'edit') {
                    ...
                    if (_this.billtype === "36H7") {
                        var transactresult = _this.props.form.getFormItemsValue(_this.formId, 'transactresult') && _this.props.form.getFormItemsValue(_this.formId, 'transactresult').value;
                        if (transactresult === 'disable') {
                            ...
                            _this.props.form.setFormItemsRequired("form_browser", {
                                //贴现银行账户
...
function cardEdit() {
    ...
    if (this.billtype === "36H7") {
        var transactresult = this.props.form.getFormItemsValue(this.formId, 'transactresult') && this.props.form.getFormItemsValue(this.formId, 'transactresult').value;
        if (transactresult === 'disable') {
            this.props.form.setFormItemsDisabled("form_browser", {
                //贴现银行账户
                discount_account: true,
...
exports.setBodyItemProp = setBodyItemProp;
...
*/
var setHeadItemProp = exports.setHeadItemProp = function setHeadItemProp(props, headCode, headItemProps) {
    var obj = {};
    var requireArray = {};
    headItemProps.forEach(function (element) {
...
function setBodyItemProp(props, bodyCode, bodyItemProps, body) {
    var flag = '';
    var tableItemProps = bodyItemProps[bodyCode];
    var tableValue = null;
    if (body) {
    ...
    for (var i = 0; i < tableItemProps.length; i++) {
        var rowId = tableItemProps[i].rowID;
        if (!rowId && tableValue) {
        ...
        props.cardTable.setEditableByRowId(bodyCode, rowId, tableItemProps[i].itemName, flag);
    }
}
 ...
 */
//请求后台接口基础路径
var BASE_URL = exports.BASE_URL = '/nccloud/fbm/endore/';
//审批appcode
var APP_CODE_A = exports.APP_CODE_A = '36180ET';
// 联查 appcode
var APP_CODE_LINK = exports.APP_CODE_LINK = '36630BLCL';
//小应用ID(??, 多语使用)
var MODULE_ID = exports.MODULE_ID = '36180ETAPPR';
// 按钮最大显示数
var BTNLIMIT = exports.BTNLIMIT = 3;

// 缓存KEY
var DATASOURCE = exports.DATASOURCE = 'fbm.fbm.endore.dataSource';
//单据类型
var BILLTYPE = exports.BILLTYPE = '36H9';

// 后端类全路径名
var FULL_AGGCLASSNAME = exports.FULL_AGGCLASSNAME = 'nc.vo.fbm.endore.AggEndoreVO';
...
function isEmptyObject(obj) {
    if (null === obj || typeof obj === "undefined") return true;else return false;
}
function isEmptyStr(obj) {
    if (null === obj || typeof obj === "undefined") return true;else if (obj === '') return true;else return false;
}
...
exports.default = buttonDisabledRule;

var _constant = __webpack_require__(196);

function buttonDisabledRule() {
  var _this = this;

  var selectedRowsLength = this.props.table.getCheckedRows(this.tableId).length;
  var checkRows = this.props.table.getCheckedRows(this.tableId);

  // 获取表格头部按钮
  var btns = this.props.button.getButtons().filter(function (item) {
    return item.area === _this.listHeadButtonArea;
  });
  // 获取需要进行规则控制的按钮
  ...
  if (selectedRowsLength === 0) {
    ...
    var enableBtn = selectEnableBtn(btns, checkRows[0]);
 ...
 */
var btnStatusControl = function btnStatusControl(buttons) {
  var btnsArray = [];
  var handleFunc = function handleFunc(btns) {
    btns.map(function (item) {
      if (item.key !== _constant.LIST_BTN.add && item.key !== _constant.LIST_BTN.refresh && item.key !== _constant.LIST_BTN.import && item.key !== _constant.LIST_BTN.export && item.key !== _constant.LIST_BTN.more) {
 ...
 * @param {*} checkedRow 
 */
var selectEnableBtn = function selectEnableBtn(buttons, checkedRow) {
  var billstatus = checkedRow.data.values.vbillstatus.value;
  // let isBillReceive = e.data.values.sfflag.value;  
  // let isnetBank = e.data.values.onlinebankflag.value;
  var removeDelBtn = void 0;
  if (billstatus !== '-1') {
    // 单据非自由态，去除删除按钮
    removeDelBtn = true;
  }
  ...
  buttons.map(function (item) {
    if (item === _constant.LIST_BTN.delete) {
      if (!removeDelBtn) {
        btns.push(item);
      }
    } else {
...
exports.getAssginUserCard = exports.compositeTurnOff = exports.billInitDataRule = exports.pageInfoClick = exports.setEditStatus = exports.afterEvent = exports.beforeEvent = exports.confirmOfDisableOnCard = exports.buttonClick = exports.buttonVisible = exports.initTemplate = undefined;

var _initTemplate = __webpack_require__(543);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _buttonVisible = __webpack_require__(544);

var _buttonVisible2 = _interopRequireDefault(_buttonVisible);

var _buttonClick = __webpack_require__(545);

var _beforeEvent = __webpack_require__(546);

var _beforeEvent2 = _interopRequireDefault(_beforeEvent);

var _afterEvent = __webpack_require__(305);

var _afterEvent2 = _interopRequireDefault(_afterEvent);

var _eventsUtils = __webpack_require__(547);

var _pageInfoClick = __webpack_require__(548);

var _pageInfoClick2 = _interopRequireDefault(_pageInfoClick);

var _billRule = __webpack_require__(304);

var _approvalEvent = __webpack_require__(549);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.initTemplate = _initTemplate2.default;
exports.buttonVisible = _buttonVisible2.default;
exports.buttonClick = _buttonClick.buttonClick;
exports.confirmOfDisableOnCard = _buttonClick.confirmOfDisableOnCard;
exports.beforeEvent = _beforeEvent2.default;
exports.afterEvent = _afterEvent2.default;
exports.setEditStatus = _eventsUtils.setEditStatus;
exports.pageInfoClick = _pageInfoClick2.default;
exports.billInitDataRule = _billRule.billInitDataRule;
exports.compositeTurnOff = _approvalEvent.compositeTurnOff;
exports.getAssginUserCard = _approvalEvent.getAssginUserCard;
...
exports.billInitDataRule = billInitDataRule;

var _constant = __webpack_require__(196);

var _commonUtil = __webpack_require__(207);
 ...
 * @param {*} data  // 单据数据
 */
function billInitDataRule(status, data) {
	switch (status) {
		case 'browse':
 ...
 * @param {*} data  单据数据
 */
var formBrowse = function formBrowse(data) {
	// // 设置画面为浏览态
	// setEditStatus.call(this, 'browse');
	if (!data) {
		// 如果没有单据数据传入，将清空主表所有数据
		this.props.form.EmptyAllFormValue(_constant.CARD.formHeadCode);
		// 将卡片页按钮全部隐藏
		this.props.button.hideButtonsByAreas(_constant.CARD.formHeadCode);
	}
};
...
var formAdd = function formAdd() {
	...
	if (this.state.curr_pk_org) {
		...
		this.props.form.setFormItemsValue(_constant.CARD.formHeadCode, {
			pk_org: pk_org, pk_org_v: pk_org_v
		});
		// this.props.resMetaAfterPkorgEdit();
		// 主动调用编辑后事件，带出默认财务组织的相关信息。
		_afterEvent.pk_orgAfterEdit.call(this, _constant.CARD.formHeadCode, 'pk_org', pk_org, null, true);
	} else {
 ...
 * @param {*} data 单据数据
 */
var formEdit = function formEdit(data) {
	if (data) {
		var id = this.props.getUrlParam('id');
		// 查询要修改的id对应的数据
		var getDataCallback = function getDataCallback(res) {
			if (res.data.head) {
				// 设置新数据
				this.props.form.setAllFormValue(_defineProperty({}, _constant.CARD.formHeadCode, res.data && res.data.head[_constant.CARD.formHeadCode]));
				// 如果是修改，要设置财务组织和单据编号不可编辑(必须在设置新数据之后再进行此步骤)
				this.props.form.setFormItemsDisabled(_constant.CARD.formHeadCode, { 'pk_org': true, 'vbillno': true });
				// 先把网银标志设为不可编辑，票据为电票时才能编辑
				this.props.form.setFormItemsDisabled(_constant.CARD.formHeadCode, { 'onlinebankflag': true });
				// 先把同行标志设为不可编辑，勾选网银后才能编辑
				this.props.form.setFormItemsDisabled(_constant.CARD.formHeadCode, { 'issamebank': true });
				// 勾选网银后才显示
		...
		var cardData = { pk: id };
		_commonUtil.doAjax.call(this, cardData, _constant.URI.endoreCardMainQuery, getDataCallback);
	}
};
 ...
 * @param {*} id 
 */
var formCopy = function formCopy() {
	// 复制选中单据 财务组织 背书单位 背书单位账号
	var oldId = this.props.getUrlParam('oldId');
 ...
 * @param {*} id
 */
var copyFormValues = function copyFormValues(id) {
	// 查询要复制的id对应的数据
	var getDataCallback = function getDataCallback(res) {
		if (res.data.head) {
			var values = res.data.head[_constant.CARD.formHeadCode].rows[0].values;
			var pk_org = values['pk_org']; // 财务组织
			var endorserbankacc = values['endorserbankacc']; // 背书单位账号
			...
			// 设置 背书单位账号 字段的值
			this.props.form.setFormItemsValue(_constant.CARD.formHeadCode, {
				endorserbankacc: endorserbankacc
			});
			// 类似财务组织字段编辑后事件
			var copyReqData = this.props.createHeadAfterEventData(_constant.CARD.pageCode, _constant.CARD.formHeadCode, '', _constant.CARD.formHeadCode, 'pk_org', pk_org);
			var copyCallback = function copyCallback(res) {
				// 设置新数据
				this.props.form.setAllFormValue(_defineProperty({}, _constant.CARD.formHeadCode, res.data.card && res.data.card.head[_constant.CARD.formHeadCode]));
				// 如果是复制，要设置财务组织不可编辑(必须在设置新数据之后再进行此步骤)
				this.props.form.setFormItemsDisabled(_constant.CARD.formHeadCode, { 'pk_org': true });
				// 先把网银标志设为不可编辑，票据为电票时才能编辑
				this.props.form.setFormItemsDisabled(_constant.CARD.formHeadCode, { 'onlinebankflag': true });
				// 先把同行标志设为不可编辑，勾选网银后才能编辑
				this.props.form.setFormItemsDisabled(_constant.CARD.formHeadCode, { 'issamebank': true });
			...
			_commonUtil.doAjax.call(this, copyReqData, _constant.URI.afterEvent, copyCallback);
		}
	};
	var cardData = { pk: id };
	_commonUtil.doAjax.call(this, cardData, _constant.URI.endoreCardMainQuery, getDataCallback);
...
exports.pk_orgAfterEdit = pk_orgAfterEdit;
...
var _FBMAfterEditUtil = __webpack_require__(186);
...
function afterEvent(props, moduleId, key, value, oldvalue) {
...
function pk_orgAfterEdit(moduleId, key, value, oldvalue, loadByDefOrg) {
	var eventdata = this.props.createHeadAfterEventData(_constant.CARD.pageCode, _constant.CARD.formHeadCode, '', moduleId, key, value);
	if (loadByDefOrg) {
		// 走后台编辑后事件
...
function changeOrgConfirm(eventdata, value) {
	this.props.form.EmptyAllFormValue(_constant.CARD.formHeadCode);
	if ((0, _commonUtil.isEmptyObject)(value.value)) {
		this.props.initMetaByPkorg();
	} else {
		getNewOrgInfo.call(this, eventdata);
	}
...
function getNewOrgInfo(eventdata) {
	...
	getDataAfterEvent.call(this, eventdata, function (res) {
		_this.props.form.setAllFormValue(_defineProperty({}, _constant.CARD.formHeadCode, res.data.card && res.data.card.head[_constant.CARD.formHeadCode]));
		//选择主组织以后，恢复其他字段的编辑性
		_this.props.resMetaAfterPkorgEdit();
		// 先把网银标志设为不可编辑，票据为电票时才能编辑
		_this.props.form.setFormItemsDisabled(_constant.CARD.formHeadCode, { onlinebankflag: true });
		// 先把同行标志设为不可编辑，勾选网银后才能编辑
		_this.props.form.setFormItemsDisabled(_constant.CARD.formHeadCode, { issamebank: true });
		// 勾选网银后才显示
		_this.props.form.setFormItemsVisible(_constant.CARD.formHeadCode, {
			banksubcompany: false
		});
	});
}
...
function pk_registerAfterEdit(moduleId, key, value, oldvalue) {
	...
	if ((0, _commonUtil.isEmptyObject)(value.values)) {
		eventdata.card.head[_constant.CARD.formHeadCode].rows[0].values.pk_register.display = '';
		eventdata.card.head[_constant.CARD.formHeadCode].rows[0].values.pk_register.value = '';
	}
	if (value.value !== oldvalue.value) {
		getDataAfterEvent.call(this, eventdata, function (res) {
			_this2.props.form.setAllFormValue(_defineProperty({}, _constant.CARD.formHeadCode, res.data.card && res.data.card.head[_constant.CARD.formHeadCode]));
			var isEbill = res.data.isEbill;
			// 票据类型为电票时，网银标识可编辑
			if (isEbill == true) {
				_this2.props.form.setFormItemsDisabled(_constant.CARD.formHeadCode, { onlinebankflag: false });
			}
			var fieldsEditable = res.data.fieldsEditable;
			if (fieldsEditable) {
				var items = [];
				...
				_FBMAfterEditUtil.setHeadItemProp.call(_this2, _this2.props, _constant.CARD.formHeadCode, items);
			}
		});
	}
}
...
function olcrateAfterEdit(moduleId, key, value, oldvalue) {
	...
	var eventdata = this.props.createHeadAfterEventData(this.pageId, _constant.CARD.formHeadCode, '', moduleId, key, value);
	// 空值，直接退出
	if ((0, _commonUtil.isEmptyObject)(value.value)) {
		return;
	}
	...
	if (value.value !== oldvalue.value) {
		getDataAfterEvent.call(this, eventdata, function (res) {
			_this3.props.form.setAllFormValue(_defineProperty({}, _constant.CARD.formHeadCode, res.data.card && res.data.card.head[_constant.CARD.formHeadCode]));
		});
	}
}
...
function onlinebankflagAfterEdit(moduleId, key, value, oldvalue) {
	...
	if (value.value) {
		// 同行标志，勾选网银后能编辑
		this.props.form.setFormItemsDisabled(_constant.CARD.formHeadCode, { issamebank: false });
		// 勾选网银后显示
		this.props.form.setFormItemsVisible(_constant.CARD.formHeadCode, {
			banksubcompany: true
		});
	} else {
		// 同行标志，取消勾选网银后不能编辑
...
exports.listBodyBtnClick = listBodyBtnClick;
exports.confirmOfDisableOnListBody = confirmOfDisableOnListBody;
...
function listBodyBtnClick(key, record, index) {
	console.log(key, record, index);
	// 当前行 主键
	var pk = record.pk_endore.value;
	switch (key) {
		case _constant.LIST_BODY_BTN.edit:
			// 编辑按钮
			this.props.pushTo('/card', {
				status: 'edit',
				pagecode: _constant.CARD.pageCode,
				id: pk
			});
			break;
		case _constant.LIST_BODY_BTN.delete:
			// 删除按钮
			handleDelInnerClick.call(this, pk, index, record);
			break;
		case _constant.LIST_BODY_BTN.commit:
			// 提交按钮
			handleCommitInnerClick.call(this, pk, index, record);
			break;
		case _constant.LIST_BODY_BTN.uncommit:
			// 收回按钮
			handleUncommitInnerClick.call(this, pk, index, record);
			break;
		case _constant.LIST_BODY_BTN.voucherMake:
			// 制证按钮
			handleVoucherInnerClick.call(this, pk, index, record);
			break;
		case _constant.LIST_BODY_BTN.voucherCancel:
			// 取消制证按钮
			handleUnVoucherInnerClick.call(this, pk, index, record);
			break;
		case _constant.LIST_BODY_BTN.commandSend:
			// 发送指令按钮
			handleSendCommandInnerClick.call(this, pk, index, record);
			break;
		case _constant.LIST_BODY_BTN.commandCancel:
			// 撤回指令按钮
			handleCancelCommandInnerClick.call(this, pk, index, record);
			break;
		case _constant.LIST_BODY_BTN.nullify:
			// 作废按钮
			handleDisableInnerClick.call(this, pk, index, record);
			break;
		case _constant.LIST_BODY_BTN.nullifyCancel:
			// 取消作废按钮
 ...
 *
 */
var handleDelInnerClick = function handleDelInnerClick(pk, index, record) {
	// 需要删除的主键数组
	var sendData = {
		pks: [pk]
	};
	...
	_commonUtil.doAjax.call(this, sendData, _constant.URI.endoreCardDelete, successCallback);
};
 ...
 * @param {*} index
 */
var handleCommitInnerClick = function handleCommitInnerClick(pk, index, record) {
	...
	_commonUtil.doAjax.call(this, sendData, _constant.URI.endoreListCommit, successCallback);
};
 ...
 * @param {*} record
 */
var handleUncommitInnerClick = function handleUncommitInnerClick(pk, index, record) {
	var ts = record.ts.value;
	...
	_commonUtil.doAjax.call(this, sendData, _constant.URI.endoreListUnCommit, successCallback);
};
 ...
 * @param {*} record
 */
var handleVoucherInnerClick = function handleVoucherInnerClick(pk, index, record) {
	var ts = record.ts.value;
	...
	var successCallback = function successCallback(res) {
		...
		if (res.data.status == 0) {
			(0, _ncLightappFront.toast)({
				color: 'danger',
				content: (0, _commonUtil.isEmptyObject)(res.data.errMsgs[0]) ? this.props.MutiInit.getIntl("36180ETAPPR") && this.props.MutiInit.getIntl("36180ETAPPR").get('36180ETAPPR-000030') : res.data.errMsgs[0] /* 国际化处理： 制证失败！*/
			});
		}
		// 全部成功
		if (res.data.status == 1) {
	...
	_commonUtil.doAjax.call(this, sendData, _constant.URI.endoreListVoucher, successCallback);
};
 ...
 * @param {*} record
 */
var handleUnVoucherInnerClick = function handleUnVoucherInnerClick(pk, index, record) {
	var ts = record.ts.value;
	...
	var successCallback = function successCallback(res) {
		...
		if (res.data.status == 0) {
			(0, _ncLightappFront.toast)({
				color: 'danger',
				content: (0, _commonUtil.isEmptyObject)(res.data.errMsgs[0]) ? this.props.MutiInit.getIntl("36180ETAPPR") && this.props.MutiInit.getIntl("36180ETAPPR").get('36180ETAPPR-000031') : res.data.errMsgs[0] /* 国际化处理： 取消制证失败！*/
			});
		}
		// 全部成功
		if (res.data.status == 1) {
	...
	_commonUtil.doAjax.call(this, sendData, _constant.URI.endoreListUnvoucher, successCallback);
};
 ...
 * @param {*} record
 */
var handleSendCommandInnerClick = function handleSendCommandInnerClick(pk, index, record) {
	var ts = record.ts.value;
	...
	var successCallback = function successCallback(res) {
		...
		if (res.data.status == 0) {
			(0, _ncLightappFront.toast)({
				color: 'danger',
				content: (0, _commonUtil.isEmptyObject)(res.data.errMsgs[0]) ? this.props.MutiInit.getIntl("36180ETAPPR") && this.props.MutiInit.getIntl("36180ETAPPR").get('36180ETAPPR-000032') : res.data.errMsgs[0] /* 国际化处理： 发送指令失败！*/
			});
		}
		// 全部成功
		if (res.data.status == 1) {
	...
	_commonUtil.doAjax.call(this, sendData, _constant.URI.endoreListCommandSend, successCallback);
};
 ...
 * @param {*} record
 */
var handleCancelCommandInnerClick = function handleCancelCommandInnerClick(pk, index, record) {
	var ts = record.ts.value;
	...
	var successCallback = function successCallback(res) {
		...
		if (res.data.status == 0) {
			(0, _ncLightappFront.toast)({
				color: 'danger',
				content: (0, _commonUtil.isEmptyObject)(res.data.errMsgs[0]) ? this.props.MutiInit.getIntl("36180ETAPPR") && this.props.MutiInit.getIntl("36180ETAPPR").get('36180ETAPPR-000033') : res.data.errMsgs[0] /* 国际化处理： 撤回指令失败！*/
			});
		}
		// 全部成功
		if (res.data.status == 1) {
	...
	_commonUtil.doAjax.call(this, sendData, _constant.URI.endoreListCommandCancel, successCallback);
};
 ...
 * @param {*} record
 */
var handleDisableInnerClick = function handleDisableInnerClick(pk, index, record) {
	var _this = this;
	...
	this.setState({
		...
		_this.props.form.setFormStatus(_this.disableNote, 'edit');
	});
};
 ...
 * @param {*} disableReason 
 */
function confirmOfDisableOnListBody(disableReason) {
	var pk = this.state.disableTmpData.key;
	var index = this.state.disableTmpData.index;
	var record = this.state.disableTmpData.record;
	var ts = record.ts.value;
	...
	var sendData = {
		...
		tss: [ts],
		isCardOpt: false,
		disableReason: disableReason[_constant.LIST.disableNote]
	};
	...
	var successCallback = function successCallback(res) {
		...
		if (res.data.status == 0) {
			(0, _ncLightappFront.toast)({
				color: 'danger',
				content: (0, _commonUtil.isEmptyObject)(res.data.errMsgs[0]) ? this.props.MutiInit.getIntl("36180ETAPPR") && this.props.MutiInit.getIntl("36180ETAPPR").get('36180ETAPPR-000034') : res.data.errMsgs[0] /* 国际化处理： 作废失败！*/
			});
		}
		// 全部成功
		if (res.data.status == 1) {
	...
	_commonUtil.doAjax.call(this, sendData, _constant.URI.endoreListNullify, successCallback);
}
 ...
 * @param {*} record
 */
var handleUnDisableInnerClick = function handleUnDisableInnerClick(pk, index, record) {
	var ts = record.ts.value;
	...
	var successCallback = function successCallback(res) {
		...
		if (res.data.status == 0) {
			(0, _ncLightappFront.toast)({
				color: 'danger',
				content: (0, _commonUtil.isEmptyObject)(res.data.errMsgs[0]) ? this.props.MutiInit.getIntl("36180ETAPPR") && this.props.MutiInit.getIntl("36180ETAPPR").get('36180ETAPPR-000035') : res.data.errMsgs[0] /* 国际化处理： 取消作废失败！*/
			});
		}
		// 全部成功
		if (res.data.status == 1) {
	...
	_commonUtil.doAjax.call(this, sendData, _constant.URI.endoreListNullifyCancel, successCallback);
};

// 处理按钮操作返回数据，刷新选中记录数据
function handleReturnData(that, record, data, index) {
	var returnData = data[_constant.LIST.tableCode].rows;
	//处理选择数据
	var pk_endore_h_check = record.pk_endore.value;
	returnData.forEach(function (returnval) {
		if (pk_endore_h_check === returnval.values.pk_endore.value) {
			var updateDataArr = [{
				index: index,
				data: { values: returnval.values }
			}];
			that.props.table.updateDataByIndexs(_constant.LIST.tableCode, updateDataArr);
		}
	});
}
...
exports.default = searchBtnClick;

var _ncLightappFront = __webpack_require__(1);

var _constant = __webpack_require__(196);

var _buttonDisabledRule = __webpack_require__(224);

var _buttonDisabledRule2 = _interopRequireDefault(_buttonDisabledRule);
...
var setDefData = _ncLightappFront.cardCache.setDefData,
    getDefData = _ncLightappFront.cardCache.getDefData;
function searchBtnClick(props, searchData) {
    // 缓存处理
    searchData = searchCatchHandle(searchData);
    // 如果刷新时 没有历史查询数据，则不进行查询操作
    if (!searchData) return;
    var searchOid = this.props.search.getQueryInfo(_constant.LIST.searchCode).oid;
    var pageInfo = this.props.table.getTablePageInfo(_constant.LIST.tableCode);
    // 整理查询数据
    var data = searchDataHandle(searchData, this.state.activeKey, pageInfo, searchOid);
    // 获取列表数据
    _commonUtil.doAjax.call(this, data, _constant.URI.endoreListMainQuery, setListRender);
}
 ...
 * @param {*} searchData
 */
var searchCatchHandle = function searchCatchHandle(searchData) {
    if (searchData && searchData.conditions && searchData.conditions.length > 0) {
        // 放入缓存
        setDefData(_constant.LIST.searchCode, _constant.DATASOURCE, searchData);
    } else {
        // 从缓存取出
        searchData = getDefData(_constant.LIST.searchCode, _constant.DATASOURCE);
        if (!searchData) {
            return;
        }
    }
 ...
 * @param {*} oid // 查询模版 oid
 */
var searchDataHandle = function searchDataHandle(searchData, status, pageInfo, oid) {
    return {
        ...
        pageInfo: pageInfo,
        pagecode: _constant.LIST.pageCode,
        //查询区编码
        queryAreaCode: _constant.LIST.searchCode,
 ...
 * @param {*} param0
 */
var setListRender = function setListRender(_ref) {
    var _ref$data = _ref.data,
        grid = _ref$data.grid,
        numvalues = _ref$data.numvalues;

    // 表格数据
    if (grid) {
        this.props.table.setAllTableData(_constant.LIST.tableCode, grid[_constant.LIST.tableCode]);
    } else {
        this.props.table.setAllTableData(_constant.LIST.tableCode, { rows: [] });
    }
    // 状态页签数据
    if (numvalues) {
        // 防止后台少传状态 造成页签内容显示不全
        this.setState({ numvalues: _extends({}, this.state.numvalues, numvalues) });
        //放入缓存
        setDefData("numvalues", _constant.DATASOURCE, this.state.numvalues);
        setDefData("activeKey", _constant.DATASOURCE, this.state.activeKey);
        if (parseInt(numvalues.ALL) < 1) {
            (0, _ncLightappFront.toast)({ color: "warning", content: this.props.MutiInit.getIntl("36180ETAPPR") && this.props.MutiInit.getIntl("36180ETAPPR").get('36180ETAPPR-000041') }); /* 国际化处理： 未查询出数据！*/
        } else {
            (0, _ncLightappFront.toast)({ color: "success", content: this.props.MutiInit.getIntl("36180ETAPPR") && this.props.MutiInit.getIntl("36180ETAPPR").get('36180ETAPPR-000042') }); /* 国际化处理： 查询成功!*/
        }
    }
    //放入缓存
    setDefData(_constant.LIST.tableCode, _constant.DATASOURCE, grid);
    // 重置按钮 状态
    _buttonDisabledRule2.default.call(this);
};
...
var Card = function (_Component) {
    ...
    function Card(props) {
        ...
        _this.handleBackBtnClick = function () {
            var linkFrom = _this.state.linkFrom;
            ...
            if (linkFrom && linkFrom === "card") {
                ...
                _ncLightappFront.pageTo.pushTo("/list");
            }
        };

        _this.controlPartPageDisplay = function () {
            var status = _this.props.getUrlParam("status");
            if (status === "browse") {
                _this.props.form.setFormStatus(_this.formHeadId, "browse");
                _this.props.BillHeadInfo.setBillHeadInfoVisible({
                ...
                _this.props.form.setFormStatus(_this.formHeadId, "edit");
                _this.props.BillHeadInfo.setBillHeadInfoVisible({
                    //控制显示返回按钮: true为显示,false为隐藏
                    showBackBtn: false,
                    //控制显示单据号：true为显示,false为隐藏
                ...
                _this.props.form.setFormStatus(_this.formHeadId, "add");
                _this.props.BillHeadInfo.setBillHeadInfoVisible({
                    //控制显示返回按钮: true为显示,false为隐藏
                    showBackBtn: false,
                    //控制显示单据号：true为显示,false为隐藏
        ...
        _this.formHeadId = _constant.CARD.formHeadCode; // 表头区域
        _this.onlineBankBillPoolId = _constant.CARD.onlineBankBillPoolCode; // 网银和票据池区域
        _this.billBasicInfoId = _constant.CARD.billBasicInfoCode; //  票据基本信息区域
        _this.clearInfoId = _constant.CARD.clearInfoCode; // 清算信息区域
        _this.operationInfoId = _constant.CARD.operationInfoCode; // 操作信息区域
        _this.disableNote = _constant.CARD.disableNote; // 作废原因区域
        _this.primaryId = "pk_endore";
        _this.moduleId = _constant.MODULE_ID; //多语使用
        _this.pageId = _this.props.getUrlParam("scene") == "linksce" ? _constant.CARD.pageCode_link : _constant.CARD.pageCode; //card页面code
        // this.primaryId = CARD.primaryId; //主键ID
        _this.cache = _constant.CARD.cardCache; //缓存key
        _this.state = {
        ...
        _events.initTemplate.call(_this);
        return _this;
    }
    ...
    _createClass(Card, [{
        ...
        value: function componentWillMount() {
            ...
            window.onbeforeunload = function () {
                if (!["browse"].includes(_this2.props.getUrlParam("status"))) {
                    return _this2.props.MutiInit.getIntl("36180ETAPPR") && _this2.props.MutiInit.getIntl("36180ETAPPR").get("36180ETAPPR-000021"); /* 国际化处理： 当前单据未保存, 您确定离开此页面？*/
                }
            };
        }
    }, {
        ...
        value: function setUIDisplay() {
            ...
            if (id) {
                ...
                var getDataCallback = function getDataCallback(res) {
                    if (res.data.head) {
                        // 页面赋值
                        this.props.form.setAllFormValue(_defineProperty({}, _constant.CARD.formHeadCode, res.data.head[_constant.CARD.formHeadCode]));
                        this.props.BillHeadInfo.setBillHeadInfoVisible({
                            // billCode: res.data.head[CARD.formHeadCode]
                            billCode: res.data.head[_constant.CARD.formHeadCode].rows[0].values.vbillno.value
                        });
                        var status = this.props.getUrlParam("status");
                        // 与数据无关的画面显示
                        this.controlPartPageDisplay();
                        // 控制按钮显示与数据相关
                        _events.buttonVisible.call(this, this.props);
                        // 根据数据与业务规则，对数据部分画面进行初始化
                        _events.billInitDataRule.call(this, status, res.data.head[_constant.CARD.formHeadCode]);
                    }
                };
                var cardData = { pk: id };
                _commonUtil.doAjax.call(this, cardData, _constant.URI.endoreCardMainQuery, getDataCallback);
                ...
                _events.buttonVisible.call(this, this.props);
                // 根据数据与业务规则，对数据部分画面进行初始化
                _events.billInitDataRule.call(this, status);
            }
        }
    }, {
        key: "render",
        value: function render() {
            ...
            var _state = this.state,
                ...
                disabledComShow = _state.disabledComShow,
                showApproveDetail = _state.showApproveDetail;

            var status = this.props.getUrlParam("status") === "browse";
            ...
            var pageType = this.props.getUrlParam("pageType");
            var isLink = this.props.getUrlParam("scene") == "linksce";
            return _react2.default.createElement(
                "div",
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            createBillHeadInfo({
                                title: this.props.MutiInit.getIntl("36180ETAPPR") && this.props.MutiInit.getIntl("36180ETAPPR").get("36180ETAPPR-000022") /* 国际化处理： 背书办理*/
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        createForm(this.formHeadId, {
                            expandArr: [_constant.CARD.onlineBankBillPoolCode], // 区域自动展开
                            onAfterEvent: _events.afterEvent.bind(this)
                            // onBeforeEvent: beforeEvent.bind(this)
                        })
                    )
                ),
                showUploader && _react2.default.createElement(NCUploader, _extends({}, billInfo, {
                    placement: "bottom",
                ...
                _react2.default.createElement(PrintOutput, {
                    ref: "printOutput",
                    url: _constant.URI.endoreCardPrintOutput,
                    data: printOutputInfo
                }),
                disabledComShow && _react2.default.createElement(_DisabledCom2.default, {
                    context: this,
                    show: disabledComShow,
                    title: this.props.MutiInit.getIntl("36180ETAPPR") && this.props.MutiInit.getIntl("36180ETAPPR").get("36180ETAPPR-000023") /* 国际化处理： 作废原因*/
                    , signCode: this.disableNote,
                    onSureCallback: _events.confirmOfDisableOnCard.bind(this)
                }),
                compositedisplay && _react2.default.createElement(ApprovalTrans, {
                    title: this.props.MutiInit.getIntl("36180ETAPPR") && this.props.MutiInit.getIntl("36180ETAPPR").get("36180ETAPPR-000024") /* 国际化处理： 指派*/
                    , data: compositedata,
                    display: compositedisplay,
                    getResult: _events.getAssginUserCard.bind(this),
                    cancel: _events.compositeTurnOff.bind(this)
                }),
...
Card = (0, _ncLightappFront.createPage)({
    billinfo: {
        billtype: "form",
        pagecode: _constant.CARD.pageCode,
        headcode: _constant.CARD.formHeadCode
    },
    mutiLangCode: _constant.MODULE_ID,
    orderOfHotKey: [_constant.CARD.formHeadCode]
})(Card);
...
exports.default = function () {
	...
	// });
	props.createUIDom({
		pagecode: _constant.CARD.pageCode, // 页面编码
		appcode: appcode // 应用编码
	}, function (data) {
		...
		if (button) {
			...
			// 先设置所有按钮不可见
			var allBtn = [];
			for (var value in _constant.CARD_BTN) {
				allBtn.push(_constant.CARD_BTN[value]);
			}
			props.button.setButtonVisible(allBtn, false);
		}
		if (template) {
			var meta = modifierMeta.call(_this, template, props);
			props.meta.setMeta(meta);
			var status = props.getUrlParam('status');
			if (status === 'browse') {
				// props.cardTable.setStatus(card_table_id, 'browse');
				var metaFromData = meta[_constant.CARD.formHeadCode];
				...
				meta[_constant.CARD.formHeadCode].items.forEach(function (val) {
					if (val.attrcode === 'pk_org') {
						val.visible = true;
						val.disabled = false;
						return;
		...
		if (data.context) {
			...
			// 保存默认的财务组织
			_this.setState({
				curr_pk_org: _context.pk_org,
				curr_orgname: _context.org_Name,
				curr_pk_org_v: _context.pk_org_v,
				curr_orgname_v: _context.org_v_Name
			});
		}
		// this.setState({
		// 	isInitTemplate:true
...
function modifierMeta(meta, props) {
	...
	meta[_constant.CARD.formHeadCode].items.map(function (item) {
		//财务组织用户过滤
		...
		if (item.attrcode === 'pk_register') {
			return item.queryCondition = function () {
				var pk_org = props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'pk_org').value;
				var busdate = props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'busdate').value;
				return {
					pk_org: pk_org,
					busdate: busdate,
...
// 按钮集合,根据单据状态区分
// 空白页按钮组
var BLANK = [_constant.CARD_BTN.add];
// 新增,编辑，复制
var EDIT = [_constant.CARD_BTN.save, _constant.CARD_BTN.saveAdd, _constant.CARD_BTN.saveCommit, _constant.CARD_BTN.cancel];
// 浏览已保存(-1)
var BROWSE_SAVE_SUCCESS = [_constant.CARD_BTN.add, _constant.CARD_BTN.edit, _constant.CARD_BTN.delete, _constant.CARD_BTN.copy, _constant.CARD_BTN.commit, // 标红
_constant.CARD_BTN.union, _constant.CARD_BTN.unionBillAccount, _constant.CARD_BTN.attackment, _constant.CARD_BTN.print, _constant.CARD_BTN.output, _constant.CARD_BTN.refresh];
// 浏览已提交
var BROWSE_COMMIT_SUCCESS = [_constant.CARD_BTN.add, _constant.CARD_BTN.copy, _constant.CARD_BTN.uncommit, _constant.CARD_BTN.union, _constant.CARD_BTN.unionBillAccount, _constant.CARD_BTN.unionApprovalDetails, _constant.CARD_BTN.attackment, _constant.CARD_BTN.print, _constant.CARD_BTN.output, _constant.CARD_BTN.refresh];
// 浏览审批进行中
var BROWSE_APPROVE_ON = [_constant.CARD_BTN.add, _constant.CARD_BTN.copy, _constant.CARD_BTN.commit, // 标红
_constant.CARD_BTN.uncommit, _constant.CARD_BTN.union, _constant.CARD_BTN.unionBillAccount, _constant.CARD_BTN.unionApprovalDetails, _constant.CARD_BTN.attackment, _constant.CARD_BTN.print, _constant.CARD_BTN.output, _constant.CARD_BTN.refresh];
// 浏览审批通过
var BROWSE_APPROVE_PASS = [_constant.CARD_BTN.add, _constant.CARD_BTN.copy, _constant.CARD_BTN.uncommit, _constant.CARD_BTN.union, _constant.CARD_BTN.unionBillAccount, _constant.CARD_BTN.unionApprovalDetails, _constant.CARD_BTN.attackment, _constant.CARD_BTN.print, _constant.CARD_BTN.output, _constant.CARD_BTN.refresh];
// 浏览审批未通过
var BROWSE_APPROVE_UNPASS = [
	// TODO
];
// 浏览审批通过已制证
var BROWSE_AFTER_VOUCHER = [_constant.CARD_BTN.add, _constant.CARD_BTN.copy, _constant.CARD_BTN.voucherCancel, _constant.CARD_BTN.union, _constant.CARD_BTN.unionBillAccount, _constant.CARD_BTN.unionApprovalDetails, _constant.CARD_BTN.attackment, _constant.CARD_BTN.print, _constant.CARD_BTN.output, _constant.CARD_BTN.refresh];
function buttonVisible(props) {
	...
	props.button.setButtonVisible(allBtn, false);
	var status = props.getUrlParam('status');
	var buttons = props.button.getButtons();
	if (status === 'browse') {
		// 云原生 事务异常 卡片态叹号 begin
		var saga_status = props.form.getFormItemsValue(this.formHeadId, 'saga_status') && props.form.getFormItemsValue(this.formHeadId, 'saga_status').value;
		...
		// 云原生 事务异常 卡片态叹号 end
		// 增加显示saga错误信息
		var saga_gtxid = props.form.getFormItemsValue(this.formHeadId, 'saga_gtxid') && props.form.getFormItemsValue(this.formHeadId, 'saga_gtxid').value;
		if (saga_gtxid && saga_status) {
			props.socket.showToast({
				gtxid: saga_gtxid,
...
// 根据单据状态控制按钮显隐性
var vbillstatusControl = function vbillstatusControl(props) {
	var billstatus = props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'vbillstatus') && props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'vbillstatus').value;
	// 判断显示制证与取消制证的标识
	var voucher = false;
	voucher = props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'voucher') && props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'voucher').value;
	// 判断显示发送指令与撤回指令的标识
	// 是否勾选网银
	var onlinebankflag = props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'onlinebankflag') && props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'onlinebankflag').value;
	// 支付指令状态
	var paymentstatus = props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'paymentstatus') && props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'paymentstatus').value;
	// 撤回指令状态
	var ecdswithdrawstatus = props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'ecdswithdrawstatus') && props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'ecdswithdrawstatus').value;
	// 判断显示作废与取消作废的标识
	var nullify = false;
	nullify = props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'disableflag') && props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'disableflag').value;
	var visibleBtn = [];
	switch (billstatus) {
		case '-1':
			//自由态
		...
		case '1':
			//审批通过
			var afterApprove = BROWSE_APPROVE_PASS;
			if (onlinebankflag) {
				// 网银
				if ('1' === paymentstatus) {
					// 支付指令成功
					if (voucher) {
						// 已制证
						afterApprove.push(_constant.CARD_BTN.voucherCancel);
						afterApprove.push(_constant.CARD_BTN.unionVoucher);
					} else {
						// 未制证
						afterApprove.push(_constant.CARD_BTN.voucherMake);
					}
				} else if ('2' === paymentstatus) {
					// 支付指令失败
					if (nullify) {
						// 已作废
						afterApprove.push(_constant.CARD_BTN.nullifyCancel);
					} else {
						// 未作废
						afterApprove.push(_constant.CARD_BTN.nullify);
					}
				} else if ('3' === paymentstatus) {
					// 支付指令交易不明
					afterApprove.push(_constant.CARD_BTN.commandCancel);
					if ((0, _commonUtil.isEmptyObject)(ecdswithdrawstatus) || (0, _commonUtil.isEmptyStr)(ecdswithdrawstatus) || '2' == ecdswithdrawstatus) {
						//撤回指令为空或失败可以再次发送指令
						afterApprove.push(_constant.CARD_BTN.commandSend);
					}
				} else {
					// 支付指令为空，没发过指令
					afterApprove.push(_constant.CARD_BTN.commandSend);
	...
	var syscode = props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'syscode') && props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'syscode').value;
	if (syscode != 'INPUT') {
		// 不是手工录入，联查付款单可用
		visibleBtn.push(_constant.CARD_BTN.unionPayBill);
	}
	// let endoreplanitem =
	...
	// }
	//	联查计划预算一直可用
	visibleBtn.push(_constant.CARD_BTN.unionFundsBudget);
			...
			while (1) {
				switch (_context.prev = _context.next) {
					case 0:
						...
						cardData = (0, _index.createSimpleBillData)(props, _constant.CARD.pageCode, _constant.CARD.formHeadCode, [], false);
					...
					case 9:
						...
						saveBeforePk = this.props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'pk_endore');

						saveCallback = function saveCallback(res) {
							if (res.data.head) {
								this.props.form.setAllFormValue(_defineProperty({}, _constant.CARD.formHeadCode, res.data.head[_constant.CARD.formHeadCode]));
								//页签赋值
								var pk_endore = res.data.head[_constant.CARD.formHeadCode].rows[0].values.pk_endore;
								var vbillno = res.data.head[_constant.CARD.formHeadCode].rows[0].values.vbillno;
								this.setState({
								...
								if (saveBeforePk && saveBeforePk.value) {
									updateCache('pk_endore', res.data.head[_constant.CARD.formHeadCode].rows[0].values.pk_endore.value, res.data, _constant.CARD.formHeadCode, _constant.DATASOURCE, res.data.head[_constant.CARD.formHeadCode].rows[0].values);
								} else {
									addCache(res.data.head[_constant.CARD.formHeadCode].rows[0].values.pk_endore.value, res.data, _constant.CARD.formHeadCode, _constant.DATASOURCE, res.data.head[_constant.CARD.formHeadCode].rows[0].values);
								}
								...
								if (isCommit) {
									doCommit.call(this, props, _constant.CARD_BTN.saveCommit);
									return;
								}
								if (!isAdd && !isCommit) {
									this.setUIDisplay();
						...
						_commonUtil.doAjax.call(this, cardData, _constant.URI.endoreCardSave, saveCallback);
...
exports.confirmOfDisableOnCard = confirmOfDisableOnCard;
...
var getNextId = _ncLightappFront.cardCache.getNextId,
    deleteCacheById = _ncLightappFront.cardCache.deleteCacheById,
    updateCache = _ncLightappFront.cardCache.updateCache,
    addCache = _ncLightappFront.cardCache.addCache; //配置的id和area信息

function buttonClick(props, id) {
	switch (id) {
		// 新增
		case _constant.CARD_BTN.add:
			doAdd.call(this, props);
			break;

		// 保存
		case _constant.CARD_BTN.save:
			doSave.call(this, props, true, false, false);
			break;

		// 保存新增
		case _constant.CARD_BTN.saveAdd:
			doSaveAdd.call(this, props);
			break;

		// 保存提交
		case _constant.CARD_BTN.saveCommit:
			doSaveCommit.call(this, props);
			break;

		// 取消
		case _constant.CARD_BTN.cancel:
			(0, _ncLightappFront.promptBox)({
		...
		// 复制
		case _constant.CARD_BTN.copy:
			doCopy.call(this, props);
			break;

		// 编辑
		case _constant.CARD_BTN.edit:
			doEdit.call(this, props);
			break;

		// 删除
		case _constant.CARD_BTN.delete:
			(0, _ncLightappFront.promptBox)({
		...
		// 提交
		case _constant.CARD_BTN.commit:
			doCommit.call(this, props, _constant.CARD_BTN.commit);
			break;

		// 收回
		case _constant.CARD_BTN.uncommit:
			doUnCommit.call(this, props);
			break;

		//发送指令
		case _constant.CARD_BTN.commandSend:
			doSendCommand.call(this, props);
			break;

		//撤回指令
		case _constant.CARD_BTN.commandCancel:
			doCancelCommand.call(this, props);
			break;

		//制证
		case _constant.CARD_BTN.voucherMake:
			doMkVoucher.call(this, props);
			break;

		//取消制证
		case _constant.CARD_BTN.voucherCancel:
			doVoucherCancel.call(this, props);
			break;

		//作废
		case _constant.CARD_BTN.nullify:
			doDisable.call(this);
			break;

		//取消作废
		case _constant.CARD_BTN.nullifyCancel:
			doUnDisable.call(this, props);
			break;

		//附件
		case _constant.CARD_BTN.attackment:
			doFiled.call(this, props);
			break;

		//打印
		case _constant.CARD_BTN.print:
			doPrint.call(this, props);
			break;

		//输出
		case _constant.CARD_BTN.output:
			doOutPut.call(this, props);
			break;

		//联查 票据台账
		case _constant.CARD_BTN.unionBillAccount:
			doLinkBook.call(this, props);
			break;

		//联查 付款单
		case _constant.CARD_BTN.unionPayBill:
			doLinkBill.call(this, props);
			break;

		//联查 审批详情
		case _constant.CARD_BTN.unionApprovalDetails:
			doLinkApprove.call(this, props);
			break;
		//联查 联查凭证
		case _constant.CARD_BTN.unionVoucher:
			doLinkVoucher.call(this, props);
			break;

		//联查 资金预算
		case _constant.CARD_BTN.unionFundsBudget:
			doLinkNtb.call(this, props);
			break;

		//刷新
		case _constant.CARD_BTN.refresh:
...
function doAdd(props) {
	var pk = props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'pk_endore') && props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'pk_endore').value;
	if (!pk) {
		pk = '';
	}
	this.props.setUrlParam({
...
function doDelete(props) {
	...
	var successCallback = function successCallback(res) {
		(0, _ncLightappFront.toast)({ color: 'success', content: this.props.MutiInit.getIntl("36180ETAPPR") && this.props.MutiInit.getIntl("36180ETAPPR").get('36180ETAPPR-000009') }); /* 国际化处理： 删除成功!*/

		var deleteid = this.props.getUrlParam('id');
		var deletenextId = getNextId(deleteid, _constant.DATASOURCE);
		deleteCacheById('pk_endore', deleteid, _constant.DATASOURCE);
...
function doCancel(props) {
	...
	if (status === 'edit') {
		...
		if (id) {
			...
			var _status = this.props.getUrlParam('status');
			// 与数据无关的画面显示
			this.controlPartPageDisplay();
			// 根据数据与业务规则，对数据部分画面进行初始化
			_billRule.billInitDataRule.call(this, _status);
		}
	} else if (status === 'copy') {
		var oldId = this.props.getUrlParam('oldId');
		//复制中的取消操作
...
function doCommit(props, callWay) {
	var pk = props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'pk_endore');
	var ts = props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'ts');

	var sendData = {
		pageid: _constant.CARD.pageCode,
		pks: [pk && pk.value],
		tss: [ts && ts.value],
		isCardOpt: true
	};
	...
	var successCallback = function successCallback(res) {
		...
		if (res.data && res.data.errMsg) {
			(0, _ncLightappFront.toast)({ color: 'danger', content: res.data.errMsg });
		} else {
			if (res.data.workflow && (res.data.workflow === 'approveflow' || res.data.workflow === 'workflow')) {
				that.setState({
					compositedata: res.data,
				...
				if (res.data.head) {
					that.props.form.setAllFormValue(_defineProperty({}, _constant.CARD.formHeadCode, res.data.head[_constant.CARD.formHeadCode]));
					updateCache('pk_endore', pk && pk.value, res.data, _constant.CARD.formHeadCode, _constant.DATASOURCE);
					if (_constant.CARD_BTN.commit === callWay) {
						(0, _ncLightappFront.toast)({
							color: 'success',
							content: this.props.MutiInit.getIntl("36180ETAPPR") && this.props.MutiInit.getIntl("36180ETAPPR").get('36180ETAPPR-000002') /* 国际化处理： 提交成功！*/
						});
					} else if (_constant.CARD_BTN.saveCommit) {
						(0, _ncLightappFront.toast)({
							color: 'success',
	...
	_commonUtil.doAjax.call(this, sendData, _constant.URI.endoreCardCommit, successCallback);
}
...
function doUnCommit(props) {
	...
	var successCallback = function successCallback(res) {
		...
		if (res.data && res.data.errMsgs && res.data.errMsgs.length > 0) {
			(0, _ncLightappFront.toast)({ color: 'danger', content: res.data.errMsgs[0] });
		} else {
			if (res.data.card.head) {
				that.props.form.setAllFormValue(_defineProperty({}, _constant.CARD.formHeadCode, res.data.card.head[_constant.CARD.formHeadCode]));
				updateCache('pk_endore', pk && pk.value, res.data.card, _constant.CARD.formHeadCode, _constant.DATASOURCE);
				(0, _ncLightappFront.toast)({
					color: 'success',
					content: this.props.MutiInit.getIntl("36180ETAPPR") && this.props.MutiInit.getIntl("36180ETAPPR").get('36180ETAPPR-000011') /* 国际化处理： 收回成功！*/
				});
	...
	_commonUtil.doAjax.call(this, sendData, _constant.URI.endoreCardUncommit, successCallback);
}
...
function doSendCommand(props) {
	...
	_commonUtil.doAjax.call(this, sendData, _constant.URI.endoreCardCommandSend, successCallback);
}
...
function doCancelCommand(props) {
	...
	_commonUtil.doAjax.call(this, sendData, _constant.URI.endoreCardCommandCancel, successCallback);
}
...
function doMkVoucher(props) {
	...
	_commonUtil.doAjax.call(this, sendData, _constant.URI.endoreCardVoucher, callback);
}
...
function doVoucherCancel(props) {
	...
	var callback = function callback(res) {
		if (res.data) {
			if (res.data && res.data.errMsgs && res.data.errMsgs.length > 0) {
				...
				if (res.data.card.head) {
					this.props.form.setAllFormValue(_defineProperty({}, _constant.CARD.formHeadCode, res.data.card.head[_constant.CARD.formHeadCode]));
					updateCache('pk_endore', pk && pk.value, res.data.card, _constant.CARD.formHeadCode, _constant.DATASOURCE);
					(0, _ncLightappFront.toast)({
						color: 'success',
						content: this.props.MutiInit.getIntl("36180ETAPPR") && this.props.MutiInit.getIntl("36180ETAPPR").get('36180ETAPPR-000015') /* 国际化处理： 取消制证成功！*/
	...
	_commonUtil.doAjax.call(this, sendData, _constant.URI.endoreCardUnvoucher, callback);
}
 ...
 * @param {*} disableReason 
 */
function confirmOfDisableOnCard(disableReason) {
	var that = this;
	var pk = that.props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'pk_endore');
	var ts = that.props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'ts');
	...
	var sendData = {
		...
		tss: [ts && ts.value],
		isCardOpt: true,
		disableReason: disableReason[_constant.CARD.disableNote]
	};
	...
	_commonUtil.doAjax.call(this, sendData, _constant.URI.endoreCardNullify, callback);
}
/**
 * 取消作废
 * @param {*} props 
...
function doUnDisable(props) {
	...
	_commonUtil.doAjax.call(this, sendData, _constant.URI.endoreCardNullifyCancel, callback);
}
...
function doLinkVoucher(props) {
	//拼接联查数据,支持批量联查
	var pk_group = props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'pk_group') && props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'pk_group').value;
	var pk_org = props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'pk_org') && props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'pk_org').value;
	var pk_endore = props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'pk_endore') && props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'pk_endore').value;
	var sendData = [{
		pk_group: pk_group, //集团主键
		pk_org: pk_org, //组织主键
		relationID: pk_endore, //单据主键
		pk_billtype: _constant.BILLTYPE //交易类型
	}];
	var successCallback = function successCallback(res) {
		if (res.success) {
			var srcCode = res.data.src;
			if ('_LinkVouchar2019' == srcCode) {
				...
				(0, _ncLightappFront.toast)({ color: 'warning', content: this.props.MutiInit.getIntl("36180ETAPPR") && this.props.MutiInit.getIntl("36180ETAPPR").get('36180ETAPPR-000019') }); /* 国际化处理： 未查到凭证*/
				return;
			}
		}
	};
	_commonUtil.doAjax.call(this, sendData, _constant.URI.endoreCardLinkVoucher, successCallback);
}
...
function doLinkBill(props) {
	var pk_endore = props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'pk_endore');
	pk_endore = pk_endore && pk_endore.value;
	var pk_register = props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'pk_register');
	...
	_commonUtil.doAjax.call(this, sendData, _constant.URI.endoreCardLinkPayBill, successaCallback);
}
...
function doLinkNtb(props) {
	var pk = props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'pk_endore').value;
	var successCallback = function successCallback(res) {
		var data = res.data;
	...
	_commonUtil.doAjax.call(this, sendData, _constant.URI.endoreCardLinkNtb, successCallback);
}
...
function doLinkBook(props) {
	var pk_register = props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'pk_register').value;
	this.props.openTo('/fbm/fbm/counterbook/main/index.html#/card', {
		billtype: "36HM", // 单据类型管理中的 (目标应用)类型代码 
...
function doLinkApprove(props) {
	var billid = props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'pk_endore');
	this.setState({
		showApproveDetail: true,
		billInfo: {
...
function doFiled(props) {
	var billno = props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'vbillno').value;
	var pk_endore = props.getUrlParam('id');
...
function doPrint(props) {
	...
	'pdf', _constant.URI.endoreCardPrintOutput, {
		appcode: appcode,
...
function doRefresh(props, showToast) {
	...
	var successCallback = function successCallback(res) {
		if (res.data) {
			...
			var titleno = res.data.head[_constant.CARD.formHeadCode].rows[0].values.vbillno.value;
			this.setState({
				billNo: titleno
			});
			this.setUIDisplay.call(this);
	...
	_commonUtil.doAjax.call(this, queryData, _constant.URI.endoreCardMainQuery, successCallback);
}
...
function beforeSave(props) {
	var inputCheckFlag = props.form.isCheckNow(this.formHeadId); //是否校验通过，必输项等
	var cusCheckFlag = customCheckBeforeSave.call(this, props); //自定义校验内容
...
exports.default = beforeEvent;
/**
 * 背书办理卡片界面 编辑前事件
 * @author：gaokung
 */
function beforeEvent(params) {}
...
function setEditStatus(status) {
  this.props.form.setFormStatus(_constant.CARD.formHeadCode, status);
...
function pageInfoClick(props, pk) {
	...
	// 有缓存用缓存的数据，没有缓存就重新查
	if (cardData) {
		props.form.setAllFormValue(_defineProperty({}, _constant.CARD.formHeadCode, cardData.head[_constant.CARD.formHeadCode]));
		var vbillno = cardData.head[_constant.CARD.formHeadCode].rows[0].values.vbillno.value;
		this.setState({
			billNo: vbillno
		});
		this.setUIDisplay();
		...
		var callback = function callback(res) {
			if (res.data) {
				this.props.form.setAllFormValue(_defineProperty({}, _constant.CARD.formHeadCode, res.data.head[_constant.CARD.formHeadCode]));
				_ncLightappFront.cardCache.updateCache('pk_endore', pk, res.data, _constant.CARD.formHeadCode, _constant.DATASOURCE);
				var _vbillno = res.data.head[_constant.CARD.formHeadCode].rows[0].values.vbillno.value;
				...
				this.props.form.setAllFormValue(_defineProperty({}, _constant.CARD.formHeadCode, {}));
			}
		};
		_commonUtil.doAjax.call(this, data, _constant.URI.endoreCardMainQuery, callback);
	}
}
...
exports.compositeTurnOff = compositeTurnOff;
exports.getAssginUserCard = getAssginUserCard;
...
function compositeTurnOff() {
	this.setState({
		compositedata: null,
		compositedisplay: false
	});
}
function getAssginUserCard(userObj) {
	var pk = this.props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'pk_endore');
	var ts = this.props.form.getFormItemsValue(_constant.CARD.formHeadCode, 'ts');
	var sendData = {
		pageid: _constant.CARD.pageCode,
		pks: [pk && pk.value],
		tss: [ts && ts.value],
	...
	_commonUtil.doAjax.call(this, sendData, _constant.URI.endoreCardCommit, success);
}
...
var _events = __webpack_require__(553);
...
var List = function (_Component) {
    ...
    function List(props) {
        ...
        _this.createNCTabPane = function () {
            var numvalues = _this.state.numvalues;

            var tabsArray = [];
            for (var key in numvalues) {
                if (numvalues.hasOwnProperty(key)) {
                    var title = "";
                    var num = numvalues[key];
                    switch (key) {
                        case "NOT_COMMIT":
                            title = _this.props.MutiInit.getIntl("36180ETAPPR") && _this.props.MutiInit.getIntl("36180ETAPPR").get("36180ETAPPR-000043"); /* 国际化处理： 待提交*/
                            break;
                        case "IN_APPROVE":
                            title = _this.props.MutiInit.getIntl("36180ETAPPR") && _this.props.MutiInit.getIntl("36180ETAPPR").get("36180ETAPPR-000044"); /* 国际化处理： 审批中*/
                            break;
                        case "ALL":
                            title = _this.props.MutiInit.getIntl("36180ETAPPR") && _this.props.MutiInit.getIntl("36180ETAPPR").get("36180ETAPPR-000045"); /* 国际化处理： 全部*/
                            break;
                        default:
                            break;
                    }
        ...
        _this.handleTabChange = function (status) {
            var newActiveKey = "";
            switch (status) {
                case "NOT_COMMIT":
                    newActiveKey = -1;
            ...
            if (activeKey != newActiveKey) {
                _this.setState({
                    ...
                    _events.searchBtnClick.call(_this);
                });
                return;
            } else {
                _this.setState({
        ...
        _this.tableId = _constant.LIST.tableCode; // 列表区域 code
        _this.listHeadButtonArea = _constant.LIST.btnCode; // 列表表头按钮区域 code
        _this.disableNote = _constant.LIST.disableNote; // 作废原因区域
    ...
    _createClass(List, [{
        ...
        key: "componentDidMount",
        value: function componentDidMount() {
            _events.initTemplate.call(this);
            //获取页签数据
        ...
        key: "disableDialogCallBack",
        value: function disableDialogCallBack(disableReason) {
            if (this.state.disableClickBtn === "") {
                return;
            }
            if (this.state.disableClickBtn === "HEAD") {
                _events.confirmOfDisableOnListHead.call(this, disableReason);
            }
            if (this.state.disableClickBtn === "BODY") {
                _events.confirmOfDisableOnListBody.call(this, disableReason);
            }
        }
    }, {
        key: "render",
        value: function render() {
            ...
            return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            createButtonApp({
                                ...
                                onButtonClick: _events.listHeadBtnClick.bind(this)
                            })
                        )
                    )
                ),
                _react2.default.createElement(
                    ...
                    NCCreateSearch(_constant.LIST.searchCode, {
                        clickSearchBtn: _events.searchBtnClick.bind(this),
                ...
                _react2.default.createElement(
                    ...
                    this.createNCTabPane().map(function (item) {
                        if (item.status != "ALL") {
                            return _react2.default.createElement(NCTabPane, {
                ...
                _react2.default.createElement(
                    ...
                    createSimpleTable(this.tableId, {
                        ...
                        pkname: _constant.LIST.primaryId,
                        onSelected: _events.selectedEvent.bind(this),
                        onSelectedAll: _events.selectedEvent.bind(this),
                        onRowDoubleClick: _events.onRowDoubleClick.bind(this),
                        componentInitFinished: function componentInitFinished() {
                            //缓存数据赋值成功的钩子函数
                            //若初始化数据后需要对数据做修改，可以在这里处理

                            // 初始化列表页的按钮可用性
                            _events.buttonDisabledRule.call(_this2);
                        }
                    })
                ),
                _react2.default.createElement(PrintOutput, {
                    ref: "printOutput",
                    url: _constant.URI.endoreListPrintOutput,
                    data: printOutputInfo
                }),
                showUploader && _react2.default.createElement(NCUploader, _extends({}, billInfo, {
                    placement: "bottom",
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(ExcelImport, _extends({}, Object.assign(this.props), {
                        moduleName: "fbm" //模块名
                        , billType: _constant.BILLTYPE //单据类型
                        , pagecode: _constant.CARD.pageCode,
                        appcode: this.appcode,
...
exports.compositeTurnOff = exports.getAssginUserCard = exports.buttonDisabledRule = exports.selectedEvent = exports.searchBtnClick = exports.pageInfoClick = exports.onRowDoubleClick = exports.confirmOfDisableOnListBody = exports.listBodyBtnClick = exports.confirmOfDisableOnListHead = exports.listHeadBtnClick = exports.initTemplate = undefined;

var _initTemplate = __webpack_require__(554);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _listHeadBtnClick = __webpack_require__(555);

var _listBodyBtnClick = __webpack_require__(306);

var _onRowDoubleClick = __webpack_require__(557);

var _onRowDoubleClick2 = _interopRequireDefault(_onRowDoubleClick);

var _pageInfoClick = __webpack_require__(558);

var _pageInfoClick2 = _interopRequireDefault(_pageInfoClick);

var _searchBtnClick = __webpack_require__(307);

var _searchBtnClick2 = _interopRequireDefault(_searchBtnClick);

var _selectedEvent = __webpack_require__(559);
...
var _approvalEvent = __webpack_require__(560);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.initTemplate = _initTemplate2.default;
exports.listHeadBtnClick = _listHeadBtnClick.listHeadBtnClick;
exports.confirmOfDisableOnListHead = _listHeadBtnClick.confirmOfDisableOnListHead;
exports.listBodyBtnClick = _listBodyBtnClick.listBodyBtnClick;
exports.confirmOfDisableOnListBody = _listBodyBtnClick.confirmOfDisableOnListBody;
exports.onRowDoubleClick = _onRowDoubleClick2.default;
exports.pageInfoClick = _pageInfoClick2.default;
exports.searchBtnClick = _searchBtnClick2.default;
exports.selectedEvent = _selectedEvent2.default;
exports.buttonDisabledRule = _buttonDisabledRule2.default;
exports.getAssginUserCard = _approvalEvent.getAssginUserCard;
exports.compositeTurnOff = _approvalEvent.compositeTurnOff;
...
var initTemplate = function initTemplate() {
	...
	var props = this.props;
	var appcode = props.getSearchParam('c') || props.getUrlParam('c');
	var excelimportconfig = (0, _ncLightappFront.excelImportconfig)(props, 'fbm', _constant.BILLTYPE, true, '', {
		appcode: appcode,
		pagecode: _constant.CARD.pageCode
	});
	...
	props.createUIDom({
		...
		if (!template[_constant.LIST.tableCode]) {
			return;
		}
		if (button) {
			props.button.setButtons(button);
			...
			// 按钮可使用规则
			_buttonDisabledRule2.default.call(_this);
		}
		if (template) {
			//列表查询区域加载默认业务单元
			(0, _util.setDefOrg2ListSrchArea)(props, _constant.LIST.searchCode, data);
			//高级查询区域加载默认业务单元
			(0, _util.setDefOrg2AdvanceSrchArea)(props, _constant.LIST.searchCode, data);
			template = modifierMeta.call(_this, props, template);
			props.meta.setMeta(template);
			var meta = props.meta.getMeta();
			var oid = meta.search.oid;
			_this.setState({ oid: oid });
		}
	});
};
...
function modifierMeta(props, meta) {
	...
	meta[_constant.LIST.tableCode].items = meta[_constant.LIST.tableCode].items.map(function (item, key) {
						...
						onClick: function onClick() {
							if (props.getUrlParam('scene') === 'linksce' || props.getUrlParam('scene') === 'fip') {
								props.pushTo('/card', {
									...
									pagecode: _constant.CARD.pageCode_link,
									scene: 'linksce'
								});
							} else {
								props.pushTo('/card', {
	...
	//添加操作列
	meta[_constant.LIST.tableCode].items.push({
		...
		render: function render(text, record, index) {
			...
			// 判断显示发送指令与撤回指令的标识
			// 是否勾选网银
			var onlinebankflag = record.onlinebankflag && record.onlinebankflag.value;
			// 支付指令状态
			var paymentstatus = record.paymentstatus && record.paymentstatus.value;
			// 撤回指令状态
			var ecdswithdrawstatus = record.ecdswithdrawstatus && record.ecdswithdrawstatus.value;
			// 判断显示作废与取消作废的标识
			var disableflag = record.disableflag && record.disableflag.value;
			switch (vbillstatus) {
				case '-1':
					//自由态
					buttonArry = [_constant.LIST_BODY_BTN.delete, _constant.LIST_BODY_BTN.edit, _constant.LIST_BODY_BTN.commit];
					break;
				case '0':
					//审批未通过
					buttonArry = [_constant.LIST_BODY_BTN.commit];
					break;
				case '1':
					//审批通过
					if (onlinebankflag) {
						...
						if ('1' === paymentstatus) {
							...
							if (voucher) {
								// 已制证
								buttonArry = [_constant.LIST_BODY_BTN.voucherCancel];
							} else {
								// 未制证
								buttonArry = [_constant.LIST_BODY_BTN.voucherMake];
							}
						} else if ('2' === paymentstatus) {
							// 支付指令失败
							if (disableflag) {
								// 已作废
								buttonArry = [_constant.LIST_BODY_BTN.nullifyCancel];
							} else {
								// 未作废
								buttonArry = [_constant.LIST_BODY_BTN.nullify];
							}
						} else if ('3' === paymentstatus) {
							// 支付指令交易不明
							buttonArry = [_constant.LIST_BODY_BTN.commandCancel];
							// 撤回指令为空或失败可以再次发送指令
							if ((0, _commonUtil.isEmptyObject)(ecdswithdrawstatus) || (0, _commonUtil.isEmptyStr)(ecdswithdrawstatus) || '2' == ecdswithdrawstatus) {
								buttonArry = [_constant.LIST_BODY_BTN.commandCancel];
								buttonArry.push(_constant.LIST_BODY_BTN.commandSend);
							}
						} else {
							// 支付指令为空，没发过指令
							buttonArry = [_constant.LIST_BODY_BTN.uncommit, _constant.LIST_BODY_BTN.commandSend];
						}
					} else {
						// 非网银
						if (voucher) {
							...
							//未制证
							buttonArry = [_constant.LIST_BODY_BTN.uncommit, _constant.LIST_BODY_BTN.voucherMake];
						}
					}
					break;
				case '2':
				...
				case '3':
					//提交
					buttonArry = [_constant.LIST_BODY_BTN.uncommit];
					break;
			}
			return props.button.createOprationButton(buttonArry, {
				area: _constant.LIST.bodyCode,
				buttonLimit: 3,
				onButtonClick: function onButtonClick(props, key) {
					return _listBodyBtnClick.listBodyBtnClick.call(_this2, key, record, index);
				}
			});
		}
	});
...
exports.listHeadBtnClick = listHeadBtnClick;
exports.confirmOfDisableOnListHead = confirmOfDisableOnListHead;
...
var _messageUtil = __webpack_require__(556);
 ...
 * @author：gaokung
 */
function listHeadBtnClick(props, key) {
	var selectedRows = void 0;
	if (key !== _constant.LIST_BTN.add) {
		// 获取选中行
		selectedRows = this.props.table.getCheckedRows(_constant.LIST.tableCode);
		if ((0, _commonUtil.isEmptyObject)(selectedRows)) {
			(0, _ncLightappFront.toast)({ color: 'warning', content: this.props.MutiInit.getIntl("36180ETAPPR") && this.props.MutiInit.getIntl("36180ETAPPR").get('36180ETAPPR-000036') }); /* 国际化处理： 未选择数据！*/
			return;
		}
	}
	switch (key) {
		case _constant.LIST_BTN.add:
			// 新增
			handleAddClick.call(this, selectedRows);
			break;
		case _constant.LIST_BTN.delete:
			// 删除
			handleDeleteClick.call(this, selectedRows);
			break;
		case _constant.LIST_BTN.copy:
			// 复制
			handleCopyClick.call(this, selectedRows);
			break;
		case _constant.LIST_BTN.refresh:
			// 刷新
			handleRefreshClick.call(this);
			break;
		case _constant.LIST_BTN.commit:
			// 提交
			handleCommitClick.call(this, selectedRows);
			break;
		case _constant.LIST_BTN.uncommit:
			// 收回
			handleUnCommitClick.call(this, selectedRows);
			break;

		case _constant.LIST_BTN.commandSend:
			// 发送指令
			handleCommandSendClick.call(this, selectedRows);
			break;
		case _constant.LIST_BTN.commandCancel:
			// 撤回指令
			handleCommandCancelClick.call(this, selectedRows);
			break;
		case _constant.LIST_BTN.nullify:
			// 作废
			handleNullifyClick.call(this, selectedRows);
			break;
		case _constant.LIST_BTN.nullifyCancel:
			// 取消作废
			handleNullifyCancelClick.call(this, selectedRows);
			break;
		case _constant.LIST_BTN.attachment:
			// 附件
			handleAttackmentClick.call(this, selectedRows);
			break;
		case _constant.LIST_BTN.print:
			// 打印
			handlePrintClick.call(this, selectedRows);
			break;
		case _constant.LIST_BTN.output:
			// 输出
			handleOutPutClick.call(this, selectedRows);
			break;
		case _constant.LIST_BTN.export:
			// 导出格式文件
...
function handleReturnData(that, selectDatas, retData) {
	var returnData = retData[_constant.LIST.tableCode].rows;
	//处理选择数据
	selectDatas.forEach(function (val) {
		var pk_endore_h_check = val.data.values.pk_endore.value;
		returnData.forEach(function (retrunval) {
 ...
 */
var handleDeleteClick = function handleDeleteClick(selectedRows) {
	var toastContent = void 0;
	if (selectedRows.length === 0) {
		// 未选择
		(0, _ncLightappFront.toast)({ color: 'warning', content: this.props.MutiInit.getIntl("36180ETAPPR") && this.props.MutiInit.getIntl("36180ETAPPR").get('36180ETAPPR-000038') }); /* 国际化处理： 请选中至少一条数据！*/
		return;
 ...
 */
function delConfirm() {
	var selectDatas = this.props.table.getCheckedRows(_constant.LIST.tableCode);

	var sendData = handleRequestData(selectDatas);
	...
	var successCallback = function successCallback(res) {
		...
		// }
		if (res.data.status) {
			(0, _messageUtil.BatchToast)(_messageUtil.OPERA_TYPE.DELETE, res.data.status, res.data.total, res.data.successNum, res.data.failNum, res.data.errMsgs, null);
		}
		handleRefreshClick.call(this);
	};
	_commonUtil.doAjax.call(this, sendData, _constant.URI.endoreListDelete, successCallback);
}
 ...
 * @param {*} selectedRows
 */
var handleCopyClick = function handleCopyClick(selectedRows) {
 ...
 * @param {*} selectedRows
 */
var handleRefreshClick = function handleRefreshClick() {
	// 重新查询数据
	_searchBtnClick2.default.call(this);
};
 ...
 * @param {*} selectedRows
 */
var handleCommitClick = function handleCommitClick(selectDatas) {
	var sendData = handleRequestData(selectDatas);
	...
	var successCallback = function successCallback(res) {
		...
		if (res.data.workflow && (res.data.workflow === 'approveflow' || res.data.workflow === 'workflow')) {
			...
			// 全部成功
			if (failIndexs == 0) {
				(0, _messageUtil.BatchToast)(_messageUtil.OPERA_TYPE.COMMIT, 1, selectDatas.length, successIndexs, failIndexs, null, null);
			} else if (selectDatas.length == failIndexs) {
				// 全部失败
				(0, _messageUtil.BatchToast)(_messageUtil.OPERA_TYPE.COMMIT, 0, selectDatas.length, successIndexs, failIndexs, res.data.errMsg && res.data.errMsg.split('\n'), null);
			} else if (failIndexs > 0) {
				// 部分成功
				(0, _messageUtil.BatchToast)(_messageUtil.OPERA_TYPE.COMMIT, 2, selectDatas.length, successIndexs, failIndexs, res.data.errMsg && res.data.errMsg.split('\n'), null);
			}
		}
		// 按钮使用规则
		_buttonDisabledRule2.default.call(this);
 ...
 * @param {*} selectedRows
 */
var handleUnCommitClick = function handleUnCommitClick(selectDatas) {
	var sendData = handleRequestData(selectDatas);
	...
	var successCallback = function successCallback(res) {
		...
		if (res.data.status) {
			(0, _messageUtil.BatchToast)(_messageUtil.OPERA_TYPE.UNCOMMIT, res.data.status, res.data.total, res.data.successNum, res.data.failNum, res.data.errMsgs, null);
		}
		// 按钮使用规则
		_buttonDisabledRule2.default.call(this);
	};
 ...
 * @param {*} selectedRows
 */
var handleCommandSendClick = function handleCommandSendClick(selectDatas) {
	var sendData = handleRequestData(selectDatas);
	...
	var successCallback = function successCallback(res) {
		...
		if (res.data.status) {
			(0, _messageUtil.BatchToast)(_messageUtil.OPERA_TYPE.COMMANDSEND, res.data.status, res.data.total, res.data.successNum, res.data.failNum, res.data.errMsgs, null);
		}
		// 按钮使用规则
		_buttonDisabledRule2.default.call(this);
	};
 ...
 * @param {*} selectedRows
 */
var handleCommandCancelClick = function handleCommandCancelClick(selectDatas) {
	var sendData = handleRequestData(selectDatas);
	...
	var successCallback = function successCallback(res) {
		...
		if (res.data.status) {
			(0, _messageUtil.BatchToast)(_messageUtil.OPERA_TYPE.COMMANDCANCEL, res.data.status, res.data.total, res.data.successNum, res.data.failNum, res.data.errMsgs, null);
		}
		// 按钮使用规则
		_buttonDisabledRule2.default.call(this);
	};
 ...
 * @param {*} selectedRows
 */
var handleNullifyClick = function handleNullifyClick() {
	var _this = this;
 ...
 * @param {*} disableReason 
 */
function confirmOfDisableOnListHead(disableReason) {
	var selectedRows = this.props.table.getCheckedRows(_constant.LIST.tableCode);
	var pks = [];
	var tss = [];
	...
	var successCallback = function successCallback(res) {
		...
		if (res.data.status) {
			(0, _messageUtil.BatchToast)(_messageUtil.OPERA_TYPE.NULLIFY, res.data.status, res.data.total, res.data.successNum, res.data.failNum, res.data.errMsgs, null);
		}
		// 按钮使用规则
		_buttonDisabledRule2.default.call(this);
	};
 ...
 * @param {*} selectedRows
 */
var handleNullifyCancelClick = function handleNullifyCancelClick(selectDatas) {
	var sendData = handleRequestData(selectDatas);
	...
	var successCallback = function successCallback(res) {
		...
		if (res.data.status) {
			(0, _messageUtil.BatchToast)(_messageUtil.OPERA_TYPE.NULLIFYCANCEL, res.data.status, res.data.total, res.data.successNum, res.data.failNum, res.data.errMsgs, null);
		}
		// 按钮使用规则
		_buttonDisabledRule2.default.call(this);
	};
 ...
 * @param {*} selectedRows
 */
var handleAttackmentClick = function handleAttackmentClick(selectedRows) {
	// 当选中条数大于 1 条数据时 取用下标最小的一条数据
	if (selectedRows.length > 1) {
		// console.info(selectedRows);
		var minIndex = getMinIndex(selectedRows);
		var billno = selectedRows[minIndex]['data']['values']['vbillno']['value'];
		var pk_endore = selectedRows[minIndex]['data']['values']['pk_endore']['value'];
	...
	if (selectedRows.length == 1) {
		...
		var _pk_endore = selectedRows[0]['data']['values']['pk_endore']['value'];
...
function handlePrintClick(selectedRows) {
	...
	selectedRows.forEach(function (element) {
		var pk_endore = element['data']['values']['pk_endore']['value'];
...
function doPrint(printpks, props) {
	...
	print(
	//支持两类: 'html'为模板打印, 'pdf'为pdf打印，这里设置为pdf
	'pdf', _constant.URI.endoreListPrintOutput, {
		appcode: appcode,
		nodekey: 'NCC36180ET',
		oids: printpks
	});
...
exports.OPERA_TYPE = exports.BatchToast = undefined;
...
var BatchToast = exports.BatchToast = function BatchToast(op, status, total, successNum, failNum, message, content) {
	var operate = '';
	...
	var title = operate + this.props.MutiInit.getIntl("36180ETAPPR") && this.props.MutiInit.getIntl("36180ETAPPR").get('36180ETAPPR-000050'); /* 国际化处理： 完毕*/
	var color = 'success';
	...
	if (!content) {
		...
		content = this.props.MutiInit.getIntl("36180ETAPPR") && this.props.MutiInit.getIntl("36180ETAPPR").get('36180ETAPPR-000054') + /* 国际化处理： 共*/
		operate + total +
		/* 国际化处理：条 */
...
var OPERA_TYPE = exports.OPERA_TYPE = {
	DELETE: 'DELETE',
	COMMIT: 'COMMIT',
	UNCOMMIT: 'UNCOMMIT',
 ...
 */
var onRowDoubleClick = function onRowDoubleClick(record, index, props, event) {
    props.pushTo("/card", {
        status: "browse",
        id: record.pk_endore && record.pk_endore.value,
        pagecode: _constant.CARD.pageCode
...
exports.default = onRowDoubleClick;
...
function pageInfoClick(props, config, pks) {
    ...
    (0, _ncLightappFront.ajax)({
        url: _constant.URI.endoreListPageQuery,
        data: { pks: pks },
        success: function success(_ref) {
            ...
            if (_success) {
                if (grid) {
                    _this.props.table.setAllTableData(_this.tableId, grid[_this.tableId]);
                } else {
...
function getAssginUserCard(userObj) {
	...
	if (selectDatas && selectDatas.length > 0) {
		...
		(0, _ncLightappFront.toast)({
			color: 'waring',
			content: this.props.MutiInit.getIntl("36180ETAPPR") && this.props.MutiInit.getIntl("36180ETAPPR").get('36180ETAPPR-000025') /* 国际化处理： 指派传参，获取pk失败！*/
		});
		return;
	}
	...
	var success = function success(res) {
		...
		if (res.data && res.data.errMsgs && res.data.errMsgs.length > 0) {
			...
			if (res.data) {
				(0, _ncLightappFront.toast)({ color: 'success', content: this.props.MutiInit.getIntl("36180ETAPPR") && this.props.MutiInit.getIntl("36180ETAPPR").get('36180ETAPPR-000026') }); /* 国际化处理： 提交成功*/
				that.setState({
					compositedata: res.data,
					compositedisplay: false
				});
				if (res.data.grid) {
					...
					if (this.record != null) {
						var updateDataArr = [{
							index: this.index,
							data: { values: res.data.grid[_constant.LIST.tableCode].rows[0].values }
						}];
						this.props.table.updateDataByIndexs(_constant.LIST.tableCode, updateDataArr);
						this.record = null;
						this.index = null;
					} else {
						var returnData = res.data.grid[_constant.LIST.tableCode].rows;
						//处理选择数据
						var selectedData = that.props.table.getCheckedRows(_constant.LIST.tableCode);
						if (selectedData && !that.index) {
							selectedData.forEach(function (val) {
								var pk_endore_check = val.data.values.pk_endore.value;
								returnData.forEach(function (retrunval) {
									if (pk_endore_check === retrunval.values.pk_endore.value) {
										...
										that.props.table.updateDataByIndexs(_constant.LIST.tableCode, _updateDataArr);
									}
								});
							});
						} else {
							that.props.table.updateDataByIndexs(_constant.LIST.tableCode, [{ index: that.index, data: { values: returnData[0].values } }]);
							that.index = null;
						}
					}
				}
	...
	_commonUtil.doAjax.call(this, sendData, _constant.URI.endoreListCommit, success);
}
...
var _router = __webpack_require__(795);
...
var _list = __webpack_require__(552);
...
var card = (0, _ncLightappFront.asyncComponent)(function () {
	return Promise.resolve(/* import() eager */).then(__webpack_require__.t.bind(null, 542, 7));
});
var routes = [{
	path: '/',
