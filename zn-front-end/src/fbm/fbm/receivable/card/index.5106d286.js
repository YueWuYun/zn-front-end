...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/fbm/receivable/card/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/fbm/receivable/card/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
//小应用编码
var app_code = exports.app_code = '36180BRB';
//联查小应用编码
var link_app_code = exports.link_app_code = '36180BRB';
//审批小应用编码
var approve_app_code = exports.approve_app_code = '36180BRBA';
//请求基础路径
var base_path = exports.base_path = '/nccloud/fbm/receivable';
//按钮平铺显示数量
var button_limit = exports.button_limit = 3;
//打印输出编码
var nodekey = exports.nodekey = '36180BRB_P03';

var module_id = exports.module_id = '36180BRB';
//单据类型
var billtype = exports.billtype = '36HN';
// 业务对应表名，修改按钮点击时用来saga校验
var tableName = exports.tableName = 'fbm_register';
/**
 * 列表
 */
var LIST = exports.LIST = {
    ...
    //缓存标示
};var DATA_SOURCE = exports.DATA_SOURCE = 'tm.fbm.receivable.datasource';
...
var _initTemplate = __webpack_require__(681);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(682);

var _initTemplate4 = _interopRequireDefault(_initTemplate3);

var _initTemplate5 = __webpack_require__(683);

var _initTemplate6 = _interopRequireDefault(_initTemplate5);

var _buttonVisible = __webpack_require__(349);

var _afterEvent = __webpack_require__(684);
...
var _constant = __webpack_require__(220);
...
function buttonVisible(props) {
    ...
    var unionBtn = ['ApproveDetail']; //联查按钮
    ...
    var fbmbilltype = props.form.getFormItemsValue(this.formId, 'fbmbilltype').value;
    if (!status) {
        showBtn = ['Add'];
    } else if (!isBrowse) {
        //编辑态
        ...
        if (!id) {
            ...
            switch (vbillstatus) {
                case '-1':
                    ...
                    showBtn = ['Add', 'Edit', 'Delete', 'Commit', 'Copy', 'Union'].concat(_toConsumableArray(commonBtn));
                    //设置新增按钮为灰，提交为红色
                ...
                case '3':
                    //提交
                    showBtn = ['Add', 'Uncommit', 'Copy', 'Union'].concat(_toConsumableArray(commonBtn));
                    break;
                case '1':
                    //已审批
                    showBtn = ['Add', 'Uncommit', 'Copy', 'Union'].concat(_toConsumableArray(commonBtn));
    ...
    _createClass(Card, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_BaseCard2.default, _extends({
                ...
                pageTitle: this.props.MutiInit.getIntl("36180BRB") && this.props.MutiInit.getIntl("36180BRB").get("36180BRB-000002") //页面标题/* 国际化处理： 期初应收票据*/
...
function modifierMeta(meta) {
		...
		if (item.attrcode == "paybillunit") {
			...
			item.queryCondition = function () {
				return {
					...
					pk_group: _this2.props.form.getFormItemsValue(_this2.formId, 'pk_group').value
				};
			};
		}
	...
	meta['baseinfo'].items.map(function (item) {
		...
		if (item.attrcode === 'pk_signagrbank') {
			//承兑人{客商档案}
			item.checkStrictly = false;
			item.queryCondition = function () {
		...
		if (item.attrcode == 'hidepaybankacc') {
			...
			item.showHistory = true;
			item.queryCondition = function () {
				var hidepayunit = _this2.props.form.getFormItemsValue(_this2.formId, 'hidepayunit');
		...
		if (item.attrcode == 'hidereceivebankacc') {
			...
			item.showHistory = true;
			item.queryCondition = function () {
				var hidereceiveunit = _this2.props.form.getFormItemsValue(_this2.formId, 'hidereceiveunit');
				var pk_curr = _this2.props.form.getFormItemsValue(_this2.formId, 'pk_curr');
				return {
...
exports.default = function (props, templateCallback) {
	...
	props.createUIDom({
		...
		appcode: _constant.link_app_code
	}, function (data) {
		if (data) {
			if (data.template) {
				var meta = data.template;
...
function afterEvent(props, moduleId, key, value, oldValue) {
	...
	var eventData = this.props.createHeadAfterEventData(this.pageId, this.formId, '', moduleId, key, value);
	if (key === 'pk_org') {
		//财务组织
			...
			_index.cardEvent.changeOrg.call(this, value).then(function () {
				if (value.value) {
					_index.cardEvent.getAfterEventData.call(_this, eventData).then(function (res) {
						...
						props.form.setFormItemsValue(_this.formId, {
							'keepunitname': {
								value: props.form.getFormItemsValue(_this.formId, 'pk_org').display
							}
						});
					});
				}
		...
		if (value.value !== oldValue.value) {
			_index.cardEvent.getAfterEventData.call(this, eventData).then(function (res) {
				...
				props.form.setFormItemsValue(_this.formId, {
					'acceptorname': {
						value: props.form.getFormItemsValue(_this.formId, 'signagrbank').display
					}
				});
			});
		}
	} else if (key === 'pk_signagrbank') {
		//承兑人
		if (value.value !== oldValue.value) {
			_index.cardEvent.getAfterEventData.call(this, eventData).then(function (res) {
				props.form.setAllFormValue(_defineProperty({}, _this.formId, res.data.head && res.data.head[_this.formId]));
				...
				props.form.setFormItemsValue(_this.formId, {
					'acceptorname': {
						value: props.form.getFormItemsValue(_this.formId, 'pk_signagrbank').display == ' ' ? props.form.getFormItemsValue(_this.formId, 'pk_signagrbank').value : props.form.getFormItemsValue(_this.formId, 'pk_signagrbank').display
					}
				});
			});
		}
	} else if (key === 'hidepayunit') {
		//出票人
		if (value.value !== oldValue.value) {
			_index.cardEvent.getAfterEventData.call(this, eventData).then(function (res) {
				props.form.setAllFormValue(_defineProperty({}, _this.formId, res.data.head && res.data.head[_this.formId]));
				...
				props.form.setFormItemsValue(_this.formId, {
					'payunit': {
						value: props.form.getFormItemsValue(_this.formId, 'hidepayunit').display == ' ' ? props.form.getFormItemsValue(_this.formId, 'hidepayunit').value : props.form.getFormItemsValue(_this.formId, 'hidepayunit').display
					}
				});
			});
		}
	} else if (key === 'hidepaybank') {
		//出票人开户行
		if (value.value !== oldValue.value) {
			_index.cardEvent.getAfterEventData.call(this, eventData).then(function (res) {
				props.form.setAllFormValue(_defineProperty({}, _this.formId, res.data.head && res.data.head[_this.formId]));
				...
				props.form.setFormItemsValue(_this.formId, {
					'paybank': {
						value: props.form.getFormItemsValue(_this.formId, 'hidepaybank').display == ' ' ? props.form.getFormItemsValue(_this.formId, 'hidepaybank').value : props.form.getFormItemsValue(_this.formId, 'hidepaybank').display
					}
				});
			});
		}
	} else if (key === 'hidereceiveunit') {
		//收款人
		if (value.value !== oldValue.value) {
			_index.cardEvent.getAfterEventData.call(this, eventData).then(function (res) {
				props.form.setAllFormValue(_defineProperty({}, _this.formId, res.data.head && res.data.head[_this.formId]));
				...
				props.form.setFormItemsValue(_this.formId, {
					'receiveunit': {
						value: props.form.getFormItemsValue(_this.formId, 'hidereceiveunit').display == ' ' ? props.form.getFormItemsValue(_this.formId, 'hidereceiveunit').value : props.form.getFormItemsValue(_this.formId, 'hidereceiveunit').display
					}
				});
			});
		}
	} else if (key === 'hidereceivebank') {
		//收款人开户行
		if (value.value !== oldValue.value) {
			_index.cardEvent.getAfterEventData.call(this, eventData).then(function (res) {
				props.form.setAllFormValue(_defineProperty({}, _this.formId, res.data.head && res.data.head[_this.formId]));
				...
				props.form.setFormItemsValue(_this.formId, {
					'receivebank': {
						value: props.form.getFormItemsValue(_this.formId, 'hidereceivebank').display == ' ' ? props.form.getFormItemsValue(_this.formId, 'hidereceivebank').value : props.form.getFormItemsValue(_this.formId, 'hidereceivebank').display
					}
				});
			});
		}
		...
		if (value.value !== oldValue.value) {
			_index.cardEvent.getAfterEventData.call(this, eventData).then(function (res) {
				...
				props.form.setFormItemsValue(_this.formId, {
					'signagrbanknum': {
						value: props.form.getFormItemsValue(_this.formId, 'acceptorbankaccount').display == ' ' ? props.form.getFormItemsValue(_this.formId, 'acceptorbankaccount').value : props.form.getFormItemsValue(_this.formId, 'acceptorbankaccount').display
					}
				});
			});
		}
	} else if (key === 'acceptorbank') {
		//承兑人开户行名
		if (value.value !== oldValue.value) {
			_index.cardEvent.getAfterEventData.call(this, eventData).then(function (res) {
				props.form.setAllFormValue(_defineProperty({}, _this.formId, res.data.head && res.data.head[_this.formId]));
				...
				props.form.setFormItemsValue(_this.formId, {
					'signagrbankname': {
						value: props.form.getFormItemsValue(_this.formId, 'acceptorbank').display == ' ' ? props.form.getFormItemsValue(_this.formId, 'acceptorbank').value : props.form.getFormItemsValue(_this.formId, 'acceptorbank').display
					}
				});
			});
		}
		...
		if (value.value !== oldValue.value) {
			_index.cardEvent.getAfterEventData.call(this, eventData).then(function (res) {
				...
				props.form.setFormItemsValue(_this.formId, {
					'signagrbankname': {
						value: props.form.getFormItemsValue(_this.formId, 'pk_acceptorbank').display
					}
				});
			});
		}
		...
		if (value.value !== oldValue.value) {
			_index.cardEvent.getAfterEventData.call(this, eventData).then(function (res) {
				...
				var pk_curr = props.form.getFormItemsValue(moduleId, 'pk_curr');
		...
		if (value.value !== oldValue.value && value.value !== '') {
			_index.cardEvent.getAfterEventData.call(this, eventData).then(function (res) {
				_this.props.form.setAllFormValue(_defineProperty({}, _this.formId, res.data.head && res.data.head[_this.formId]));
				_this.props.cardTable.setAllTabsData(res.data.bodys, _this.tabOrder);
			});
		...
		if (value.value !== oldValue.value) {
			_index.cardEvent.getAfterEventData.call(this, eventData).then(function (res) {
				...
				props.form.setFormItemsValue(_this.formId, {
					'paybankacc': {
						value: props.form.getFormItemsValue(_this.formId, 'hidepaybankacc').display == ' ' ? props.form.getFormItemsValue(_this.formId, 'hidepaybankacc').value : props.form.getFormItemsValue(_this.formId, 'hidepaybankacc').display
					}
				});
				//设置带出的承兑信息
				var fbmbilltype = props.form.getFormItemsValue(_this.formId, 'fbmbilltype').value;
				if (fbmbilltype == _this.pknotetype_bank || fbmbilltype == _this.pknotetype_ebank) {
					//银行承兑
	...
	} else if (key === 'hidereceivebankacc') {
		//收款银行账户
		if (value.value !== oldValue.value) {
			_index.cardEvent.getAfterEventData.call(this, eventData).then(function (res) {
				props.form.setAllFormValue(_defineProperty({}, _this.formId, res.data.head && res.data.head[_this.formId]));
				...
				props.form.setFormItemsValue(_this.formId, {
					'receivebankacc': {
						value: props.form.getFormItemsValue(_this.formId, 'hidereceivebankacc').display == ' ' ? props.form.getFormItemsValue(_this.formId, 'hidereceivebankacc').value : props.form.getFormItemsValue(_this.formId, 'hidereceivebankacc').display
					}
				});
			});
		}
	} else if (key === 'paybillunit') {
		//付票单位
		if (value.value !== oldValue.value) {
			_index.cardEvent.getAfterEventData.call(this, eventData).then(function (res) {
				props.form.setAllFormValue(_defineProperty({}, _this.formId, res.data.head && res.data.head[_this.formId]));
				...
				props.form.setFormItemsValue(_this.formId, {
					'hidepaybillunit': {
						value: props.form.getFormItemsValue(_this.formId, 'paybillunit').display == ' ' ? props.form.getFormItemsValue(_this.formId, 'paybillunit').value : props.form.getFormItemsValue(_this.formId, 'paybillunit').display
					}
				});
			});
		}
