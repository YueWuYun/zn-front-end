...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/fbm/receivable/list/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/fbm/receivable/list/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
var _initTemplate = __webpack_require__(686);
...
disabledBtnsParam.push({
    btnName: "Uncommit",
    rules: function rules(current) {
        return current.vbillstatus && current.vbillstatus.value !== "3" && current.vbillstatus.value !== "1" && current.vbillstatus.value !== "2" && current.vbillstatus.value !== "0";
    }
});
...
var List = function (_Component) {
    ...
    function List(props) {
        ...
        _this.myRenderCompleteEvent = function () {
            ...
            var money = muti && muti.get("36180BRB-000008") /* 国际化处理： 票据金额*/;
            var start = muti && muti.get("36180BRB-000009") /* 国际化处理： 开始*/;
            var end = muti && muti.get("36180BRB-000010") /* 国际化处理： 结束*/;
        ...
        value: function render() {
            var tabs = {
                ...
                items: [{
                    key: "-1",
                    name: "numZY",
                    title: this.props.MutiInit.getIntl("36180BRB") && this.props.MutiInit.getIntl("36180BRB").get("36180BRB-000005") /* 国际化处理： 待提交*/
                }, {
                    key: "2,3",
                    name: "numTJ",
                    title: this.props.MutiInit.getIntl("36180BRB") && this.props.MutiInit.getIntl("36180BRB").get("36180BRB-000006") /* 国际化处理： 审批中*/
                }, {
                    key: "all",
                    title: this.props.MutiInit.getIntl("36180BRB") && this.props.MutiInit.getIntl("36180BRB").get("36180BRB-000007") /* 国际化处理： 全部*/
                }],
...
exports.default = function (props) {
	...
	var excelimportconfig = (0, _ncLightappFront.excelImportconfig)(props, "fbm", '36HN', true, "", { "appcode": _constant.app_code, "pagecode": _constant.CARD.page_id });
	props.createUIDom({
		...
		if (data) {
			if (data.button) {
				...
				props.button.setButtons(button);
				props.button.setPopContent('DeleteInner', _this.props.MutiInit.getIntl("36180BRB") && _this.props.MutiInit.getIntl("36180BRB").get('36180BRB-000003')); /* 国际化处理： 确认要删除吗?*/
...
function modifierMeta(props, meta) {
	...
	meta[this.searchId].items.map(function (item) {
		...
		if (item.attrcode === "paybillunit") {
			...
			item.queryCondition = function () {
				return {
					pk_org: _this2.props.search.getSearchValByField(_this2.searchId, 'pk_org').value.firstvalue, //组织
					pk_group: _this2.props.search.getSearchValByField(_this2.searchId, 'pk_group').value.firstvalue //集团
				};
			};
		}
