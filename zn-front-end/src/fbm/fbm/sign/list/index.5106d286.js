...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fbm/fbm/sign/list/index"] = factory(require("nc-lightapp-front"), require("react"), require("react-dom"), require("axios"));
	else
		root["fbm/fbm/sign/list/index"] = factory(root["nc-lightapp-front"], root["React"], root["ReactDOM"], root["axios"]);
...
//小应用编码
var app_code = exports.app_code = '36180BS';
//联查小应用编码
var link_app_code = exports.link_app_code = '36180BSA';
//审批小应用编码
var approve_app_code = exports.approve_app_code = '36180BSA';
//请求基础路径
var base_path = exports.base_path = '/nccloud/fbm/sign';
//按钮平铺显示数量
var button_limit = exports.button_limit = 3;
//打印输出编码
var nodekey = exports.nodekey = '36180BS4NCC';

var module_id = exports.module_id = 'fbm';
//单据类型
var billtype = exports.billtype = '36H2';

var fullAggClassName = exports.fullAggClassName = 'nc.vo.fbm.register.AggRegisterVO';
...
var LIST = exports.LIST = {
    ...
    disabled_btn: ['Delete', 'Commit', 'Uncommit', 'Print', 'Output', 'Attachment', 'ApproveDetail', 'CreditAmount', 'Copy', 'LinkSDBook', 'LinkBudgetPlan', 'Voucher', 'CreditAmount', 'Guarantee', 'SendInstruction', 'CancelInstruction', 'Destroy', 'Disabled', 'CancelDisabled', 'LinkInnerAccount', 'LQueryInSecurityAcc'], //默认禁用按钮
    ...
    //缓存标示
};var DATA_SOURCE = exports.DATA_SOURCE = 'tm.fbm.payregister.datasource';
...
var _initTemplate = __webpack_require__(710);

var _initTemplate2 = _interopRequireDefault(_initTemplate);

var _initTemplate3 = __webpack_require__(711);

var _initTemplate4 = _interopRequireDefault(_initTemplate3);

var _searchBtnClick = __webpack_require__(712);

var _searchBtnClick2 = _interopRequireDefault(_searchBtnClick);

var _buttonDisable = __webpack_require__(713);
...
var _constant = __webpack_require__(211);
...
var disabledBtnsParam = [].concat(_toConsumableArray(_constant.DISABLE_BTN_PARAM)); //复制数组，不然会共用卡片页disabledBtnsParam的引用
...
disabledBtnsParam.push({
    ...
    rules: function rules(current) {
        return current.initflag && current.initflag.value;
    }
});
...
var List = function (_Component) {
    ...
    function List(props) {
        ...
        _this.tabChangeServal = function (status, callback) {
            ...
            var queryInfo = this.props.search.getQueryInfo(this.searchId, false);
            this.setState({ activeTab: status }, function () {
        ...
        _this.myselectedEvent = function (props, moduleId, record, index, status) {
            ...
            var initflag = record.initflag && record.initflag.value;
            if (initflag) {
                // 期初数据，附件除上传禁用
        ...
        _this.myRenderCompleteEvent = function () {
            var muti = this.props.MutiInit.getIntl('36180BS'); //this.moduleId
            var money = muti && muti.get("36180BS-000014") /* 国际化处理： 票据金额*/;
            var start = muti && muti.get("36180BS-000015") /* 国际化处理： 开始*/;
            var end = muti && muti.get("36180BS-000016") /* 国际化处理： 结束*/;
            this.props.search.setTemlateByField(this.searchId, 'money', 'defaultPlaceholder', { start: money + start, end: money + end });
    ...
    _createClass(List, [{
        ...
        value: function componentWillMount() {
            ...
            var callback = function callback(json, status, inlt) {
                // json 多语json格式参数； status： 是否请求到json多语，可用来判断多语资源是否请求到并进行一些别的操作； inlt： 可用来进行占位符的一些操作
                if (status) {
                    _this3.setState({ json: json, inlt: inlt }); // 保存json和inlt到页面state中并刷新页面
                }
            };
        }
        ...
        value: function render() {
            var tabs = {
                ...
                items: [{
                    key: "-1",
                    name: "DTJ",
                    title: this.props.MutiInit.getIntl("36180BS") && this.props.MutiInit.getIntl("36180BS").get("36180BS-000009") /* 国际化处理： 待提交*/
                }, {
                    key: "2",
                    name: "SPZ",
                    title: this.props.MutiInit.getIntl("36180BS") && this.props.MutiInit.getIntl("36180BS").get("36180BS-000010") /* 国际化处理： 审批中*/
                }, {
                    key: "10",
                    name: "paying",
                    title: this.props.MutiInit.getIntl("36180BS") && this.props.MutiInit.getIntl("36180BS").get("36180BS-000012") /* 国际化处理： 指令处理中*/
                },, {
                    key: "all",
                    title: this.props.MutiInit.getIntl("36180BS") && this.props.MutiInit.getIntl("36180BS").get("36180BS-000011") /* 国际化处理： 全部*/
                }],
            ...
            return _react2.default.createElement(_BaseList2.default, _extends({
                ...
                constant: {
                    ...
                    disabledBtnOne: _constant.LIST.disabled_btn_one, //列表只有一条数据的条件，按钮才可用
                ...
                _searchBtnClick: _events.searchBtnClick,
                _componentInitFinished: this.componentInitFinished,
                _renderCompleteEvent: this.myRenderCompleteEvent,
                pageTitle: this.props.MutiInit.getIntl("36180BS") && this.props.MutiInit.getIntl("36180BS").get("36180BS-000007") //节点标题
                ...
                , linkItems: ["approveDetail", "bankBalance", "ntb", "creditBalance"] //联查显示的组件
...
exports.default = function (props) {
	...
	var app_code = props.getSearchParam('c');
	var excelimportconfig = (0, _ncLightappFront.excelImportconfig)(props, "fbm", '36H2', true, "", { "appcode": app_code, "pagecode": _constant.CARD.page_id });
	...
	props.createUIDom({
		...
		if (data) {
			if (data.button) {
				...
				props.button.setButtons(button);
				props.button.setPopContent('DeleteInner', _this.props.MutiInit.getIntl("36180BS") && _this.props.MutiInit.getIntl("36180BS").get('36180BS-000008')); /* 国际化处理： 确认要删除吗?*/
...
function modifierMeta(props, meta) {
	...
	if (meta[this.searchId] && meta[this.searchId].items) {
		meta[this.searchId].items.map(function (item) {
			if (item.attrcode === 'pk_org') {
			...
			} else if (item.attrcode === 'bondvariety') {
				//发债品种
				...
				item.queryCondition = function () {
					...
					item.queryCondition = function () {
						var pk_org = _this2.props.search.getSearchValByField(_this2.searchId, "pk_org") && _this2.props.search.getSearchValByField(_this2.searchId, "pk_org").value && _this2.props.search.getSearchValByField(_this2.searchId, "pk_org").value.firstvalue;

						var pk_group = _this2.props.search.getSearchValByField(_this2.searchId, "pk_group") && _this2.props.search.getSearchValByField(_this2.searchId, "pk_group").value && _this2.props.search.getSearchValByField(_this2.searchId, "pk_group").value.firstvalue;
						return {
							pk_org: pk_org,
							pk_group: pk_group
						};
			...
			return React.createElement(
				...
				props.button.createErrorButton({
					...
					sucessCallBack: function sucessCallBack() {
						...
						var initflag = record.initflag && record.initflag.value;
						// 指令状态
						var elcpaymentstatus = record.elcpaymentstatus && record.elcpaymentstatus.value;
...
var querytype = _constant.LIST.list_querytype;
//点击查询，获取查询区数据
function clickSearchBtn(props, searchVal, a, b, c, d, e, f) {
    var _this2 = this;

    var searchdatas = this.props.search.getQueryInfo(this.searchId);
    searchVal = searchdatas.querycondition;
    var _this = this;
    var queryInfo = props.search.getQueryInfo(search_id, false);
                    ...
                    if (data && data.groupData) {
                        ...
                        if (a) {
                            ...
                            if (data.groupData.ALL == '0') {
                                (0, _ncLightappFront.toast)({ color: 'warning', content: '未查询出符合条件的数据!' });
                            } else {
                                (0, _ncLightappFront.toast)({ color: 'success', content: '查询成功' });
                            }
                        }
...
var filterSearchValue = function filterSearchValue(searchVal) {
    var tabKey = this.state.activeTab;
    if (tabKey == 'all') {
        // 如果是全部的话，则返回
        return;
    ...
    var condition2 = (0, _ncLightappFront.deepClone)(condition);
...
function buttonDisable() {
    ...
    if (selectDatas.length == 1) {
        ...
        var hasDis = false;
        var hasInit = false;
        var hasNetSucc = false;
        var hasVoucher = false;
        var item = selectDatas[0];
        // console.log(item);
        var vbillstatus = item.data.values.vbillstatus.value;
        var paymentstatus = item.data.values.paymentstatus.value;
        var onlinebankflag = item.data.values.cyberbankflag.value;
        var disableflag = item.data.values.disableflag.value;
        var voucher = item.data.values.voucher.value;
        var initflag = item.data.values.initflag.value;
        var registerstatus = item.data.values.registerstatus.value;
        var LinkInnerAccount = item.data.values.pk_inbalaacc && item.data.values.pk_inbalaacc.value;
        var LQueryInSecurityAcc = item.data.values.pk_insecurityacc && item.data.values.pk_insecurityacc.value;
        if (!LinkInnerAccount) {
            disBtn.push(_constant.btns.LinkInnerAccount);
        }
        if (!LQueryInSecurityAcc) {
            disBtn.push(_constant.btns.LQueryInSecurityAcc);
        }
        if (vbillstatus != 1) {
            // 待提交
            hasapprove = true;
        ...
        if (!hasapprove) {
            // 审批通过的
            disBtn.push(_constant.btns.commitBtn);
            if (!hasnet) {
                // 非网银
                disBtn.push(_constant.btns.sendCommandBtn);
                disBtn.push(_constant.btns.takeCommandBtn);
                disBtn.push(_constant.btns.disabledBtn);
                disBtn.push(_constant.btns.unDisabledBtn);
            } else {
                // 网银的
                if (!hasDis) {
                    disBtn.push(_constant.btns.unDisabledBtn);
            ...
            if (!hasVoucher) {
                // 非已制证
                disBtn.push(_constant.btns.linkVoucherBtn);
            } else {
                // 已制证
                disBtn.push(_constant.btns.uncommitBtn);
            }
            if (!(registerstatus === "has_paybill" || registerstatus === "has_return")) {
                disBtn.push(_constant.btns.DestroyBtn);
            }
        } else {
            // 待提交的，已提交未审批通过的
            if (vbillstatus == -1) {
                disBtn.push(_constant.btns.linkApproveBtn);
                disBtn.push(_constant.btns.uncommitBtn);
            } else {
                disBtn.push(_constant.btns.commitBtn);
            }
    ...
    if (tabKey == '-1') {
        ...
        // 审批中
        disBtn.push(_constant.btns.deleteBtn);
        disBtn.push(_constant.btns.commitBtn);
        disBtn.push(_constant.btns.sendCommandBtn);
        disBtn.push(_constant.btns.takeCommandBtn);
        disBtn.push(_constant.btns.disabledBtn);
