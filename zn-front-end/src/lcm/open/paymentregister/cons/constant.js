...
//小应用编码
export const app_code = "361701PR";
//联查小应用编码
export const app_code_link = "361701PRL";
//审批小应用编码
export const app_code_approve = "361701PRA";
//请求基础路径
export const base_path = "/nccloud/lcm/paymentregister";
//按钮平铺显示数量
...
//多语使用的key
export const mutliLangKey = "361701PR";
//单据类型
export const billtype = "36U5";
...
export const rateType = {
  ...
  "selllcrate": {
    rateType: "rate", //汇率类型
    currType: "pk_sell_currtype" //币种字段名
  }, 
  "sellglcrate": {
    rateType: "grouprate", //汇率类型
    currType: "pk_sell_currtype" //币种字段名
 ...
 */
export const LIST = {
  primary_id: "pk_payment", //列表页面主键
  billNo: "vbillno", //单据编号
  page_id: "361701PR_LIST", //页面编码
  page_id_link: "361701PRL_LIST", //联查页面编码
 ...
 */
export const CARD = {
  primary_id: "pk_payment", //表头主键
  billNo: "vbillno", // 单据编号key
  page_id: "361701PR_CARD", //页面编码
  page_id_link: "361701PRL_CARD", //联查页面编码
  page_id_approve: "361701PRA_CARD", //审批页面编码
  form_id: "header", //表头表单编码
  paymentinfo_id: "paymentInfo",//表头付款信息编码
  head_btn_code: "head", //表头按钮区域
...
export const API_URL = {
  ...
  ntbLink: `${base_path}/ntblinkbill.do`, //预算联查单据
  linkVoucher: `${base_path}/voucher.do`, //联查凭证
  voucherlink: `${base_path}/voucherlinkbill.do`, //凭证反联查
  makeVoucher: `${base_path}/makevoucher.do`, // 制证
  cancelVoucher: `${base_path}/unmakevoucher.do`, // 取消制证
...
export const LinkConfig = {
  ...
  ApproveDetail: {
    // 审批详情
    appcode: "361701PRA", // 应用编码
    pagecode: "361701PRA_CARD", // 页面编码
  },
  FundPlan: {
    // 计划预算
    params: {
    ...
    url: "/nccloud/lcm/paymentregister/linkntb.do", // 联查地址
  },
  Voucher: {
    // 凭证
    params: {
...
export const PullBillConfig = {
  origin: {
    ...
    appcode: "361701PR", // 拉单列表页应用编码
    pagecode: "361701PR_CARD", // 拉单列表页页面模板编码
  ...
  target: {
    ...
    appcode: "361701PR", // 拉单列表页应用编码
    pagecode: "361701PRT_LIST", // 拉单列表页页面模板编码
    head_btn_code: "head", // 拉单列表页表头按钮区域编码
    search_id: "list_query", //查询区域编码
    search_oid: "1001A910000000000RXT", //查询区域oid
    transferTableId: "list_head", // 拉单列表区域编码
    transferTablePk: "pk_arrival", // 拉单列表数据单据主键
  },
};
