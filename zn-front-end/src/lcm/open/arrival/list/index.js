...
class List extends Component {
  ...
  render() {
    ...
    let pageTitle = multiLang["361701IA-000000"]; /* 国际化处理： 到单承付 */
    ...
    let tabs = [
      {
        ...
        num: "(0)",
        status: "-1,0",
        content: multiLang["361701IA-000001"] /* 国际化处理： 待提交*/,
      },
      {
        key: "approving",
        num: "(0)",
        status: "2,3",
        content: multiLang["361701IA-000002"] /* 国际化处理： 审批中*/,
      },
      {
        key: "all",
        num: "",
        status: "5",
        content: multiLang["361701IA-000005"] /* 国际化处理： 全部*/,
      },
    ]; // tab页签
    return (
      <BaseList
