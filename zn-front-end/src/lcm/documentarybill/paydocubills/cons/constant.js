...
//小应用编码
export const app_code = "361703DBP";
//联查小应用编码
export const app_code_link = "361703DBP";
//审批小应用编码
export const app_code_approve = "361703DBPA";
//请求基础路径
export const base_path = "/nccloud/lcm/docupay";
//按钮平铺显示数量
export const button_limit = 3;
// 打印应用标识
export const nodekey = "LIST";
//多语使用的key
export const mutliLangKey = "361703DBP";
//单据类型
export const billtype = "36UE";
/**
 * 列表
 */
export const LIST = {
  primary_id: "pk_payrcpt", //列表页面主键
  billNo: "vbillno", //单据编号
  page_id: "361703DBP_LIST", // 页面编码
 ...
 */
export const CARD = {
  primary_id: "pk_payrcpt", //表头主键
  billNo: "vbillno", //单据编号
  page_id: "361703DBP_CARD", //页面编码
  page_id_link: "361703DBPL_CARD", //联查页面编码
  page_id_approve: "361703DBPA_CARD", //审批页面编码
...
//缓存标示
export const DATA_SOURCE = "tm.lcm.documentarybill.paydocubills.datasource";

// 查询区缓存参数
export const SEARCH_CACHE = {
  key: "lcm.documentarybill.paydocubills.searchCache", // 查询区域缓存Key
  dataSource: "lcm.documentarybill.paydocubills.searchSpace", // 查询区域缓存数据的名称空间
};
// 激活页签缓存参数
export const TABKEY_CACHE = {
  key: "lcm.documentarybill.paydocubills.tabKeyCache", // 激活页签缓存Key
  dataSource: "lcm.documentarybill.paydocubills.tabKeySpace", // 激活页签缓存数据的名称空间
};
// 页签集合缓存参数
export const TABS_CACHE = {
  key: "lcm.documentarybill.paydocubills.tabsCache", // 页签集合缓存Key
  dataSource: "lcm.documentarybill.paydocubills.tabsSpace", // 页签集合缓存数据的名称空间
};
// 列表页数据缓存参数
export const TABLE_CACHE = {
  key: "lcm.documentarybill.paydocubills.tableCache", // 页签集合缓存Key
  dataSource: "lcm.documentarybill.paydocubills.tableSpace", // 页签集合缓存数据的名称空间
};
...
export const API_URL = {
  ...
  deleteversion:`${base_path}/delversion.do`, // 删除版本
...
export const LinkConfig = {
  ...
  ApproveDetail: {
    // 审批详情
    appcode: "361703DBPA", // 应用编码
    pagecode: "361703DBPA_CARD", // 页面编码
  },
  HistoryVersion: {
    // 历史版本
    params: {
    ...
    url: "/lcm/documentarybill/paydocubills/main/index.html#/card",
    appcode: "361703DBP", // 应用编码
    pagecode: "361703DBP_CARD", // 页面编码
  },
};
