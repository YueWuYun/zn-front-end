...
class List extends Component {
  ...
  multiLangCallback = (multiLang, status, inlt) => {
    if (status) {
      ...
      console.log(
        this.state.multiLang["361703DBA-000004"]
      ); /* 国际化处理： 未加载到本页面多语资源 */
    }
  };
    ...
    let tabs = [
      {
        ...
        num: "(0)",
        status: "-1,0",
        content: multiLang["361703DBA-000001"] /* 国际化处理： 待提交*/,
      },
      {
        key: "approving",
        num: "(0)",
        status: "2,3",
        content: multiLang["361703DBA-000002"] /* 国际化处理： 审批中*/,
      },
      {
        key: "all",
        num: "",
        status: "5",
        content: multiLang["361703DBA-000005"] /* 国际化处理： 全部*/,
      },
    ]; //tab页签
    return (
      <BaseList
