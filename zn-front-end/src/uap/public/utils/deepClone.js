...
let newClone = function(data) {
    var v = JSON.stringify(data, function (k, v) {
        if (
            Object.prototype.toString.call(v) === '[object Array]' ||
            Object.prototype.toString.call(v) === '[object String]' ||
            Object.prototype.toString.call(v) === '[object Undefined]' ||
            Object.prototype.toString.call(v) === '[object Null]' ||
            (Object.prototype.toString.call(v) === '[object Object]' && !v.$$typeof) ||
    ...
    if (typeof v !== 'string' ||  v.length < 23456789) {
        v = clone(data);
    } else {
        v = JSON.parse(v);
    }
