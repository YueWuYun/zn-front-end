...
class UploadImg extends Component {
    ...
    render() {
        ...
        return (
            <div>
                {uploadModalShow && <NCModal dialogClassName="upload-model" fieldid="upload_modal-area"
                    ...
                    <NCModal.Body>
                        <NCUpload fieldid="upload_img" {...props} beforeUpload={this.beforeUpload}
                            data={{...paramObj}}    
                            action={uploadAction || '/upload.do'}
                            NcUploadOnChange={this.uploadChange.bind(this)}>
                            <NCButton shape="border" colors="second">
                                <NCIcon type="uf-upload" fieldid="upload_btn_icon"/> {this.state.json['1880000025-000014']}
                            </NCButton>
                    ...
                    <NCModal.Footer fieldid="bottom-area">
                        <NCButton onClick={ this.closeModal.bind(this, 'ensure') } colors="second" fieldid="ensure">{this.state.json['1880000025-000015']}</NCButton>
                        <NCButton onClick={ this.closeModal.bind(this, 'del') } colors="primary" disabled={!uploadImgSrc} fieldid="cancel">{this.state.json['1880000025-000016']}</NCButton>
