/*2+0Qf+roUlDHXBeA/o9JMKm61vPibpbCxVeqRBzEHbQpiJrCo/vlHvH0VCwZCApQ*/
...
export default function buttonVisible(props) {
  ...
  if (scene === "approvesce" || scene === "linksce" || ntbparadimvo) return;
  // 审批状态
  ...
  if (status && !isBrowse) {
    ...
    if (
      ...
      showBtn.push("print", "printout", "file", "refresh");
