...
//应用编码
export const APPCODE = '96H10110';

//单据类型
export const BILL_TYPE_CODE = 'ZJJH';
 ...
 */
export const LIST = {
        page_title: '96H10110-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '96H10110_LIST',                     //页面编码
...
//请求基础路径
export const base_path = '/nccloud/zjcmp_cd/zz/';

//url
export const REQUEST_URL = {
        save: `/nccloud/zjcmp_cd/zz/savezzfundplanVO.do`,                       //保存
        delete: `/nccloud/zjcmp_cd/zz/deletezzfundplanVO.do`,                        //删除
        queryCard: `/nccloud/zjcmp_cd/zz/querycardzzfundplanVO.do`,                      //卡片查询
        queryList: `/nccloud/zjcmp_cd/zz/querypagezzfundplanVO.do`,              //列表查询
        queryListByPks: `/nccloud/zjcmp_cd/zz/querypagebypkzzfundplanVO.do`,     //列表分页查询
        commit: `/nccloud/zjcmp_cd/zz/commitzzfundplanVO.do`,                   //提交
        unCommit: `/nccloud/zjcmp_cd/zz/uncommitzzfundplanVO.do`,               //收回
