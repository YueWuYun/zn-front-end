...
//应用编码
export const APPCODE = '96H10107';

//单据类型
export const BILL_TYPE_CODE = 'NCCD';
 ...
 */
export const LIST = {
        page_title: '96H10107-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '96H10107_LIST',                     //页面编码
...
//请求基础路径
export const base_path = '/nccloud/zjcmp_cd/zjcmp_cd/';

//url
export const REQUEST_URL = {
        save: `/nccloud/zjcmp_cd/zjcmp_cd/savejtdbdeVO.do`,                       //保存
        delete: `/nccloud/zjcmp_cd/zjcmp_cd/deletejtdbdeVO.do`,                        //删除
        queryCard: `/nccloud/zjcmp_cd/zjcmp_cd/querycardjtdbdeVO.do`,                      //卡片查询
        queryList: `/nccloud/zjcmp_cd/zjcmp_cd/querypagejtdbdeVO.do`,              //列表查询
        queryListByPks: `/nccloud/zjcmp_cd/zjcmp_cd/querypagebypkjtdbdeVO.do`,     //列表分页查询
        commit: `/nccloud/zjcmp_cd/zjcmp_cd/commitjtdbdeVO.do`,                   //提交
        unCommit: `/nccloud/zjcmp_cd/zjcmp_cd/uncommitjtdbdeVO.do`,               //收回
...
export const FIELD = {
        org: 'pk_org',                                                   //组织
        //orgV: 'pk_org_v',                                              //组织多版本
        billStatus: 'billstatus',                             //单据状态字段（用以按钮控制）
        ts: 'ts'                                                                 //时间戳
};

//主属性字段名
export const PRIMARY_KEY = {
        head_id: 'pk_billcode',           //表头主键字段名
        body_id: 'pk_billbody',           //表体主键字段名
