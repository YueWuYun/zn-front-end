...
export default function bodyButtonClick(props, key, text, record, index) {
    ...
    switch (key) {
        ...
        case 'calculategrid':
            listSingleOperator.call(this,props, list_page_id, 'head',requesturl.calculate, record,'pk_demandintcal', index, this.state.json['36340CDIC-000013']/**国际化处理：计息 */, demandintcalCacheKey);
            break;
        case 'uncalculategrid':
            listSingleOperator.call(this,props, list_page_id, 'head',requesturl.uncalculate, record,'pk_demandintcal', index, this.state.json['36340CDIC-000014']/**国际化处理：取消计息 */, demandintcalCacheKey);
            break;
        case 'preaccruedgrid':
        ...
        case 'unpreaccruedgrid':
            listSingleOperator.call(this,props, list_page_id, 'head',requesturl.unpreaccrued, record,'pk_demandintcal', index, this.state.json['36340CDIC-000016']/**国际化处理：取消预提 */, demandintcalCacheKey);
           break;
    }
};
