...
export default function (props, id) {
  ...
  switch (id) {
    ...
    case 'voucher':
        if(!pk_intlistv){
            toast({color:"warning",content:this.state.json['36340FDIB-000015']}) 
            return;
        }
        let pk_intlist = this.props.form.getFormItemsValue(formId, 'pk_interest').value;
        ...
        linkVoucherApp.call(this,props,pk_intlist,pk_groupv,pk_orgv,'36LW',billnov);
        break;
     //联查存单
     case 'dereceipt':
...
                    processFormulamsg(this.props, res);
                    ...
                    toast({
                        duration: 3,
                        title: this.state.json['36340FDIB-000004']/**国际化处理：刷新成功 */,
                        color: 'success'
                    })
                } 
            }
