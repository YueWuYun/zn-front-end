...
class List extends Component {
	...
	componentWillMount() {
		...
		getMultiLang({ moduleId: '36340FDIC', domainName: 'ifac', callback });
	}
			...
			<div className="nc-bill-list">
                ...
                <NCDiv areaCode={NCDiv.config.HEADER} className="nc-bill-header-area" >                
                        <div className="header-title-search-area">
                            {createBillHeadInfo(
                                {
									title:this.state.json['36340FDIC-000024'],
	...
	withholdingContent() {
		return (
			<div className="addModal">
				...
				{this.state.json['36340FDIC-000025']/**国际化处理：预提结束日 */}
				</span>}
				<NCDatePicker
					format={dateFormat}
					placeholder={this.state.json['36340FDIC-000026']/**国际化处理：选择日期 */}
