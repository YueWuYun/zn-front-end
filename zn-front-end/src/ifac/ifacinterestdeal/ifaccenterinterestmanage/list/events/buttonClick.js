    ...
    switch (id) {
        ...
        case 'preaccrued':
            ...
            modal.show('withholding',{
               title: this.state.json['36340FDIC-000015']/**国际化处理：预提结束日录入 */,
               //点击确定按钮事件
        ...
        //内部定期利息管理取消预提
        case 'unpreaccrued':
            listMultiOperator.call(this,props, list_page_id, 'head', 'pk_depositreceipt', requesturl.unpreaccrued, this.state.json['36340FDIC-000016']/**国际化处理：取消预提 */,'depositcode', demandintcalCacheKey);
            break;
        ...
        case 'trycalculate':
            ...
            modal.show('tryinterest',{
               title: this.state.json['36340FDIC-000017']/**国际化处理：试算日期录入 */,
               //点击确定按钮事件
            ...
            ajax({
                ...
                success: (res) => {
                    ...
                    if (success) {
                        ...
                        toast({
                            duration: 3,
                            title: this.state.json['36340FDIC-000018']/**国际化处理：刷新成功 */,
                            color: 'success'
                        })
                    }
