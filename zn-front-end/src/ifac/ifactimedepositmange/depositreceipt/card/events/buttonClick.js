...
          title: this.state.json['36340FDLB-000068'],// 弹框表头信息/* 国际化处理： 确认修改*/
          content: this.state.json['36340FDLB-000069'],//this.modalContent(), //弹框内容，可以是字符串或dom/* 国际化处理： 计息对象未计息，修改有可能导致积数调整失效，是否继续?*/
