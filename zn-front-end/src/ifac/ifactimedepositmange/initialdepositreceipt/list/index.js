...
import { moduleId, list, card, javaUrl,baseReqUrl, billtype, appCode } from "../cons/constant.js";
import { NCTabs } from "../commom";
import {go2CardCheck,appendMultiLangRes } from "../../../../tmpub/pub/util/index"; 
...
class List extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            //     DQR: {
            //         num: "0",
            //         content: "36340FDLI-000014" /* 国际化处理： 待确认*/,
            //         status: "1"
            //     },
            //     YQR: {
            //         num: "0",
            //         content: "36340FDLI-000015" /* 国际化处理： 已确认*/,
            //         status: "2"
            //     },
            //     all: {
            //         num: "",
            //         content: "36340FDLI-000016" /* 国际化处理： 全部*/,
            //         status: ""
            //     }
            // }, //tab页签
    ...
    getAssginUsedr = val => {
        bodyBtnOperation.call(
            ...
            javaUrl.commit,
            this.state.json["36340FDLI-000017"],
            false,
            val
        ); /* 国际化处理： 提交成功*/
    };
            ...
            <div className="nc-bill-list" >
                ...
                <NCDiv areaCode={NCDiv.config.HEADER} className="nc-bill-header-area">
                        <div className="header-title-search-area">
                            {createBillHeadInfo(
								{
                                    title: this.state.json["36340FDLI-000002"],
                                    // loadMultiLang(this.props, '36340FDLI-000002'),//国际化处理： 内部定期业务品种设置
                ...
                <div className="nc-bill-search-area">
                    {NCCreateSearch(this.searchId, {
                        ...
                        // searchBtnName: this.state.json["36340FDLI-000018"] /* 国际化处理： 查询*/,
