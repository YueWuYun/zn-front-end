    ...
    if (Object.keys(pkMapTs).length > 0) {
        ajax({
            ...
            success: (res) => {
                ...
                succContent = succCount > 0 ? loadMultiLang(props, '36340FDW-000038')+succContent + loadMultiLang(props, '36340--000120')/*'项'*/ + actionname + loadMultiLang(props, '36340--000121')/*'成功'*/ : '';
                let content = (succContent == '' ? '' : succContent + '，') + (failCount > 0 ? loadMultiLang(props, '36340FDW-000038')+errContent + loadMultiLang(props, '36340--000120')/*'项'*/  + actionname + loadMultiLang(props, '36340--000122')/*'失败'*/ : '');
                //全部成功
