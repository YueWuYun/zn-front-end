...
let {pageCodeCard, billtype,pkname,FixedWithDrawapplyApproveConst, formId ,base_url } = CONSTANTS;
		...
		return ( 
			<div className="nc-bill-card">
				...
				{createCardWebSocket(this.props, {
                    ...
                    billpkname: pkname,
					billtype: billtype,
					dataSource:FixedWithDrawapplyApproveConst.dataSource
