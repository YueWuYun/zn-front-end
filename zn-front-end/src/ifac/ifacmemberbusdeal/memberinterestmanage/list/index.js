...
class List extends Component {
	...
	componentWillMount() {
		...
		getMultiLang({ moduleId: '36340FDICC', domainName: 'ifac', callback });
	}
			...
			<div className="nc-bill-list">
                ...
                <NCDiv areaCode={NCDiv.config.HEADER} className="nc-bill-header-area" >                
                        <div className="header-title-search-area">
                            {createBillHeadInfo(
                                {
									title:this.state.json['36340FDICC-000024'],
	...
	withholdingContent() {
		return (
			<div className="addModal">
				...
				{this.state.json['36340FDICC-000025']/**国际化处理：预提结束日 */}
				</span>}
				<NCDatePicker
					format={dateFormat}
					placeholder={this.state.json['36340FDICC-000026']/**国际化处理：选择日期 */}
	...
	trycontent () {
		return (
			<div className="addModal">
				<div style={{ height: '35px'}} />
				{<span className="modal-label">
				{this.state.json['36340FDICC-000028']/**国际化处理：结束日期 */}
				</span>}
				<NCDatePicker
					format={dateFormat}
					placeholder={this.state.json['36340FDICC-000026']/**国际化处理：选择日期 */}
