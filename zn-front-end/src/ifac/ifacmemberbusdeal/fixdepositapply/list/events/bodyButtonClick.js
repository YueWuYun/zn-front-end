...
import { card, baseReqUrl, javaUrl,list } from '../../cons/constant.js';
...
export function bodyButtonClick (key, record, index) {
    ...
    switch (key) {
        ...
        case DELETE_INNER_BTN:  //删除 
            bodyBtnOperation.call(this, list, javaUrl.delete, this.state.json['36340FDSA-000007'], false, null, this.state.json['36340FDSA-000005'])/* 国际化处理： 删除成功!*/
            break;
        case SUBMIT_INNER_BTN:  //提交
            bodyBtnOperation.call(this, list, javaUrl.commit, this.state.json['36340FDSA-000001'], false, null, this.state.json['36340FDSA-000023']);/* 国际化处理： 提交成功!,提交,提交*/
            break;
        case  UNSUBMIT_INNER_BTN:  //收回
            bodyBtnOperation.call(this, list, javaUrl.uncommit, this.state.json['36340FDSA-000010'], false, null, this.state.json['36340FDSA-000024']);/* 国际化处理： 收回成功!,收回,收回*/
            break;
        case ENTRUST_INNER_BTN:  //委托办理
            bodyBtnOperation.call(this, list, javaUrl.entrust, this.state.json['36340FDSA-000028'], false, null, this.state.json['36340FDSA-000030']);/* 国际化处理： 提交成功!,提交,提交*/
            break;
        case  UNENTRUST_INNER_BTN:  //取消委托办理
            bodyBtnOperation.call(this, list, javaUrl.unentrust, this.state.json['36340FDSA-000029'], false, null, this.state.json['36340FDSA-000031']);/* 国际化处理： 收回成功!,收回,收回*/
            break;
        default:
            break;
    }
...
export function bodyBtnOperation (list, path, content, isBatch= false, userObj= null, opername) {
    if (isBatch && !list.length) {
        toast({
            color: 'warning', content: this.state.json['36340FDSA-000020']/* 国际化处理： 请选择至少一条数据!*/
        });
        return;
    }
    let data= {
