...
import {appendMultiLangRes} from "../../../../tmpub/pub/util/index";
//联查内部账户组件
...
class Card extends Component {
    ...
    getAssginUsedr = val => {
        this.btnOperation(
            javaUrl.commit,
            this.state.json["36140DV-000001"],
            null,
            val
        ); /* 国际化处理： 提交成功!*/
    };
    ...
    render() {
        ...
        let { showApproveDetail, compositedisplay, compositedata, accModalShow, currentpk } = this.state;
        let { createForm } = form;
