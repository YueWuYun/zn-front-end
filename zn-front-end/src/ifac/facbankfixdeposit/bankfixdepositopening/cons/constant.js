...
*/
//请求后台接口基础路径
export const baseReqUrl = '/nccloud/ifac/bankfixdepositopening/';   
//按钮平铺显示数量
export const btnLimit = 3;
//appcode
export const appCode = '36140FDLI';
//appcode--联查
...
// 列表页面相关编码
export const list= {
    pageCode: '36140FDLI_L01',                                 //列表页面code
    btnCode: 'list_head',                                       //列表页面按钮区域code
    searchCode: '36140FDLI_list_search',                                  //列表页面查询区域code
    tableCode: 'head',                                    //列表页面表格区域code
    bodyCode: 'list_inner',                                     //列表页面表格区域按钮code
    searchOid: '1001Z61000000000TCDA',                          //列表页面查询区域oid
    listCache: 'ifac.facbankfixdeposit.bankfixdepositopening.tableData',         //列表页面缓存
    ...
    searchKey: 'ifac.facbankfixdeposit.bankfixdepositopening.list.search.key',            //查询区域缓存的key 
    statusKey: 'ifac.facbankfixdeposit.bankfixdepositopening.list.status.key',            //tab状态区域缓存的key
    statusNumKey: 'ifac.facbankfixdeposit.bankfixdepositopening.list.statusNum.key',      //tab状态区域数量缓存的key
...
*/
export const card= {
    pageCode: '36140FDLI_C01',                             //卡片页面code
    pageCode_appro: '36140FDLI_C01',                      //卡片页面code--联查
    primaryId: 'pk_fixdepostopening',                     //卡片页面主键ID
    headCode: 'head',                                     //卡片页面主表区域code
    form02: "36140FDLI_C01_form01", //卡片页面主表区域code
    form03: "36140FDLI_C01_form02", //卡片页面主表区域code
    btnCode: 'card_head',                                    //卡片页面按钮区域code
    cardCache: 'ifac.facbankfixdeposit.bankfixdepositopening.cacheKey',      //卡片页面缓存
};
/**
 * 表字段名称
*/
