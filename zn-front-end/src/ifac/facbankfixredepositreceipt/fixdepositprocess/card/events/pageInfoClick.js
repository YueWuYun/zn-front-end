...
import { pageCodeCard, formId, base_url, pkname, dataSource } from '../../cons/constant';
...
export default function (props, pk) {
    ...
    if (cardData) {
        ...
        this.billID = cardData.head[formId].rows[0].values.pk_deposit.value || '';
        ...
        ajax({
            ...
            success: (res) => {
                if (res.data) {
                    ...
                    toast({ color: 'warning', content: this.props.MutiInit.getIntl("36140FDSR") && this.props.MutiInit.getIntl("36140FDSR").get('36140FDSR-000033') });
