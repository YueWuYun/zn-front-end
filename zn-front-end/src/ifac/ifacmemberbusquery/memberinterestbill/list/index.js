...
class List extends Component {
	...
	componentWillMount() {
		...
		getMultiLang({ moduleId: '36341FNIBS', domainName: 'ifac', callback },{
	...
	onRowDoubleClick = (record,index,props,e) =>{
		let pk = record.pk_interest.value;
		let type = this.props.getUrlParam('type');
	...
	render() {
		...
		return (
			<div className="nc-bill-list">
                            ...
                            {createBillHeadInfo(
                                {
									...
									title:this.state.json['36341FNIBS-000017'],
				...
				{(scene != 'linksce' && scene != 'fip'&&type2!='tryinter'&&type2!='interlist') ? 
