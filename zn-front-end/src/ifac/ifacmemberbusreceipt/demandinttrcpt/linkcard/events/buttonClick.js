  ...
  switch (id) {
    ...
    case 'LinkReceipt':
      ...
      if (pk_banktype != '0001Z01000000000036R') {
        toast({ color: "warning", content: that.state.json['36340CDIR-000052'] })/* 国际化处理： 银行账户不存在回单*/
        break;
      }

      if (account_no === null || account_no == '' || account_no === undefined) {
        toast({ color: "warning", content: that.state.json['36340CDIR-000008'] })/* 国际化处理： 暂无数据*/
        break;
      }
